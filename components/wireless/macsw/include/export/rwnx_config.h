 ...
 ****************************************************************************************
 */
/* Include mac_types.h for AC_MAX. Use the public include path so both
   macsw internal and external consumers can find it. */
#include "mac_types.h"

/// Build for fully hosted partitioning
#ifdef CFG_FHOST
  #define NX_FULLY_HOSTED  1
  // Phase 10G/H: AMSDU enabled (was #undef CFG_AMSDU)
  // #undef CFG_AMSDU
...
/// Beaconing support
  ...
  #define NX_BEACON_AC_VI 0
  #define NX_AC_BCN_USED  1
#else
...
/**
 *******************************************************************************
 * @name Compatibility macros for release code (NX_* aliases for RW_* names)
 *******************************************************************************
 */
/// Whether specific HE MU Access Point code is enabled or not
#ifndef NX_MAC_HE_MU_AP
#define NX_MAC_HE_MU_AP 0
#endif

/// Maximum number of simultaneous users in TX/RX
#ifndef NX_MU_USER_MAX
#define NX_MU_USER_MAX RW_USER_MAX
#endif

/// MESH compatibility
#ifndef NX_MESH
#define NX_MESH RW_MESH_EN
#endif
#ifndef NX_UMESH
#define NX_UMESH RW_UMESH_EN
#endif
#ifndef NX_MESH_VIF_NB
#define NX_MESH_VIF_NB RW_MESH_VIF_NB
#endif
#ifndef NX_MESH_LINK_NB
#define NX_MESH_LINK_NB RW_MESH_LINK_NB
#endif
#ifndef NX_MESH_PATH_NB
#define NX_MESH_PATH_NB RW_MESH_PATH_NB
#endif
#ifndef NX_MESH_PROXY_NB
#define NX_MESH_PROXY_NB RW_MESH_PROXY_NB
#endif

/// TX descriptor max count
#ifndef NX_TX_DESC_MAX
#if NX_TXDESC_CNT1 > NX_TXDESC_CNT0
#define NX_TX_DESC_MAX_BK_BE NX_TXDESC_CNT1
#else
#define NX_TX_DESC_MAX_BK_BE NX_TXDESC_CNT0
#endif
#if NX_TXDESC_CNT3 > NX_TXDESC_CNT2
#define NX_TX_DESC_MAX_VI_VO NX_TXDESC_CNT3
#else
#define NX_TX_DESC_MAX_VI_VO NX_TXDESC_CNT2
#endif
#if NX_TX_DESC_MAX_VI_VO > NX_TX_DESC_MAX_BK_BE
#define NX_TX_DESC_MAX NX_TX_DESC_MAX_VI_VO
#else
#define NX_TX_DESC_MAX NX_TX_DESC_MAX_BK_BE
#endif
#endif

/// Beamformer compatibility
#ifndef NX_BFMER
#define NX_BFMER RW_BFMER_EN
#endif
#ifndef NX_BFR_TXFRAME_CNT
#define NX_BFR_TXFRAME_CNT RW_BFR_TXFRAME_CNT
#endif
#ifndef NX_NFR_TXFRAME_CNT
#define NX_NFR_TXFRAME_CNT NX_BFR_TXFRAME_CNT
#endif

/// Flag indicating if the FW is compiled for a MAC HW implementing per-user RX buffers
#ifndef NX_RX_PER_USER_BUF
#define NX_RX_PER_USER_BUF 0
#endif

/// HE MU AP
#ifndef NX_HE_MU_AP
#define NX_HE_MU_AP 0
#endif

/// MU TX descriptor count
#ifndef NX_MU_TXDESC_CNT
#define NX_MU_TXDESC_CNT 0
#endif
