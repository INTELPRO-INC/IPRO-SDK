...
#ifndef _EXPORT_ENUM_H_
#define _EXPORT_ENUM_H_

/* Skip enum declarations when compiling macsw internal code, as the
   release headers already define them. */
