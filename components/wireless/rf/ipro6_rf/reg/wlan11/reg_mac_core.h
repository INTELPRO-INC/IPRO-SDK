...
#ifndef RW_KEY_EXTENDED
#define RW_KEY_EXTENDED  0
#endif
 ...
 * <tr><td> 31:00 <td> signature <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_SIGNATURE_ADDR   0x24B00000
 ...
 * <table>
 * <caption>VERSION_1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 19 <td>   muMIMOTx <td> W <td> R <td> 0
 * <tr><td> 18 <td>      bfmer <td> W <td> R <td> 0
 * <tr><td> 17 <td>      bfmee <td> W <td> R <td> 0
 * <tr><td> 15 <td>         he <td> W <td> R <td> 1
 * <tr><td> 14 <td>       coex <td> W <td> R <td> 0
 * <tr><td> 13 <td>       wapi <td> W <td> R <td> 0
 * <tr><td> 12 <td>        tpc <td> W <td> R <td> 1
 * <tr><td> 11 <td>        vht <td> W <td> R <td> 1
 * <tr><td> 10 <td>         ht <td> W <td> R <td> 1
 * <tr><td> 09 <td>       gcmp <td> W <td> R <td> 0
 * <tr><td> 08 <td>        rce <td> W <td> R <td> 0
 * <tr><td> 07 <td>       ccmp <td> W <td> R <td> 0
 * <tr><td> 06 <td>       tkip <td> W <td> R <td> 0
 * <tr><td> 05 <td>        wep <td> W <td> R <td> 0
 * <tr><td> 04 <td>   security <td> W <td> R <td> 0
 * <tr><td> 03 <td>        sme <td> W <td> R <td> 0
 * <tr><td> 01 <td>       edca <td> W <td> R <td> 1
 * <tr><td> 00 <td>        qos <td> W <td> R <td> 1
 * </table>
 *
 * @{
 */
...
#define NXMAC_VERSION_1_ADDR   0x24B00004
...
#define NXMAC_VERSION_1_RESET  0x00009C03
...
/// HE field bit
#define NXMAC_HE_BIT            ((uint32_t)0x00008000)
/// HE field position
#define NXMAC_HE_POS            15
/// COEX field bit
...
/// GCMP field bit
#define NXMAC_GCMP_BIT          ((uint32_t)0x00000200)
/// GCMP field position
#define NXMAC_GCMP_POS          9
/// RCE field bit
...
/// GCMP field reset value
#define NXMAC_GCMP_RST          0x0
 ...
 * @param[out] gcmp - Will be populated with the current value of this field from the register.
 ...
 */
__INLINE void nxmac_version_1_unpack(uint8_t* mumimotx, uint8_t* bfmer, uint8_t* bfmee, uint8_t* he, uint8_t* coex, uint8_t* wapi, uint8_t* tpc, uint8_t* vht, uint8_t* ht, uint8_t* gcmp, uint8_t* rce, uint8_t* ccmp, uint8_t* tkip, uint8_t* wep, uint8_t* security, uint8_t* sme, uint8_t* edca, uint8_t* qos)
{
    ...
    *he = (localVal & ((uint32_t)0x00008000)) >> 15;
    ...
    *gcmp = (localVal & ((uint32_t)0x00000200)) >> 9;
...
/**
 * @brief Returns the current value of the he field in the VERSION_1 register.
 *
 * The VERSION_1 register will be read and the he field's value will be returned.
 *
 * @return The current value of the he field in the VERSION_1 register.
 */
__INLINE uint8_t nxmac_he_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_VERSION_1_ADDR);
...
/**
 * @brief Returns the current value of the gcmp field in the VERSION_1 register.
 *
 * The VERSION_1 register will be read and the gcmp field's value will be returned.
 *
 * @return The current value of the gcmp field in the VERSION_1 register.
 */
__INLINE uint8_t nxmac_gcmp_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_VERSION_1_ADDR);
 ...
 * <table>
 * <caption>VERSION_2 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 16:14 <td>    phaseNumber <td> W <td> R <td> 0x0
 * <tr><td> 13:08 <td>  releaseNumber <td> W <td> R <td> 0x0
 * <tr><td> 07    <td>      ieRelease <td> W <td> R <td> 0
 * <tr><td> 06:00 <td>      umVersion <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_VERSION_2_ADDR   0x24B00008
 ...
 * <table>
 * <caption>BITMAP_CNT bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 15:00 <td>  bitmapCnt <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_BITMAP_CNT_ADDR   0x24B0000C
 ...
 * <table>
 * <caption>MAC_ADDR_LOW bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>   macAddrLow <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_MAC_ADDR_LOW_ADDR   0x24B00010
 ...
 * <table>
 * <caption>MAC_ADDR_HI bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 15:00 <td>   macAddrHigh <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_MAC_ADDR_HI_ADDR   0x24B00014
 ...
 * <table>
 * <caption>MAC_ADDR_LOW_MASK bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>    macAddrLowMask <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_MAC_ADDR_LOW_MASK_ADDR   0x24B00018
 ...
 * <table>
 * <caption>MAC_ADDR_HI_MASK bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 15:00 <td>    macAddrHighMask <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_MAC_ADDR_HI_MASK_ADDR   0x24B0001C
 ...
 * <table>
 * <caption>BSS_ID_LOW bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>   bssIDLow <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_BSS_ID_LOW_ADDR   0x24B00020
 ...
 * <table>
 * <caption>BSS_ID_HI bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 15:00 <td>   bssIDHigh <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_BSS_ID_HI_ADDR   0x24B00024
 ...
 * <table>
 * <caption>BSS_ID_LOW_MASK bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>    bssIDLowMask <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_BSS_ID_LOW_MASK_ADDR   0x24B00028
 ...
 * <table>
 * <caption>BSS_ID_HI_MASK bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 15:00 <td>    bssIDHighMask <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_BSS_ID_HI_MASK_ADDR   0x24B0002C
...
/**
 * @name BSS_COLOR register definitions
 * <table>
 * <caption>BSS_COLOR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 09    <td>    partialBSSColorEn <td> R <td> R/W <td> 0
 * <tr><td> 08    <td>           bssColorEn <td> R <td> R/W <td> 0
 * <tr><td> 05:00 <td>             bssColor <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the BSS_COLOR register
#define NXMAC_BSS_COLOR_ADDR   0x24B00034
/// Offset of the BSS_COLOR register from the base address
#define NXMAC_BSS_COLOR_OFFSET 0x00000034
/// Index of the BSS_COLOR register
#define NXMAC_BSS_COLOR_INDEX  0x0000000D
/// Reset value of the BSS_COLOR register
#define NXMAC_BSS_COLOR_RESET  0x00000000

/**
 * @brief Returns the current value of the BSS_COLOR register.
 * The BSS_COLOR register will be read and its value returned.
 * @return The current value of the BSS_COLOR register.
 */
__INLINE uint32_t nxmac_bss_color_get(void)
{
    return REG_PL_RD(NXMAC_BSS_COLOR_ADDR);
}

/**
 * @brief Sets the BSS_COLOR register to a value.
 * The BSS_COLOR register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_bss_color_set(uint32_t value)
{
    REG_PL_WR(NXMAC_BSS_COLOR_ADDR, value);
}
...
/**
 * @brief Constructs a value for the BSS_COLOR register given values for its fields
 * and writes the value to the register.
 *
 * @param[in] partialbsscoloren - The value to use for the partialBSSColorEn field.
 * @param[in] bsscoloren - The value to use for the bssColorEn field.
 * @param[in] bsscolor - The value to use for the bssColor field.
 */
__INLINE void nxmac_bss_color_pack(uint8_t partialbsscoloren, uint8_t bsscoloren, uint8_t bsscolor)
{
    ASSERT_ERR((((uint32_t)partialbsscoloren << 9) & ~((uint32_t)0x00000200)) == 0);
    ASSERT_ERR((((uint32_t)bsscoloren << 8) & ~((uint32_t)0x00000100)) == 0);
    ASSERT_ERR((((uint32_t)bsscolor << 0) & ~((uint32_t)0x0000003F)) == 0);
    REG_PL_WR(NXMAC_BSS_COLOR_ADDR,  ((uint32_t)partialbsscoloren << 9) | ((uint32_t)bsscoloren << 8) | ((uint32_t)bsscolor << 0));
}

/**
 * @brief Unpacks BSS_COLOR's fields from current value of the BSS_COLOR register.
 *
 * Reads the BSS_COLOR register and populates all the _field variables with the corresponding
 * values from the register.
 *
 * @param[out] partialbsscoloren - Will be populated with the current value of this field from the register.
 * @param[out] bsscoloren - Will be populated with the current value of this field from the register.
 * @param[out] bsscolor - Will be populated with the current value of this field from the register.
 */
__INLINE void nxmac_bss_color_unpack(uint8_t* partialbsscoloren, uint8_t* bsscoloren, uint8_t* bsscolor)
{
    uint32_t localVal = REG_PL_RD(NXMAC_BSS_COLOR_ADDR);

    *partialbsscoloren = (localVal & ((uint32_t)0x00000200)) >> 9;
    *bsscoloren = (localVal & ((uint32_t)0x00000100)) >> 8;
    *bsscolor = (localVal & ((uint32_t)0x0000003F)) >> 0;
}

/**
 * @brief Returns the current value of the partialBSSColorEn field in the BSS_COLOR register.
 *
 * The BSS_COLOR register will be read and the partialBSSColorEn field's value will be returned.
 *
 * @return The current value of the partialBSSColorEn field in the BSS_COLOR register.
 */
__INLINE uint8_t nxmac_partial_bss_color_en_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_BSS_COLOR_ADDR);
    return ((localVal & ((uint32_t)0x00000200)) >> 9);
}
...
/**
 * @brief Sets the partialBSSColorEn field of the BSS_COLOR register.
 *
 * The BSS_COLOR register will be read, modified to contain the new field value, and written.
 *
 * @param[in] partialbsscoloren - The value to set the field to.
 */
__INLINE void nxmac_partial_bss_color_en_setf(uint8_t partialbsscoloren)
{
    ASSERT_ERR((((uint32_t)partialbsscoloren << 9) & ~((uint32_t)0x00000200)) == 0);
    REG_PL_WR(NXMAC_BSS_COLOR_ADDR, (REG_PL_RD(NXMAC_BSS_COLOR_ADDR) & ~((uint32_t)0x00000200)) | ((uint32_t)partialbsscoloren << 9));
}

/**
 * @brief Returns the current value of the bssColorEn field in the BSS_COLOR register.
 *
 * The BSS_COLOR register will be read and the bssColorEn field's value will be returned.
 *
 * @return The current value of the bssColorEn field in the BSS_COLOR register.
 */
__INLINE uint8_t nxmac_bss_color_en_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_BSS_COLOR_ADDR);
    return ((localVal & ((uint32_t)0x00000100)) >> 8);
}
...
/**
 * @brief Sets the bssColorEn field of the BSS_COLOR register.
 *
 * The BSS_COLOR register will be read, modified to contain the new field value, and written.
 *
 * @param[in] bsscoloren - The value to set the field to.
 */
__INLINE void nxmac_bss_color_en_setf(uint8_t bsscoloren)
{
    ASSERT_ERR((((uint32_t)bsscoloren << 8) & ~((uint32_t)0x00000100)) == 0);
    REG_PL_WR(NXMAC_BSS_COLOR_ADDR, (REG_PL_RD(NXMAC_BSS_COLOR_ADDR) & ~((uint32_t)0x00000100)) | ((uint32_t)bsscoloren << 8));
}

/**
 * @brief Returns the current value of the bssColor field in the BSS_COLOR register.
 *
 * The BSS_COLOR register will be read and the bssColor field's value will be returned.
 *
 * @return The current value of the bssColor field in the BSS_COLOR register.
 */
__INLINE uint8_t nxmac_bss_color_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_BSS_COLOR_ADDR);
...
/**
 * @brief Sets the bssColor field of the BSS_COLOR register.
 *
 * The BSS_COLOR register will be read, modified to contain the new field value, and written.
 *
 * @param[in] bsscolor - The value to set the field to.
 */
__INLINE void nxmac_bss_color_setf(uint8_t bsscolor)
{
    ASSERT_ERR((((uint32_t)bsscolor << 0) & ~((uint32_t)0x0000003F)) == 0);
    REG_PL_WR(NXMAC_BSS_COLOR_ADDR, (REG_PL_RD(NXMAC_BSS_COLOR_ADDR) & ~((uint32_t)0x0000003F)) | ((uint32_t)bsscolor << 0));
}
 ...
 * <table>
 * <caption>STATE_CNTRL bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 07:04 <td>     nextState <td> R/W <td> R/W <td> 0x0
 * <tr><td> 03:00 <td>  currentState <td> R/W <td> R <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_STATE_CNTRL_ADDR   0x24B00038
 ...
 * <table>
 * <caption>SCAN_CNTRL bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 22:20 <td>   primaryChPosition <td> R <td> R/W <td> 0x0
 * <tr><td> 15:00 <td>          probeDelay <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_SCAN_CNTRL_ADDR   0x24B0003C
...
// field definitions
/// PRIMARY_CH_POSITION field mask
#define NXMAC_PRIMARY_CH_POSITION_MASK   ((uint32_t)0x00700000)
/// PRIMARY_CH_POSITION field LSB position
#define NXMAC_PRIMARY_CH_POSITION_LSB    20
/// PRIMARY_CH_POSITION field width
#define NXMAC_PRIMARY_CH_POSITION_WIDTH  ((uint32_t)0x00000003)
...
/// PRIMARY_CH_POSITION field reset value
#define NXMAC_PRIMARY_CH_POSITION_RST    0x0
/// PROBE_DELAY field reset value
#define NXMAC_PROBE_DELAY_RST            0x0

/**
 * @brief Constructs a value for the SCAN_CNTRL register given values for its fields
 * and writes the value to the register.
 *
 * @param[in] primarychposition - The value to use for the primaryChPosition field.
 * @param[in] probedelay - The value to use for the probeDelay field.
 */
__INLINE void nxmac_scan_cntrl_pack(uint8_t primarychposition, uint16_t probedelay)
{
    ASSERT_ERR((((uint32_t)primarychposition << 20) & ~((uint32_t)0x00700000)) == 0);
    ASSERT_ERR((((uint32_t)probedelay << 0) & ~((uint32_t)0x0000FFFF)) == 0);
    REG_PL_WR(NXMAC_SCAN_CNTRL_ADDR,  ((uint32_t)primarychposition << 20) | ((uint32_t)probedelay << 0));
}

/**
 * @brief Unpacks SCAN_CNTRL's fields from current value of the SCAN_CNTRL register.
 *
 * Reads the SCAN_CNTRL register and populates all the _field variables with the corresponding
 * values from the register.
 *
 * @param[out] primarychposition - Will be populated with the current value of this field from the register.
 * @param[out] probedelay - Will be populated with the current value of this field from the register.
 */
__INLINE void nxmac_scan_cntrl_unpack(uint8_t* primarychposition, uint16_t* probedelay)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SCAN_CNTRL_ADDR);

    *primarychposition = (localVal & ((uint32_t)0x00700000)) >> 20;
    *probedelay = (localVal & ((uint32_t)0x0000FFFF)) >> 0;
}

/**
 * @brief Returns the current value of the primaryChPosition field in the SCAN_CNTRL register.
 *
 * The SCAN_CNTRL register will be read and the primaryChPosition field's value will be returned.
 *
 * @return The current value of the primaryChPosition field in the SCAN_CNTRL register.
 */
__INLINE uint8_t nxmac_primary_ch_position_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SCAN_CNTRL_ADDR);
...
/**
 * @brief Sets the primaryChPosition field of the SCAN_CNTRL register.
 *
 * The SCAN_CNTRL register will be read, modified to contain the new field value, and written.
 *
 * @param[in] primarychposition - The value to set the field to.
 */
__INLINE void nxmac_primary_ch_position_setf(uint8_t primarychposition)
{
    ASSERT_ERR((((uint32_t)primarychposition << 20) & ~((uint32_t)0x00700000)) == 0);
    REG_PL_WR(NXMAC_SCAN_CNTRL_ADDR, (REG_PL_RD(NXMAC_SCAN_CNTRL_ADDR) & ~((uint32_t)0x00700000)) | ((uint32_t)primarychposition << 20));
}
...
{
    ASSERT_ERR((((uint32_t)probedelay << 0) & ~((uint32_t)0x0000FFFF)) == 0);
    REG_PL_WR(NXMAC_SCAN_CNTRL_ADDR, (REG_PL_RD(NXMAC_SCAN_CNTRL_ADDR) & ~((uint32_t)0x0000FFFF)) | ((uint32_t)probedelay << 0));
}
 ...
 * <table>
 * <caption>DOZE_CNTRL_1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 16    <td>      wakeupDTIM <td> R <td> R/W <td> 0
 * <tr><td> 15:00 <td>  listenInterval <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_DOZE_CNTRL_1_ADDR   0x24B00044
 ...
 */
__INLINE void nxmac_doze_cntrl_1_pack(uint8_t wakeupdtim, uint16_t listeninterval)
{
    ASSERT_ERR((((uint32_t)wakeupdtim << 16) & ~((uint32_t)0x00010000)) == 0);
    ASSERT_ERR((((uint32_t)listeninterval << 0) & ~((uint32_t)0x0000FFFF)) == 0);
    REG_PL_WR(NXMAC_DOZE_CNTRL_1_ADDR,  ((uint32_t)wakeupdtim << 16) | ((uint32_t)listeninterval << 0));
}
 ...
 */
__INLINE void nxmac_doze_cntrl_1_unpack(uint8_t* wakeupdtim, uint16_t* listeninterval)
{
 ...
 * <table>
 * <caption>MAC_CNTRL_1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 26    <td>             rxRIFSEn <td> R <td> R/W <td> 0
 * <tr><td> 25    <td>        tsfMgtDisable <td> R <td> R/W <td> 0
 * <tr><td> 24    <td>       tsfUpdatedBySW <td> R/W <td> R/W <td> 0
 * <tr><td> 19    <td>    disableSVDRxPause <td> R <td> R/W <td> 0
 * <tr><td> 18    <td>       disableBQRResp <td> R <td> R/W <td> 0
 * <tr><td> 16:14 <td>             abgnMode <td> R <td> R/W <td> 0x3
 * <tr><td> 13    <td>       keyStoRAMReset <td> R/W <td> R/W <td> 0
 * <tr><td> 12    <td>        mibTableReset <td> R/W <td> R/W <td> 0
 * <tr><td> 11    <td>   rateControllerMPIF <td> R <td> R/W <td> 1
 * <tr><td> 10    <td>        disableBAResp <td> R <td> R/W <td> 0
 * <tr><td> 09    <td>       disableCTSResp <td> R <td> R/W <td> 0
 * <tr><td> 08    <td>       disableACKResp <td> R <td> R/W <td> 0
 * <tr><td> 07    <td>      activeClkGating <td> R <td> R/W <td> 1
 * <tr><td> 06    <td>    enableLPClkSwitch <td> R <td> R/W <td> 0
 * <tr><td> 05    <td>         lpClk32786Hz <td> R <td> R/W <td> 0
 * <tr><td> 02    <td>               pwrMgt <td> R <td> R/W <td> 0
 * <tr><td> 01    <td>                   ap <td> R <td> R/W <td> 0
 * <tr><td> 00    <td>              bssType <td> R <td> R/W <td> 1
 * </table>
 *
 * @{
 */
...
#define NXMAC_MAC_CNTRL_1_ADDR   0x24B0004C
...
/// DISABLE_SVD_RX_PAUSE field bit
#define NXMAC_DISABLE_SVD_RX_PAUSE_BIT    ((uint32_t)0x00080000)
/// DISABLE_SVD_RX_PAUSE field position
#define NXMAC_DISABLE_SVD_RX_PAUSE_POS    19
/// DISABLE_BQR_RESP field bit
#define NXMAC_DISABLE_BQR_RESP_BIT        ((uint32_t)0x00040000)
/// DISABLE_BQR_RESP field position
#define NXMAC_DISABLE_BQR_RESP_POS        18
...
/// DISABLE_SVD_RX_PAUSE field reset value
#define NXMAC_DISABLE_SVD_RX_PAUSE_RST    0x0
/// DISABLE_BQR_RESP field reset value
#define NXMAC_DISABLE_BQR_RESP_RST        0x0
 ...
 * @param[in] disablesvdrxpause - The value to use for the disableSVDRxPause field.
 * @param[in] disablebqrresp - The value to use for the disableBQRResp field.
 ...
 */
__INLINE void nxmac_mac_cntrl_1_pack(uint8_t rxrifsen, uint8_t tsfmgtdisable, uint8_t tsfupdatedbysw, uint8_t disablesvdrxpause, uint8_t disablebqrresp, uint8_t abgnmode, uint8_t keystoramreset, uint8_t mibtablereset, uint8_t ratecontrollermpif, uint8_t disablebaresp, uint8_t disablectsresp, uint8_t disableackresp, uint8_t activeclkgating, uint8_t enablelpclkswitch, uint8_t lpclk32786hz, uint8_t pwrmgt, uint8_t ap, uint8_t bsstype)
{
    ...
    ASSERT_ERR((((uint32_t)disablesvdrxpause << 19) & ~((uint32_t)0x00080000)) == 0);
    ASSERT_ERR((((uint32_t)disablebqrresp << 18) & ~((uint32_t)0x00040000)) == 0);
    ...
    REG_PL_WR(NXMAC_MAC_CNTRL_1_ADDR,  ((uint32_t)rxrifsen << 26) | ((uint32_t)tsfmgtdisable << 25) | ((uint32_t)tsfupdatedbysw << 24) | ((uint32_t)disablesvdrxpause << 19) | ((uint32_t)disablebqrresp << 18) | ((uint32_t)abgnmode << 14) | ((uint32_t)keystoramreset << 13) | ((uint32_t)mibtablereset << 12) | ((uint32_t)ratecontrollermpif << 11) | ((uint32_t)disablebaresp << 10) | ((uint32_t)disablectsresp << 9) | ((uint32_t)disableackresp << 8) | ((uint32_t)activeclkgating << 7) | ((uint32_t)enablelpclkswitch << 6) | ((uint32_t)lpclk32786hz << 5) | ((uint32_t)pwrmgt << 2) | ((uint32_t)ap << 1) | ((uint32_t)bsstype << 0));
}
 ...
 * @param[out] disablesvdrxpause - Will be populated with the current value of this field from the register.
 * @param[out] disablebqrresp - Will be populated with the current value of this field from the register.
...
__INLINE void nxmac_mac_cntrl_1_unpack(uint8_t* rxrifsen, uint8_t* tsfmgtdisable, uint8_t* tsfupdatedbysw, uint8_t* disablesvdrxpause, uint8_t* disablebqrresp, uint8_t* abgnmode, uint8_t* keystoramreset, uint8_t* mibtablereset, uint8_t* ratecontrollermpif, uint8_t* disablebaresp, uint8_t* disablectsresp, uint8_t* disableackresp, uint8_t* activeclkgating, uint8_t* enablelpclkswitch, uint8_t* lpclk32786hz, uint8_t* pwrmgt, uint8_t* ap, uint8_t* bsstype)
{
    ...
    *disablesvdrxpause = (localVal & ((uint32_t)0x00080000)) >> 19;
    *disablebqrresp = (localVal & ((uint32_t)0x00040000)) >> 18;
...
/**
 * @brief Returns the current value of the disableSVDRxPause field in the MAC_CNTRL_1 register.
 *
 * The MAC_CNTRL_1 register will be read and the disableSVDRxPause field's value will be returned.
 *
 * @return The current value of the disableSVDRxPause field in the MAC_CNTRL_1 register.
 */
__INLINE uint8_t nxmac_disable_svd_rx_pause_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_MAC_CNTRL_1_ADDR);
    return ((localVal & ((uint32_t)0x00080000)) >> 19);
}
...
/**
 * @brief Sets the disableSVDRxPause field of the MAC_CNTRL_1 register.
 *
 * The MAC_CNTRL_1 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] disablesvdrxpause - The value to set the field to.
 */
__INLINE void nxmac_disable_svd_rx_pause_setf(uint8_t disablesvdrxpause)
{
    ASSERT_ERR((((uint32_t)disablesvdrxpause << 19) & ~((uint32_t)0x00080000)) == 0);
    REG_PL_WR(NXMAC_MAC_CNTRL_1_ADDR, (REG_PL_RD(NXMAC_MAC_CNTRL_1_ADDR) & ~((uint32_t)0x00080000)) | ((uint32_t)disablesvdrxpause << 19));
}

/**
 * @brief Returns the current value of the disableBQRResp field in the MAC_CNTRL_1 register.
 *
 * The MAC_CNTRL_1 register will be read and the disableBQRResp field's value will be returned.
 *
 * @return The current value of the disableBQRResp field in the MAC_CNTRL_1 register.
 */
__INLINE uint8_t nxmac_disable_bqr_resp_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_MAC_CNTRL_1_ADDR);
    return ((localVal & ((uint32_t)0x00040000)) >> 18);
}
...
/**
 * @brief Sets the disableBQRResp field of the MAC_CNTRL_1 register.
 *
 * The MAC_CNTRL_1 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] disablebqrresp - The value to set the field to.
 */
__INLINE void nxmac_disable_bqr_resp_setf(uint8_t disablebqrresp)
{
    ASSERT_ERR((((uint32_t)disablebqrresp << 18) & ~((uint32_t)0x00040000)) == 0);
    REG_PL_WR(NXMAC_MAC_CNTRL_1_ADDR, (REG_PL_RD(NXMAC_MAC_CNTRL_1_ADDR) & ~((uint32_t)0x00040000)) | ((uint32_t)disablebqrresp << 18));
}
 ...
 * <table>
 * <caption>MAC_ERR_REC_CNTRL bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 16 <td>       rxFlowCntrlEn <td> R <td> R/W <td> 0
 * <tr><td> 07 <td>     baPSBitmapReset <td> R/W <td> R/W <td> 0
 * <tr><td> 05 <td>   macPHYIFFIFOReset <td> R/W <td> R/W <td> 0
 * <tr><td> 04 <td>         txFIFOReset <td> R/W <td> R/W <td> 0
 * <tr><td> 03 <td>         rxFIFOReset <td> R/W <td> R/W <td> 0
 * <tr><td> 02 <td>          hwFSMReset <td> R/W <td> R/W <td> 0
 * <tr><td> 01 <td>           useErrDet <td> R <td> R/W <td> 0
 * <tr><td> 00 <td>           useErrRec <td> W <td> R <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_MAC_ERR_REC_CNTRL_ADDR   0x24B00054
 ...
 */
__INLINE void nxmac_mac_err_rec_cntrl_pack(uint8_t rxflowcntrlen, uint8_t bapsbitmapreset, uint8_t macphyiffiforeset, uint8_t txfiforeset, uint8_t rxfiforeset, uint8_t hwfsmreset, uint8_t useerrdet)
{
    ...
    REG_PL_WR(NXMAC_MAC_ERR_REC_CNTRL_ADDR,  ((uint32_t)rxflowcntrlen << 16) | ((uint32_t)bapsbitmapreset << 7) | ((uint32_t)macphyiffiforeset << 5) | ((uint32_t)txfiforeset << 4) | ((uint32_t)rxfiforeset << 3) | ((uint32_t)hwfsmreset << 2) | ((uint32_t)useerrdet << 1));
}
 ...
 */
__INLINE void nxmac_mac_err_rec_cntrl_unpack(uint8_t* rxflowcntrlen, uint8_t* bapsbitmapreset, uint8_t* macphyiffiforeset, uint8_t* txfiforeset, uint8_t* rxfiforeset, uint8_t* hwfsmreset, uint8_t* useerrdet, uint8_t* useerrrec)
{
 ...
 * <table>
 * <caption>MAC_ERR_SET_STATUS bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 03 <td>        errInHWLevel3 <td> R/W <td> S <td> 0
 * <tr><td> 02 <td>      errInTxRxLevel2 <td> R/W <td> S <td> 0
 * <tr><td> 01 <td>        errInRxLevel1 <td> R/W <td> S <td> 0
 * <tr><td> 00 <td>        errInTxLevel1 <td> R/W <td> S <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_MAC_ERR_SET_STATUS_ADDR   0x24B00058
 ...
 * <table>
 * <caption>MAC_ERR_CLEAR_STATUS bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 03 <td>         clearErrInHWLevel3 <td> R/W <td> C <td> 0
 * <tr><td> 02 <td>       clearErrInTxRxLevel2 <td> R/W <td> C <td> 0
 * <tr><td> 01 <td>         clearErrInRxLevel1 <td> R/W <td> C <td> 0
 * <tr><td> 00 <td>         clearErrInTxLevel1 <td> R/W <td> C <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_MAC_ERR_CLEAR_STATUS_ADDR   0x24B0005C
 ...
 * <table>
 * <caption>RX_CNTRL bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31 <td>        enDuplicateDetection <td> W <td> R <td> 0
 * <tr><td> 30 <td>               acceptUnknown <td> R <td> R/W <td> 0
 * <tr><td> 29 <td>       acceptOtherDataFrames <td> R <td> R/W <td> 0
 * <tr><td> 28 <td>               acceptQoSNull <td> R <td> R/W <td> 1
 * <tr><td> 27 <td>             acceptQCFWOData <td> R <td> R/W <td> 0
 * <tr><td> 26 <td>                 acceptQData <td> R <td> R/W <td> 1
 * <tr><td> 25 <td>              acceptCFWOData <td> R <td> R/W <td> 0
 * <tr><td> 24 <td>                  acceptData <td> R <td> R/W <td> 1
 * <tr><td> 23 <td>      acceptOtherCntrlFrames <td> R <td> R/W <td> 0
 * <tr><td> 22 <td>                 acceptCFEnd <td> R <td> R/W <td> 0
 * <tr><td> 21 <td>                   acceptACK <td> R <td> R/W <td> 0
 * <tr><td> 20 <td>                   acceptCTS <td> R <td> R/W <td> 0
 * <tr><td> 19 <td>                   acceptRTS <td> R <td> R/W <td> 0
 * <tr><td> 18 <td>                acceptPSPoll <td> R <td> R/W <td> 1
 * <tr><td> 17 <td>                    acceptBA <td> R <td> R/W <td> 1
 * <tr><td> 16 <td>                   acceptBAR <td> R <td> R/W <td> 1
 * <tr><td> 15 <td>       acceptOtherMgmtFrames <td> R <td> R/W <td> 1
 * <tr><td> 14 <td>           acceptBfmeeFrames <td> R <td> R/W <td> 0
 * <tr><td> 13 <td>             acceptAllBeacon <td> R <td> R/W <td> 0
 * <tr><td> 12 <td>         acceptNotExpectedBA <td> R <td> R/W <td> 0
 * <tr><td> 11 <td>    acceptDecryptErrorFrames <td> R <td> R/W <td> 0
 * <tr><td> 10 <td>                acceptBeacon <td> R <td> R/W <td> 1
 * <tr><td> 09 <td>             acceptProbeResp <td> R <td> R/W <td> 1
 * <tr><td> 08 <td>              acceptProbeReq <td> R <td> R/W <td> 1
 * <tr><td> 07 <td>             acceptMyUnicast <td> R <td> R/W <td> 1
 * <tr><td> 06 <td>               acceptUnicast <td> R <td> R/W <td> 0
 * <tr><td> 05 <td>           acceptErrorFrames <td> R <td> R/W <td> 0
 * <tr><td> 04 <td>            acceptOtherBSSID <td> R <td> R/W <td> 0
 * <tr><td> 03 <td>             acceptBroadcast <td> R <td> R/W <td> 1
 * <tr><td> 02 <td>             acceptMulticast <td> R <td> R/W <td> 0
 * <tr><td> 01 <td>                 dontDecrypt <td> R <td> R/W <td> 0
 * <tr><td> 00 <td>              excUnencrypted <td> R <td> R/W <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_RX_CNTRL_ADDR   0x24B00060
 ...
 * <table>
 * <caption>BCN_CNTRL_1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:24 <td>        noBcnTxTime <td> R <td> R/W <td> 0x0
 * <tr><td> 23    <td>     impTBTTIn128Us <td> R <td> R/W <td> 0
 * <tr><td> 22:16 <td>      impTBTTPeriod <td> R <td> R/W <td> 0x0
 * <tr><td> 15:00 <td>          beaconInt <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_BCN_CNTRL_1_ADDR   0x24B00064
 ...
 * <table>
 * <caption>BCN_CNTRL_2 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:16 <td>               aid <td> R <td> R/W <td> 0x0
 * <tr><td> 15:08 <td>         timOffset <td> R <td> R/W <td> 0x0
 * <tr><td> 07:00 <td>   bcnUpdateOffset <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_BCN_CNTRL_2_ADDR   0x24B00068
...
/**
 * @name DTIM_1 register definitions
 * <table>
 * <caption>DTIM_1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31    <td>    dtimUpdatedBySW <td> R/W <td> R/W <td> 0
 * <tr><td> 07:00 <td>         dtimPeriod <td> R/W <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the DTIM_1 register
#define NXMAC_DTIM_1_ADDR   0x24B00090
/// Offset of the DTIM_1 register from the base address
#define NXMAC_DTIM_1_OFFSET 0x00000090
/// Index of the DTIM_1 register
#define NXMAC_DTIM_1_INDEX  0x00000024
/// Reset value of the DTIM_1 register
#define NXMAC_DTIM_1_RESET  0x00000000

/**
 * @brief Returns the current value of the DTIM_1 register.
 * The DTIM_1 register will be read and its value returned.
 * @return The current value of the DTIM_1 register.
 */
__INLINE uint32_t nxmac_dtim_1_get(void)
{
    return REG_PL_RD(NXMAC_DTIM_1_ADDR);
}

/**
 * @brief Sets the DTIM_1 register to a value.
 * The DTIM_1 register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_dtim_1_set(uint32_t value)
{
    REG_PL_WR(NXMAC_DTIM_1_ADDR, value);
}
...
/**
 * @brief Constructs a value for the DTIM_1 register given values for its fields
 * and writes the value to the register.
 *
 ...
 */
__INLINE void nxmac_dtim_1_pack(uint8_t dtimupdatedbysw, uint8_t dtimperiod)
{
    ASSERT_ERR((((uint32_t)dtimupdatedbysw << 31) & ~((uint32_t)0x80000000)) == 0);
    ASSERT_ERR((((uint32_t)dtimperiod << 0) & ~((uint32_t)0x000000FF)) == 0);
    REG_PL_WR(NXMAC_DTIM_1_ADDR,  ((uint32_t)dtimupdatedbysw << 31) | ((uint32_t)dtimperiod << 0));
}

/**
 * @brief Unpacks DTIM_1's fields from current value of the DTIM_1 register.
 *
 * Reads the DTIM_1 register and populates all the _field variables with the corresponding
 * values from the register.
 *
 ...
 */
__INLINE void nxmac_dtim_1_unpack(uint8_t* dtimupdatedbysw, uint8_t* dtimperiod)
{
    uint32_t localVal = REG_PL_RD(NXMAC_DTIM_1_ADDR);
...
/**
 * @brief Returns the current value of the dtimUpdatedBySW field in the DTIM_1 register.
 *
 * The DTIM_1 register will be read and the dtimUpdatedBySW field's value will be returned.
 *
 * @return The current value of the dtimUpdatedBySW field in the DTIM_1 register.
 */
...
/**
 * @brief Sets the dtimUpdatedBySW field of the DTIM_1 register.
 *
 * The DTIM_1 register will be read, modified to contain the new field value, and written.
 *
...
{
    ASSERT_ERR((((uint32_t)dtimupdatedbysw << 31) & ~((uint32_t)0x80000000)) == 0);
    REG_PL_WR(NXMAC_DTIM_1_ADDR, (REG_PL_RD(NXMAC_DTIM_1_ADDR) & ~((uint32_t)0x80000000)) | ((uint32_t)dtimupdatedbysw << 31));
}

/**
 * @brief Returns the current value of the dtimPeriod field in the DTIM_1 register.
 *
 * The DTIM_1 register will be read and the dtimPeriod field's value will be returned.
 *
 * @return The current value of the dtimPeriod field in the DTIM_1 register.
 */
...
/**
 * @brief Sets the dtimPeriod field of the DTIM_1 register.
 *
 * The DTIM_1 register will be read, modified to contain the new field value, and written.
 *
...
{
    ASSERT_ERR((((uint32_t)dtimperiod << 0) & ~((uint32_t)0x000000FF)) == 0);
    REG_PL_WR(NXMAC_DTIM_1_ADDR, (REG_PL_RD(NXMAC_DTIM_1_ADDR) & ~((uint32_t)0x000000FF)) | ((uint32_t)dtimperiod << 0));
}
 ...
 * <table>
 * <caption>RETRY_LIMITS bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 15:08 <td>      dot11LongRetryLimit <td> R <td> R/W <td> 0x4
 * <tr><td> 07:00 <td>     dot11ShortRetryLimit <td> R <td> R/W <td> 0x7
 * </table>
 *
 * @{
 */
...
#define NXMAC_RETRY_LIMITS_ADDR   0x24B00098
 ...
 * <table>
 * <caption>BB_SERVICE bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 28:26 <td>    maxPHYNtx <td> R <td> R/W <td> 0x1
 * <tr><td> 23:16 <td>   bbServiceB <td> R <td> R/W <td> 0x0
 * <tr><td> 15:00 <td>   bbServiceA <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_BB_SERVICE_ADDR   0x24B0009C
...
#define NXMAC_BB_SERVICE_RESET  0x04000000
...
#define NXMAC_MAX_PHY_NTX_RST     0x1
 ...
 * <table>
 * <caption>MAX_POWER_LEVEL bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 23:16 <td>    ofdmMinPwrLevel <td> R <td> R/W <td> 0x0
 * <tr><td> 15:08 <td>    dsssMaxPwrLevel <td> R <td> R/W <td> 0xF
 * <tr><td> 07:00 <td>    ofdmMaxPwrLevel <td> R <td> R/W <td> 0xF
 * </table>
 *
 * @{
 */
...
#define NXMAC_MAX_POWER_LEVEL_ADDR   0x24B000A0
...
#define NXMAC_MAX_POWER_LEVEL_RESET  0x00000F0F
...
// field definitions
/// OFDM_MIN_PWR_LEVEL field mask
#define NXMAC_OFDM_MIN_PWR_LEVEL_MASK   ((uint32_t)0x00FF0000)
/// OFDM_MIN_PWR_LEVEL field LSB position
#define NXMAC_OFDM_MIN_PWR_LEVEL_LSB    16
/// OFDM_MIN_PWR_LEVEL field width
#define NXMAC_OFDM_MIN_PWR_LEVEL_WIDTH  ((uint32_t)0x00000008)
...
/// OFDM_MIN_PWR_LEVEL field reset value
#define NXMAC_OFDM_MIN_PWR_LEVEL_RST    0x0
/// DSSS_MAX_PWR_LEVEL field reset value
#define NXMAC_DSSS_MAX_PWR_LEVEL_RST    0xF
/// OFDM_MAX_PWR_LEVEL field reset value
#define NXMAC_OFDM_MAX_PWR_LEVEL_RST    0xF

/**
 * @brief Constructs a value for the MAX_POWER_LEVEL register given values for its fields
 * and writes the value to the register.
 *
 * @param[in] ofdmminpwrlevel - The value to use for the ofdmMinPwrLevel field.
 ...
 */
__INLINE void nxmac_max_power_level_pack(uint8_t ofdmminpwrlevel, uint8_t dsssmaxpwrlevel, uint8_t ofdmmaxpwrlevel)
{
    ASSERT_ERR((((uint32_t)ofdmminpwrlevel << 16) & ~((uint32_t)0x00FF0000)) == 0);
    ASSERT_ERR((((uint32_t)dsssmaxpwrlevel << 8) & ~((uint32_t)0x0000FF00)) == 0);
    ASSERT_ERR((((uint32_t)ofdmmaxpwrlevel << 0) & ~((uint32_t)0x000000FF)) == 0);
    REG_PL_WR(NXMAC_MAX_POWER_LEVEL_ADDR,  ((uint32_t)ofdmminpwrlevel << 16) | ((uint32_t)dsssmaxpwrlevel << 8) | ((uint32_t)ofdmmaxpwrlevel << 0));
}
 ...
 * values from the register.
 *
 * @param[out] ofdmminpwrlevel - Will be populated with the current value of this field from the register.
 ...
 */
__INLINE void nxmac_max_power_level_unpack(uint8_t* ofdmminpwrlevel, uint8_t* dsssmaxpwrlevel, uint8_t* ofdmmaxpwrlevel)
{
    uint32_t localVal = REG_PL_RD(NXMAC_MAX_POWER_LEVEL_ADDR);

    *ofdmminpwrlevel = (localVal & ((uint32_t)0x00FF0000)) >> 16;
    *dsssmaxpwrlevel = (localVal & ((uint32_t)0x0000FF00)) >> 8;
    *ofdmmaxpwrlevel = (localVal & ((uint32_t)0x000000FF)) >> 0;
}

/**
 * @brief Returns the current value of the ofdmMinPwrLevel field in the MAX_POWER_LEVEL register.
 *
 * The MAX_POWER_LEVEL register will be read and the ofdmMinPwrLevel field's value will be returned.
 *
 * @return The current value of the ofdmMinPwrLevel field in the MAX_POWER_LEVEL register.
 */
__INLINE uint8_t nxmac_ofdm_min_pwr_level_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_MAX_POWER_LEVEL_ADDR);
    return ((localVal & ((uint32_t)0x00FF0000)) >> 16);
}
...
/**
 * @brief Sets the ofdmMinPwrLevel field of the MAX_POWER_LEVEL register.
 *
 * The MAX_POWER_LEVEL register will be read, modified to contain the new field value, and written.
 *
 * @param[in] ofdmminpwrlevel - The value to set the field to.
 */
__INLINE void nxmac_ofdm_min_pwr_level_setf(uint8_t ofdmminpwrlevel)
{
    ASSERT_ERR((((uint32_t)ofdmminpwrlevel << 16) & ~((uint32_t)0x00FF0000)) == 0);
    REG_PL_WR(NXMAC_MAX_POWER_LEVEL_ADDR, (REG_PL_RD(NXMAC_MAX_POWER_LEVEL_ADDR) & ~((uint32_t)0x00FF0000)) | ((uint32_t)ofdmminpwrlevel << 16));
}
 ...
 * <table>
 * <caption>ENCR_KEY_0 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>     encrKeyRAMWord0 <td> R/W <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_ENCR_KEY_0_ADDR   0x24B000AC
 ...
 * <table>
 * <caption>ENCR_KEY_1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>     encrKeyRAMWord1 <td> R/W <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_ENCR_KEY_1_ADDR   0x24B000B0
 ...
 * <table>
 * <caption>ENCR_KEY_2 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>     encrKeyRAMWord2 <td> R/W <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_ENCR_KEY_2_ADDR   0x24B000B4
 ...
 * <table>
 * <caption>ENCR_KEY_3 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>     encrKeyRAMWord3 <td> R/W <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_ENCR_KEY_3_ADDR   0x24B000B8
 ...
 * <table>
 * <caption>ENCR_MAC_ADDR_LOW bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>    macAddrRAMLow <td> R/W <td> R/W <td> 0xFFFFFFFF
 * </table>
 *
 * @{
 */
...
#define NXMAC_ENCR_MAC_ADDR_LOW_ADDR   0x24B000BC
 ...
 * <table>
 * <caption>ENCR_MAC_ADDR_HIGH bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 15:00 <td>    macAddrRAMHigh <td> R/W <td> R/W <td> 0xFFFF
 * </table>
 *
 * @{
 */
...
#define NXMAC_ENCR_MAC_ADDR_HIGH_ADDR   0x24B000C0
 ...
 * <table>
 * <caption>ENCR_CNTRL bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31    <td>         newRead <td> R/W <td> R/W <td> 0
 * <tr><td> 30    <td>        newWrite <td> R/W <td> R/W <td> 0
 * <tr><td> 29    <td>       newSearch <td> R/W <td> R/W <td> 0
 * <tr><td> 28    <td>     searchError <td> W <td> R/W <td> 0
 * <tr><td> 25:16 <td>     keyIndexRAM <td> R/W <td> R/W <td> 0x0
 * <tr><td> 13:12 <td>         cLenRAM <td> R/W <td> R/W <td> 0x0
 * <tr><td> 10:08 <td>        cTypeRAM <td> R/W <td> R/W <td> 0x0
 * <tr><td> 07:04 <td>       vlanIDRAM <td> R/W <td> R/W <td> 0x0
 * <tr><td> 03:02 <td>          sppRAM <td> R/W <td> R/W <td> 0x0
 * <tr><td> 01    <td>    useDefKeyRAM <td> R/W <td> R/W <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_ENCR_CNTRL_ADDR   0x24B000C4
...
/// C_LEN_RAM field mask
#define NXMAC_C_LEN_RAM_MASK         ((uint32_t)0x00003000)
/// C_LEN_RAM field LSB position
#define NXMAC_C_LEN_RAM_LSB          12
/// C_LEN_RAM field width
#define NXMAC_C_LEN_RAM_WIDTH        ((uint32_t)0x00000002)
 ...
 */
__INLINE void nxmac_encr_cntrl_pack(uint8_t newread, uint8_t newwrite, uint8_t newsearch, uint8_t searcherror, uint16_t keyindexram, uint8_t clenram, uint8_t ctyperam, uint8_t vlanidram, uint8_t sppram, uint8_t usedefkeyram)
{
    ...
    ASSERT_ERR((((uint32_t)clenram << 12) & ~((uint32_t)0x00003000)) == 0);
    ...
    REG_PL_WR(NXMAC_ENCR_CNTRL_ADDR,  ((uint32_t)newread << 31) | ((uint32_t)newwrite << 30) | ((uint32_t)newsearch << 29) | ((uint32_t)searcherror << 28) | ((uint32_t)keyindexram << 16) | ((uint32_t)clenram << 12) | ((uint32_t)ctyperam << 8) | ((uint32_t)vlanidram << 4) | ((uint32_t)sppram << 2) | ((uint32_t)usedefkeyram << 1));
}
 ...
 */
__INLINE void nxmac_encr_cntrl_unpack(uint8_t* newread, uint8_t* newwrite, uint8_t* newsearch, uint8_t* searcherror, uint16_t* keyindexram, uint8_t* clenram, uint8_t* ctyperam, uint8_t* vlanidram, uint8_t* sppram, uint8_t* usedefkeyram)
{
    ...
    *clenram = (localVal & ((uint32_t)0x00003000)) >> 12;
...
{
    ASSERT_ERR((((uint32_t)clenram << 12) & ~((uint32_t)0x00003000)) == 0);
    REG_PL_WR(NXMAC_ENCR_CNTRL_ADDR, (REG_PL_RD(NXMAC_ENCR_CNTRL_ADDR) & ~((uint32_t)0x00003000)) | ((uint32_t)clenram << 12));
}
 ...
 * <table>
 * <caption>ENCR_WPI_INT_KEY_0 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>      encrIntKeyRAMWord0 <td> R/W <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_ENCR_WPI_INT_KEY_0_ADDR   0x24B000C8
 ...
 * <table>
 * <caption>ENCR_WPI_INT_KEY_1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>      encrIntKeyRAMWord1 <td> R/W <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_ENCR_WPI_INT_KEY_1_ADDR   0x24B000CC
 ...
 * <table>
 * <caption>ENCR_WPI_INT_KEY_2 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>      encrIntKeyRAMWord2 <td> R/W <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_ENCR_WPI_INT_KEY_2_ADDR   0x24B000D0
 ...
 * <table>
 * <caption>ENCR_WPI_INT_KEY_3 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>      encrIntKeyRAMWord3 <td> R/W <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_ENCR_WPI_INT_KEY_3_ADDR   0x24B000D4
 ...
 * <table>
 * <caption>ENCR_RAM_CONFIG bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:24 <td>      staKeyMaxIndex <td> W <td> R <td> 0x0
 * <tr><td> 19:16 <td>                nVAP <td> R <td> R/W <td> 0x0
 * <tr><td> 15:08 <td>      staKeyEndIndex <td> R <td> R/W <td> 0x0
 * <tr><td> 07:00 <td>    staKeyStartIndex <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_ENCR_RAM_CONFIG_ADDR   0x24B000D8
 ...
 * <table>
 * <caption>RATES bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 11:00 <td>    bssBasicRateSet <td> R <td> R/W <td> 0x150
 * </table>
 *
 * @{
 */
...
#define NXMAC_RATES_ADDR   0x24B000DC
 ...
 * <table>
 * <caption>OLBC bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:24 <td>  dsssCount <td> R <td> R/W <td> 0x0
 * <tr><td> 23:16 <td>  ofdmCount <td> R <td> R/W <td> 0x0
 * <tr><td> 15:00 <td>  olbcTimer <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_OLBC_ADDR   0x24B000E0
 ...
 * <table>
 * <caption>TIMINGS_1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 27:18 <td>      txChainDelayInMACClk <td> R <td> R/W <td> 0x0
 * <tr><td> 17:08 <td>         txRFDelayInMACClk <td> R <td> R/W <td> 0x0
 * <tr><td> 07:00 <td>            macCoreClkFreq <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_TIMINGS_1_ADDR   0x24B000E4
 ...
 * <table>
 * <caption>TIMINGS_2 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 23:08 <td>     slotTimeInMACClk <td> R <td> R/W <td> 0x0
 * <tr><td> 07:00 <td>             slotTime <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_TIMINGS_2_ADDR   0x24B000E8
 ...
 * <table>
 * <caption>TIMINGS_3 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 29:20 <td>         rxRFDelayInMACClk <td> R <td> R/W <td> 0x0
 * <tr><td> 09:00 <td>      macProcDelayInMACClk <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_TIMINGS_3_ADDR   0x24B000EC
 ...
 */
__INLINE void nxmac_timings_3_pack(uint16_t rxrfdelayinmacclk, uint16_t macprocdelayinmacclk)
{
    ...
    REG_PL_WR(NXMAC_TIMINGS_3_ADDR,  ((uint32_t)rxrfdelayinmacclk << 20) | ((uint32_t)macprocdelayinmacclk << 0));
}
 ...
 */
__INLINE void nxmac_timings_3_unpack(uint16_t* rxrfdelayinmacclk, uint16_t* macprocdelayinmacclk)
{
 ...
 * <table>
 * <caption>TIMINGS_4 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:22 <td>      radioWakeUpTime <td> R <td> R/W <td> 0x0
 * <tr><td> 21:12 <td>       radioChirpTime <td> R <td> R/W <td> 0x0
 * <tr><td> 01:00 <td>     wt2CryptClkRatio <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_TIMINGS_4_ADDR   0x24B000F0
 ...
 * <table>
 * <caption>TIMINGS_5 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 23:08 <td>     sifsBInMACClk <td> R <td> R/W <td> 0x0
 * <tr><td> 07:00 <td>             sifsB <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_TIMINGS_5_ADDR   0x24B000F4
 ...
 * <table>
 * <caption>TIMINGS_6 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 23:08 <td>     sifsAInMACClk <td> R <td> R/W <td> 0x0
 * <tr><td> 07:00 <td>             sifsA <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_TIMINGS_6_ADDR   0x24B000F8
 ...
 * <table>
 * <caption>TIMINGS_7 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:16 <td>      heTBCSDlyInMACClk <td> R <td> R/W <td> 0x0
 * <tr><td> 11:08 <td>             rxCCADelay <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_TIMINGS_7_ADDR   0x24B000FC
...
// field definitions
/// HE_TBCS_DLY_IN_MAC_CLK field mask
#define NXMAC_HE_TBCS_DLY_IN_MAC_CLK_MASK   ((uint32_t)0xFFFF0000)
/// HE_TBCS_DLY_IN_MAC_CLK field LSB position
#define NXMAC_HE_TBCS_DLY_IN_MAC_CLK_LSB    16
/// HE_TBCS_DLY_IN_MAC_CLK field width
#define NXMAC_HE_TBCS_DLY_IN_MAC_CLK_WIDTH  ((uint32_t)0x00000010)
...
/// HE_TBCS_DLY_IN_MAC_CLK field reset value
#define NXMAC_HE_TBCS_DLY_IN_MAC_CLK_RST    0x0
 ...
 * and writes the value to the register.
 *
 * @param[in] hetbcsdlyinmacclk - The value to use for the heTBCSDlyInMACClk field.
 * @param[in] rxccadelay - The value to use for the rxCCADelay field.
 */
__INLINE void nxmac_timings_7_pack(uint16_t hetbcsdlyinmacclk, uint8_t rxccadelay)
{
    ASSERT_ERR((((uint32_t)hetbcsdlyinmacclk << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    ASSERT_ERR((((uint32_t)rxccadelay << 8) & ~((uint32_t)0x00000F00)) == 0);
    REG_PL_WR(NXMAC_TIMINGS_7_ADDR,  ((uint32_t)hetbcsdlyinmacclk << 16) | ((uint32_t)rxccadelay << 8));
}
 ...
 * values from the register.
 *
 * @param[out] hetbcsdlyinmacclk - Will be populated with the current value of this field from the register.
 * @param[out] rxccadelay - Will be populated with the current value of this field from the register.
 */
__INLINE void nxmac_timings_7_unpack(uint16_t* hetbcsdlyinmacclk, uint8_t* rxccadelay)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TIMINGS_7_ADDR);

    *hetbcsdlyinmacclk = (localVal & ((uint32_t)0xFFFF0000)) >> 16;
    *rxccadelay = (localVal & ((uint32_t)0x00000F00)) >> 8;
}

/**
 * @brief Returns the current value of the heTBCSDlyInMACClk field in the TIMINGS_7 register.
 *
 * The TIMINGS_7 register will be read and the heTBCSDlyInMACClk field's value will be returned.
 *
 * @return The current value of the heTBCSDlyInMACClk field in the TIMINGS_7 register.
 */
__INLINE uint16_t nxmac_he_tbcs_dly_in_mac_clk_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TIMINGS_7_ADDR);
    return ((localVal & ((uint32_t)0xFFFF0000)) >> 16);
}
...
/**
 * @brief Sets the heTBCSDlyInMACClk field of the TIMINGS_7 register.
 *
 * The TIMINGS_7 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] hetbcsdlyinmacclk - The value to set the field to.
 */
__INLINE void nxmac_he_tbcs_dly_in_mac_clk_setf(uint16_t hetbcsdlyinmacclk)
{
    ASSERT_ERR((((uint32_t)hetbcsdlyinmacclk << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    REG_PL_WR(NXMAC_TIMINGS_7_ADDR, (REG_PL_RD(NXMAC_TIMINGS_7_ADDR) & ~((uint32_t)0xFFFF0000)) | ((uint32_t)hetbcsdlyinmacclk << 16));
}
 ...
 * <table>
 * <caption>TIMINGS_8 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:24 <td>     rxStartDelayMIMO <td> R <td> R/W <td> 0x21
 * <tr><td> 23:16 <td>    rxStartDelayShort <td> R <td> R/W <td> 0x66
 * <tr><td> 15:08 <td>     rxStartDelayLong <td> R <td> R/W <td> 0xC6
 * <tr><td> 07:00 <td>     rxStartDelayOFDM <td> R <td> R/W <td> 0x21
 * </table>
 *
 * @{
 */
...
#define NXMAC_TIMINGS_8_ADDR   0x24B00100
 ...
 * <table>
 * <caption>TIMINGS_9 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 29:20 <td>             rifsTOInMACClk <td> R <td> R/W <td> 0x0
 * <tr><td> 09:00 <td>       txDMAProcDlyInMACClk <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_TIMINGS_9_ADDR   0x24B00104
 ...
 */
__INLINE void nxmac_timings_9_pack(uint16_t rifstoinmacclk, uint16_t txdmaprocdlyinmacclk)
{
    ...
    REG_PL_WR(NXMAC_TIMINGS_9_ADDR,  ((uint32_t)rifstoinmacclk << 20) | ((uint32_t)txdmaprocdlyinmacclk << 0));
}
 ...
 */
__INLINE void nxmac_timings_9_unpack(uint16_t* rifstoinmacclk, uint16_t* txdmaprocdlyinmacclk)
{
...
/**
 * @name RX_CNTRL_2 register definitions
 * <table>
 * <caption>RX_CNTRL_2 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 19    <td>       disableRxBuffer2 <td> R <td> R/W <td> 0
 * <tr><td> 18    <td>    dataMHStoredwithPld <td> R <td> R/W <td> 0
 * <tr><td> 17    <td>     mgtMHStoredwithPld <td> R <td> R/W <td> 1
 * <tr><td> 16    <td>    ctrlMHStoredwithPld <td> R <td> R/W <td> 1
 * <tr><td> 15:08 <td>      partialUnwrapSize <td> R <td> R/W <td> 0x32
 * <tr><td> 05:04 <td>        dataFrmWrapMode <td> R <td> R/W <td> 0x2
 * <tr><td> 03:02 <td>         mgtFrmWrapMode <td> R <td> R/W <td> 0x1
 * <tr><td> 01:00 <td>        ctrlFrmWrapMode <td> R <td> R/W <td> 0x1
 * </table>
 *
 * @{
 */

/// Address of the RX_CNTRL_2 register
#define NXMAC_RX_CNTRL_2_ADDR   0x24B0010C
/// Offset of the RX_CNTRL_2 register from the base address
#define NXMAC_RX_CNTRL_2_OFFSET 0x0000010C
/// Index of the RX_CNTRL_2 register
#define NXMAC_RX_CNTRL_2_INDEX  0x00000043
/// Reset value of the RX_CNTRL_2 register
#define NXMAC_RX_CNTRL_2_RESET  0x00033225

/**
 * @brief Returns the current value of the RX_CNTRL_2 register.
 * The RX_CNTRL_2 register will be read and its value returned.
 * @return The current value of the RX_CNTRL_2 register.
 */
__INLINE uint32_t nxmac_rx_cntrl_2_get(void)
{
    return REG_PL_RD(NXMAC_RX_CNTRL_2_ADDR);
}

/**
 * @brief Sets the RX_CNTRL_2 register to a value.
 * The RX_CNTRL_2 register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_rx_cntrl_2_set(uint32_t value)
{
    REG_PL_WR(NXMAC_RX_CNTRL_2_ADDR, value);
}

// field definitions
/// DISABLE_RX_BUFFER_2 field bit
#define NXMAC_DISABLE_RX_BUFFER_2_BIT       ((uint32_t)0x00080000)
/// DISABLE_RX_BUFFER_2 field position
#define NXMAC_DISABLE_RX_BUFFER_2_POS       19
/// DATA_MH_STOREDWITH_PLD field bit
#define NXMAC_DATA_MH_STOREDWITH_PLD_BIT    ((uint32_t)0x00040000)
/// DATA_MH_STOREDWITH_PLD field position
#define NXMAC_DATA_MH_STOREDWITH_PLD_POS    18
/// MGT_MH_STOREDWITH_PLD field bit
#define NXMAC_MGT_MH_STOREDWITH_PLD_BIT     ((uint32_t)0x00020000)
/// MGT_MH_STOREDWITH_PLD field position
#define NXMAC_MGT_MH_STOREDWITH_PLD_POS     17
/// CTRL_MH_STOREDWITH_PLD field bit
#define NXMAC_CTRL_MH_STOREDWITH_PLD_BIT    ((uint32_t)0x00010000)
/// CTRL_MH_STOREDWITH_PLD field position
#define NXMAC_CTRL_MH_STOREDWITH_PLD_POS    16
/// PARTIAL_UNWRAP_SIZE field mask
#define NXMAC_PARTIAL_UNWRAP_SIZE_MASK      ((uint32_t)0x0000FF00)
/// PARTIAL_UNWRAP_SIZE field LSB position
#define NXMAC_PARTIAL_UNWRAP_SIZE_LSB       8
/// PARTIAL_UNWRAP_SIZE field width
#define NXMAC_PARTIAL_UNWRAP_SIZE_WIDTH     ((uint32_t)0x00000008)
/// DATA_FRM_WRAP_MODE field mask
#define NXMAC_DATA_FRM_WRAP_MODE_MASK       ((uint32_t)0x00000030)
/// DATA_FRM_WRAP_MODE field LSB position
#define NXMAC_DATA_FRM_WRAP_MODE_LSB        4
/// DATA_FRM_WRAP_MODE field width
#define NXMAC_DATA_FRM_WRAP_MODE_WIDTH      ((uint32_t)0x00000002)
/// MGT_FRM_WRAP_MODE field mask
#define NXMAC_MGT_FRM_WRAP_MODE_MASK        ((uint32_t)0x0000000C)
/// MGT_FRM_WRAP_MODE field LSB position
#define NXMAC_MGT_FRM_WRAP_MODE_LSB         2
/// MGT_FRM_WRAP_MODE field width
#define NXMAC_MGT_FRM_WRAP_MODE_WIDTH       ((uint32_t)0x00000002)
/// CTRL_FRM_WRAP_MODE field mask
#define NXMAC_CTRL_FRM_WRAP_MODE_MASK       ((uint32_t)0x00000003)
/// CTRL_FRM_WRAP_MODE field LSB position
#define NXMAC_CTRL_FRM_WRAP_MODE_LSB        0
/// CTRL_FRM_WRAP_MODE field width
#define NXMAC_CTRL_FRM_WRAP_MODE_WIDTH      ((uint32_t)0x00000002)

/// DISABLE_RX_BUFFER_2 field reset value
#define NXMAC_DISABLE_RX_BUFFER_2_RST       0x0
/// DATA_MH_STOREDWITH_PLD field reset value
#define NXMAC_DATA_MH_STOREDWITH_PLD_RST    0x0
/// MGT_MH_STOREDWITH_PLD field reset value
#define NXMAC_MGT_MH_STOREDWITH_PLD_RST     0x1
/// CTRL_MH_STOREDWITH_PLD field reset value
#define NXMAC_CTRL_MH_STOREDWITH_PLD_RST    0x1
/// PARTIAL_UNWRAP_SIZE field reset value
#define NXMAC_PARTIAL_UNWRAP_SIZE_RST       0x32
/// DATA_FRM_WRAP_MODE field reset value
#define NXMAC_DATA_FRM_WRAP_MODE_RST        0x2
/// MGT_FRM_WRAP_MODE field reset value
#define NXMAC_MGT_FRM_WRAP_MODE_RST         0x1
/// CTRL_FRM_WRAP_MODE field reset value
#define NXMAC_CTRL_FRM_WRAP_MODE_RST        0x1

/**
 * @brief Constructs a value for the RX_CNTRL_2 register given values for its fields
 * and writes the value to the register.
 *
 * @param[in] disablerxbuffer2 - The value to use for the disableRxBuffer2 field.
 * @param[in] datamhstoredwithpld - The value to use for the dataMHStoredwithPld field.
 * @param[in] mgtmhstoredwithpld - The value to use for the mgtMHStoredwithPld field.
 * @param[in] ctrlmhstoredwithpld - The value to use for the ctrlMHStoredwithPld field.
 * @param[in] partialunwrapsize - The value to use for the partialUnwrapSize field.
 * @param[in] datafrmwrapmode - The value to use for the dataFrmWrapMode field.
 * @param[in] mgtfrmwrapmode - The value to use for the mgtFrmWrapMode field.
 * @param[in] ctrlfrmwrapmode - The value to use for the ctrlFrmWrapMode field.
 */
__INLINE void nxmac_rx_cntrl_2_pack(uint8_t disablerxbuffer2, uint8_t datamhstoredwithpld, uint8_t mgtmhstoredwithpld, uint8_t ctrlmhstoredwithpld, uint8_t partialunwrapsize, uint8_t datafrmwrapmode, uint8_t mgtfrmwrapmode, uint8_t ctrlfrmwrapmode)
{
    ASSERT_ERR((((uint32_t)disablerxbuffer2 << 19) & ~((uint32_t)0x00080000)) == 0);
    ASSERT_ERR((((uint32_t)datamhstoredwithpld << 18) & ~((uint32_t)0x00040000)) == 0);
    ASSERT_ERR((((uint32_t)mgtmhstoredwithpld << 17) & ~((uint32_t)0x00020000)) == 0);
    ASSERT_ERR((((uint32_t)ctrlmhstoredwithpld << 16) & ~((uint32_t)0x00010000)) == 0);
    ASSERT_ERR((((uint32_t)partialunwrapsize << 8) & ~((uint32_t)0x0000FF00)) == 0);
    ASSERT_ERR((((uint32_t)datafrmwrapmode << 4) & ~((uint32_t)0x00000030)) == 0);
    ASSERT_ERR((((uint32_t)mgtfrmwrapmode << 2) & ~((uint32_t)0x0000000C)) == 0);
    ASSERT_ERR((((uint32_t)ctrlfrmwrapmode << 0) & ~((uint32_t)0x00000003)) == 0);
    REG_PL_WR(NXMAC_RX_CNTRL_2_ADDR,  ((uint32_t)disablerxbuffer2 << 19) | ((uint32_t)datamhstoredwithpld << 18) | ((uint32_t)mgtmhstoredwithpld << 17) | ((uint32_t)ctrlmhstoredwithpld << 16) | ((uint32_t)partialunwrapsize << 8) | ((uint32_t)datafrmwrapmode << 4) | ((uint32_t)mgtfrmwrapmode << 2) | ((uint32_t)ctrlfrmwrapmode << 0));
}

/**
 * @brief Unpacks RX_CNTRL_2's fields from current value of the RX_CNTRL_2 register.
 *
 * Reads the RX_CNTRL_2 register and populates all the _field variables with the corresponding
 * values from the register.
 *
 * @param[out] disablerxbuffer2 - Will be populated with the current value of this field from the register.
 * @param[out] datamhstoredwithpld - Will be populated with the current value of this field from the register.
 * @param[out] mgtmhstoredwithpld - Will be populated with the current value of this field from the register.
 * @param[out] ctrlmhstoredwithpld - Will be populated with the current value of this field from the register.
 * @param[out] partialunwrapsize - Will be populated with the current value of this field from the register.
 * @param[out] datafrmwrapmode - Will be populated with the current value of this field from the register.
 * @param[out] mgtfrmwrapmode - Will be populated with the current value of this field from the register.
 * @param[out] ctrlfrmwrapmode - Will be populated with the current value of this field from the register.
 */
__INLINE void nxmac_rx_cntrl_2_unpack(uint8_t* disablerxbuffer2, uint8_t* datamhstoredwithpld, uint8_t* mgtmhstoredwithpld, uint8_t* ctrlmhstoredwithpld, uint8_t* partialunwrapsize, uint8_t* datafrmwrapmode, uint8_t* mgtfrmwrapmode, uint8_t* ctrlfrmwrapmode)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_CNTRL_2_ADDR);

    *disablerxbuffer2 = (localVal & ((uint32_t)0x00080000)) >> 19;
    *datamhstoredwithpld = (localVal & ((uint32_t)0x00040000)) >> 18;
    *mgtmhstoredwithpld = (localVal & ((uint32_t)0x00020000)) >> 17;
    *ctrlmhstoredwithpld = (localVal & ((uint32_t)0x00010000)) >> 16;
    *partialunwrapsize = (localVal & ((uint32_t)0x0000FF00)) >> 8;
    *datafrmwrapmode = (localVal & ((uint32_t)0x00000030)) >> 4;
    *mgtfrmwrapmode = (localVal & ((uint32_t)0x0000000C)) >> 2;
    *ctrlfrmwrapmode = (localVal & ((uint32_t)0x00000003)) >> 0;
}

/**
 * @brief Returns the current value of the disableRxBuffer2 field in the RX_CNTRL_2 register.
 *
 * The RX_CNTRL_2 register will be read and the disableRxBuffer2 field's value will be returned.
 *
 * @return The current value of the disableRxBuffer2 field in the RX_CNTRL_2 register.
 */
__INLINE uint8_t nxmac_disable_rx_buffer_2_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_CNTRL_2_ADDR);
    return ((localVal & ((uint32_t)0x00080000)) >> 19);
}
...
/**
 * @brief Sets the disableRxBuffer2 field of the RX_CNTRL_2 register.
 *
 * The RX_CNTRL_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] disablerxbuffer2 - The value to set the field to.
 */
__INLINE void nxmac_disable_rx_buffer_2_setf(uint8_t disablerxbuffer2)
{
    ASSERT_ERR((((uint32_t)disablerxbuffer2 << 19) & ~((uint32_t)0x00080000)) == 0);
    REG_PL_WR(NXMAC_RX_CNTRL_2_ADDR, (REG_PL_RD(NXMAC_RX_CNTRL_2_ADDR) & ~((uint32_t)0x00080000)) | ((uint32_t)disablerxbuffer2 << 19));
}

/**
 * @brief Returns the current value of the dataMHStoredwithPld field in the RX_CNTRL_2 register.
 *
 * The RX_CNTRL_2 register will be read and the dataMHStoredwithPld field's value will be returned.
 *
 * @return The current value of the dataMHStoredwithPld field in the RX_CNTRL_2 register.
 */
__INLINE uint8_t nxmac_data_mh_storedwith_pld_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_CNTRL_2_ADDR);
    return ((localVal & ((uint32_t)0x00040000)) >> 18);
}
...
/**
 * @brief Sets the dataMHStoredwithPld field of the RX_CNTRL_2 register.
 *
 * The RX_CNTRL_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] datamhstoredwithpld - The value to set the field to.
 */
__INLINE void nxmac_data_mh_storedwith_pld_setf(uint8_t datamhstoredwithpld)
{
    ASSERT_ERR((((uint32_t)datamhstoredwithpld << 18) & ~((uint32_t)0x00040000)) == 0);
    REG_PL_WR(NXMAC_RX_CNTRL_2_ADDR, (REG_PL_RD(NXMAC_RX_CNTRL_2_ADDR) & ~((uint32_t)0x00040000)) | ((uint32_t)datamhstoredwithpld << 18));
}

/**
 * @brief Returns the current value of the mgtMHStoredwithPld field in the RX_CNTRL_2 register.
 *
 * The RX_CNTRL_2 register will be read and the mgtMHStoredwithPld field's value will be returned.
 *
 * @return The current value of the mgtMHStoredwithPld field in the RX_CNTRL_2 register.
 */
__INLINE uint8_t nxmac_mgt_mh_storedwith_pld_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_CNTRL_2_ADDR);
    return ((localVal & ((uint32_t)0x00020000)) >> 17);
}
...
/**
 * @brief Sets the mgtMHStoredwithPld field of the RX_CNTRL_2 register.
 *
 * The RX_CNTRL_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] mgtmhstoredwithpld - The value to set the field to.
 */
__INLINE void nxmac_mgt_mh_storedwith_pld_setf(uint8_t mgtmhstoredwithpld)
{
    ASSERT_ERR((((uint32_t)mgtmhstoredwithpld << 17) & ~((uint32_t)0x00020000)) == 0);
    REG_PL_WR(NXMAC_RX_CNTRL_2_ADDR, (REG_PL_RD(NXMAC_RX_CNTRL_2_ADDR) & ~((uint32_t)0x00020000)) | ((uint32_t)mgtmhstoredwithpld << 17));
}

/**
 * @brief Returns the current value of the ctrlMHStoredwithPld field in the RX_CNTRL_2 register.
 *
 * The RX_CNTRL_2 register will be read and the ctrlMHStoredwithPld field's value will be returned.
 *
 * @return The current value of the ctrlMHStoredwithPld field in the RX_CNTRL_2 register.
 */
__INLINE uint8_t nxmac_ctrl_mh_storedwith_pld_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_CNTRL_2_ADDR);
    return ((localVal & ((uint32_t)0x00010000)) >> 16);
}
...
/**
 * @brief Sets the ctrlMHStoredwithPld field of the RX_CNTRL_2 register.
 *
 * The RX_CNTRL_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] ctrlmhstoredwithpld - The value to set the field to.
 */
__INLINE void nxmac_ctrl_mh_storedwith_pld_setf(uint8_t ctrlmhstoredwithpld)
{
    ASSERT_ERR((((uint32_t)ctrlmhstoredwithpld << 16) & ~((uint32_t)0x00010000)) == 0);
    REG_PL_WR(NXMAC_RX_CNTRL_2_ADDR, (REG_PL_RD(NXMAC_RX_CNTRL_2_ADDR) & ~((uint32_t)0x00010000)) | ((uint32_t)ctrlmhstoredwithpld << 16));
}

/**
 * @brief Returns the current value of the partialUnwrapSize field in the RX_CNTRL_2 register.
 *
 * The RX_CNTRL_2 register will be read and the partialUnwrapSize field's value will be returned.
 *
 * @return The current value of the partialUnwrapSize field in the RX_CNTRL_2 register.
 */
__INLINE uint8_t nxmac_partial_unwrap_size_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_CNTRL_2_ADDR);
    return ((localVal & ((uint32_t)0x0000FF00)) >> 8);
}
...
/**
 * @brief Sets the partialUnwrapSize field of the RX_CNTRL_2 register.
 *
 * The RX_CNTRL_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] partialunwrapsize - The value to set the field to.
 */
__INLINE void nxmac_partial_unwrap_size_setf(uint8_t partialunwrapsize)
{
    ASSERT_ERR((((uint32_t)partialunwrapsize << 8) & ~((uint32_t)0x0000FF00)) == 0);
    REG_PL_WR(NXMAC_RX_CNTRL_2_ADDR, (REG_PL_RD(NXMAC_RX_CNTRL_2_ADDR) & ~((uint32_t)0x0000FF00)) | ((uint32_t)partialunwrapsize << 8));
}

/**
 * @brief Returns the current value of the dataFrmWrapMode field in the RX_CNTRL_2 register.
 *
 * The RX_CNTRL_2 register will be read and the dataFrmWrapMode field's value will be returned.
 *
 * @return The current value of the dataFrmWrapMode field in the RX_CNTRL_2 register.
 */
__INLINE uint8_t nxmac_data_frm_wrap_mode_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_CNTRL_2_ADDR);
...
/**
 * @brief Sets the dataFrmWrapMode field of the RX_CNTRL_2 register.
 *
 * The RX_CNTRL_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] datafrmwrapmode - The value to set the field to.
 */
__INLINE void nxmac_data_frm_wrap_mode_setf(uint8_t datafrmwrapmode)
{
    ASSERT_ERR((((uint32_t)datafrmwrapmode << 4) & ~((uint32_t)0x00000030)) == 0);
    REG_PL_WR(NXMAC_RX_CNTRL_2_ADDR, (REG_PL_RD(NXMAC_RX_CNTRL_2_ADDR) & ~((uint32_t)0x00000030)) | ((uint32_t)datafrmwrapmode << 4));
}

/**
 * @brief Returns the current value of the mgtFrmWrapMode field in the RX_CNTRL_2 register.
 *
 * The RX_CNTRL_2 register will be read and the mgtFrmWrapMode field's value will be returned.
 *
 * @return The current value of the mgtFrmWrapMode field in the RX_CNTRL_2 register.
 */
__INLINE uint8_t nxmac_mgt_frm_wrap_mode_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_CNTRL_2_ADDR);
    return ((localVal & ((uint32_t)0x0000000C)) >> 2);
}
...
/**
 * @brief Sets the mgtFrmWrapMode field of the RX_CNTRL_2 register.
 *
 * The RX_CNTRL_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] mgtfrmwrapmode - The value to set the field to.
 */
__INLINE void nxmac_mgt_frm_wrap_mode_setf(uint8_t mgtfrmwrapmode)
{
    ASSERT_ERR((((uint32_t)mgtfrmwrapmode << 2) & ~((uint32_t)0x0000000C)) == 0);
    REG_PL_WR(NXMAC_RX_CNTRL_2_ADDR, (REG_PL_RD(NXMAC_RX_CNTRL_2_ADDR) & ~((uint32_t)0x0000000C)) | ((uint32_t)mgtfrmwrapmode << 2));
}

/**
 * @brief Returns the current value of the ctrlFrmWrapMode field in the RX_CNTRL_2 register.
 *
 * The RX_CNTRL_2 register will be read and the ctrlFrmWrapMode field's value will be returned.
 *
 * @return The current value of the ctrlFrmWrapMode field in the RX_CNTRL_2 register.
 */
__INLINE uint8_t nxmac_ctrl_frm_wrap_mode_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_CNTRL_2_ADDR);
    return ((localVal & ((uint32_t)0x00000003)) >> 0);
}
...
/**
 * @brief Sets the ctrlFrmWrapMode field of the RX_CNTRL_2 register.
 *
 * The RX_CNTRL_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] ctrlfrmwrapmode - The value to set the field to.
 */
__INLINE void nxmac_ctrl_frm_wrap_mode_setf(uint8_t ctrlfrmwrapmode)
{
    ASSERT_ERR((((uint32_t)ctrlfrmwrapmode << 0) & ~((uint32_t)0x00000003)) == 0);
    REG_PL_WR(NXMAC_RX_CNTRL_2_ADDR, (REG_PL_RD(NXMAC_RX_CNTRL_2_ADDR) & ~((uint32_t)0x00000003)) | ((uint32_t)ctrlfrmwrapmode << 0));
}
 ...
 * <table>
 * <caption>TX_TRIGGER_TIMER bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 15:08 <td>     txPacketTimeout <td> R <td> R/W <td> 0xF
 * <tr><td> 07:00 <td>   txAbsoluteTimeout <td> R <td> R/W <td> 0x9C
 * </table>
 *
 * @{
 */
...
#define NXMAC_TX_TRIGGER_TIMER_ADDR   0x24B00110
 ...
 * <table>
 * <caption>RX_TRIGGER_TIMER bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 15:08 <td>     rxPacketTimeout <td> R <td> R/W <td> 0xF
 * <tr><td> 07:00 <td>   rxAbsoluteTimeout <td> R <td> R/W <td> 0x9C
 * </table>
 *
 * @{
 */
...
#define NXMAC_RX_TRIGGER_TIMER_ADDR   0x24B00114
...
#define NXMAC_RX_TRIGGER_TIMER_RESET  0x00000F9C
 ...
 */
__INLINE void nxmac_rx_trigger_timer_pack(uint8_t rxpackettimeout, uint8_t rxabsolutetimeout)
{
    ASSERT_ERR((((uint32_t)rxpackettimeout << 8) & ~((uint32_t)0x0000FF00)) == 0);
    ASSERT_ERR((((uint32_t)rxabsolutetimeout << 0) & ~((uint32_t)0x000000FF)) == 0);
    REG_PL_WR(NXMAC_RX_TRIGGER_TIMER_ADDR,  ((uint32_t)rxpackettimeout << 8) | ((uint32_t)rxabsolutetimeout << 0));
}
 ...
 */
__INLINE void nxmac_rx_trigger_timer_unpack(uint8_t* rxpackettimeout, uint8_t* rxabsolutetimeout)
{
 ...
 * <table>
 * <caption>MIB_TABLE_WRITE bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:16 <td>           mibValue <td> R <td> R/W <td> 0x0
 * <tr><td> 15    <td>           mibWrite <td> R/W <td> R/W <td> 0
 * <tr><td> 14    <td>   mibIncrementMode <td> R <td> R/W <td> 1
 * <tr><td> 09:00 <td>      mibTableIndex <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_MIB_TABLE_WRITE_ADDR   0x24B00118
 ...
 * <table>
 * <caption>MONOTONIC_COUNTER_1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>   monotonicCounter1 <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_MONOTONIC_COUNTER_1_ADDR   0x24B0011C
 ...
 * <table>
 * <caption>MONOTONIC_COUNTER_2_LO bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>    monotonicCounterLow2 <td> R/W <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
 ...
 * <table>
 * <caption>MONOTONIC_COUNTER_2_HI bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31    <td>    monotonicCounter2SWUpdate <td> R <td> R/W <td> 0
 * <tr><td> 15:00 <td>        monotonicCounterHigh2 <td> R/W <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_MONOTONIC_COUNTER_2_HI_ADDR   0x24B00124
 ...
 * <table>
 * <caption>ABS_TIMER bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>   absTimerValue <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_ABS_TIMER_ADDR   0x24B00128
 ...
 * <table>
 * <caption>MAX_RX_LENGTH bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 19:00 <td>   maxAllowedLength <td> R <td> R/W <td> 0xFFFF
 * </table>
 *
 * @{
 */
...
#define NXMAC_MAX_RX_LENGTH_ADDR   0x24B00150
 ...
 * <table>
 * <caption>EDCA_AC_0 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 27:12 <td>    txOpLimit0 <td> R <td> R/W <td> 0x0
 * <tr><td> 11:08 <td>        cwMax0 <td> R <td> R/W <td> 0xA
 * <tr><td> 07:04 <td>        cwMin0 <td> R <td> R/W <td> 0x4
 * <tr><td> 03:00 <td>        aifsn0 <td> R <td> R/W <td> 0x7
 * </table>
 *
 * @{
 */
...
#define NXMAC_EDCA_AC_0_ADDR   0x24B00200
 ...
 * <table>
 * <caption>EDCA_AC_1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 27:12 <td>    txOpLimit1 <td> R <td> R/W <td> 0x0
 * <tr><td> 11:08 <td>        cwMax1 <td> R <td> R/W <td> 0xA
 * <tr><td> 07:04 <td>        cwMin1 <td> R <td> R/W <td> 0x4
 * <tr><td> 03:00 <td>        aifsn1 <td> R <td> R/W <td> 0x3
 * </table>
 *
 * @{
 */
...
#define NXMAC_EDCA_AC_1_ADDR   0x24B00204
 ...
 * <table>
 * <caption>EDCA_AC_2 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 27:12 <td>    txOpLimit2 <td> R <td> R/W <td> 0x5E
 * <tr><td> 11:08 <td>        cwMax2 <td> R <td> R/W <td> 0x4
 * <tr><td> 07:04 <td>        cwMin2 <td> R <td> R/W <td> 0x3
 * <tr><td> 03:00 <td>        aifsn2 <td> R <td> R/W <td> 0x2
 * </table>
 *
 * @{
 */
...
#define NXMAC_EDCA_AC_2_ADDR   0x24B00208
 ...
 * <table>
 * <caption>EDCA_AC_3 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 27:12 <td>    txOpLimit3 <td> R <td> R/W <td> 0x2F
 * <tr><td> 11:08 <td>        cwMax3 <td> R <td> R/W <td> 0x3
 * <tr><td> 07:04 <td>        cwMin3 <td> R <td> R/W <td> 0x2
 * <tr><td> 03:00 <td>        aifsn3 <td> R <td> R/W <td> 0x2
 * </table>
 *
 * @{
 */
...
#define NXMAC_EDCA_AC_3_ADDR   0x24B0020C
 ...
 * <table>
 * <caption>EDCA_CCA_BUSY bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>   ccaBusyDur <td> R/W <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_EDCA_CCA_BUSY_ADDR   0x24B00220
 ...
 * <table>
 * <caption>EDCA_CNTRL bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 05 <td>          keepTXOPOpen <td> R <td> R/W <td> 0
 * <tr><td> 04 <td>     remTXOPInDurField <td> R <td> R/W <td> 0
 * <tr><td> 01 <td>             sendCFEnd <td> R <td> R/W <td> 0
 * <tr><td> 00 <td>          sendCFEndNow <td> R/W <td> R/W <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_EDCA_CNTRL_ADDR   0x24B00224
 ...
 * <table>
 * <caption>QUIET_ELEMENT_1A bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:16 <td>   quietDuration1 <td> R/W <td> R/W <td> 0x0
 * <tr><td> 15:08 <td>     quietPeriod1 <td> R/W <td> R/W <td> 0x0
 * <tr><td> 07:00 <td>      quietCount1 <td> R/W <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_QUIET_ELEMENT_1A_ADDR   0x24B00280
 ...
 * <table>
 * <caption>QUIET_ELEMENT_1B bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 15:00 <td>   quietOffset1 <td> R/W <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_QUIET_ELEMENT_1B_ADDR   0x24B00284
 ...
 * <table>
 * <caption>ADD_CCA_BUSY_SEC_20 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>     ccaBusyDurSec20 <td> R/W <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_ADD_CCA_BUSY_SEC_20_ADDR   0x24B00290
 ...
 * <table>
 * <caption>ADD_CCA_BUSY_SEC_40 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>     ccaBusyDurSec40 <td> R/W <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_ADD_CCA_BUSY_SEC_40_ADDR   0x24B00294
 ...
 * <table>
 * <caption>ADD_CCA_BUSY_SEC_80 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>     ccaBusyDurSec80 <td> R/W <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_ADD_CCA_BUSY_SEC_80_ADDR   0x24B00298
 ...
 * <table>
 * <caption>STBC_CNTRL bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:25 <td>    basicSTBCMCS <td> R <td> R/W <td> 0x0
 * <tr><td> 24    <td>     dualCTSProt <td> R <td> R/W <td> 0
 * <tr><td> 23:16 <td>      ctsSTBCDur <td> R <td> R/W <td> 0x0
 * <tr><td> 15:00 <td>    cfEndSTBCDur <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_STBC_CNTRL_ADDR   0x24B00300
 ...
 * <table>
 * <caption>TX_BW_CNTRL bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 22:20 <td>        maxSupportedNss <td> R <td> R/W <td> 0x0
 * <tr><td> 17:16 <td>         maxSupportedBW <td> R <td> R/W <td> 0x0
 * <tr><td> 15:08 <td>           aPPDUMaxTime <td> R <td> R/W <td> 0xA
 * <tr><td> 07    <td>                dynBWEn <td> R <td> R/W <td> 0
 * <tr><td> 06:04 <td>    numTryBWAcquisition <td> R <td> R/W <td> 0x1
 * <tr><td> 03    <td>          dropToLowerBW <td> R <td> R/W <td> 1
 * <tr><td> 02:01 <td>          defaultBWTXOP <td> R <td> R/W <td> 0x0
 * <tr><td> 00    <td>         defaultBWTXOPV <td> R <td> R/W <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_TX_BW_CNTRL_ADDR   0x24B00310
...
#define NXMAC_TX_BW_CNTRL_RESET  0x00000A18
...
// field definitions
/// MAX_SUPPORTED_NSS field mask
#define NXMAC_MAX_SUPPORTED_NSS_MASK        ((uint32_t)0x00700000)
/// MAX_SUPPORTED_NSS field LSB position
#define NXMAC_MAX_SUPPORTED_NSS_LSB         20
/// MAX_SUPPORTED_NSS field width
#define NXMAC_MAX_SUPPORTED_NSS_WIDTH       ((uint32_t)0x00000003)
...
/// MAX_SUPPORTED_NSS field reset value
#define NXMAC_MAX_SUPPORTED_NSS_RST         0x0
/// MAX_SUPPORTED_BW field reset value
#define NXMAC_MAX_SUPPORTED_BW_RST          0x0
 ...
 * and writes the value to the register.
 *
 * @param[in] maxsupportednss - The value to use for the maxSupportedNss field.
 ...
 */
__INLINE void nxmac_tx_bw_cntrl_pack(uint8_t maxsupportednss, uint8_t maxsupportedbw, uint8_t appdumaxtime, uint8_t dynbwen, uint8_t numtrybwacquisition, uint8_t droptolowerbw, uint8_t defaultbwtxop, uint8_t defaultbwtxopv)
{
    ASSERT_ERR((((uint32_t)maxsupportednss << 20) & ~((uint32_t)0x00700000)) == 0);
    ...
    REG_PL_WR(NXMAC_TX_BW_CNTRL_ADDR,  ((uint32_t)maxsupportednss << 20) | ((uint32_t)maxsupportedbw << 16) | ((uint32_t)appdumaxtime << 8) | ((uint32_t)dynbwen << 7) | ((uint32_t)numtrybwacquisition << 4) | ((uint32_t)droptolowerbw << 3) | ((uint32_t)defaultbwtxop << 1) | ((uint32_t)defaultbwtxopv << 0));
}
 ...
 * values from the register.
 *
 * @param[out] maxsupportednss - Will be populated with the current value of this field from the register.
 ...
 */
__INLINE void nxmac_tx_bw_cntrl_unpack(uint8_t* maxsupportednss, uint8_t* maxsupportedbw, uint8_t* appdumaxtime, uint8_t* dynbwen, uint8_t* numtrybwacquisition, uint8_t* droptolowerbw, uint8_t* defaultbwtxop, uint8_t* defaultbwtxopv)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TX_BW_CNTRL_ADDR);

    *maxsupportednss = (localVal & ((uint32_t)0x00700000)) >> 20;
...
/**
 * @brief Returns the current value of the maxSupportedNss field in the TX_BW_CNTRL register.
 *
 * The TX_BW_CNTRL register will be read and the maxSupportedNss field's value will be returned.
 *
 * @return The current value of the maxSupportedNss field in the TX_BW_CNTRL register.
 */
__INLINE uint8_t nxmac_max_supported_nss_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TX_BW_CNTRL_ADDR);
    return ((localVal & ((uint32_t)0x00700000)) >> 20);
}
...
/**
 * @brief Sets the maxSupportedNss field of the TX_BW_CNTRL register.
 *
 * The TX_BW_CNTRL register will be read, modified to contain the new field value, and written.
 *
 * @param[in] maxsupportednss - The value to set the field to.
 */
__INLINE void nxmac_max_supported_nss_setf(uint8_t maxsupportednss)
{
    ASSERT_ERR((((uint32_t)maxsupportednss << 20) & ~((uint32_t)0x00700000)) == 0);
    REG_PL_WR(NXMAC_TX_BW_CNTRL_ADDR, (REG_PL_RD(NXMAC_TX_BW_CNTRL_ADDR) & ~((uint32_t)0x00700000)) | ((uint32_t)maxsupportednss << 20));
}
 ...
 * <table>
 * <caption>HTMCS bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 21:16 <td>     bssBasicHTMCSSetUM <td> R <td> R/W <td> 0x0
 * <tr><td> 15:00 <td>     bssBasicHTMCSSetEM <td> R <td> R/W <td> 0xFFFF
 * </table>
 *
 * @{
 */
...
#define NXMAC_HTMCS_ADDR   0x24B00314
 ...
 * <table>
 * <caption>VHTMCS bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 15:00 <td>    bssBasicVHTMCSSet <td> R <td> R/W <td> 0xFFFF
 * </table>
 *
 * @{
 */
...
#define NXMAC_VHTMCS_ADDR   0x24B0031C
 ...
 * <table>
 * <caption>LSTP bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 00 <td>  supportLSTP <td> R <td> R/W <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_LSTP_ADDR   0x24B00320
...
/**
 * @name HE_CONFIG register definitions
 * <table>
 * <caption>HE_CONFIG bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 21    <td>                dcmSupport <td> R <td> R/W <td> 0
 * <tr><td> 20    <td>            dopplerSupport <td> R <td> R/W <td> 0
 * <tr><td> 17    <td>              enableOBSSPD <td> R <td> R/W <td> 0
 * <tr><td> 16    <td>                 enableSRP <td> R <td> R/W <td> 0
 * <tr><td> 10    <td>    acceptAllTriggerFrames <td> R <td> R/W <td> 0
 * <tr><td> 09    <td>     acceptTriggerSWFrames <td> R <td> R/W <td> 0
 * <tr><td> 08    <td>     acceptTriggerHWFrames <td> R <td> R/W <td> 0
 * <tr><td> 07    <td>              disableTBUPH <td> R <td> R/W <td> 0
 * <tr><td> 06    <td>         disableTBRU26Resp <td> R <td> R/W <td> 0
 * <tr><td> 05    <td>               disableTBCS <td> R <td> R/W <td> 0
 * <tr><td> 04    <td>             disableTBResp <td> R <td> R/W <td> 0
 * <tr><td> 02:00 <td>              defaultPEDur <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the HE_CONFIG register
#define NXMAC_HE_CONFIG_ADDR   0x24B00324
/// Offset of the HE_CONFIG register from the base address
#define NXMAC_HE_CONFIG_OFFSET 0x00000324
/// Index of the HE_CONFIG register
#define NXMAC_HE_CONFIG_INDEX  0x000000C9
/// Reset value of the HE_CONFIG register
#define NXMAC_HE_CONFIG_RESET  0x00000000

/**
 * @brief Returns the current value of the HE_CONFIG register.
 * The HE_CONFIG register will be read and its value returned.
 * @return The current value of the HE_CONFIG register.
 */
__INLINE uint32_t nxmac_he_config_get(void)
{
    return REG_PL_RD(NXMAC_HE_CONFIG_ADDR);
}

/**
 * @brief Sets the HE_CONFIG register to a value.
 * The HE_CONFIG register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_he_config_set(uint32_t value)
{
    REG_PL_WR(NXMAC_HE_CONFIG_ADDR, value);
}

// field definitions
/// DCM_SUPPORT field bit
#define NXMAC_DCM_SUPPORT_BIT                  ((uint32_t)0x00200000)
/// DCM_SUPPORT field position
#define NXMAC_DCM_SUPPORT_POS                  21
/// DOPPLER_SUPPORT field bit
#define NXMAC_DOPPLER_SUPPORT_BIT              ((uint32_t)0x00100000)
/// DOPPLER_SUPPORT field position
#define NXMAC_DOPPLER_SUPPORT_POS              20
/// ENABLE_OBSSPD field bit
#define NXMAC_ENABLE_OBSSPD_BIT                ((uint32_t)0x00020000)
/// ENABLE_OBSSPD field position
#define NXMAC_ENABLE_OBSSPD_POS                17
/// ENABLE_SRP field bit
#define NXMAC_ENABLE_SRP_BIT                   ((uint32_t)0x00010000)
/// ENABLE_SRP field position
#define NXMAC_ENABLE_SRP_POS                   16
/// ACCEPT_ALL_TRIGGER_FRAMES field bit
#define NXMAC_ACCEPT_ALL_TRIGGER_FRAMES_BIT    ((uint32_t)0x00000400)
/// ACCEPT_ALL_TRIGGER_FRAMES field position
#define NXMAC_ACCEPT_ALL_TRIGGER_FRAMES_POS    10
/// ACCEPT_TRIGGER_SW_FRAMES field bit
#define NXMAC_ACCEPT_TRIGGER_SW_FRAMES_BIT     ((uint32_t)0x00000200)
/// ACCEPT_TRIGGER_SW_FRAMES field position
#define NXMAC_ACCEPT_TRIGGER_SW_FRAMES_POS     9
/// ACCEPT_TRIGGER_HW_FRAMES field bit
#define NXMAC_ACCEPT_TRIGGER_HW_FRAMES_BIT     ((uint32_t)0x00000100)
/// ACCEPT_TRIGGER_HW_FRAMES field position
#define NXMAC_ACCEPT_TRIGGER_HW_FRAMES_POS     8
/// DISABLE_TBUPH field bit
#define NXMAC_DISABLE_TBUPH_BIT                ((uint32_t)0x00000080)
/// DISABLE_TBUPH field position
#define NXMAC_DISABLE_TBUPH_POS                7
/// DISABLE_TBRU_26_RESP field bit
#define NXMAC_DISABLE_TBRU_26_RESP_BIT         ((uint32_t)0x00000040)
/// DISABLE_TBRU_26_RESP field position
#define NXMAC_DISABLE_TBRU_26_RESP_POS         6
/// DISABLE_TBCS field bit
#define NXMAC_DISABLE_TBCS_BIT                 ((uint32_t)0x00000020)
/// DISABLE_TBCS field position
#define NXMAC_DISABLE_TBCS_POS                 5
/// DISABLE_TB_RESP field bit
#define NXMAC_DISABLE_TB_RESP_BIT              ((uint32_t)0x00000010)
/// DISABLE_TB_RESP field position
#define NXMAC_DISABLE_TB_RESP_POS              4
/// DEFAULT_PE_DUR field mask
#define NXMAC_DEFAULT_PE_DUR_MASK              ((uint32_t)0x00000007)
/// DEFAULT_PE_DUR field LSB position
#define NXMAC_DEFAULT_PE_DUR_LSB               0
/// DEFAULT_PE_DUR field width
#define NXMAC_DEFAULT_PE_DUR_WIDTH             ((uint32_t)0x00000003)

/// DCM_SUPPORT field reset value
#define NXMAC_DCM_SUPPORT_RST                  0x0
/// DOPPLER_SUPPORT field reset value
#define NXMAC_DOPPLER_SUPPORT_RST              0x0
/// ENABLE_OBSSPD field reset value
#define NXMAC_ENABLE_OBSSPD_RST                0x0
/// ENABLE_SRP field reset value
#define NXMAC_ENABLE_SRP_RST                   0x0
/// ACCEPT_ALL_TRIGGER_FRAMES field reset value
#define NXMAC_ACCEPT_ALL_TRIGGER_FRAMES_RST    0x0
/// ACCEPT_TRIGGER_SW_FRAMES field reset value
#define NXMAC_ACCEPT_TRIGGER_SW_FRAMES_RST     0x0
/// ACCEPT_TRIGGER_HW_FRAMES field reset value
#define NXMAC_ACCEPT_TRIGGER_HW_FRAMES_RST     0x0
/// DISABLE_TBUPH field reset value
#define NXMAC_DISABLE_TBUPH_RST                0x0
/// DISABLE_TBRU_26_RESP field reset value
#define NXMAC_DISABLE_TBRU_26_RESP_RST         0x0
/// DISABLE_TBCS field reset value
#define NXMAC_DISABLE_TBCS_RST                 0x0
/// DISABLE_TB_RESP field reset value
#define NXMAC_DISABLE_TB_RESP_RST              0x0
/// DEFAULT_PE_DUR field reset value
#define NXMAC_DEFAULT_PE_DUR_RST               0x0

/**
 * @brief Constructs a value for the HE_CONFIG register given values for its fields
 * and writes the value to the register.
 *
 * @param[in] dcmsupport - The value to use for the dcmSupport field.
 * @param[in] dopplersupport - The value to use for the dopplerSupport field.
 * @param[in] enableobsspd - The value to use for the enableOBSSPD field.
 * @param[in] enablesrp - The value to use for the enableSRP field.
 * @param[in] acceptalltriggerframes - The value to use for the acceptAllTriggerFrames field.
 * @param[in] accepttriggerswframes - The value to use for the acceptTriggerSWFrames field.
 * @param[in] accepttriggerhwframes - The value to use for the acceptTriggerHWFrames field.
 * @param[in] disabletbuph - The value to use for the disableTBUPH field.
 * @param[in] disabletbru26resp - The value to use for the disableTBRU26Resp field.
 * @param[in] disabletbcs - The value to use for the disableTBCS field.
 * @param[in] disabletbresp - The value to use for the disableTBResp field.
 * @param[in] defaultpedur - The value to use for the defaultPEDur field.
 */
__INLINE void nxmac_he_config_pack(uint8_t dcmsupport, uint8_t dopplersupport, uint8_t enableobsspd, uint8_t enablesrp, uint8_t acceptalltriggerframes, uint8_t accepttriggerswframes, uint8_t accepttriggerhwframes, uint8_t disabletbuph, uint8_t disabletbru26resp, uint8_t disabletbcs, uint8_t disabletbresp, uint8_t defaultpedur)
{
    ASSERT_ERR((((uint32_t)dcmsupport << 21) & ~((uint32_t)0x00200000)) == 0);
    ASSERT_ERR((((uint32_t)dopplersupport << 20) & ~((uint32_t)0x00100000)) == 0);
    ASSERT_ERR((((uint32_t)enableobsspd << 17) & ~((uint32_t)0x00020000)) == 0);
    ASSERT_ERR((((uint32_t)enablesrp << 16) & ~((uint32_t)0x00010000)) == 0);
    ASSERT_ERR((((uint32_t)acceptalltriggerframes << 10) & ~((uint32_t)0x00000400)) == 0);
    ASSERT_ERR((((uint32_t)accepttriggerswframes << 9) & ~((uint32_t)0x00000200)) == 0);
    ASSERT_ERR((((uint32_t)accepttriggerhwframes << 8) & ~((uint32_t)0x00000100)) == 0);
    ASSERT_ERR((((uint32_t)disabletbuph << 7) & ~((uint32_t)0x00000080)) == 0);
    ASSERT_ERR((((uint32_t)disabletbru26resp << 6) & ~((uint32_t)0x00000040)) == 0);
    ASSERT_ERR((((uint32_t)disabletbcs << 5) & ~((uint32_t)0x00000020)) == 0);
    ASSERT_ERR((((uint32_t)disabletbresp << 4) & ~((uint32_t)0x00000010)) == 0);
    ASSERT_ERR((((uint32_t)defaultpedur << 0) & ~((uint32_t)0x00000007)) == 0);
    REG_PL_WR(NXMAC_HE_CONFIG_ADDR,  ((uint32_t)dcmsupport << 21) | ((uint32_t)dopplersupport << 20) | ((uint32_t)enableobsspd << 17) | ((uint32_t)enablesrp << 16) | ((uint32_t)acceptalltriggerframes << 10) | ((uint32_t)accepttriggerswframes << 9) | ((uint32_t)accepttriggerhwframes << 8) | ((uint32_t)disabletbuph << 7) | ((uint32_t)disabletbru26resp << 6) | ((uint32_t)disabletbcs << 5) | ((uint32_t)disabletbresp << 4) | ((uint32_t)defaultpedur << 0));
}

/**
 * @brief Unpacks HE_CONFIG's fields from current value of the HE_CONFIG register.
 *
 * Reads the HE_CONFIG register and populates all the _field variables with the corresponding
 * values from the register.
 *
 * @param[out] dcmsupport - Will be populated with the current value of this field from the register.
 * @param[out] dopplersupport - Will be populated with the current value of this field from the register.
 * @param[out] enableobsspd - Will be populated with the current value of this field from the register.
 * @param[out] enablesrp - Will be populated with the current value of this field from the register.
 * @param[out] acceptalltriggerframes - Will be populated with the current value of this field from the register.
 * @param[out] accepttriggerswframes - Will be populated with the current value of this field from the register.
 * @param[out] accepttriggerhwframes - Will be populated with the current value of this field from the register.
 * @param[out] disabletbuph - Will be populated with the current value of this field from the register.
 * @param[out] disabletbru26resp - Will be populated with the current value of this field from the register.
 * @param[out] disabletbcs - Will be populated with the current value of this field from the register.
 * @param[out] disabletbresp - Will be populated with the current value of this field from the register.
 * @param[out] defaultpedur - Will be populated with the current value of this field from the register.
 */
__INLINE void nxmac_he_config_unpack(uint8_t* dcmsupport, uint8_t* dopplersupport, uint8_t* enableobsspd, uint8_t* enablesrp, uint8_t* acceptalltriggerframes, uint8_t* accepttriggerswframes, uint8_t* accepttriggerhwframes, uint8_t* disabletbuph, uint8_t* disabletbru26resp, uint8_t* disabletbcs, uint8_t* disabletbresp, uint8_t* defaultpedur)
{
    uint32_t localVal = REG_PL_RD(NXMAC_HE_CONFIG_ADDR);

    *dcmsupport = (localVal & ((uint32_t)0x00200000)) >> 21;
    *dopplersupport = (localVal & ((uint32_t)0x00100000)) >> 20;
    *enableobsspd = (localVal & ((uint32_t)0x00020000)) >> 17;
    *enablesrp = (localVal & ((uint32_t)0x00010000)) >> 16;
    *acceptalltriggerframes = (localVal & ((uint32_t)0x00000400)) >> 10;
    *accepttriggerswframes = (localVal & ((uint32_t)0x00000200)) >> 9;
    *accepttriggerhwframes = (localVal & ((uint32_t)0x00000100)) >> 8;
    *disabletbuph = (localVal & ((uint32_t)0x00000080)) >> 7;
    *disabletbru26resp = (localVal & ((uint32_t)0x00000040)) >> 6;
    *disabletbcs = (localVal & ((uint32_t)0x00000020)) >> 5;
    *disabletbresp = (localVal & ((uint32_t)0x00000010)) >> 4;
    *defaultpedur = (localVal & ((uint32_t)0x00000007)) >> 0;
}

/**
 * @brief Returns the current value of the dcmSupport field in the HE_CONFIG register.
 *
 * The HE_CONFIG register will be read and the dcmSupport field's value will be returned.
 *
 * @return The current value of the dcmSupport field in the HE_CONFIG register.
 */
__INLINE uint8_t nxmac_dcm_support_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_HE_CONFIG_ADDR);
    return ((localVal & ((uint32_t)0x00200000)) >> 21);
}
...
/**
 * @brief Sets the dcmSupport field of the HE_CONFIG register.
 *
 * The HE_CONFIG register will be read, modified to contain the new field value, and written.
 *
 * @param[in] dcmsupport - The value to set the field to.
 */
__INLINE void nxmac_dcm_support_setf(uint8_t dcmsupport)
{
    ASSERT_ERR((((uint32_t)dcmsupport << 21) & ~((uint32_t)0x00200000)) == 0);
    REG_PL_WR(NXMAC_HE_CONFIG_ADDR, (REG_PL_RD(NXMAC_HE_CONFIG_ADDR) & ~((uint32_t)0x00200000)) | ((uint32_t)dcmsupport << 21));
}

/**
 * @brief Returns the current value of the dopplerSupport field in the HE_CONFIG register.
 *
 * The HE_CONFIG register will be read and the dopplerSupport field's value will be returned.
 *
 * @return The current value of the dopplerSupport field in the HE_CONFIG register.
 */
__INLINE uint8_t nxmac_doppler_support_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_HE_CONFIG_ADDR);
    return ((localVal & ((uint32_t)0x00100000)) >> 20);
}
...
/**
 * @brief Sets the dopplerSupport field of the HE_CONFIG register.
 *
 * The HE_CONFIG register will be read, modified to contain the new field value, and written.
 *
 * @param[in] dopplersupport - The value to set the field to.
 */
__INLINE void nxmac_doppler_support_setf(uint8_t dopplersupport)
{
    ASSERT_ERR((((uint32_t)dopplersupport << 20) & ~((uint32_t)0x00100000)) == 0);
    REG_PL_WR(NXMAC_HE_CONFIG_ADDR, (REG_PL_RD(NXMAC_HE_CONFIG_ADDR) & ~((uint32_t)0x00100000)) | ((uint32_t)dopplersupport << 20));
}

/**
 * @brief Returns the current value of the enableOBSSPD field in the HE_CONFIG register.
 *
 * The HE_CONFIG register will be read and the enableOBSSPD field's value will be returned.
 *
 * @return The current value of the enableOBSSPD field in the HE_CONFIG register.
 */
__INLINE uint8_t nxmac_enable_obsspd_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_HE_CONFIG_ADDR);
    return ((localVal & ((uint32_t)0x00020000)) >> 17);
}
...
/**
 * @brief Sets the enableOBSSPD field of the HE_CONFIG register.
 *
 * The HE_CONFIG register will be read, modified to contain the new field value, and written.
 *
 * @param[in] enableobsspd - The value to set the field to.
 */
__INLINE void nxmac_enable_obsspd_setf(uint8_t enableobsspd)
{
    ASSERT_ERR((((uint32_t)enableobsspd << 17) & ~((uint32_t)0x00020000)) == 0);
    REG_PL_WR(NXMAC_HE_CONFIG_ADDR, (REG_PL_RD(NXMAC_HE_CONFIG_ADDR) & ~((uint32_t)0x00020000)) | ((uint32_t)enableobsspd << 17));
}

/**
 * @brief Returns the current value of the enableSRP field in the HE_CONFIG register.
 *
 * The HE_CONFIG register will be read and the enableSRP field's value will be returned.
 *
 * @return The current value of the enableSRP field in the HE_CONFIG register.
 */
__INLINE uint8_t nxmac_enable_srp_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_HE_CONFIG_ADDR);
    return ((localVal & ((uint32_t)0x00010000)) >> 16);
}
...
/**
 * @brief Sets the enableSRP field of the HE_CONFIG register.
 *
 * The HE_CONFIG register will be read, modified to contain the new field value, and written.
 *
 * @param[in] enablesrp - The value to set the field to.
 */
__INLINE void nxmac_enable_srp_setf(uint8_t enablesrp)
{
    ASSERT_ERR((((uint32_t)enablesrp << 16) & ~((uint32_t)0x00010000)) == 0);
    REG_PL_WR(NXMAC_HE_CONFIG_ADDR, (REG_PL_RD(NXMAC_HE_CONFIG_ADDR) & ~((uint32_t)0x00010000)) | ((uint32_t)enablesrp << 16));
}

/**
 * @brief Returns the current value of the acceptAllTriggerFrames field in the HE_CONFIG register.
 *
 * The HE_CONFIG register will be read and the acceptAllTriggerFrames field's value will be returned.
 *
 * @return The current value of the acceptAllTriggerFrames field in the HE_CONFIG register.
 */
__INLINE uint8_t nxmac_accept_all_trigger_frames_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_HE_CONFIG_ADDR);
    return ((localVal & ((uint32_t)0x00000400)) >> 10);
}
...
/**
 * @brief Sets the acceptAllTriggerFrames field of the HE_CONFIG register.
 *
 * The HE_CONFIG register will be read, modified to contain the new field value, and written.
 *
 * @param[in] acceptalltriggerframes - The value to set the field to.
 */
__INLINE void nxmac_accept_all_trigger_frames_setf(uint8_t acceptalltriggerframes)
{
    ASSERT_ERR((((uint32_t)acceptalltriggerframes << 10) & ~((uint32_t)0x00000400)) == 0);
    REG_PL_WR(NXMAC_HE_CONFIG_ADDR, (REG_PL_RD(NXMAC_HE_CONFIG_ADDR) & ~((uint32_t)0x00000400)) | ((uint32_t)acceptalltriggerframes << 10));
}

/**
 * @brief Returns the current value of the acceptTriggerSWFrames field in the HE_CONFIG register.
 *
 * The HE_CONFIG register will be read and the acceptTriggerSWFrames field's value will be returned.
 *
 * @return The current value of the acceptTriggerSWFrames field in the HE_CONFIG register.
 */
__INLINE uint8_t nxmac_accept_trigger_sw_frames_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_HE_CONFIG_ADDR);
    return ((localVal & ((uint32_t)0x00000200)) >> 9);
}
...
/**
 * @brief Sets the acceptTriggerSWFrames field of the HE_CONFIG register.
 *
 * The HE_CONFIG register will be read, modified to contain the new field value, and written.
 *
 * @param[in] accepttriggerswframes - The value to set the field to.
 */
__INLINE void nxmac_accept_trigger_sw_frames_setf(uint8_t accepttriggerswframes)
{
    ASSERT_ERR((((uint32_t)accepttriggerswframes << 9) & ~((uint32_t)0x00000200)) == 0);
    REG_PL_WR(NXMAC_HE_CONFIG_ADDR, (REG_PL_RD(NXMAC_HE_CONFIG_ADDR) & ~((uint32_t)0x00000200)) | ((uint32_t)accepttriggerswframes << 9));
}

/**
 * @brief Returns the current value of the acceptTriggerHWFrames field in the HE_CONFIG register.
 *
 * The HE_CONFIG register will be read and the acceptTriggerHWFrames field's value will be returned.
 *
 * @return The current value of the acceptTriggerHWFrames field in the HE_CONFIG register.
 */
__INLINE uint8_t nxmac_accept_trigger_hw_frames_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_HE_CONFIG_ADDR);
    return ((localVal & ((uint32_t)0x00000100)) >> 8);
}
...
/**
 * @brief Sets the acceptTriggerHWFrames field of the HE_CONFIG register.
 *
 * The HE_CONFIG register will be read, modified to contain the new field value, and written.
 *
 * @param[in] accepttriggerhwframes - The value to set the field to.
 */
__INLINE void nxmac_accept_trigger_hw_frames_setf(uint8_t accepttriggerhwframes)
{
    ASSERT_ERR((((uint32_t)accepttriggerhwframes << 8) & ~((uint32_t)0x00000100)) == 0);
    REG_PL_WR(NXMAC_HE_CONFIG_ADDR, (REG_PL_RD(NXMAC_HE_CONFIG_ADDR) & ~((uint32_t)0x00000100)) | ((uint32_t)accepttriggerhwframes << 8));
}

/**
 * @brief Returns the current value of the disableTBUPH field in the HE_CONFIG register.
 *
 * The HE_CONFIG register will be read and the disableTBUPH field's value will be returned.
 *
 * @return The current value of the disableTBUPH field in the HE_CONFIG register.
 */
__INLINE uint8_t nxmac_disable_tbuph_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_HE_CONFIG_ADDR);
    return ((localVal & ((uint32_t)0x00000080)) >> 7);
}
...
/**
 * @brief Sets the disableTBUPH field of the HE_CONFIG register.
 *
 * The HE_CONFIG register will be read, modified to contain the new field value, and written.
 *
 * @param[in] disabletbuph - The value to set the field to.
 */
__INLINE void nxmac_disable_tbuph_setf(uint8_t disabletbuph)
{
    ASSERT_ERR((((uint32_t)disabletbuph << 7) & ~((uint32_t)0x00000080)) == 0);
    REG_PL_WR(NXMAC_HE_CONFIG_ADDR, (REG_PL_RD(NXMAC_HE_CONFIG_ADDR) & ~((uint32_t)0x00000080)) | ((uint32_t)disabletbuph << 7));
}

/**
 * @brief Returns the current value of the disableTBRU26Resp field in the HE_CONFIG register.
 *
 * The HE_CONFIG register will be read and the disableTBRU26Resp field's value will be returned.
 *
 * @return The current value of the disableTBRU26Resp field in the HE_CONFIG register.
 */
__INLINE uint8_t nxmac_disable_tbru_26_resp_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_HE_CONFIG_ADDR);
    return ((localVal & ((uint32_t)0x00000040)) >> 6);
}
...
/**
 * @brief Sets the disableTBRU26Resp field of the HE_CONFIG register.
 *
 * The HE_CONFIG register will be read, modified to contain the new field value, and written.
 *
 * @param[in] disabletbru26resp - The value to set the field to.
 */
__INLINE void nxmac_disable_tbru_26_resp_setf(uint8_t disabletbru26resp)
{
    ASSERT_ERR((((uint32_t)disabletbru26resp << 6) & ~((uint32_t)0x00000040)) == 0);
    REG_PL_WR(NXMAC_HE_CONFIG_ADDR, (REG_PL_RD(NXMAC_HE_CONFIG_ADDR) & ~((uint32_t)0x00000040)) | ((uint32_t)disabletbru26resp << 6));
}

/**
 * @brief Returns the current value of the disableTBCS field in the HE_CONFIG register.
 *
 * The HE_CONFIG register will be read and the disableTBCS field's value will be returned.
 *
 * @return The current value of the disableTBCS field in the HE_CONFIG register.
 */
__INLINE uint8_t nxmac_disable_tbcs_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_HE_CONFIG_ADDR);
    return ((localVal & ((uint32_t)0x00000020)) >> 5);
}
...
/**
 * @brief Sets the disableTBCS field of the HE_CONFIG register.
 *
 * The HE_CONFIG register will be read, modified to contain the new field value, and written.
 *
 * @param[in] disabletbcs - The value to set the field to.
 */
__INLINE void nxmac_disable_tbcs_setf(uint8_t disabletbcs)
{
    ASSERT_ERR((((uint32_t)disabletbcs << 5) & ~((uint32_t)0x00000020)) == 0);
    REG_PL_WR(NXMAC_HE_CONFIG_ADDR, (REG_PL_RD(NXMAC_HE_CONFIG_ADDR) & ~((uint32_t)0x00000020)) | ((uint32_t)disabletbcs << 5));
}

/**
 * @brief Returns the current value of the disableTBResp field in the HE_CONFIG register.
 *
 * The HE_CONFIG register will be read and the disableTBResp field's value will be returned.
 *
 * @return The current value of the disableTBResp field in the HE_CONFIG register.
 */
__INLINE uint8_t nxmac_disable_tb_resp_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_HE_CONFIG_ADDR);
    return ((localVal & ((uint32_t)0x00000010)) >> 4);
}
...
/**
 * @brief Sets the disableTBResp field of the HE_CONFIG register.
 *
 * The HE_CONFIG register will be read, modified to contain the new field value, and written.
 *
 * @param[in] disabletbresp - The value to set the field to.
 */
__INLINE void nxmac_disable_tb_resp_setf(uint8_t disabletbresp)
{
    ASSERT_ERR((((uint32_t)disabletbresp << 4) & ~((uint32_t)0x00000010)) == 0);
    REG_PL_WR(NXMAC_HE_CONFIG_ADDR, (REG_PL_RD(NXMAC_HE_CONFIG_ADDR) & ~((uint32_t)0x00000010)) | ((uint32_t)disabletbresp << 4));
}

/**
 * @brief Returns the current value of the defaultPEDur field in the HE_CONFIG register.
 *
 * The HE_CONFIG register will be read and the defaultPEDur field's value will be returned.
 *
 * @return The current value of the defaultPEDur field in the HE_CONFIG register.
 */
__INLINE uint8_t nxmac_default_pe_dur_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_HE_CONFIG_ADDR);
...
/**
 * @brief Sets the defaultPEDur field of the HE_CONFIG register.
 *
 * The HE_CONFIG register will be read, modified to contain the new field value, and written.
 *
 * @param[in] defaultpedur - The value to set the field to.
 */
__INLINE void nxmac_default_pe_dur_setf(uint8_t defaultpedur)
{
    ASSERT_ERR((((uint32_t)defaultpedur << 0) & ~((uint32_t)0x00000007)) == 0);
    REG_PL_WR(NXMAC_HE_CONFIG_ADDR, (REG_PL_RD(NXMAC_HE_CONFIG_ADDR) & ~((uint32_t)0x00000007)) | ((uint32_t)defaultpedur << 0));
}

/// @}

/**
 * @name SP_CONFIG_1 register definitions
 * <table>
 * <caption>SP_CONFIG_1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:24 <td>         srgOBSSPDMaxOffset <td> R <td> R/W <td> 0x0
 * <tr><td> 23:16 <td>         srgOBSSPDMinOffset <td> R <td> R/W <td> 0x0
 * <tr><td> 15:08 <td>      nonSRGOBSSPDMaxOffset <td> R <td> R/W <td> 0x0
 * <tr><td> 03    <td>      srgInformationPresent <td> R <td> R/W <td> 0
 * <tr><td> 02    <td>        nonSRGOffsetPresent <td> R <td> R/W <td> 0
 * <tr><td> 01    <td>   nonSRGOBSSPDSRDisallowed <td> R <td> R/W <td> 0
 * <tr><td> 00    <td>              SRPDisallowed <td> R <td> R/W <td> 0
 * </table>
 *
 * @{
 */

/// Address of the SP_CONFIG_1 register
#define NXMAC_SP_CONFIG_1_ADDR   0x24B00328
/// Offset of the SP_CONFIG_1 register from the base address
#define NXMAC_SP_CONFIG_1_OFFSET 0x00000328
/// Index of the SP_CONFIG_1 register
#define NXMAC_SP_CONFIG_1_INDEX  0x000000CA
/// Reset value of the SP_CONFIG_1 register
#define NXMAC_SP_CONFIG_1_RESET  0x00000000

/**
 * @brief Returns the current value of the SP_CONFIG_1 register.
 * The SP_CONFIG_1 register will be read and its value returned.
 * @return The current value of the SP_CONFIG_1 register.
 */
__INLINE uint32_t nxmac_sp_config_1_get(void)
{
    return REG_PL_RD(NXMAC_SP_CONFIG_1_ADDR);
}

/**
 * @brief Sets the SP_CONFIG_1 register to a value.
 * The SP_CONFIG_1 register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_sp_config_1_set(uint32_t value)
{
    REG_PL_WR(NXMAC_SP_CONFIG_1_ADDR, value);
}

// field definitions
/// SRG_OBSSPD_MAX_OFFSET field mask
#define NXMAC_SRG_OBSSPD_MAX_OFFSET_MASK        ((uint32_t)0xFF000000)
/// SRG_OBSSPD_MAX_OFFSET field LSB position
#define NXMAC_SRG_OBSSPD_MAX_OFFSET_LSB         24
/// SRG_OBSSPD_MAX_OFFSET field width
#define NXMAC_SRG_OBSSPD_MAX_OFFSET_WIDTH       ((uint32_t)0x00000008)
/// SRG_OBSSPD_MIN_OFFSET field mask
#define NXMAC_SRG_OBSSPD_MIN_OFFSET_MASK        ((uint32_t)0x00FF0000)
/// SRG_OBSSPD_MIN_OFFSET field LSB position
#define NXMAC_SRG_OBSSPD_MIN_OFFSET_LSB         16
/// SRG_OBSSPD_MIN_OFFSET field width
#define NXMAC_SRG_OBSSPD_MIN_OFFSET_WIDTH       ((uint32_t)0x00000008)
/// NON_SRGOBSSPD_MAX_OFFSET field mask
#define NXMAC_NON_SRGOBSSPD_MAX_OFFSET_MASK     ((uint32_t)0x0000FF00)
/// NON_SRGOBSSPD_MAX_OFFSET field LSB position
#define NXMAC_NON_SRGOBSSPD_MAX_OFFSET_LSB      8
/// NON_SRGOBSSPD_MAX_OFFSET field width
#define NXMAC_NON_SRGOBSSPD_MAX_OFFSET_WIDTH    ((uint32_t)0x00000008)
/// SRG_INFORMATION_PRESENT field bit
#define NXMAC_SRG_INFORMATION_PRESENT_BIT       ((uint32_t)0x00000008)
/// SRG_INFORMATION_PRESENT field position
#define NXMAC_SRG_INFORMATION_PRESENT_POS       3
/// NON_SRG_OFFSET_PRESENT field bit
#define NXMAC_NON_SRG_OFFSET_PRESENT_BIT        ((uint32_t)0x00000004)
/// NON_SRG_OFFSET_PRESENT field position
#define NXMAC_NON_SRG_OFFSET_PRESENT_POS        2
/// NON_SRGOBSSPDSR_DISALLOWED field bit
#define NXMAC_NON_SRGOBSSPDSR_DISALLOWED_BIT    ((uint32_t)0x00000002)
/// NON_SRGOBSSPDSR_DISALLOWED field position
#define NXMAC_NON_SRGOBSSPDSR_DISALLOWED_POS    1
/// SRP_DISALLOWED field bit
#define NXMAC_SRP_DISALLOWED_BIT                ((uint32_t)0x00000001)
/// SRP_DISALLOWED field position
#define NXMAC_SRP_DISALLOWED_POS                0

/// SRG_OBSSPD_MAX_OFFSET field reset value
#define NXMAC_SRG_OBSSPD_MAX_OFFSET_RST         0x0
/// SRG_OBSSPD_MIN_OFFSET field reset value
#define NXMAC_SRG_OBSSPD_MIN_OFFSET_RST         0x0
/// NON_SRGOBSSPD_MAX_OFFSET field reset value
#define NXMAC_NON_SRGOBSSPD_MAX_OFFSET_RST      0x0
/// SRG_INFORMATION_PRESENT field reset value
#define NXMAC_SRG_INFORMATION_PRESENT_RST       0x0
/// NON_SRG_OFFSET_PRESENT field reset value
#define NXMAC_NON_SRG_OFFSET_PRESENT_RST        0x0
/// NON_SRGOBSSPDSR_DISALLOWED field reset value
#define NXMAC_NON_SRGOBSSPDSR_DISALLOWED_RST    0x0
/// SRP_DISALLOWED field reset value
#define NXMAC_SRP_DISALLOWED_RST                0x0

/**
 * @brief Constructs a value for the SP_CONFIG_1 register given values for its fields
 * and writes the value to the register.
 *
 * @param[in] srgobsspdmaxoffset - The value to use for the srgOBSSPDMaxOffset field.
 * @param[in] srgobsspdminoffset - The value to use for the srgOBSSPDMinOffset field.
 * @param[in] nonsrgobsspdmaxoffset - The value to use for the nonSRGOBSSPDMaxOffset field.
 * @param[in] srginformationpresent - The value to use for the srgInformationPresent field.
 * @param[in] nonsrgoffsetpresent - The value to use for the nonSRGOffsetPresent field.
 * @param[in] nonsrgobsspdsrdisallowed - The value to use for the nonSRGOBSSPDSRDisallowed field.
 * @param[in] srpdisallowed - The value to use for the SRPDisallowed field.
 */
__INLINE void nxmac_sp_config_1_pack(uint8_t srgobsspdmaxoffset, uint8_t srgobsspdminoffset, uint8_t nonsrgobsspdmaxoffset, uint8_t srginformationpresent, uint8_t nonsrgoffsetpresent, uint8_t nonsrgobsspdsrdisallowed, uint8_t srpdisallowed)
{
    ASSERT_ERR((((uint32_t)srgobsspdmaxoffset << 24) & ~((uint32_t)0xFF000000)) == 0);
    ASSERT_ERR((((uint32_t)srgobsspdminoffset << 16) & ~((uint32_t)0x00FF0000)) == 0);
    ASSERT_ERR((((uint32_t)nonsrgobsspdmaxoffset << 8) & ~((uint32_t)0x0000FF00)) == 0);
    ASSERT_ERR((((uint32_t)srginformationpresent << 3) & ~((uint32_t)0x00000008)) == 0);
    ASSERT_ERR((((uint32_t)nonsrgoffsetpresent << 2) & ~((uint32_t)0x00000004)) == 0);
    ASSERT_ERR((((uint32_t)nonsrgobsspdsrdisallowed << 1) & ~((uint32_t)0x00000002)) == 0);
    ASSERT_ERR((((uint32_t)srpdisallowed << 0) & ~((uint32_t)0x00000001)) == 0);
    REG_PL_WR(NXMAC_SP_CONFIG_1_ADDR,  ((uint32_t)srgobsspdmaxoffset << 24) | ((uint32_t)srgobsspdminoffset << 16) | ((uint32_t)nonsrgobsspdmaxoffset << 8) | ((uint32_t)srginformationpresent << 3) | ((uint32_t)nonsrgoffsetpresent << 2) | ((uint32_t)nonsrgobsspdsrdisallowed << 1) | ((uint32_t)srpdisallowed << 0));
}

/**
 * @brief Unpacks SP_CONFIG_1's fields from current value of the SP_CONFIG_1 register.
 *
 * Reads the SP_CONFIG_1 register and populates all the _field variables with the corresponding
 * values from the register.
 *
 * @param[out] srgobsspdmaxoffset - Will be populated with the current value of this field from the register.
 * @param[out] srgobsspdminoffset - Will be populated with the current value of this field from the register.
 * @param[out] nonsrgobsspdmaxoffset - Will be populated with the current value of this field from the register.
 * @param[out] srginformationpresent - Will be populated with the current value of this field from the register.
 * @param[out] nonsrgoffsetpresent - Will be populated with the current value of this field from the register.
 * @param[out] nonsrgobsspdsrdisallowed - Will be populated with the current value of this field from the register.
 * @param[out] srpdisallowed - Will be populated with the current value of this field from the register.
 */
__INLINE void nxmac_sp_config_1_unpack(uint8_t* srgobsspdmaxoffset, uint8_t* srgobsspdminoffset, uint8_t* nonsrgobsspdmaxoffset, uint8_t* srginformationpresent, uint8_t* nonsrgoffsetpresent, uint8_t* nonsrgobsspdsrdisallowed, uint8_t* srpdisallowed)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SP_CONFIG_1_ADDR);

    *srgobsspdmaxoffset = (localVal & ((uint32_t)0xFF000000)) >> 24;
    *srgobsspdminoffset = (localVal & ((uint32_t)0x00FF0000)) >> 16;
    *nonsrgobsspdmaxoffset = (localVal & ((uint32_t)0x0000FF00)) >> 8;
    *srginformationpresent = (localVal & ((uint32_t)0x00000008)) >> 3;
    *nonsrgoffsetpresent = (localVal & ((uint32_t)0x00000004)) >> 2;
    *nonsrgobsspdsrdisallowed = (localVal & ((uint32_t)0x00000002)) >> 1;
    *srpdisallowed = (localVal & ((uint32_t)0x00000001)) >> 0;
}

/**
 * @brief Returns the current value of the srgOBSSPDMaxOffset field in the SP_CONFIG_1 register.
 *
 * The SP_CONFIG_1 register will be read and the srgOBSSPDMaxOffset field's value will be returned.
 *
 * @return The current value of the srgOBSSPDMaxOffset field in the SP_CONFIG_1 register.
 */
__INLINE uint8_t nxmac_srg_obsspd_max_offset_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SP_CONFIG_1_ADDR);
    return ((localVal & ((uint32_t)0xFF000000)) >> 24);
}
...
/**
 * @brief Sets the srgOBSSPDMaxOffset field of the SP_CONFIG_1 register.
 *
 * The SP_CONFIG_1 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] srgobsspdmaxoffset - The value to set the field to.
 */
__INLINE void nxmac_srg_obsspd_max_offset_setf(uint8_t srgobsspdmaxoffset)
{
    ASSERT_ERR((((uint32_t)srgobsspdmaxoffset << 24) & ~((uint32_t)0xFF000000)) == 0);
    REG_PL_WR(NXMAC_SP_CONFIG_1_ADDR, (REG_PL_RD(NXMAC_SP_CONFIG_1_ADDR) & ~((uint32_t)0xFF000000)) | ((uint32_t)srgobsspdmaxoffset << 24));
}

/**
 * @brief Returns the current value of the srgOBSSPDMinOffset field in the SP_CONFIG_1 register.
 *
 * The SP_CONFIG_1 register will be read and the srgOBSSPDMinOffset field's value will be returned.
 *
 * @return The current value of the srgOBSSPDMinOffset field in the SP_CONFIG_1 register.
 */
__INLINE uint8_t nxmac_srg_obsspd_min_offset_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SP_CONFIG_1_ADDR);
    return ((localVal & ((uint32_t)0x00FF0000)) >> 16);
}
...
/**
 * @brief Sets the srgOBSSPDMinOffset field of the SP_CONFIG_1 register.
 *
 * The SP_CONFIG_1 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] srgobsspdminoffset - The value to set the field to.
 */
__INLINE void nxmac_srg_obsspd_min_offset_setf(uint8_t srgobsspdminoffset)
{
    ASSERT_ERR((((uint32_t)srgobsspdminoffset << 16) & ~((uint32_t)0x00FF0000)) == 0);
    REG_PL_WR(NXMAC_SP_CONFIG_1_ADDR, (REG_PL_RD(NXMAC_SP_CONFIG_1_ADDR) & ~((uint32_t)0x00FF0000)) | ((uint32_t)srgobsspdminoffset << 16));
}

/**
 * @brief Returns the current value of the nonSRGOBSSPDMaxOffset field in the SP_CONFIG_1 register.
 *
 * The SP_CONFIG_1 register will be read and the nonSRGOBSSPDMaxOffset field's value will be returned.
 *
 * @return The current value of the nonSRGOBSSPDMaxOffset field in the SP_CONFIG_1 register.
 */
__INLINE uint8_t nxmac_non_srgobsspd_max_offset_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SP_CONFIG_1_ADDR);
    return ((localVal & ((uint32_t)0x0000FF00)) >> 8);
}
...
/**
 * @brief Sets the nonSRGOBSSPDMaxOffset field of the SP_CONFIG_1 register.
 *
 * The SP_CONFIG_1 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] nonsrgobsspdmaxoffset - The value to set the field to.
 */
__INLINE void nxmac_non_srgobsspd_max_offset_setf(uint8_t nonsrgobsspdmaxoffset)
{
    ASSERT_ERR((((uint32_t)nonsrgobsspdmaxoffset << 8) & ~((uint32_t)0x0000FF00)) == 0);
    REG_PL_WR(NXMAC_SP_CONFIG_1_ADDR, (REG_PL_RD(NXMAC_SP_CONFIG_1_ADDR) & ~((uint32_t)0x0000FF00)) | ((uint32_t)nonsrgobsspdmaxoffset << 8));
}

/**
 * @brief Returns the current value of the srgInformationPresent field in the SP_CONFIG_1 register.
 *
 * The SP_CONFIG_1 register will be read and the srgInformationPresent field's value will be returned.
 *
 * @return The current value of the srgInformationPresent field in the SP_CONFIG_1 register.
 */
__INLINE uint8_t nxmac_srg_information_present_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SP_CONFIG_1_ADDR);
    return ((localVal & ((uint32_t)0x00000008)) >> 3);
}
...
/**
 * @brief Sets the srgInformationPresent field of the SP_CONFIG_1 register.
 *
 * The SP_CONFIG_1 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] srginformationpresent - The value to set the field to.
 */
__INLINE void nxmac_srg_information_present_setf(uint8_t srginformationpresent)
{
    ASSERT_ERR((((uint32_t)srginformationpresent << 3) & ~((uint32_t)0x00000008)) == 0);
    REG_PL_WR(NXMAC_SP_CONFIG_1_ADDR, (REG_PL_RD(NXMAC_SP_CONFIG_1_ADDR) & ~((uint32_t)0x00000008)) | ((uint32_t)srginformationpresent << 3));
}

/**
 * @brief Returns the current value of the nonSRGOffsetPresent field in the SP_CONFIG_1 register.
 *
 * The SP_CONFIG_1 register will be read and the nonSRGOffsetPresent field's value will be returned.
 *
 * @return The current value of the nonSRGOffsetPresent field in the SP_CONFIG_1 register.
 */
__INLINE uint8_t nxmac_non_srg_offset_present_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SP_CONFIG_1_ADDR);
    return ((localVal & ((uint32_t)0x00000004)) >> 2);
}
...
/**
 * @brief Sets the nonSRGOffsetPresent field of the SP_CONFIG_1 register.
 *
 * The SP_CONFIG_1 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] nonsrgoffsetpresent - The value to set the field to.
 */
__INLINE void nxmac_non_srg_offset_present_setf(uint8_t nonsrgoffsetpresent)
{
    ASSERT_ERR((((uint32_t)nonsrgoffsetpresent << 2) & ~((uint32_t)0x00000004)) == 0);
    REG_PL_WR(NXMAC_SP_CONFIG_1_ADDR, (REG_PL_RD(NXMAC_SP_CONFIG_1_ADDR) & ~((uint32_t)0x00000004)) | ((uint32_t)nonsrgoffsetpresent << 2));
}

/**
 * @brief Returns the current value of the nonSRGOBSSPDSRDisallowed field in the SP_CONFIG_1 register.
 *
 * The SP_CONFIG_1 register will be read and the nonSRGOBSSPDSRDisallowed field's value will be returned.
 *
 * @return The current value of the nonSRGOBSSPDSRDisallowed field in the SP_CONFIG_1 register.
 */
__INLINE uint8_t nxmac_non_srgobsspdsr_disallowed_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SP_CONFIG_1_ADDR);
    return ((localVal & ((uint32_t)0x00000002)) >> 1);
}
...
/**
 * @brief Sets the nonSRGOBSSPDSRDisallowed field of the SP_CONFIG_1 register.
 *
 * The SP_CONFIG_1 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] nonsrgobsspdsrdisallowed - The value to set the field to.
 */
__INLINE void nxmac_non_srgobsspdsr_disallowed_setf(uint8_t nonsrgobsspdsrdisallowed)
{
    ASSERT_ERR((((uint32_t)nonsrgobsspdsrdisallowed << 1) & ~((uint32_t)0x00000002)) == 0);
    REG_PL_WR(NXMAC_SP_CONFIG_1_ADDR, (REG_PL_RD(NXMAC_SP_CONFIG_1_ADDR) & ~((uint32_t)0x00000002)) | ((uint32_t)nonsrgobsspdsrdisallowed << 1));
}

/**
 * @brief Returns the current value of the SRPDisallowed field in the SP_CONFIG_1 register.
 *
 * The SP_CONFIG_1 register will be read and the SRPDisallowed field's value will be returned.
 *
 * @return The current value of the SRPDisallowed field in the SP_CONFIG_1 register.
 */
__INLINE uint8_t nxmac_srp_disallowed_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SP_CONFIG_1_ADDR);
    return ((localVal & ((uint32_t)0x00000001)) >> 0);
}
...
/**
 * @brief Sets the SRPDisallowed field of the SP_CONFIG_1 register.
 *
 * The SP_CONFIG_1 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] srpdisallowed - The value to set the field to.
 */
__INLINE void nxmac_srp_disallowed_setf(uint8_t srpdisallowed)
{
    ASSERT_ERR((((uint32_t)srpdisallowed << 0) & ~((uint32_t)0x00000001)) == 0);
    REG_PL_WR(NXMAC_SP_CONFIG_1_ADDR, (REG_PL_RD(NXMAC_SP_CONFIG_1_ADDR) & ~((uint32_t)0x00000001)) | ((uint32_t)srpdisallowed << 0));
}

/// @}

/**
 * @name SRGBSS_COLOR_BITMAP_LOW register definitions
 * <table>
 * <caption>SRGBSS_COLOR_BITMAP_LOW bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>    SRGBSSColorBitmapLow <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the SRGBSS_COLOR_BITMAP_LOW register
#define NXMAC_SRGBSS_COLOR_BITMAP_LOW_ADDR   0x24B0032C
/// Offset of the SRGBSS_COLOR_BITMAP_LOW register from the base address
#define NXMAC_SRGBSS_COLOR_BITMAP_LOW_OFFSET 0x0000032C
/// Index of the SRGBSS_COLOR_BITMAP_LOW register
#define NXMAC_SRGBSS_COLOR_BITMAP_LOW_INDEX  0x000000CB
/// Reset value of the SRGBSS_COLOR_BITMAP_LOW register
#define NXMAC_SRGBSS_COLOR_BITMAP_LOW_RESET  0x00000000

/**
 * @brief Returns the current value of the SRGBSS_COLOR_BITMAP_LOW register.
 * The SRGBSS_COLOR_BITMAP_LOW register will be read and its value returned.
 * @return The current value of the SRGBSS_COLOR_BITMAP_LOW register.
 */
__INLINE uint32_t nxmac_srgbss_color_bitmap_low_get(void)
{
    return REG_PL_RD(NXMAC_SRGBSS_COLOR_BITMAP_LOW_ADDR);
}

/**
 * @brief Sets the SRGBSS_COLOR_BITMAP_LOW register to a value.
 * The SRGBSS_COLOR_BITMAP_LOW register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_srgbss_color_bitmap_low_set(uint32_t value)
{
    REG_PL_WR(NXMAC_SRGBSS_COLOR_BITMAP_LOW_ADDR, value);
}

// field definitions
/// SRGBSS_COLOR_BITMAP_LOW field mask
#define NXMAC_SRGBSS_COLOR_BITMAP_LOW_MASK   ((uint32_t)0xFFFFFFFF)
/// SRGBSS_COLOR_BITMAP_LOW field LSB position
#define NXMAC_SRGBSS_COLOR_BITMAP_LOW_LSB    0
/// SRGBSS_COLOR_BITMAP_LOW field width
#define NXMAC_SRGBSS_COLOR_BITMAP_LOW_WIDTH  ((uint32_t)0x00000020)

/// SRGBSS_COLOR_BITMAP_LOW field reset value
#define NXMAC_SRGBSS_COLOR_BITMAP_LOW_RST    0x0

/**
 * @brief Returns the current value of the SRGBSSColorBitmapLow field in the SRGBSS_COLOR_BITMAP_LOW register.
 *
 * The SRGBSS_COLOR_BITMAP_LOW register will be read and the SRGBSSColorBitmapLow field's value will be returned.
 *
 * @return The current value of the SRGBSSColorBitmapLow field in the SRGBSS_COLOR_BITMAP_LOW register.
 */
__INLINE uint32_t nxmac_srgbss_color_bitmap_low_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SRGBSS_COLOR_BITMAP_LOW_ADDR);
    ASSERT_ERR((localVal & ~((uint32_t)0xFFFFFFFF)) == 0);
    return (localVal >> 0);
}

/**
 * @brief Sets the SRGBSSColorBitmapLow field of the SRGBSS_COLOR_BITMAP_LOW register.
 *
 * The SRGBSS_COLOR_BITMAP_LOW register will be read, modified to contain the new field value, and written.
 *
 * @param[in] srgbsscolorbitmaplow - The value to set the field to.
 */
__INLINE void nxmac_srgbss_color_bitmap_low_setf(uint32_t srgbsscolorbitmaplow)
{
    ASSERT_ERR((((uint32_t)srgbsscolorbitmaplow << 0) & ~((uint32_t)0xFFFFFFFF)) == 0);
    REG_PL_WR(NXMAC_SRGBSS_COLOR_BITMAP_LOW_ADDR, (uint32_t)srgbsscolorbitmaplow << 0);
}

/// @}

/**
 * @name SRGBSS_COLOR_BITMAP_HIGH register definitions
 * <table>
 * <caption>SRGBSS_COLOR_BITMAP_HIGH bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>    SRGBSSColorBitmapHigh <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the SRGBSS_COLOR_BITMAP_HIGH register
#define NXMAC_SRGBSS_COLOR_BITMAP_HIGH_ADDR   0x24B00330
/// Offset of the SRGBSS_COLOR_BITMAP_HIGH register from the base address
#define NXMAC_SRGBSS_COLOR_BITMAP_HIGH_OFFSET 0x00000330
/// Index of the SRGBSS_COLOR_BITMAP_HIGH register
#define NXMAC_SRGBSS_COLOR_BITMAP_HIGH_INDEX  0x000000CC
/// Reset value of the SRGBSS_COLOR_BITMAP_HIGH register
#define NXMAC_SRGBSS_COLOR_BITMAP_HIGH_RESET  0x00000000

/**
 * @brief Returns the current value of the SRGBSS_COLOR_BITMAP_HIGH register.
 * The SRGBSS_COLOR_BITMAP_HIGH register will be read and its value returned.
 * @return The current value of the SRGBSS_COLOR_BITMAP_HIGH register.
 */
__INLINE uint32_t nxmac_srgbss_color_bitmap_high_get(void)
{
    return REG_PL_RD(NXMAC_SRGBSS_COLOR_BITMAP_HIGH_ADDR);
}

/**
 * @brief Sets the SRGBSS_COLOR_BITMAP_HIGH register to a value.
 * The SRGBSS_COLOR_BITMAP_HIGH register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_srgbss_color_bitmap_high_set(uint32_t value)
{
    REG_PL_WR(NXMAC_SRGBSS_COLOR_BITMAP_HIGH_ADDR, value);
}

// field definitions
/// SRGBSS_COLOR_BITMAP_HIGH field mask
#define NXMAC_SRGBSS_COLOR_BITMAP_HIGH_MASK   ((uint32_t)0xFFFFFFFF)
/// SRGBSS_COLOR_BITMAP_HIGH field LSB position
#define NXMAC_SRGBSS_COLOR_BITMAP_HIGH_LSB    0
/// SRGBSS_COLOR_BITMAP_HIGH field width
#define NXMAC_SRGBSS_COLOR_BITMAP_HIGH_WIDTH  ((uint32_t)0x00000020)

/// SRGBSS_COLOR_BITMAP_HIGH field reset value
#define NXMAC_SRGBSS_COLOR_BITMAP_HIGH_RST    0x0

/**
 * @brief Returns the current value of the SRGBSSColorBitmapHigh field in the SRGBSS_COLOR_BITMAP_HIGH register.
 *
 * The SRGBSS_COLOR_BITMAP_HIGH register will be read and the SRGBSSColorBitmapHigh field's value will be returned.
 *
 * @return The current value of the SRGBSSColorBitmapHigh field in the SRGBSS_COLOR_BITMAP_HIGH register.
 */
__INLINE uint32_t nxmac_srgbss_color_bitmap_high_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SRGBSS_COLOR_BITMAP_HIGH_ADDR);
    ASSERT_ERR((localVal & ~((uint32_t)0xFFFFFFFF)) == 0);
    return (localVal >> 0);
}

/**
 * @brief Sets the SRGBSSColorBitmapHigh field of the SRGBSS_COLOR_BITMAP_HIGH register.
 *
 * The SRGBSS_COLOR_BITMAP_HIGH register will be read, modified to contain the new field value, and written.
 *
 * @param[in] srgbsscolorbitmaphigh - The value to set the field to.
 */
__INLINE void nxmac_srgbss_color_bitmap_high_setf(uint32_t srgbsscolorbitmaphigh)
{
    ASSERT_ERR((((uint32_t)srgbsscolorbitmaphigh << 0) & ~((uint32_t)0xFFFFFFFF)) == 0);
    REG_PL_WR(NXMAC_SRGBSS_COLOR_BITMAP_HIGH_ADDR, (uint32_t)srgbsscolorbitmaphigh << 0);
}

/// @}

/**
 * @name SRG_PARTIAL_BSSID_BITMAP_LOW register definitions
 * <table>
 * <caption>SRG_PARTIAL_BSSID_BITMAP_LOW bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>     SRGPartialBSSIDBitmapLow <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the SRG_PARTIAL_BSSID_BITMAP_LOW register
#define NXMAC_SRG_PARTIAL_BSSID_BITMAP_LOW_ADDR   0x24B00334
/// Offset of the SRG_PARTIAL_BSSID_BITMAP_LOW register from the base address
#define NXMAC_SRG_PARTIAL_BSSID_BITMAP_LOW_OFFSET 0x00000334
/// Index of the SRG_PARTIAL_BSSID_BITMAP_LOW register
#define NXMAC_SRG_PARTIAL_BSSID_BITMAP_LOW_INDEX  0x000000CD
/// Reset value of the SRG_PARTIAL_BSSID_BITMAP_LOW register
#define NXMAC_SRG_PARTIAL_BSSID_BITMAP_LOW_RESET  0x00000000

/**
 * @brief Returns the current value of the SRG_PARTIAL_BSSID_BITMAP_LOW register.
 * The SRG_PARTIAL_BSSID_BITMAP_LOW register will be read and its value returned.
 * @return The current value of the SRG_PARTIAL_BSSID_BITMAP_LOW register.
 */
__INLINE uint32_t nxmac_srg_partial_bssid_bitmap_low_get(void)
{
    return REG_PL_RD(NXMAC_SRG_PARTIAL_BSSID_BITMAP_LOW_ADDR);
}

/**
 * @brief Sets the SRG_PARTIAL_BSSID_BITMAP_LOW register to a value.
 * The SRG_PARTIAL_BSSID_BITMAP_LOW register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_srg_partial_bssid_bitmap_low_set(uint32_t value)
{
    REG_PL_WR(NXMAC_SRG_PARTIAL_BSSID_BITMAP_LOW_ADDR, value);
}

// field definitions
/// SRG_PARTIAL_BSSID_BITMAP_LOW field mask
#define NXMAC_SRG_PARTIAL_BSSID_BITMAP_LOW_MASK   ((uint32_t)0xFFFFFFFF)
/// SRG_PARTIAL_BSSID_BITMAP_LOW field LSB position
#define NXMAC_SRG_PARTIAL_BSSID_BITMAP_LOW_LSB    0
/// SRG_PARTIAL_BSSID_BITMAP_LOW field width
#define NXMAC_SRG_PARTIAL_BSSID_BITMAP_LOW_WIDTH  ((uint32_t)0x00000020)

/// SRG_PARTIAL_BSSID_BITMAP_LOW field reset value
#define NXMAC_SRG_PARTIAL_BSSID_BITMAP_LOW_RST    0x0

/**
 * @brief Returns the current value of the SRGPartialBSSIDBitmapLow field in the SRG_PARTIAL_BSSID_BITMAP_LOW register.
 *
 * The SRG_PARTIAL_BSSID_BITMAP_LOW register will be read and the SRGPartialBSSIDBitmapLow field's value will be returned.
 *
 * @return The current value of the SRGPartialBSSIDBitmapLow field in the SRG_PARTIAL_BSSID_BITMAP_LOW register.
 */
__INLINE uint32_t nxmac_srg_partial_bssid_bitmap_low_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SRG_PARTIAL_BSSID_BITMAP_LOW_ADDR);
    ASSERT_ERR((localVal & ~((uint32_t)0xFFFFFFFF)) == 0);
    return (localVal >> 0);
}

/**
 * @brief Sets the SRGPartialBSSIDBitmapLow field of the SRG_PARTIAL_BSSID_BITMAP_LOW register.
 *
 * The SRG_PARTIAL_BSSID_BITMAP_LOW register will be read, modified to contain the new field value, and written.
 *
 * @param[in] srgpartialbssidbitmaplow - The value to set the field to.
 */
__INLINE void nxmac_srg_partial_bssid_bitmap_low_setf(uint32_t srgpartialbssidbitmaplow)
{
    ASSERT_ERR((((uint32_t)srgpartialbssidbitmaplow << 0) & ~((uint32_t)0xFFFFFFFF)) == 0);
    REG_PL_WR(NXMAC_SRG_PARTIAL_BSSID_BITMAP_LOW_ADDR, (uint32_t)srgpartialbssidbitmaplow << 0);
}

/// @}

/**
 * @name SRG_PARTIAL_BSSID_BITMAP_HIGH register definitions
 * <table>
 * <caption>SRG_PARTIAL_BSSID_BITMAP_HIGH bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>     SRGPartialBSSIDBitmapHigh <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the SRG_PARTIAL_BSSID_BITMAP_HIGH register
#define NXMAC_SRG_PARTIAL_BSSID_BITMAP_HIGH_ADDR   0x24B00338
/// Offset of the SRG_PARTIAL_BSSID_BITMAP_HIGH register from the base address
#define NXMAC_SRG_PARTIAL_BSSID_BITMAP_HIGH_OFFSET 0x00000338
/// Index of the SRG_PARTIAL_BSSID_BITMAP_HIGH register
#define NXMAC_SRG_PARTIAL_BSSID_BITMAP_HIGH_INDEX  0x000000CE
/// Reset value of the SRG_PARTIAL_BSSID_BITMAP_HIGH register
#define NXMAC_SRG_PARTIAL_BSSID_BITMAP_HIGH_RESET  0x00000000

/**
 * @brief Returns the current value of the SRG_PARTIAL_BSSID_BITMAP_HIGH register.
 * The SRG_PARTIAL_BSSID_BITMAP_HIGH register will be read and its value returned.
 * @return The current value of the SRG_PARTIAL_BSSID_BITMAP_HIGH register.
 */
__INLINE uint32_t nxmac_srg_partial_bssid_bitmap_high_get(void)
{
    return REG_PL_RD(NXMAC_SRG_PARTIAL_BSSID_BITMAP_HIGH_ADDR);
}

/**
 * @brief Sets the SRG_PARTIAL_BSSID_BITMAP_HIGH register to a value.
 * The SRG_PARTIAL_BSSID_BITMAP_HIGH register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_srg_partial_bssid_bitmap_high_set(uint32_t value)
{
    REG_PL_WR(NXMAC_SRG_PARTIAL_BSSID_BITMAP_HIGH_ADDR, value);
}

// field definitions
/// SRG_PARTIAL_BSSID_BITMAP_HIGH field mask
#define NXMAC_SRG_PARTIAL_BSSID_BITMAP_HIGH_MASK   ((uint32_t)0xFFFFFFFF)
/// SRG_PARTIAL_BSSID_BITMAP_HIGH field LSB position
#define NXMAC_SRG_PARTIAL_BSSID_BITMAP_HIGH_LSB    0
/// SRG_PARTIAL_BSSID_BITMAP_HIGH field width
#define NXMAC_SRG_PARTIAL_BSSID_BITMAP_HIGH_WIDTH  ((uint32_t)0x00000020)

/// SRG_PARTIAL_BSSID_BITMAP_HIGH field reset value
#define NXMAC_SRG_PARTIAL_BSSID_BITMAP_HIGH_RST    0x0

/**
 * @brief Returns the current value of the SRGPartialBSSIDBitmapHigh field in the SRG_PARTIAL_BSSID_BITMAP_HIGH register.
 *
 * The SRG_PARTIAL_BSSID_BITMAP_HIGH register will be read and the SRGPartialBSSIDBitmapHigh field's value will be returned.
 *
 * @return The current value of the SRGPartialBSSIDBitmapHigh field in the SRG_PARTIAL_BSSID_BITMAP_HIGH register.
 */
__INLINE uint32_t nxmac_srg_partial_bssid_bitmap_high_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SRG_PARTIAL_BSSID_BITMAP_HIGH_ADDR);
    ASSERT_ERR((localVal & ~((uint32_t)0xFFFFFFFF)) == 0);
    return (localVal >> 0);
}

/**
 * @brief Sets the SRGPartialBSSIDBitmapHigh field of the SRG_PARTIAL_BSSID_BITMAP_HIGH register.
 *
 * The SRG_PARTIAL_BSSID_BITMAP_HIGH register will be read, modified to contain the new field value, and written.
 *
 * @param[in] srgpartialbssidbitmaphigh - The value to set the field to.
 */
__INLINE void nxmac_srg_partial_bssid_bitmap_high_setf(uint32_t srgpartialbssidbitmaphigh)
{
    ASSERT_ERR((((uint32_t)srgpartialbssidbitmaphigh << 0) & ~((uint32_t)0xFFFFFFFF)) == 0);
    REG_PL_WR(NXMAC_SRG_PARTIAL_BSSID_BITMAP_HIGH_ADDR, (uint32_t)srgpartialbssidbitmaphigh << 0);
}
 ...
 * <table>
 * <caption>BFMEE_CONTROL bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:30 <td>     bfrHELTFType <td> R <td> R/W <td> 0x0
 * <tr><td> 29:28 <td>        bfrGIType <td> R <td> R/W <td> 0x0
 * <tr><td> 27:25 <td>     bfrFormatMod <td> R <td> R/W <td> 0x4
 * <tr><td> 24    <td>       bfrShortGI <td> R <td> R/W <td> 0
 * <tr><td> 23:16 <td>           bfrMCS <td> R <td> R/W <td> 0x84
 * <tr><td> 10:08 <td>          bfmeeNc <td> R <td> R/W <td> 0x1
 * <tr><td> 07:05 <td>          bfmeeNr <td> R <td> R/W <td> 0x1
 * <tr><td> 04:03 <td>    bfmeeGrouping <td> R <td> R/W <td> 0x0
 * <tr><td> 02    <td>    bfmeeCodebook <td> R <td> R/W <td> 1
 * <tr><td> 01    <td>   bfmeeMUSupport <td> R <td> R/W <td> 0
 * <tr><td> 00    <td>      bfmeeEnable <td> R <td> R/W <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_BFMEE_CONTROL_ADDR   0x24B00350
...
// field definitions
/// BFR_HELTF_TYPE field mask
#define NXMAC_BFR_HELTF_TYPE_MASK     ((uint32_t)0xC0000000)
/// BFR_HELTF_TYPE field LSB position
#define NXMAC_BFR_HELTF_TYPE_LSB      30
/// BFR_HELTF_TYPE field width
#define NXMAC_BFR_HELTF_TYPE_WIDTH    ((uint32_t)0x00000002)
/// BFR_GI_TYPE field mask
#define NXMAC_BFR_GI_TYPE_MASK        ((uint32_t)0x30000000)
/// BFR_GI_TYPE field LSB position
#define NXMAC_BFR_GI_TYPE_LSB         28
/// BFR_GI_TYPE field width
#define NXMAC_BFR_GI_TYPE_WIDTH       ((uint32_t)0x00000002)
...
/// BFR_HELTF_TYPE field reset value
#define NXMAC_BFR_HELTF_TYPE_RST      0x0
/// BFR_GI_TYPE field reset value
#define NXMAC_BFR_GI_TYPE_RST         0x0
 ...
 * and writes the value to the register.
 *
 * @param[in] bfrheltftype - The value to use for the bfrHELTFType field.
 * @param[in] bfrgitype - The value to use for the bfrGIType field.
 ...
 */
__INLINE void nxmac_bfmee_control_pack(uint8_t bfrheltftype, uint8_t bfrgitype, uint8_t bfrformatmod, uint8_t bfrshortgi, uint8_t bfrmcs, uint8_t bfmeenc, uint8_t bfmeenr, uint8_t bfmeegrouping, uint8_t bfmeecodebook, uint8_t bfmeemusupport, uint8_t bfmeeenable)
{
    ASSERT_ERR((((uint32_t)bfrheltftype << 30) & ~((uint32_t)0xC0000000)) == 0);
    ASSERT_ERR((((uint32_t)bfrgitype << 28) & ~((uint32_t)0x30000000)) == 0);
    ...
    REG_PL_WR(NXMAC_BFMEE_CONTROL_ADDR,  ((uint32_t)bfrheltftype << 30) | ((uint32_t)bfrgitype << 28) | ((uint32_t)bfrformatmod << 25) | ((uint32_t)bfrshortgi << 24) | ((uint32_t)bfrmcs << 16) | ((uint32_t)bfmeenc << 8) | ((uint32_t)bfmeenr << 5) | ((uint32_t)bfmeegrouping << 3) | ((uint32_t)bfmeecodebook << 2) | ((uint32_t)bfmeemusupport << 1) | ((uint32_t)bfmeeenable << 0));
}
 ...
 * values from the register.
 *
 * @param[out] bfrheltftype - Will be populated with the current value of this field from the register.
 * @param[out] bfrgitype - Will be populated with the current value of this field from the register.
 ...
 */
__INLINE void nxmac_bfmee_control_unpack(uint8_t* bfrheltftype, uint8_t* bfrgitype, uint8_t* bfrformatmod, uint8_t* bfrshortgi, uint8_t* bfrmcs, uint8_t* bfmeenc, uint8_t* bfmeenr, uint8_t* bfmeegrouping, uint8_t* bfmeecodebook, uint8_t* bfmeemusupport, uint8_t* bfmeeenable)
{
    uint32_t localVal = REG_PL_RD(NXMAC_BFMEE_CONTROL_ADDR);

    *bfrheltftype = (localVal & ((uint32_t)0xC0000000)) >> 30;
    *bfrgitype = (localVal & ((uint32_t)0x30000000)) >> 28;
...
/**
 * @brief Returns the current value of the bfrHELTFType field in the BFMEE_CONTROL register.
 *
 * The BFMEE_CONTROL register will be read and the bfrHELTFType field's value will be returned.
 *
 * @return The current value of the bfrHELTFType field in the BFMEE_CONTROL register.
 */
__INLINE uint8_t nxmac_bfr_heltf_type_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_BFMEE_CONTROL_ADDR);
...
/**
 * @brief Sets the bfrHELTFType field of the BFMEE_CONTROL register.
 *
 * The BFMEE_CONTROL register will be read, modified to contain the new field value, and written.
 *
 * @param[in] bfrheltftype - The value to set the field to.
 */
__INLINE void nxmac_bfr_heltf_type_setf(uint8_t bfrheltftype)
{
    ASSERT_ERR((((uint32_t)bfrheltftype << 30) & ~((uint32_t)0xC0000000)) == 0);
    REG_PL_WR(NXMAC_BFMEE_CONTROL_ADDR, (REG_PL_RD(NXMAC_BFMEE_CONTROL_ADDR) & ~((uint32_t)0xC0000000)) | ((uint32_t)bfrheltftype << 30));
}

/**
 * @brief Returns the current value of the bfrGIType field in the BFMEE_CONTROL register.
 *
 * The BFMEE_CONTROL register will be read and the bfrGIType field's value will be returned.
 *
 * @return The current value of the bfrGIType field in the BFMEE_CONTROL register.
 */
__INLINE uint8_t nxmac_bfr_gi_type_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_BFMEE_CONTROL_ADDR);
...
/**
 * @brief Sets the bfrGIType field of the BFMEE_CONTROL register.
 *
 * The BFMEE_CONTROL register will be read, modified to contain the new field value, and written.
 *
 * @param[in] bfrgitype - The value to set the field to.
 */
__INLINE void nxmac_bfr_gi_type_setf(uint8_t bfrgitype)
{
    ASSERT_ERR((((uint32_t)bfrgitype << 28) & ~((uint32_t)0x30000000)) == 0);
    REG_PL_WR(NXMAC_BFMEE_CONTROL_ADDR, (REG_PL_RD(NXMAC_BFMEE_CONTROL_ADDR) & ~((uint32_t)0x30000000)) | ((uint32_t)bfrgitype << 28));
}
...
/**
 * @name RESP_CONTROL register definitions
 * <table>
 * <caption>RESP_CONTROL bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 07:00 <td>    defaultRespSMMIndex <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the RESP_CONTROL register
#define NXMAC_RESP_CONTROL_ADDR   0x24B00360
/// Offset of the RESP_CONTROL register from the base address
#define NXMAC_RESP_CONTROL_OFFSET 0x00000360
/// Index of the RESP_CONTROL register
#define NXMAC_RESP_CONTROL_INDEX  0x000000D8
/// Reset value of the RESP_CONTROL register
#define NXMAC_RESP_CONTROL_RESET  0x00000000

/**
 * @brief Returns the current value of the RESP_CONTROL register.
 * The RESP_CONTROL register will be read and its value returned.
 * @return The current value of the RESP_CONTROL register.
 */
__INLINE uint32_t nxmac_resp_control_get(void)
{
    return REG_PL_RD(NXMAC_RESP_CONTROL_ADDR);
}

/**
 * @brief Sets the RESP_CONTROL register to a value.
 * The RESP_CONTROL register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_resp_control_set(uint32_t value)
{
    REG_PL_WR(NXMAC_RESP_CONTROL_ADDR, value);
}

// field definitions
/// DEFAULT_RESP_SMM_INDEX field mask
#define NXMAC_DEFAULT_RESP_SMM_INDEX_MASK   ((uint32_t)0x000000FF)
/// DEFAULT_RESP_SMM_INDEX field LSB position
#define NXMAC_DEFAULT_RESP_SMM_INDEX_LSB    0
/// DEFAULT_RESP_SMM_INDEX field width
#define NXMAC_DEFAULT_RESP_SMM_INDEX_WIDTH  ((uint32_t)0x00000008)

/// DEFAULT_RESP_SMM_INDEX field reset value
#define NXMAC_DEFAULT_RESP_SMM_INDEX_RST    0x0

/**
 * @brief Returns the current value of the defaultRespSMMIndex field in the RESP_CONTROL register.
 *
 * The RESP_CONTROL register will be read and the defaultRespSMMIndex field's value will be returned.
 *
 * @return The current value of the defaultRespSMMIndex field in the RESP_CONTROL register.
 */
__INLINE uint8_t nxmac_default_resp_smm_index_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RESP_CONTROL_ADDR);
    ASSERT_ERR((localVal & ~((uint32_t)0x000000FF)) == 0);
    return (localVal >> 0);
}

/**
 * @brief Sets the defaultRespSMMIndex field of the RESP_CONTROL register.
 *
 * The RESP_CONTROL register will be read, modified to contain the new field value, and written.
 *
 * @param[in] defaultrespsmmindex - The value to set the field to.
 */
__INLINE void nxmac_default_resp_smm_index_setf(uint8_t defaultrespsmmindex)
{
    ASSERT_ERR((((uint32_t)defaultrespsmmindex << 0) & ~((uint32_t)0x000000FF)) == 0);
    REG_PL_WR(NXMAC_RESP_CONTROL_ADDR, (uint32_t)defaultrespsmmindex << 0);
}
 ...
 * <table>
 * <caption>COEX_CONTROL bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:28 <td>           coexForceWlanPTI <td> R <td> R/W <td> 0x0
 * <tr><td> 27    <td>     coexForceWlanPTIToggle <td> R <td> R/W <td> 0
 * <tr><td> 26    <td>        coexForceWlanChanBw <td> R <td> R/W <td> 0
 * <tr><td> 25    <td>            coexForceWlanRx <td> R <td> R/W <td> 0
 * <tr><td> 24    <td>            coexForceWlanTx <td> R <td> R/W <td> 0
 * <tr><td> 22:16 <td>           coexWlanChanFreq <td> R <td> R/W <td> 0x0
 * <tr><td> 12    <td>         coexWlanChanOffset <td> R <td> R/W <td> 0
 * <tr><td> 07:06 <td>         coexAutoPTIAdjIncr <td> R <td> R/W <td> 0x1
 * <tr><td> 05    <td>       coexAutoPTIAdjEnable <td> R <td> R/W <td> 1
 * <tr><td> 04    <td>            coexForceEnable <td> R <td> R/W <td> 0
 * <tr><td> 03    <td>       coexPostponeTxEnable <td> R <td> R/W <td> 1
 * <tr><td> 02    <td>       coexPHYRxAbortEnable <td> R <td> R/W <td> 0
 * <tr><td> 01    <td>       coexPHYTxAbortEnable <td> R <td> R/W <td> 0
 * <tr><td> 00    <td>                 coexEnable <td> R <td> R/W <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_COEX_CONTROL_ADDR   0x24B00400
...
#define NXMAC_COEX_CONTROL2_ADDR  0x24B00410
__INLINE void nxmac_coex_control2_set(uint32_t value)
{
    ASSERT_ERR((((uint32_t)value << 0) & ~((uint32_t)0x0000001f)) == 0);
    REG_PL_WR(NXMAC_COEX_CONTROL2_ADDR, (REG_PL_RD(NXMAC_COEX_CONTROL2_ADDR) & ~((uint32_t)0x0000001f)) | ((uint32_t)value << 0));
}
 ...
 * <table>
 * <caption>COEX_PTI bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:28 <td>    coexPTIBcnData <td> R <td> R/W <td> 0x0
 * <tr><td> 27:24 <td>     coexPTIBKData <td> R <td> R/W <td> 0x0
 * <tr><td> 23:20 <td>     coexPTIBEData <td> R <td> R/W <td> 0x2
 * <tr><td> 19:16 <td>     coexPTIVIData <td> R <td> R/W <td> 0x4
 * <tr><td> 15:12 <td>     coexPTIVOData <td> R <td> R/W <td> 0x6
 * <tr><td> 11:08 <td>        coexPTIMgt <td> R <td> R/W <td> 0x6
 * <tr><td> 07:04 <td>       coexPTICntl <td> R <td> R/W <td> 0x3
 * <tr><td> 03:00 <td>        coexPTIAck <td> R <td> R/W <td> 0x7
 * </table>
 *
 * @{
 */
...
#define NXMAC_COEX_PTI_ADDR   0x24B00404
 ...
 * <table>
 * <caption>COEX_STAT bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 11:08 <td>           coexWlanPTIState <td> W <td> R <td> 0x0
 * <tr><td> 05    <td>     coexWlanPTIToggleState <td> W <td> R <td> 0
 * <tr><td> 04    <td>        coexWlanChanBwState <td> W <td> R <td> 0
 * <tr><td> 03    <td>            coexWlanRxState <td> W <td> R <td> 0
 * <tr><td> 02    <td>            coexWlanTxState <td> W <td> R <td> 0
 * <tr><td> 01    <td>       coexWlanRxAbortState <td> W <td> R <td> 0
 * <tr><td> 00    <td>       coexWlanTxAbortState <td> W <td> R <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_COEX_STAT_ADDR   0x24B00408
 ...
 * <table>
 * <caption>COEX_INT bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 03 <td>      coexWlanRxAbortFallEn <td> R <td> R/W <td> 0
 * <tr><td> 02 <td>      coexWlanRxAbortRiseEn <td> R <td> R/W <td> 0
 * <tr><td> 01 <td>      coexWlanTxAbortFallEn <td> R <td> R/W <td> 0
 * <tr><td> 00 <td>      coexWlanTxAbortRiseEn <td> R <td> R/W <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_COEX_INT_ADDR   0x24B0040C
 ...
 * <table>
 * <caption>DEBUG_HWSM_1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:24 <td>   macControlLs <td> W <td> R <td> 0x0
 * <tr><td> 16:08 <td>    txControlLs <td> W <td> R <td> 0x0
 * <tr><td> 05:00 <td>    rxControlLs <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_DEBUG_HWSM_1_ADDR   0x24B00500
 ...
 * <table>
 * <caption>DEBUG_HWSM_2 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:24 <td>   macControlCs <td> W <td> R <td> 0x0
 * <tr><td> 16:08 <td>    txControlCs <td> W <td> R <td> 0x0
 * <tr><td> 05:00 <td>    rxControlCs <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_DEBUG_HWSM_2_ADDR   0x24B00504
 ...
 * <table>
 * <caption>DEBUG_PORT_VALUE bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>   debugPortRead <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_DEBUG_PORT_VALUE_ADDR   0x24B0050C
 ...
 * <table>
 * <caption>DEBUG_PORT_SEL bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 15:08 <td>    debugPortSel2 <td> R <td> R/W <td> 0x0
 * <tr><td> 07:00 <td>    debugPortSel1 <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_DEBUG_PORT_SEL_ADDR   0x24B00510
...
/**
 * @name DEBUG_BASIC_NAV register definitions
 * <table>
 * <caption>DEBUG_BASIC_NAV bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 25:00 <td>   basicNAVCounter <td> R/W <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the DEBUG_BASIC_NAV register
#define NXMAC_DEBUG_BASIC_NAV_ADDR   0x24B00514
/// Offset of the DEBUG_BASIC_NAV register from the base address
#define NXMAC_DEBUG_BASIC_NAV_OFFSET 0x00000514
/// Index of the DEBUG_BASIC_NAV register
#define NXMAC_DEBUG_BASIC_NAV_INDEX  0x00000145
/// Reset value of the DEBUG_BASIC_NAV register
#define NXMAC_DEBUG_BASIC_NAV_RESET  0x00000000

/**
 * @brief Returns the current value of the DEBUG_BASIC_NAV register.
 * The DEBUG_BASIC_NAV register will be read and its value returned.
 * @return The current value of the DEBUG_BASIC_NAV register.
 */
__INLINE uint32_t nxmac_debug_basic_nav_get(void)
{
    return REG_PL_RD(NXMAC_DEBUG_BASIC_NAV_ADDR);
}

/**
 * @brief Sets the DEBUG_BASIC_NAV register to a value.
 * The DEBUG_BASIC_NAV register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_debug_basic_nav_set(uint32_t value)
{
    REG_PL_WR(NXMAC_DEBUG_BASIC_NAV_ADDR, value);
}

// field definitions
/// BASIC_NAV_COUNTER field mask
#define NXMAC_BASIC_NAV_COUNTER_MASK   ((uint32_t)0x03FFFFFF)
/// BASIC_NAV_COUNTER field LSB position
#define NXMAC_BASIC_NAV_COUNTER_LSB    0
/// BASIC_NAV_COUNTER field width
#define NXMAC_BASIC_NAV_COUNTER_WIDTH  ((uint32_t)0x0000001A)

/// BASIC_NAV_COUNTER field reset value
#define NXMAC_BASIC_NAV_COUNTER_RST    0x0

/**
 * @brief Returns the current value of the basicNAVCounter field in the DEBUG_BASIC_NAV register.
 *
 * The DEBUG_BASIC_NAV register will be read and the basicNAVCounter field's value will be returned.
 *
 * @return The current value of the basicNAVCounter field in the DEBUG_BASIC_NAV register.
 */
__INLINE uint32_t nxmac_basic_nav_counter_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_DEBUG_BASIC_NAV_ADDR);
    ASSERT_ERR((localVal & ~((uint32_t)0x03FFFFFF)) == 0);
    return (localVal >> 0);
}

/**
 * @brief Sets the basicNAVCounter field of the DEBUG_BASIC_NAV register.
 *
 * The DEBUG_BASIC_NAV register will be read, modified to contain the new field value, and written.
 *
 * @param[in] basicnavcounter - The value to set the field to.
 */
__INLINE void nxmac_basic_nav_counter_setf(uint32_t basicnavcounter)
{
    ASSERT_ERR((((uint32_t)basicnavcounter << 0) & ~((uint32_t)0x03FFFFFF)) == 0);
    REG_PL_WR(NXMAC_DEBUG_BASIC_NAV_ADDR, (uint32_t)basicnavcounter << 0);
}
 ...
 * <table>
 * <caption>DEBUG_CW bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 25:24 <td>  backoffOffset <td> R <td> R/W <td> 0x0
 * <tr><td> 18:16 <td>       activeAC <td> W <td> R <td> 0x0
 * <tr><td> 15:12 <td>     currentCW3 <td> W <td> R <td> 0x2
 * <tr><td> 11:08 <td>     currentCW2 <td> W <td> R <td> 0x3
 * <tr><td> 07:04 <td>     currentCW1 <td> W <td> R <td> 0x4
 * <tr><td> 03:00 <td>     currentCW0 <td> W <td> R <td> 0x4
 * </table>
 *
 * @{
 */
...
#define NXMAC_DEBUG_CW_ADDR   0x24B00518
...
#define NXMAC_ACTIVE_AC_MASK        ((uint32_t)0x00070000)
/// ACTIVE_AC field LSB position
#define NXMAC_ACTIVE_AC_LSB         16
/// ACTIVE_AC field width
#define NXMAC_ACTIVE_AC_WIDTH       ((uint32_t)0x00000003)
...
__INLINE void nxmac_debug_cw_unpack(uint8_t* backoffoffset, uint8_t* activeac, uint8_t* currentcw3, uint8_t* currentcw2, uint8_t* currentcw1, uint8_t* currentcw0)
{
    ...
    *activeac = (localVal & ((uint32_t)0x00070000)) >> 16;
 ...
 * <table>
 * <caption>DEBUG_QSRC bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:24 <td>  ac3QSRC <td> W <td> R <td> 0x0
 * <tr><td> 23:16 <td>  ac2QSRC <td> W <td> R <td> 0x0
 * <tr><td> 15:08 <td>  ac1QSRC <td> W <td> R <td> 0x0
 * <tr><td> 07:00 <td>  ac0QSRC <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_DEBUG_QSRC_ADDR   0x24B0051C
 ...
 * <table>
 * <caption>DEBUG_QLRC bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:24 <td>  ac3QLRC <td> W <td> R <td> 0x0
 * <tr><td> 23:16 <td>  ac2QLRC <td> W <td> R <td> 0x0
 * <tr><td> 15:08 <td>  ac1QLRC <td> W <td> R <td> 0x0
 * <tr><td> 07:00 <td>  ac0QLRC <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_DEBUG_QLRC_ADDR   0x24B00520
...
/**
 * @name DEBUG_UORA register definitions
 * <table>
 * <caption>DEBUG_UORA bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 06:00 <td>  ocwLFSR <td> R/W <td> R/W <td> 0x1
 * </table>
 *
 * @{
 */

/// Address of the DEBUG_UORA register
#define NXMAC_DEBUG_UORA_ADDR   0x24B00558
/// Offset of the DEBUG_UORA register from the base address
#define NXMAC_DEBUG_UORA_OFFSET 0x00000558
/// Index of the DEBUG_UORA register
#define NXMAC_DEBUG_UORA_INDEX  0x00000156
/// Reset value of the DEBUG_UORA register
#define NXMAC_DEBUG_UORA_RESET  0x00000001

/**
 * @brief Returns the current value of the DEBUG_UORA register.
 * The DEBUG_UORA register will be read and its value returned.
 * @return The current value of the DEBUG_UORA register.
 */
__INLINE uint32_t nxmac_debug_uora_get(void)
{
    return REG_PL_RD(NXMAC_DEBUG_UORA_ADDR);
}

/**
 * @brief Sets the DEBUG_UORA register to a value.
 * The DEBUG_UORA register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_debug_uora_set(uint32_t value)
{
    REG_PL_WR(NXMAC_DEBUG_UORA_ADDR, value);
}

// field definitions
/// OCW_LFSR field mask
#define NXMAC_OCW_LFSR_MASK   ((uint32_t)0x0000007F)
/// OCW_LFSR field LSB position
#define NXMAC_OCW_LFSR_LSB    0
/// OCW_LFSR field width
#define NXMAC_OCW_LFSR_WIDTH  ((uint32_t)0x00000007)

/// OCW_LFSR field reset value
#define NXMAC_OCW_LFSR_RST    0x1

/**
 * @brief Returns the current value of the ocwLFSR field in the DEBUG_UORA register.
 *
 * The DEBUG_UORA register will be read and the ocwLFSR field's value will be returned.
 *
 * @return The current value of the ocwLFSR field in the DEBUG_UORA register.
 */
__INLINE uint8_t nxmac_ocw_lfsr_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_DEBUG_UORA_ADDR);
    ASSERT_ERR((localVal & ~((uint32_t)0x0000007F)) == 0);
    return (localVal >> 0);
}

/**
 * @brief Sets the ocwLFSR field of the DEBUG_UORA register.
 *
 * The DEBUG_UORA register will be read, modified to contain the new field value, and written.
 *
 * @param[in] ocwlfsr - The value to set the field to.
 */
__INLINE void nxmac_ocw_lfsr_setf(uint8_t ocwlfsr)
{
    ASSERT_ERR((((uint32_t)ocwlfsr << 0) & ~((uint32_t)0x0000007F)) == 0);
    REG_PL_WR(NXMAC_DEBUG_UORA_ADDR, (uint32_t)ocwlfsr << 0);
}
 ...
 * <table>
 * <caption>DEBUG_PHY bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 01 <td>      rxEndForTimingErrRec <td> R <td> R/W <td> 0
 * <tr><td> 00 <td>     rxReqForceDeassertion <td> R <td> R/W <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_DEBUG_PHY_ADDR   0x24B0055C
...
/**
 * @name DEBUG_INTRA_NAV register definitions
 * <table>
 * <caption>DEBUG_INTRA_NAV bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 15:00 <td>   intraNAVCounter <td> R/W <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the DEBUG_INTRA_NAV register
#define NXMAC_DEBUG_INTRA_NAV_ADDR   0x24B00560
/// Offset of the DEBUG_INTRA_NAV register from the base address
#define NXMAC_DEBUG_INTRA_NAV_OFFSET 0x00000560
/// Index of the DEBUG_INTRA_NAV register
#define NXMAC_DEBUG_INTRA_NAV_INDEX  0x00000158
/// Reset value of the DEBUG_INTRA_NAV register
#define NXMAC_DEBUG_INTRA_NAV_RESET  0x00000000

/**
 * @brief Returns the current value of the DEBUG_INTRA_NAV register.
 * The DEBUG_INTRA_NAV register will be read and its value returned.
 * @return The current value of the DEBUG_INTRA_NAV register.
 */
__INLINE uint32_t nxmac_debug_intra_nav_get(void)
{
    return REG_PL_RD(NXMAC_DEBUG_INTRA_NAV_ADDR);
}

/**
 * @brief Sets the DEBUG_INTRA_NAV register to a value.
 * The DEBUG_INTRA_NAV register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_debug_intra_nav_set(uint32_t value)
{
    REG_PL_WR(NXMAC_DEBUG_INTRA_NAV_ADDR, value);
}

// field definitions
/// INTRA_NAV_COUNTER field mask
#define NXMAC_INTRA_NAV_COUNTER_MASK   ((uint32_t)0x0000FFFF)
/// INTRA_NAV_COUNTER field LSB position
#define NXMAC_INTRA_NAV_COUNTER_LSB    0
/// INTRA_NAV_COUNTER field width
#define NXMAC_INTRA_NAV_COUNTER_WIDTH  ((uint32_t)0x00000010)

/// INTRA_NAV_COUNTER field reset value
#define NXMAC_INTRA_NAV_COUNTER_RST    0x0

/**
 * @brief Returns the current value of the intraNAVCounter field in the DEBUG_INTRA_NAV register.
 *
 * The DEBUG_INTRA_NAV register will be read and the intraNAVCounter field's value will be returned.
 *
 * @return The current value of the intraNAVCounter field in the DEBUG_INTRA_NAV register.
 */
__INLINE uint16_t nxmac_intra_nav_counter_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_DEBUG_INTRA_NAV_ADDR);
    ASSERT_ERR((localVal & ~((uint32_t)0x0000FFFF)) == 0);
    return (localVal >> 0);
}

/**
 * @brief Sets the intraNAVCounter field of the DEBUG_INTRA_NAV register.
 *
 * The DEBUG_INTRA_NAV register will be read, modified to contain the new field value, and written.
 *
 * @param[in] intranavcounter - The value to set the field to.
 */
__INLINE void nxmac_intra_nav_counter_setf(uint16_t intranavcounter)
{
    ASSERT_ERR((((uint32_t)intranavcounter << 0) & ~((uint32_t)0x0000FFFF)) == 0);
    REG_PL_WR(NXMAC_DEBUG_INTRA_NAV_ADDR, (uint32_t)intranavcounter << 0);
}
