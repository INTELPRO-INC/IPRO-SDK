 ...
 * <table>
 * <caption>NEXT_TBTT bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 15:00 <td>  nextTBTT <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_NEXT_TBTT_ADDR   0x24B08040
 ...
 * <table>
 * <caption>DOZE_CNTRL_2 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31 <td>    wakeUpFromDoze <td> R <td> R/W <td> 0
 * <tr><td> 00 <td>          wakeUpSW <td> R <td> R/W <td> 1
 * </table>
 *
 * @{
 */
...
#define NXMAC_DOZE_CNTRL_2_ADDR   0x24B08048
 ...
 * <table>
 * <caption>MAC_CNTRL_2 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 00 <td>  softReset <td> R <td> R/W <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_MAC_CNTRL_2_ADDR   0x24B08050
 ...
 * <table>
 * <caption>GEN_INT_STATUS bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 26 <td>         tbTxDMADead <td> R/W <td> S <td> 0
 * <tr><td> 25 <td>    rxPayloadDMADead <td> R/W <td> S <td> 0
 * <tr><td> 24 <td>     rxHeaderDMADead <td> R/W <td> S <td> 0
 * <tr><td> 23 <td>          phyRxStart <td> R/W <td> S <td> 0
 * <tr><td> 22 <td>              phyErr <td> R/W <td> S <td> 0
 * <tr><td> 21 <td>    macPHYIFUnderRun <td> R/W <td> S <td> 0
 * <tr><td> 20 <td>               hwErr <td> R/W <td> S <td> 0
 * <tr><td> 19 <td>          impSecDTIM <td> R/W <td> S <td> 0
 * <tr><td> 18 <td>          impPriDTIM <td> R/W <td> S <td> 0
 * <tr><td> 17 <td>        bcnTxDMADead <td> R/W <td> S <td> 0
 * <tr><td> 16 <td>        ac3TxDMADead <td> R/W <td> S <td> 0
 * <tr><td> 15 <td>        ac2TxDMADead <td> R/W <td> S <td> 0
 * <tr><td> 14 <td>        ac1TxDMADead <td> R/W <td> S <td> 0
 * <tr><td> 13 <td>        ac0TxDMADead <td> R/W <td> S <td> 0
 * <tr><td> 12 <td>             ptError <td> R/W <td> S <td> 0
 * <tr><td> 11 <td>              timSet <td> R/W <td> S <td> 0
 * <tr><td> 10 <td>            olbcDSSS <td> R/W <td> S <td> 0
 * <tr><td> 09 <td>            olbcOFDM <td> R/W <td> S <td> 0
 * <tr><td> 08 <td>      rxFIFOOverFlow <td> R/W <td> S <td> 0
 * <tr><td> 06 <td>    macPHYIFOverflow <td> R/W <td> S <td> 0
 * <tr><td> 05 <td>           coexEvent <td> R/W <td> S <td> 0
 * <tr><td> 03 <td>        absGenTimers <td> W <td> R <td> 0
 * <tr><td> 02 <td>       idleInterrupt <td> R/W <td> S <td> 0
 * <tr><td> 01 <td>          impSecTBTT <td> R/W <td> S <td> 0
 * <tr><td> 00 <td>          impPriTBTT <td> R/W <td> S <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_GEN_INT_STATUS_ADDR   0x24B0806C
 ...
 * and writes the value to the register.
 *
 * @param[in] tbtxdmadead - The value to use for the tbTxDMADead field.
 ...
 */
__INLINE void nxmac_gen_int_status_pack(uint8_t tbtxdmadead, uint8_t rxpayloaddmadead, uint8_t rxheaderdmadead, uint8_t phyrxstart, uint8_t phyerr, uint8_t macphyifunderrun, uint8_t hwerr, uint8_t impsecdtim, uint8_t imppridtim, uint8_t bcntxdmadead, uint8_t ac3txdmadead, uint8_t ac2txdmadead, uint8_t ac1txdmadead, uint8_t ac0txdmadead, uint8_t pterror, uint8_t timset, uint8_t olbcdsss, uint8_t olbcofdm, uint8_t rxfifooverflow, uint8_t macphyifoverflow, uint8_t coexevent, uint8_t idleinterrupt, uint8_t impsectbtt, uint8_t imppritbtt)
{
    ASSERT_ERR((((uint32_t)tbtxdmadead << 26) & ~((uint32_t)0x04000000)) == 0);
 ...
 * values from the register.
 *
 * @param[out] tbtxdmadead - Will be populated with the current value of this field from the register.
 ...
 */
__INLINE void nxmac_gen_int_status_unpack(uint8_t* tbtxdmadead, uint8_t* rxpayloaddmadead, uint8_t* rxheaderdmadead, uint8_t* phyrxstart, uint8_t* phyerr, uint8_t* macphyifunderrun, uint8_t* hwerr, uint8_t* impsecdtim, uint8_t* imppridtim, uint8_t* bcntxdmadead, uint8_t* ac3txdmadead, uint8_t* ac2txdmadead, uint8_t* ac1txdmadead, uint8_t* ac0txdmadead, uint8_t* pterror, uint8_t* timset, uint8_t* olbcdsss, uint8_t* olbcofdm, uint8_t* rxfifooverflow, uint8_t* macphyifoverflow, uint8_t* coexevent, uint8_t* absgentimers, uint8_t* idleinterrupt, uint8_t* impsectbtt, uint8_t* imppritbtt)
{
    uint32_t localVal = REG_PL_RD(NXMAC_GEN_INT_STATUS_ADDR);

    *tbtxdmadead = (localVal & ((uint32_t)0x04000000)) >> 26;
...
/**
 * @brief Returns the current value of the tbTxDMADead field in the GEN_INT_STATUS register.
 *
 * The GEN_INT_STATUS register will be read and the tbTxDMADead field's value will be returned.
 *
 * @return The current value of the tbTxDMADead field in the GEN_INT_STATUS register.
 */
__INLINE uint8_t nxmac_status_tb_tx_dma_dead_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_GEN_INT_STATUS_ADDR);
...
/**
 * @brief Sets the tbTxDMADead field of the GEN_INT_STATUS register.
 *
 * The GEN_INT_STATUS register will be read, modified to contain the new field value, and written.
 *
 * @param[in] tbtxdmadead - The value to set the field to.
 */
__INLINE void nxmac_status_tb_tx_dma_dead_setf(uint8_t tbtxdmadead)
{
    ASSERT_ERR((((uint32_t)tbtxdmadead << 26) & ~((uint32_t)0x04000000)) == 0);
    REG_PL_WR(NXMAC_GEN_INT_STATUS_ADDR, (uint32_t)tbtxdmadead << 26);
}
 ...
 * <table>
 * <caption>GEN_INT_ACK bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 26 <td>         tbTxDMADead <td> R <td> C <td> 0
 * <tr><td> 25 <td>    rxPayloadDMADead <td> R <td> C <td> 0
 * <tr><td> 24 <td>     rxHeaderDMADead <td> R <td> C <td> 0
 * <tr><td> 23 <td>          phyRxStart <td> R <td> C <td> 0
 * <tr><td> 22 <td>              phyErr <td> R <td> C <td> 0
 * <tr><td> 21 <td>    macPHYIFUnderRun <td> R <td> C <td> 0
 * <tr><td> 20 <td>               hwErr <td> R <td> C <td> 0
 * <tr><td> 19 <td>          impSecDTIM <td> R <td> C <td> 0
 * <tr><td> 18 <td>          impPriDTIM <td> R <td> C <td> 0
 * <tr><td> 17 <td>        bcnTxDMADead <td> R <td> C <td> 0
 * <tr><td> 16 <td>        ac3TxDMADead <td> R <td> C <td> 0
 * <tr><td> 15 <td>        ac2TxDMADead <td> R <td> C <td> 0
 * <tr><td> 14 <td>        ac1TxDMADead <td> R <td> C <td> 0
 * <tr><td> 13 <td>        ac0TxDMADead <td> R <td> C <td> 0
 * <tr><td> 12 <td>             ptError <td> R <td> C <td> 0
 * <tr><td> 11 <td>              timSet <td> R <td> C <td> 0
 * <tr><td> 10 <td>            olbcDSSS <td> R <td> C <td> 0
 * <tr><td> 09 <td>            olbcOFDM <td> R <td> C <td> 0
 * <tr><td> 08 <td>      rxFIFOOverFlow <td> R <td> C <td> 0
 * <tr><td> 06 <td>    macPHYIFOverflow <td> R <td> C <td> 0
 * <tr><td> 05 <td>           coexEvent <td> R <td> C <td> 0
 * <tr><td> 02 <td>       idleInterrupt <td> R <td> C <td> 0
 * <tr><td> 01 <td>          impSecTBTT <td> R <td> C <td> 0
 * <tr><td> 00 <td>          impPriTBTT <td> R <td> C <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_GEN_INT_ACK_ADDR   0x24B08070
 ...
 * @param[in] imppritbtt - The value to use for the impPriTBTT field.
 */
__INLINE void nxmac_gen_int_ack_pack(uint8_t tbtxdmadead, uint8_t rxpayloaddmadead, uint8_t rxheaderdmadead, uint8_t phyrxstart, uint8_t phyerr, uint8_t macphyifunderrun, uint8_t hwerr, uint8_t impsecdtim, uint8_t imppridtim, uint8_t bcntxdmadead, uint8_t ac3txdmadead, uint8_t ac2txdmadead, uint8_t ac1txdmadead, uint8_t ac0txdmadead, uint8_t pterror, uint8_t timset, uint8_t olbcdsss, uint8_t olbcofdm, uint8_t rxfifooverflow, uint8_t macphyifoverflow, uint8_t coexevent, uint8_t idleinterrupt, uint8_t impsectbtt, uint8_t imppritbtt)
{
    ASSERT_ERR((((uint32_t)tbtxdmadead << 26) & ~((uint32_t)0x04000000)) == 0);
    ASSERT_ERR((((uint32_t)rxpayloaddmadead << 25) & ~((uint32_t)0x02000000)) == 0);
    ASSERT_ERR((((uint32_t)rxheaderdmadead << 24) & ~((uint32_t)0x01000000)) == 0);
    ...
    ASSERT_ERR((((uint32_t)impsectbtt << 1) & ~((uint32_t)0x00000002)) == 0);
    ASSERT_ERR((((uint32_t)imppritbtt << 0) & ~((uint32_t)0x00000001)) == 0);
    REG_PL_WR(NXMAC_GEN_INT_ACK_ADDR,  ((uint32_t)tbtxdmadead << 26) | ((uint32_t)rxpayloaddmadead << 25) | ((uint32_t)rxheaderdmadead << 24) | ((uint32_t)phyrxstart << 23) | ((uint32_t)phyerr << 22) | ((uint32_t)macphyifunderrun << 21) | ((uint32_t)hwerr << 20) | ((uint32_t)impsecdtim << 19) | ((uint32_t)imppridtim << 18) | ((uint32_t)bcntxdmadead << 17) | ((uint32_t)ac3txdmadead << 16) | ((uint32_t)ac2txdmadead << 15) | ((uint32_t)ac1txdmadead << 14) | ((uint32_t)ac0txdmadead << 13) | ((uint32_t)pterror << 12) | ((uint32_t)timset << 11) | ((uint32_t)olbcdsss << 10) | ((uint32_t)olbcofdm << 9) | ((uint32_t)rxfifooverflow << 8) | ((uint32_t)macphyifoverflow << 6) | ((uint32_t)coexevent << 5) | ((uint32_t)idleinterrupt << 2) | ((uint32_t)impsectbtt << 1) | ((uint32_t)imppritbtt << 0));
}

/**
 * @brief Sets the tbTxDMADead field of the GEN_INT_ACK register.
 *
 * The GEN_INT_ACK register will be read, modified to contain the new field value, and written.
 *
 * @param[in] tbtxdmadead - The value to set the field to.
 */
__INLINE void nxmac_ack_tb_tx_dma_dead_clearf(uint8_t tbtxdmadead)
{
    ASSERT_ERR((((uint32_t)tbtxdmadead << 26) & ~((uint32_t)0x04000000)) == 0);
    REG_PL_WR(NXMAC_GEN_INT_ACK_ADDR, (uint32_t)tbtxdmadead << 26);
}
 ...
 * <table>
 * <caption>GEN_INT_ENABLE bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31 <td>      masterGenIntEn <td> R <td> R/W <td> 0
 * <tr><td> 26 <td>         tbTxDMADead <td> R <td> R/W <td> 0
 * <tr><td> 25 <td>    rxPayloadDMADead <td> R <td> R/W <td> 0
 * <tr><td> 24 <td>     rxHeaderDMADead <td> R <td> R/W <td> 0
 * <tr><td> 23 <td>          phyRxStart <td> R <td> R/W <td> 0
 * <tr><td> 22 <td>              phyErr <td> R <td> R/W <td> 0
 * <tr><td> 21 <td>    macPHYIFUnderRun <td> R <td> R/W <td> 0
 * <tr><td> 20 <td>               hwErr <td> R <td> R/W <td> 0
 * <tr><td> 19 <td>          impSecDTIM <td> R <td> R/W <td> 0
 * <tr><td> 18 <td>          impPriDTIM <td> R <td> R/W <td> 0
 * <tr><td> 17 <td>        bcnTxDMADead <td> R <td> R/W <td> 0
 * <tr><td> 16 <td>        ac3TxDMADead <td> R <td> R/W <td> 0
 * <tr><td> 15 <td>        ac2TxDMADead <td> R <td> R/W <td> 0
 * <tr><td> 14 <td>        ac1TxDMADead <td> R <td> R/W <td> 0
 * <tr><td> 13 <td>        ac0TxDMADead <td> R <td> R/W <td> 0
 * <tr><td> 12 <td>             ptError <td> R <td> R/W <td> 0
 * <tr><td> 11 <td>              timSet <td> R <td> R/W <td> 0
 * <tr><td> 10 <td>            olbcDSSS <td> R <td> R/W <td> 0
 * <tr><td> 09 <td>            olbcOFDM <td> R <td> R/W <td> 0
 * <tr><td> 08 <td>      rxFIFOOverFlow <td> R <td> R/W <td> 0
 * <tr><td> 06 <td>    macPHYIFOverflow <td> R <td> R/W <td> 0
 * <tr><td> 05 <td>           coexEvent <td> R <td> R/W <td> 0
 * <tr><td> 03 <td>        absGenTimers <td> R <td> R/W <td> 0
 * <tr><td> 02 <td>       idleInterrupt <td> R <td> R/W <td> 0
 * <tr><td> 01 <td>          impSecTBTT <td> R <td> R/W <td> 0
 * <tr><td> 00 <td>          impPriTBTT <td> R <td> R/W <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_GEN_INT_ENABLE_ADDR   0x24B08074
...
/// TB_TX_DMA_DEAD field bit
#define NXMAC_TB_TX_DMA_DEAD_BIT         ((uint32_t)0x04000000)
/// TB_TX_DMA_DEAD field position
#define NXMAC_TB_TX_DMA_DEAD_POS         26
...
/// TB_TX_DMA_DEAD field reset value
#define NXMAC_TB_TX_DMA_DEAD_RST         0x0
 ...
 * @param[in] imppritbtt - The value to use for the impPriTBTT field.
 */
__INLINE void nxmac_gen_int_enable_pack(uint8_t mastergeninten, uint8_t tbtxdmadead, uint8_t rxpayloaddmadead, uint8_t rxheaderdmadead, uint8_t phyrxstart, uint8_t phyerr, uint8_t macphyifunderrun, uint8_t hwerr, uint8_t impsecdtim, uint8_t imppridtim, uint8_t bcntxdmadead, uint8_t ac3txdmadead, uint8_t ac2txdmadead, uint8_t ac1txdmadead, uint8_t ac0txdmadead, uint8_t pterror, uint8_t timset, uint8_t olbcdsss, uint8_t olbcofdm, uint8_t rxfifooverflow, uint8_t macphyifoverflow, uint8_t coexevent, uint8_t absgentimers, uint8_t idleinterrupt, uint8_t impsectbtt, uint8_t imppritbtt)
{
    ...
    ASSERT_ERR((((uint32_t)impsectbtt << 1) & ~((uint32_t)0x00000002)) == 0);
    ASSERT_ERR((((uint32_t)imppritbtt << 0) & ~((uint32_t)0x00000001)) == 0);
    REG_PL_WR(NXMAC_GEN_INT_ENABLE_ADDR,  ((uint32_t)mastergeninten << 31) | ((uint32_t)tbtxdmadead << 26) | ((uint32_t)rxpayloaddmadead << 25) | ((uint32_t)rxheaderdmadead << 24) | ((uint32_t)phyrxstart << 23) | ((uint32_t)phyerr << 22) | ((uint32_t)macphyifunderrun << 21) | ((uint32_t)hwerr << 20) | ((uint32_t)impsecdtim << 19) | ((uint32_t)imppridtim << 18) | ((uint32_t)bcntxdmadead << 17) | ((uint32_t)ac3txdmadead << 16) | ((uint32_t)ac2txdmadead << 15) | ((uint32_t)ac1txdmadead << 14) | ((uint32_t)ac0txdmadead << 13) | ((uint32_t)pterror << 12) | ((uint32_t)timset << 11) | ((uint32_t)olbcdsss << 10) | ((uint32_t)olbcofdm << 9) | ((uint32_t)rxfifooverflow << 8) | ((uint32_t)macphyifoverflow << 6) | ((uint32_t)coexevent << 5) | ((uint32_t)absgentimers << 3) | ((uint32_t)idleinterrupt << 2) | ((uint32_t)impsectbtt << 1) | ((uint32_t)imppritbtt << 0));
}
 ...
 * @param[out] imppritbtt - Will be populated with the current value of this field from the register.
 */
__INLINE void nxmac_gen_int_enable_unpack(uint8_t* mastergeninten, uint8_t* tbtxdmadead, uint8_t* rxpayloaddmadead, uint8_t* rxheaderdmadead, uint8_t* phyrxstart, uint8_t* phyerr, uint8_t* macphyifunderrun, uint8_t* hwerr, uint8_t* impsecdtim, uint8_t* imppridtim, uint8_t* bcntxdmadead, uint8_t* ac3txdmadead, uint8_t* ac2txdmadead, uint8_t* ac1txdmadead, uint8_t* ac0txdmadead, uint8_t* pterror, uint8_t* timset, uint8_t* olbcdsss, uint8_t* olbcofdm, uint8_t* rxfifooverflow, uint8_t* macphyifoverflow, uint8_t* coexevent, uint8_t* absgentimers, uint8_t* idleinterrupt, uint8_t* impsectbtt, uint8_t* imppritbtt)
{
...
/**
 * @brief Returns the current value of the tbTxDMADead field in the GEN_INT_ENABLE register.
 *
 * The GEN_INT_ENABLE register will be read and the tbTxDMADead field's value will be returned.
 *
 * @return The current value of the tbTxDMADead field in the GEN_INT_ENABLE register.
 */
__INLINE uint8_t nxmac_enable_tb_tx_dma_dead_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_GEN_INT_ENABLE_ADDR);
    return ((localVal & ((uint32_t)0x04000000)) >> 26);
}
...
/**
 * @brief Sets the tbTxDMADead field of the GEN_INT_ENABLE register.
 *
 * The GEN_INT_ENABLE register will be read, modified to contain the new field value, and written.
 *
 * @param[in] tbtxdmadead - The value to set the field to.
 */
__INLINE void nxmac_enable_tb_tx_dma_dead_setf(uint8_t tbtxdmadead)
{
    ASSERT_ERR((((uint32_t)tbtxdmadead << 26) & ~((uint32_t)0x04000000)) == 0);
    REG_PL_WR(NXMAC_GEN_INT_ENABLE_ADDR, (REG_PL_RD(NXMAC_GEN_INT_ENABLE_ADDR) & ~((uint32_t)0x04000000)) | ((uint32_t)tbtxdmadead << 26));
}
 ...
 * <table>
 * <caption>TX_RX_INT_STATUS bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 29 <td>      tbTxBufTrigger <td> R/W <td> S <td> 0
 * <tr><td> 28 <td>     bcnTxBufTrigger <td> R/W <td> S <td> 0
 * <tr><td> 27 <td>     ac3TxBufTrigger <td> R/W <td> S <td> 0
 * <tr><td> 26 <td>     ac2TxBufTrigger <td> R/W <td> S <td> 0
 * <tr><td> 25 <td>     ac1TxBufTrigger <td> R/W <td> S <td> 0
 * <tr><td> 24 <td>     ac0TxBufTrigger <td> R/W <td> S <td> 0
 * <tr><td> 23 <td>    ac3BWDropTrigger <td> R/W <td> S <td> 0
 * <tr><td> 22 <td>    ac2BWDropTrigger <td> R/W <td> S <td> 0
 * <tr><td> 21 <td>    ac1BWDropTrigger <td> R/W <td> S <td> 0
 * <tr><td> 20 <td>    ac0BWDropTrigger <td> R/W <td> S <td> 0
 * <tr><td> 18 <td>    rxBuffer2Trigger <td> R/W <td> S <td> 0
 * <tr><td> 17 <td>      timerRxTrigger <td> R/W <td> S <td> 0
 * <tr><td> 16 <td>    rxBuffer1Trigger <td> R/W <td> S <td> 0
 * <tr><td> 15 <td>    secUserTxTrigger <td> R/W <td> R <td> 0
 * <tr><td> 14 <td>      timerTxTrigger <td> R/W <td> S <td> 0
 * <tr><td> 13 <td>        txopComplete <td> R/W <td> S <td> 0
 * <tr><td> 12 <td>       tbTxCancelled <td> R/W <td> S <td> 0
 * <tr><td> 11 <td>         tbTxTrigger <td> R/W <td> S <td> 0
 * <tr><td> 10 <td>        bcnTxTrigger <td> R/W <td> S <td> 0
 * <tr><td> 09 <td>        ac3TxTrigger <td> R/W <td> S <td> 0
 * <tr><td> 08 <td>        ac2TxTrigger <td> R/W <td> S <td> 0
 * <tr><td> 07 <td>        ac1TxTrigger <td> R/W <td> S <td> 0
 * <tr><td> 06 <td>        ac0TxTrigger <td> R/W <td> S <td> 0
 * <tr><td> 04 <td>       tbProtTrigger <td> R/W <td> S <td> 0
 * <tr><td> 03 <td>      ac3ProtTrigger <td> R/W <td> S <td> 0
 * <tr><td> 02 <td>      ac2ProtTrigger <td> R/W <td> S <td> 0
 * <tr><td> 01 <td>      ac1ProtTrigger <td> R/W <td> S <td> 0
 * <tr><td> 00 <td>      ac0ProtTrigger <td> R/W <td> S <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_TX_RX_INT_STATUS_ADDR   0x24B08078
 ...
 * and writes the value to the register.
 *
 * @param[in] tbtxbuftrigger - The value to use for the tbTxBufTrigger field.
 ...
 * @param[in] rxbuffer2trigger - The value to use for the rxBuffer2Trigger field.
 * @param[in] timerrxtrigger - The value to use for the timerRxTrigger field.
 * @param[in] rxbuffer1trigger - The value to use for the rxBuffer1Trigger field.
 ...
 * @param[in] tbtxcancelled - The value to use for the tbTxCancelled field.
 * @param[in] tbtxtrigger - The value to use for the tbTxTrigger field.
 ...
 * @param[in] tbprottrigger - The value to use for the tbProtTrigger field.
 ...
 */
__INLINE void nxmac_tx_rx_int_status_pack(uint8_t tbtxbuftrigger, uint8_t bcntxbuftrigger, uint8_t ac3txbuftrigger, uint8_t ac2txbuftrigger, uint8_t ac1txbuftrigger, uint8_t ac0txbuftrigger, uint8_t ac3bwdroptrigger, uint8_t ac2bwdroptrigger, uint8_t ac1bwdroptrigger, uint8_t ac0bwdroptrigger, uint8_t rxbuffer2trigger, uint8_t timerrxtrigger, uint8_t rxbuffer1trigger, uint8_t timertxtrigger, uint8_t txopcomplete, uint8_t tbtxcancelled, uint8_t tbtxtrigger, uint8_t bcntxtrigger, uint8_t ac3txtrigger, uint8_t ac2txtrigger, uint8_t ac1txtrigger, uint8_t ac0txtrigger, uint8_t tbprottrigger, uint8_t ac3prottrigger, uint8_t ac2prottrigger, uint8_t ac1prottrigger, uint8_t ac0prottrigger)
{
    ASSERT_ERR((((uint32_t)tbtxbuftrigger << 29) & ~((uint32_t)0x20000000)) == 0);
    ...
    ASSERT_ERR((((uint32_t)rxbuffer2trigger << 18) & ~((uint32_t)0x00040000)) == 0);
    ASSERT_ERR((((uint32_t)timerrxtrigger << 17) & ~((uint32_t)0x00020000)) == 0);
    ASSERT_ERR((((uint32_t)rxbuffer1trigger << 16) & ~((uint32_t)0x00010000)) == 0);
    ASSERT_ERR((((uint32_t)timertxtrigger << 14) & ~((uint32_t)0x00004000)) == 0);
    ASSERT_ERR((((uint32_t)txopcomplete << 13) & ~((uint32_t)0x00002000)) == 0);
    ASSERT_ERR((((uint32_t)tbtxcancelled << 12) & ~((uint32_t)0x00001000)) == 0);
    ASSERT_ERR((((uint32_t)tbtxtrigger << 11) & ~((uint32_t)0x00000800)) == 0);
    ...
    ASSERT_ERR((((uint32_t)tbprottrigger << 4) & ~((uint32_t)0x00000010)) == 0);
    ...
    REG_PL_WR(NXMAC_TX_RX_INT_STATUS_ADDR,  ((uint32_t)tbtxbuftrigger << 29) | ((uint32_t)bcntxbuftrigger << 28) | ((uint32_t)ac3txbuftrigger << 27) | ((uint32_t)ac2txbuftrigger << 26) | ((uint32_t)ac1txbuftrigger << 25) | ((uint32_t)ac0txbuftrigger << 24) | ((uint32_t)ac3bwdroptrigger << 23) | ((uint32_t)ac2bwdroptrigger << 22) | ((uint32_t)ac1bwdroptrigger << 21) | ((uint32_t)ac0bwdroptrigger << 20) | ((uint32_t)rxbuffer2trigger << 18) | ((uint32_t)timerrxtrigger << 17) | ((uint32_t)rxbuffer1trigger << 16) | ((uint32_t)timertxtrigger << 14) | ((uint32_t)txopcomplete << 13) | ((uint32_t)tbtxcancelled << 12) | ((uint32_t)tbtxtrigger << 11) | ((uint32_t)bcntxtrigger << 10) | ((uint32_t)ac3txtrigger << 9) | ((uint32_t)ac2txtrigger << 8) | ((uint32_t)ac1txtrigger << 7) | ((uint32_t)ac0txtrigger << 6) | ((uint32_t)tbprottrigger << 4) | ((uint32_t)ac3prottrigger << 3) | ((uint32_t)ac2prottrigger << 2) | ((uint32_t)ac1prottrigger << 1) | ((uint32_t)ac0prottrigger << 0));
}
 ...
 * values from the register.
 *
 * @param[out] tbtxbuftrigger - Will be populated with the current value of this field from the register.
 ...
 * @param[out] rxbuffer2trigger - Will be populated with the current value of this field from the register.
 * @param[out] timerrxtrigger - Will be populated with the current value of this field from the register.
 * @param[out] rxbuffer1trigger - Will be populated with the current value of this field from the register.
 ...
 * @param[out] tbtxcancelled - Will be populated with the current value of this field from the register.
 * @param[out] tbtxtrigger - Will be populated with the current value of this field from the register.
 ...
 * @param[out] tbprottrigger - Will be populated with the current value of this field from the register.
 ...
 */
__INLINE void nxmac_tx_rx_int_status_unpack(uint8_t* tbtxbuftrigger, uint8_t* bcntxbuftrigger, uint8_t* ac3txbuftrigger, uint8_t* ac2txbuftrigger, uint8_t* ac1txbuftrigger, uint8_t* ac0txbuftrigger, uint8_t* ac3bwdroptrigger, uint8_t* ac2bwdroptrigger, uint8_t* ac1bwdroptrigger, uint8_t* ac0bwdroptrigger, uint8_t* rxbuffer2trigger, uint8_t* timerrxtrigger, uint8_t* rxbuffer1trigger, uint8_t* secusertxtrigger, uint8_t* timertxtrigger, uint8_t* txopcomplete, uint8_t* tbtxcancelled, uint8_t* tbtxtrigger, uint8_t* bcntxtrigger, uint8_t* ac3txtrigger, uint8_t* ac2txtrigger, uint8_t* ac1txtrigger, uint8_t* ac0txtrigger, uint8_t* tbprottrigger, uint8_t* ac3prottrigger, uint8_t* ac2prottrigger, uint8_t* ac1prottrigger, uint8_t* ac0prottrigger)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TX_RX_INT_STATUS_ADDR);

    *tbtxbuftrigger = (localVal & ((uint32_t)0x20000000)) >> 29;
    ...
    *rxbuffer2trigger = (localVal & ((uint32_t)0x00040000)) >> 18;
    *timerrxtrigger = (localVal & ((uint32_t)0x00020000)) >> 17;
    *rxbuffer1trigger = (localVal & ((uint32_t)0x00010000)) >> 16;
    ...
    *tbtxcancelled = (localVal & ((uint32_t)0x00001000)) >> 12;
    *tbtxtrigger = (localVal & ((uint32_t)0x00000800)) >> 11;
    ...
    *tbprottrigger = (localVal & ((uint32_t)0x00000010)) >> 4;
...
/**
 * @brief Returns the current value of the tbTxBufTrigger field in the TX_RX_INT_STATUS register.
 *
 * The TX_RX_INT_STATUS register will be read and the tbTxBufTrigger field's value will be returned.
 *
 * @return The current value of the tbTxBufTrigger field in the TX_RX_INT_STATUS register.
 */
__INLINE uint8_t nxmac_status_tb_tx_buf_trigger_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TX_RX_INT_STATUS_ADDR);
...
/**
 * @brief Sets the tbTxBufTrigger field of the TX_RX_INT_STATUS register.
 *
 * The TX_RX_INT_STATUS register will be read, modified to contain the new field value, and written.
 *
 * @param[in] tbtxbuftrigger - The value to set the field to.
 */
__INLINE void nxmac_status_tb_tx_buf_trigger_setf(uint8_t tbtxbuftrigger)
{
    ASSERT_ERR((((uint32_t)tbtxbuftrigger << 29) & ~((uint32_t)0x20000000)) == 0);
    REG_PL_WR(NXMAC_TX_RX_INT_STATUS_ADDR, (uint32_t)tbtxbuftrigger << 29);
}
...
/**
 * @brief Returns the current value of the rxBuffer2Trigger field in the TX_RX_INT_STATUS register.
 *
 * The TX_RX_INT_STATUS register will be read and the rxBuffer2Trigger field's value will be returned.
 *
 * @return The current value of the rxBuffer2Trigger field in the TX_RX_INT_STATUS register.
 */
__INLINE uint8_t nxmac_status_rx_buffer_2_trigger_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TX_RX_INT_STATUS_ADDR);
    return ((localVal & ((uint32_t)0x00040000)) >> 18);
}
...
/**
 * @brief Sets the rxBuffer2Trigger field of the TX_RX_INT_STATUS register.
 *
 * The TX_RX_INT_STATUS register will be read, modified to contain the new field value, and written.
 *
 * @param[in] rxbuffer2trigger - The value to set the field to.
 */
__INLINE void nxmac_status_rx_buffer_2_trigger_setf(uint8_t rxbuffer2trigger)
{
    ASSERT_ERR((((uint32_t)rxbuffer2trigger << 18) & ~((uint32_t)0x00040000)) == 0);
    REG_PL_WR(NXMAC_TX_RX_INT_STATUS_ADDR, (uint32_t)rxbuffer2trigger << 18);
}
...
/**
 * @brief Returns the current value of the rxBuffer1Trigger field in the TX_RX_INT_STATUS register.
 *
 * The TX_RX_INT_STATUS register will be read and the rxBuffer1Trigger field's value will be returned.
 *
 * @return The current value of the rxBuffer1Trigger field in the TX_RX_INT_STATUS register.
 */
__INLINE uint8_t nxmac_status_rx_buffer_1_trigger_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TX_RX_INT_STATUS_ADDR);
    return ((localVal & ((uint32_t)0x00010000)) >> 16);
}
...
/**
 * @brief Sets the rxBuffer1Trigger field of the TX_RX_INT_STATUS register.
 *
 * The TX_RX_INT_STATUS register will be read, modified to contain the new field value, and written.
 *
 * @param[in] rxbuffer1trigger - The value to set the field to.
 */
__INLINE void nxmac_status_rx_buffer_1_trigger_setf(uint8_t rxbuffer1trigger)
{
    ASSERT_ERR((((uint32_t)rxbuffer1trigger << 16) & ~((uint32_t)0x00010000)) == 0);
    REG_PL_WR(NXMAC_TX_RX_INT_STATUS_ADDR, (uint32_t)rxbuffer1trigger << 16);
}
...
/**
 * @brief Returns the current value of the tbTxCancelled field in the TX_RX_INT_STATUS register.
 *
 * The TX_RX_INT_STATUS register will be read and the tbTxCancelled field's value will be returned.
 *
 * @return The current value of the tbTxCancelled field in the TX_RX_INT_STATUS register.
 */
__INLINE uint8_t nxmac_status_tb_tx_cancelled_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TX_RX_INT_STATUS_ADDR);
    return ((localVal & ((uint32_t)0x00001000)) >> 12);
}
...
/**
 * @brief Sets the tbTxCancelled field of the TX_RX_INT_STATUS register.
 *
 * The TX_RX_INT_STATUS register will be read, modified to contain the new field value, and written.
 *
 * @param[in] tbtxcancelled - The value to set the field to.
 */
__INLINE void nxmac_status_tb_tx_cancelled_setf(uint8_t tbtxcancelled)
{
    ASSERT_ERR((((uint32_t)tbtxcancelled << 12) & ~((uint32_t)0x00001000)) == 0);
    REG_PL_WR(NXMAC_TX_RX_INT_STATUS_ADDR, (uint32_t)tbtxcancelled << 12);
}

/**
 * @brief Returns the current value of the tbTxTrigger field in the TX_RX_INT_STATUS register.
 *
 * The TX_RX_INT_STATUS register will be read and the tbTxTrigger field's value will be returned.
 *
 * @return The current value of the tbTxTrigger field in the TX_RX_INT_STATUS register.
 */
__INLINE uint8_t nxmac_status_tb_tx_trigger_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TX_RX_INT_STATUS_ADDR);
    return ((localVal & ((uint32_t)0x00000800)) >> 11);
}
...
/**
 * @brief Sets the tbTxTrigger field of the TX_RX_INT_STATUS register.
 *
 * The TX_RX_INT_STATUS register will be read, modified to contain the new field value, and written.
 *
 * @param[in] tbtxtrigger - The value to set the field to.
 */
__INLINE void nxmac_status_tb_tx_trigger_setf(uint8_t tbtxtrigger)
{
    ASSERT_ERR((((uint32_t)tbtxtrigger << 11) & ~((uint32_t)0x00000800)) == 0);
    REG_PL_WR(NXMAC_TX_RX_INT_STATUS_ADDR, (uint32_t)tbtxtrigger << 11);
}
...
/**
 * @brief Returns the current value of the tbProtTrigger field in the TX_RX_INT_STATUS register.
 *
 * The TX_RX_INT_STATUS register will be read and the tbProtTrigger field's value will be returned.
 *
 * @return The current value of the tbProtTrigger field in the TX_RX_INT_STATUS register.
 */
__INLINE uint8_t nxmac_status_tb_prot_trigger_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TX_RX_INT_STATUS_ADDR);
...
/**
 * @brief Sets the tbProtTrigger field of the TX_RX_INT_STATUS register.
 *
 * The TX_RX_INT_STATUS register will be read, modified to contain the new field value, and written.
 *
 * @param[in] tbprottrigger - The value to set the field to.
 */
__INLINE void nxmac_status_tb_prot_trigger_setf(uint8_t tbprottrigger)
{
    ASSERT_ERR((((uint32_t)tbprottrigger << 4) & ~((uint32_t)0x00000010)) == 0);
    REG_PL_WR(NXMAC_TX_RX_INT_STATUS_ADDR, (uint32_t)tbprottrigger << 4);
}
 ...
 * <table>
 * <caption>TX_RX_INT_ACK bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 29 <td>      tbTxBufTrigger <td> R <td> C <td> 0
 * <tr><td> 28 <td>     bcnTxBufTrigger <td> R <td> C <td> 0
 * <tr><td> 27 <td>     ac3TxBufTrigger <td> R <td> C <td> 0
 * <tr><td> 26 <td>     ac2TxBufTrigger <td> R <td> C <td> 0
 * <tr><td> 25 <td>     ac1TxBufTrigger <td> R <td> C <td> 0
 * <tr><td> 24 <td>     ac0TxBufTrigger <td> R <td> C <td> 0
 * <tr><td> 23 <td>    ac3BWDropTrigger <td> R <td> C <td> 0
 * <tr><td> 22 <td>    ac2BWDropTrigger <td> R <td> C <td> 0
 * <tr><td> 21 <td>    ac1BWDropTrigger <td> R <td> C <td> 0
 * <tr><td> 20 <td>    ac0BWDropTrigger <td> R <td> C <td> 0
 * <tr><td> 18 <td>    rxBuffer2Trigger <td> R <td> C <td> 0
 * <tr><td> 17 <td>      timerRxTrigger <td> R <td> C <td> 0
 * <tr><td> 16 <td>    rxBuffer1Trigger <td> R <td> C <td> 0
 * <tr><td> 14 <td>      timerTxTrigger <td> R <td> C <td> 0
 * <tr><td> 13 <td>        txopComplete <td> R <td> C <td> 0
 * <tr><td> 12 <td>       tbTxCancelled <td> R <td> C <td> 0
 * <tr><td> 11 <td>         tbTxTrigger <td> R <td> C <td> 0
 * <tr><td> 10 <td>        bcnTxTrigger <td> R <td> C <td> 0
 * <tr><td> 09 <td>        ac3TxTrigger <td> R <td> C <td> 0
 * <tr><td> 08 <td>        ac2TxTrigger <td> R <td> C <td> 0
 * <tr><td> 07 <td>        ac1TxTrigger <td> R <td> C <td> 0
 * <tr><td> 06 <td>        ac0TxTrigger <td> R <td> C <td> 0
 * <tr><td> 04 <td>       tbProtTrigger <td> R <td> C <td> 0
 * <tr><td> 03 <td>      ac3ProtTrigger <td> R <td> C <td> 0
 * <tr><td> 02 <td>      ac2ProtTrigger <td> R <td> C <td> 0
 * <tr><td> 01 <td>      ac1ProtTrigger <td> R <td> C <td> 0
 * <tr><td> 00 <td>      ac0ProtTrigger <td> R <td> C <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_TX_RX_INT_ACK_ADDR   0x24B0807C
 ...
 * @param[in] ac0prottrigger - The value to use for the ac0ProtTrigger field.
 */
__INLINE void nxmac_tx_rx_int_ack_pack(uint8_t tbtxbuftrigger, uint8_t bcntxbuftrigger, uint8_t ac3txbuftrigger, uint8_t ac2txbuftrigger, uint8_t ac1txbuftrigger, uint8_t ac0txbuftrigger, uint8_t ac3bwdroptrigger, uint8_t ac2bwdroptrigger, uint8_t ac1bwdroptrigger, uint8_t ac0bwdroptrigger, uint8_t rxbuffer2trigger, uint8_t timerrxtrigger, uint8_t rxbuffer1trigger, uint8_t timertxtrigger, uint8_t txopcomplete, uint8_t tbtxcancelled, uint8_t tbtxtrigger, uint8_t bcntxtrigger, uint8_t ac3txtrigger, uint8_t ac2txtrigger, uint8_t ac1txtrigger, uint8_t ac0txtrigger, uint8_t tbprottrigger, uint8_t ac3prottrigger, uint8_t ac2prottrigger, uint8_t ac1prottrigger, uint8_t ac0prottrigger)
{
    ASSERT_ERR((((uint32_t)tbtxbuftrigger << 29) & ~((uint32_t)0x20000000)) == 0);
    ASSERT_ERR((((uint32_t)bcntxbuftrigger << 28) & ~((uint32_t)0x10000000)) == 0);
    ASSERT_ERR((((uint32_t)ac3txbuftrigger << 27) & ~((uint32_t)0x08000000)) == 0);
    ...
    ASSERT_ERR((((uint32_t)ac1prottrigger << 1) & ~((uint32_t)0x00000002)) == 0);
    ASSERT_ERR((((uint32_t)ac0prottrigger << 0) & ~((uint32_t)0x00000001)) == 0);
    REG_PL_WR(NXMAC_TX_RX_INT_ACK_ADDR,  ((uint32_t)tbtxbuftrigger << 29) | ((uint32_t)bcntxbuftrigger << 28) | ((uint32_t)ac3txbuftrigger << 27) | ((uint32_t)ac2txbuftrigger << 26) | ((uint32_t)ac1txbuftrigger << 25) | ((uint32_t)ac0txbuftrigger << 24) | ((uint32_t)ac3bwdroptrigger << 23) | ((uint32_t)ac2bwdroptrigger << 22) | ((uint32_t)ac1bwdroptrigger << 21) | ((uint32_t)ac0bwdroptrigger << 20) | ((uint32_t)rxbuffer2trigger << 18) | ((uint32_t)timerrxtrigger << 17) | ((uint32_t)rxbuffer1trigger << 16) | ((uint32_t)timertxtrigger << 14) | ((uint32_t)txopcomplete << 13) | ((uint32_t)tbtxcancelled << 12) | ((uint32_t)tbtxtrigger << 11) | ((uint32_t)bcntxtrigger << 10) | ((uint32_t)ac3txtrigger << 9) | ((uint32_t)ac2txtrigger << 8) | ((uint32_t)ac1txtrigger << 7) | ((uint32_t)ac0txtrigger << 6) | ((uint32_t)tbprottrigger << 4) | ((uint32_t)ac3prottrigger << 3) | ((uint32_t)ac2prottrigger << 2) | ((uint32_t)ac1prottrigger << 1) | ((uint32_t)ac0prottrigger << 0));
}

/**
 * @brief Sets the tbTxBufTrigger field of the TX_RX_INT_ACK register.
 *
 * The TX_RX_INT_ACK register will be read, modified to contain the new field value, and written.
 *
 * @param[in] tbtxbuftrigger - The value to set the field to.
 */
__INLINE void nxmac_ack_tb_tx_buf_trigger_clearf(uint8_t tbtxbuftrigger)
{
    ASSERT_ERR((((uint32_t)tbtxbuftrigger << 29) & ~((uint32_t)0x20000000)) == 0);
    REG_PL_WR(NXMAC_TX_RX_INT_ACK_ADDR, (uint32_t)tbtxbuftrigger << 29);
}
...
/**
 * @brief Sets the rxBuffer2Trigger field of the TX_RX_INT_ACK register.
 *
 * The TX_RX_INT_ACK register will be read, modified to contain the new field value, and written.
 *
 * @param[in] rxbuffer2trigger - The value to set the field to.
 */
__INLINE void nxmac_ack_rx_buffer_2_trigger_clearf(uint8_t rxbuffer2trigger)
{
    ASSERT_ERR((((uint32_t)rxbuffer2trigger << 18) & ~((uint32_t)0x00040000)) == 0);
    REG_PL_WR(NXMAC_TX_RX_INT_ACK_ADDR, (uint32_t)rxbuffer2trigger << 18);
}
...
/**
 * @brief Sets the rxBuffer1Trigger field of the TX_RX_INT_ACK register.
 *
 * The TX_RX_INT_ACK register will be read, modified to contain the new field value, and written.
 *
 * @param[in] rxbuffer1trigger - The value to set the field to.
 */
__INLINE void nxmac_ack_rx_buffer_1_trigger_clearf(uint8_t rxbuffer1trigger)
{
    ASSERT_ERR((((uint32_t)rxbuffer1trigger << 16) & ~((uint32_t)0x00010000)) == 0);
    REG_PL_WR(NXMAC_TX_RX_INT_ACK_ADDR, (uint32_t)rxbuffer1trigger << 16);
}
...
/**
 * @brief Sets the tbTxCancelled field of the TX_RX_INT_ACK register.
 *
 * The TX_RX_INT_ACK register will be read, modified to contain the new field value, and written.
 *
 * @param[in] tbtxcancelled - The value to set the field to.
 */
__INLINE void nxmac_ack_tb_tx_cancelled_clearf(uint8_t tbtxcancelled)
{
    ASSERT_ERR((((uint32_t)tbtxcancelled << 12) & ~((uint32_t)0x00001000)) == 0);
    REG_PL_WR(NXMAC_TX_RX_INT_ACK_ADDR, (uint32_t)tbtxcancelled << 12);
}

/**
 * @brief Sets the tbTxTrigger field of the TX_RX_INT_ACK register.
 *
 * The TX_RX_INT_ACK register will be read, modified to contain the new field value, and written.
 *
 * @param[in] tbtxtrigger - The value to set the field to.
 */
__INLINE void nxmac_ack_tb_tx_trigger_clearf(uint8_t tbtxtrigger)
{
    ASSERT_ERR((((uint32_t)tbtxtrigger << 11) & ~((uint32_t)0x00000800)) == 0);
    REG_PL_WR(NXMAC_TX_RX_INT_ACK_ADDR, (uint32_t)tbtxtrigger << 11);
}
...
/**
 * @brief Sets the tbProtTrigger field of the TX_RX_INT_ACK register.
 *
 * The TX_RX_INT_ACK register will be read, modified to contain the new field value, and written.
 *
 * @param[in] tbprottrigger - The value to set the field to.
 */
__INLINE void nxmac_ack_tb_prot_trigger_clearf(uint8_t tbprottrigger)
{
    ASSERT_ERR((((uint32_t)tbprottrigger << 4) & ~((uint32_t)0x00000010)) == 0);
    REG_PL_WR(NXMAC_TX_RX_INT_ACK_ADDR, (uint32_t)tbprottrigger << 4);
}
 ...
 * <table>
 * <caption>TX_RX_INT_ENABLE bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31 <td>     masterTxRxIntEn <td> R <td> R/W <td> 0
 * <tr><td> 29 <td>      tbTxBufTrigger <td> R <td> R/W <td> 0
 * <tr><td> 28 <td>     bcnTxBufTrigger <td> R <td> R/W <td> 0
 * <tr><td> 27 <td>     ac3TxBufTrigger <td> R <td> R/W <td> 0
 * <tr><td> 26 <td>     ac2TxBufTrigger <td> R <td> R/W <td> 0
 * <tr><td> 25 <td>     ac1TxBufTrigger <td> R <td> R/W <td> 0
 * <tr><td> 24 <td>     ac0TxBufTrigger <td> R <td> R/W <td> 0
 * <tr><td> 23 <td>    ac3BWDropTrigger <td> R <td> R/W <td> 0
 * <tr><td> 22 <td>    ac2BWDropTrigger <td> R <td> R/W <td> 0
 * <tr><td> 21 <td>    ac1BWDropTrigger <td> R <td> R/W <td> 0
 * <tr><td> 20 <td>    ac0BWDropTrigger <td> R <td> R/W <td> 0
 * <tr><td> 18 <td>    rxBuffer2Trigger <td> R <td> R/W <td> 0
 * <tr><td> 17 <td>      timerRxTrigger <td> R <td> R/W <td> 0
 * <tr><td> 16 <td>    rxBuffer1Trigger <td> R <td> R/W <td> 0
 * <tr><td> 15 <td>    secUserTxTrigger <td> R <td> R/W <td> 0
 * <tr><td> 14 <td>      timerTxTrigger <td> R <td> R/W <td> 0
 * <tr><td> 13 <td>        txopComplete <td> R <td> R/W <td> 0
 * <tr><td> 12 <td>       tbTxCancelled <td> R <td> R/W <td> 0
 * <tr><td> 11 <td>         tbTxTrigger <td> R <td> R/W <td> 0
 * <tr><td> 10 <td>        bcnTxTrigger <td> R <td> R/W <td> 0
 * <tr><td> 09 <td>        ac3TxTrigger <td> R <td> R/W <td> 0
 * <tr><td> 08 <td>        ac2TxTrigger <td> R <td> R/W <td> 0
 * <tr><td> 07 <td>        ac1TxTrigger <td> R <td> R/W <td> 0
 * <tr><td> 06 <td>        ac0TxTrigger <td> R <td> R/W <td> 0
 * <tr><td> 04 <td>       tbProtTrigger <td> R <td> R/W <td> 0
 * <tr><td> 03 <td>      ac3ProtTrigger <td> R <td> R/W <td> 0
 * <tr><td> 02 <td>      ac2ProtTrigger <td> R <td> R/W <td> 0
 * <tr><td> 01 <td>      ac1ProtTrigger <td> R <td> R/W <td> 0
 * <tr><td> 00 <td>      ac0ProtTrigger <td> R <td> R/W <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_TX_RX_INT_ENABLE_ADDR   0x24B08080
...
/// TB_TX_BUF_TRIGGER field bit
#define NXMAC_TB_TX_BUF_TRIGGER_BIT      ((uint32_t)0x20000000)
/// TB_TX_BUF_TRIGGER field position
#define NXMAC_TB_TX_BUF_TRIGGER_POS      29
...
/// RX_BUFFER_2_TRIGGER field bit
#define NXMAC_RX_BUFFER_2_TRIGGER_BIT    ((uint32_t)0x00040000)
/// RX_BUFFER_2_TRIGGER field position
#define NXMAC_RX_BUFFER_2_TRIGGER_POS    18
...
/// RX_BUFFER_1_TRIGGER field bit
#define NXMAC_RX_BUFFER_1_TRIGGER_BIT    ((uint32_t)0x00010000)
/// RX_BUFFER_1_TRIGGER field position
#define NXMAC_RX_BUFFER_1_TRIGGER_POS    16
...
/// TB_TX_CANCELLED field bit
#define NXMAC_TB_TX_CANCELLED_BIT        ((uint32_t)0x00001000)
/// TB_TX_CANCELLED field position
#define NXMAC_TB_TX_CANCELLED_POS        12
/// TB_TX_TRIGGER field bit
#define NXMAC_TB_TX_TRIGGER_BIT          ((uint32_t)0x00000800)
/// TB_TX_TRIGGER field position
#define NXMAC_TB_TX_TRIGGER_POS          11
...
/// TB_PROT_TRIGGER field bit
#define NXMAC_TB_PROT_TRIGGER_BIT        ((uint32_t)0x00000010)
/// TB_PROT_TRIGGER field position
#define NXMAC_TB_PROT_TRIGGER_POS        4
...
/// TB_TX_BUF_TRIGGER field reset value
#define NXMAC_TB_TX_BUF_TRIGGER_RST      0x0
...
/// RX_BUFFER_2_TRIGGER field reset value
#define NXMAC_RX_BUFFER_2_TRIGGER_RST    0x0
/// TIMER_RX_TRIGGER field reset value
#define NXMAC_TIMER_RX_TRIGGER_RST       0x0
/// RX_BUFFER_1_TRIGGER field reset value
#define NXMAC_RX_BUFFER_1_TRIGGER_RST    0x0
...
/// TB_TX_CANCELLED field reset value
#define NXMAC_TB_TX_CANCELLED_RST        0x0
/// TB_TX_TRIGGER field reset value
#define NXMAC_TB_TX_TRIGGER_RST          0x0
...
/// TB_PROT_TRIGGER field reset value
#define NXMAC_TB_PROT_TRIGGER_RST        0x0
 ...
 * @param[in] ac0prottrigger - The value to use for the ac0ProtTrigger field.
 */
__INLINE void nxmac_tx_rx_int_enable_pack(uint8_t mastertxrxinten, uint8_t tbtxbuftrigger, uint8_t bcntxbuftrigger, uint8_t ac3txbuftrigger, uint8_t ac2txbuftrigger, uint8_t ac1txbuftrigger, uint8_t ac0txbuftrigger, uint8_t ac3bwdroptrigger, uint8_t ac2bwdroptrigger, uint8_t ac1bwdroptrigger, uint8_t ac0bwdroptrigger, uint8_t rxbuffer2trigger, uint8_t timerrxtrigger, uint8_t rxbuffer1trigger, uint8_t secusertxtrigger, uint8_t timertxtrigger, uint8_t txopcomplete, uint8_t tbtxcancelled, uint8_t tbtxtrigger, uint8_t bcntxtrigger, uint8_t ac3txtrigger, uint8_t ac2txtrigger, uint8_t ac1txtrigger, uint8_t ac0txtrigger, uint8_t tbprottrigger, uint8_t ac3prottrigger, uint8_t ac2prottrigger, uint8_t ac1prottrigger, uint8_t ac0prottrigger)
{
    ...
    ASSERT_ERR((((uint32_t)ac1prottrigger << 1) & ~((uint32_t)0x00000002)) == 0);
    ASSERT_ERR((((uint32_t)ac0prottrigger << 0) & ~((uint32_t)0x00000001)) == 0);
    REG_PL_WR(NXMAC_TX_RX_INT_ENABLE_ADDR,  ((uint32_t)mastertxrxinten << 31) | ((uint32_t)tbtxbuftrigger << 29) | ((uint32_t)bcntxbuftrigger << 28) | ((uint32_t)ac3txbuftrigger << 27) | ((uint32_t)ac2txbuftrigger << 26) | ((uint32_t)ac1txbuftrigger << 25) | ((uint32_t)ac0txbuftrigger << 24) | ((uint32_t)ac3bwdroptrigger << 23) | ((uint32_t)ac2bwdroptrigger << 22) | ((uint32_t)ac1bwdroptrigger << 21) | ((uint32_t)ac0bwdroptrigger << 20) | ((uint32_t)rxbuffer2trigger << 18) | ((uint32_t)timerrxtrigger << 17) | ((uint32_t)rxbuffer1trigger << 16) | ((uint32_t)secusertxtrigger << 15) | ((uint32_t)timertxtrigger << 14) | ((uint32_t)txopcomplete << 13) | ((uint32_t)tbtxcancelled << 12) | ((uint32_t)tbtxtrigger << 11) | ((uint32_t)bcntxtrigger << 10) | ((uint32_t)ac3txtrigger << 9) | ((uint32_t)ac2txtrigger << 8) | ((uint32_t)ac1txtrigger << 7) | ((uint32_t)ac0txtrigger << 6) | ((uint32_t)tbprottrigger << 4) | ((uint32_t)ac3prottrigger << 3) | ((uint32_t)ac2prottrigger << 2) | ((uint32_t)ac1prottrigger << 1) | ((uint32_t)ac0prottrigger << 0));
}
...
/**
 * @brief Returns the current value of the tbTxBufTrigger field in the TX_RX_INT_ENABLE register.
 *
 * The TX_RX_INT_ENABLE register will be read and the tbTxBufTrigger field's value will be returned.
 *
 * @return The current value of the tbTxBufTrigger field in the TX_RX_INT_ENABLE register.
 */
__INLINE uint8_t nxmac_enable_tb_tx_buf_trigger_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TX_RX_INT_ENABLE_ADDR);
    return ((localVal & ((uint32_t)0x20000000)) >> 29);
}
...
/**
 * @brief Sets the tbTxBufTrigger field of the TX_RX_INT_ENABLE register.
 *
 * The TX_RX_INT_ENABLE register will be read, modified to contain the new field value, and written.
 *
 * @param[in] tbtxbuftrigger - The value to set the field to.
 */
__INLINE void nxmac_enable_tb_tx_buf_trigger_setf(uint8_t tbtxbuftrigger)
{
    ASSERT_ERR((((uint32_t)tbtxbuftrigger << 29) & ~((uint32_t)0x20000000)) == 0);
    REG_PL_WR(NXMAC_TX_RX_INT_ENABLE_ADDR, (REG_PL_RD(NXMAC_TX_RX_INT_ENABLE_ADDR) & ~((uint32_t)0x20000000)) | ((uint32_t)tbtxbuftrigger << 29));
}
...
/**
 * @brief Returns the current value of the rxBuffer2Trigger field in the TX_RX_INT_ENABLE register.
 *
 * The TX_RX_INT_ENABLE register will be read and the rxBuffer2Trigger field's value will be returned.
 *
 * @return The current value of the rxBuffer2Trigger field in the TX_RX_INT_ENABLE register.
 */
__INLINE uint8_t nxmac_enable_rx_buffer_2_trigger_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TX_RX_INT_ENABLE_ADDR);
    return ((localVal & ((uint32_t)0x00040000)) >> 18);
}
...
/**
 * @brief Sets the rxBuffer2Trigger field of the TX_RX_INT_ENABLE register.
 *
 * The TX_RX_INT_ENABLE register will be read, modified to contain the new field value, and written.
 *
 * @param[in] rxbuffer2trigger - The value to set the field to.
 */
__INLINE void nxmac_enable_rx_buffer_2_trigger_setf(uint8_t rxbuffer2trigger)
{
    ASSERT_ERR((((uint32_t)rxbuffer2trigger << 18) & ~((uint32_t)0x00040000)) == 0);
    REG_PL_WR(NXMAC_TX_RX_INT_ENABLE_ADDR, (REG_PL_RD(NXMAC_TX_RX_INT_ENABLE_ADDR) & ~((uint32_t)0x00040000)) | ((uint32_t)rxbuffer2trigger << 18));
}
...
/**
 * @brief Returns the current value of the rxBuffer1Trigger field in the TX_RX_INT_ENABLE register.
 *
 * The TX_RX_INT_ENABLE register will be read and the rxBuffer1Trigger field's value will be returned.
 *
 * @return The current value of the rxBuffer1Trigger field in the TX_RX_INT_ENABLE register.
 */
__INLINE uint8_t nxmac_enable_rx_buffer_1_trigger_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TX_RX_INT_ENABLE_ADDR);
    return ((localVal & ((uint32_t)0x00010000)) >> 16);
}
...
/**
 * @brief Sets the rxBuffer1Trigger field of the TX_RX_INT_ENABLE register.
 *
 * The TX_RX_INT_ENABLE register will be read, modified to contain the new field value, and written.
 *
 * @param[in] rxbuffer1trigger - The value to set the field to.
 */
__INLINE void nxmac_enable_rx_buffer_1_trigger_setf(uint8_t rxbuffer1trigger)
{
    ASSERT_ERR((((uint32_t)rxbuffer1trigger << 16) & ~((uint32_t)0x00010000)) == 0);
    REG_PL_WR(NXMAC_TX_RX_INT_ENABLE_ADDR, (REG_PL_RD(NXMAC_TX_RX_INT_ENABLE_ADDR) & ~((uint32_t)0x00010000)) | ((uint32_t)rxbuffer1trigger << 16));
}
...
/**
 * @brief Returns the current value of the tbTxCancelled field in the TX_RX_INT_ENABLE register.
 *
 * The TX_RX_INT_ENABLE register will be read and the tbTxCancelled field's value will be returned.
 *
 * @return The current value of the tbTxCancelled field in the TX_RX_INT_ENABLE register.
 */
__INLINE uint8_t nxmac_enable_tb_tx_cancelled_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TX_RX_INT_ENABLE_ADDR);
    return ((localVal & ((uint32_t)0x00001000)) >> 12);
}
...
/**
 * @brief Sets the tbTxCancelled field of the TX_RX_INT_ENABLE register.
 *
 * The TX_RX_INT_ENABLE register will be read, modified to contain the new field value, and written.
 *
 * @param[in] tbtxcancelled - The value to set the field to.
 */
__INLINE void nxmac_enable_tb_tx_cancelled_setf(uint8_t tbtxcancelled)
{
    ASSERT_ERR((((uint32_t)tbtxcancelled << 12) & ~((uint32_t)0x00001000)) == 0);
    REG_PL_WR(NXMAC_TX_RX_INT_ENABLE_ADDR, (REG_PL_RD(NXMAC_TX_RX_INT_ENABLE_ADDR) & ~((uint32_t)0x00001000)) | ((uint32_t)tbtxcancelled << 12));
}

/**
 * @brief Returns the current value of the tbTxTrigger field in the TX_RX_INT_ENABLE register.
 *
 * The TX_RX_INT_ENABLE register will be read and the tbTxTrigger field's value will be returned.
 *
 * @return The current value of the tbTxTrigger field in the TX_RX_INT_ENABLE register.
 */
__INLINE uint8_t nxmac_enable_tb_tx_trigger_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TX_RX_INT_ENABLE_ADDR);
    return ((localVal & ((uint32_t)0x00000800)) >> 11);
}
...
/**
 * @brief Sets the tbTxTrigger field of the TX_RX_INT_ENABLE register.
 *
 * The TX_RX_INT_ENABLE register will be read, modified to contain the new field value, and written.
 *
 * @param[in] tbtxtrigger - The value to set the field to.
 */
__INLINE void nxmac_enable_tb_tx_trigger_setf(uint8_t tbtxtrigger)
{
    ASSERT_ERR((((uint32_t)tbtxtrigger << 11) & ~((uint32_t)0x00000800)) == 0);
    REG_PL_WR(NXMAC_TX_RX_INT_ENABLE_ADDR, (REG_PL_RD(NXMAC_TX_RX_INT_ENABLE_ADDR) & ~((uint32_t)0x00000800)) | ((uint32_t)tbtxtrigger << 11));
}
...
/**
 * @brief Returns the current value of the tbProtTrigger field in the TX_RX_INT_ENABLE register.
 *
 * The TX_RX_INT_ENABLE register will be read and the tbProtTrigger field's value will be returned.
 *
 * @return The current value of the tbProtTrigger field in the TX_RX_INT_ENABLE register.
 */
__INLINE uint8_t nxmac_enable_tb_prot_trigger_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TX_RX_INT_ENABLE_ADDR);
    return ((localVal & ((uint32_t)0x00000010)) >> 4);
}
...
/**
 * @brief Sets the tbProtTrigger field of the TX_RX_INT_ENABLE register.
 *
 * The TX_RX_INT_ENABLE register will be read, modified to contain the new field value, and written.
 *
 * @param[in] tbprottrigger - The value to set the field to.
 */
__INLINE void nxmac_enable_tb_prot_trigger_setf(uint8_t tbprottrigger)
{
    ASSERT_ERR((((uint32_t)tbprottrigger << 4) & ~((uint32_t)0x00000010)) == 0);
    REG_PL_WR(NXMAC_TX_RX_INT_ENABLE_ADDR, (REG_PL_RD(NXMAC_TX_RX_INT_ENABLE_ADDR) & ~((uint32_t)0x00000010)) | ((uint32_t)tbprottrigger << 4));
}
 ...
 * <table>
 * <caption>TIMERS_INT_EVENT_SET bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 09 <td>   absTimers9 <td> R <td> S <td> 0
 * <tr><td> 08 <td>   absTimers8 <td> R <td> S <td> 0
 * <tr><td> 07 <td>   absTimers7 <td> R <td> S <td> 0
 * <tr><td> 06 <td>   absTimers6 <td> R <td> S <td> 0
 * <tr><td> 05 <td>   absTimers5 <td> R <td> S <td> 0
 * <tr><td> 04 <td>   absTimers4 <td> R <td> S <td> 0
 * <tr><td> 03 <td>   absTimers3 <td> R <td> S <td> 0
 * <tr><td> 02 <td>   absTimers2 <td> R <td> S <td> 0
 * <tr><td> 01 <td>   absTimers1 <td> R <td> S <td> 0
 * <tr><td> 00 <td>   absTimers0 <td> R <td> S <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_TIMERS_INT_EVENT_SET_ADDR   0x24B08084
 ...
 * <table>
 * <caption>TIMERS_INT_EVENT_CLEAR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 09 <td>   absTimers9 <td> R <td> C <td> 0
 * <tr><td> 08 <td>   absTimers8 <td> R <td> C <td> 0
 * <tr><td> 07 <td>   absTimers7 <td> R <td> C <td> 0
 * <tr><td> 06 <td>   absTimers6 <td> R <td> C <td> 0
 * <tr><td> 05 <td>   absTimers5 <td> R <td> C <td> 0
 * <tr><td> 04 <td>   absTimers4 <td> R <td> C <td> 0
 * <tr><td> 03 <td>   absTimers3 <td> R <td> C <td> 0
 * <tr><td> 02 <td>   absTimers2 <td> R <td> C <td> 0
 * <tr><td> 01 <td>   absTimers1 <td> R <td> C <td> 0
 * <tr><td> 00 <td>   absTimers0 <td> R <td> C <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_TIMERS_INT_EVENT_CLEAR_ADDR   0x24B08088
 ...
 * <table>
 * <caption>TIMERS_INT_UN_MASK bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 09 <td>   maskabsTimers9 <td> R <td> R/W <td> 0
 * <tr><td> 08 <td>   maskabsTimers8 <td> R <td> R/W <td> 0
 * <tr><td> 07 <td>   maskabsTimers7 <td> R <td> R/W <td> 0
 * <tr><td> 06 <td>   maskabsTimers6 <td> R <td> R/W <td> 0
 * <tr><td> 05 <td>   maskabsTimers5 <td> R <td> R/W <td> 0
 * <tr><td> 04 <td>   maskabsTimers4 <td> R <td> R/W <td> 0
 * <tr><td> 03 <td>   maskabsTimers3 <td> R <td> R/W <td> 0
 * <tr><td> 02 <td>   maskabsTimers2 <td> R <td> R/W <td> 0
 * <tr><td> 01 <td>   maskabsTimers1 <td> R <td> R/W <td> 0
 * <tr><td> 00 <td>   maskabsTimers0 <td> R <td> R/W <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_TIMERS_INT_UN_MASK_ADDR   0x24B0808C
 ...
 * <table>
 * <caption>TSF_LO bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>   tsfTimerLow <td> R/W <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_TSF_LO_ADDR   0x24B080A4
 ...
 * <table>
 * <caption>TSF_HI bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>   tsfTimerHigh <td> R/W <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_TSF_HI_ADDR   0x24B080A8
 ...
 * <table>
 * <caption>TIME_ON_AIR_PARAM_1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:30 <td>         ppduSTBC <td> R <td> R/W <td> 0x0
 * <tr><td> 29:28 <td>    ppduNumExtnSS <td> R <td> R/W <td> 0x0
 * <tr><td> 27:26 <td>           ppduBW <td> R <td> R/W <td> 0x0
 * <tr><td> 25:24 <td>           ppduGI <td> R <td> R/W <td> 0x0
 * <tr><td> 23:20 <td>      ppduPreType <td> R <td> R/W <td> 0x0
 * <tr><td> 19:00 <td>       ppduLength <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_TIME_ON_AIR_PARAM_1_ADDR   0x24B08160
...
/// PPDU_BW field mask
#define NXMAC_PPDU_BW_MASK            ((uint32_t)0x0C000000)
/// PPDU_BW field LSB position
#define NXMAC_PPDU_BW_LSB             26
/// PPDU_BW field width
#define NXMAC_PPDU_BW_WIDTH           ((uint32_t)0x00000002)
/// PPDU_GI field mask
#define NXMAC_PPDU_GI_MASK            ((uint32_t)0x03000000)
/// PPDU_GI field LSB position
#define NXMAC_PPDU_GI_LSB             24
/// PPDU_GI field width
#define NXMAC_PPDU_GI_WIDTH           ((uint32_t)0x00000002)
/// PPDU_PRE_TYPE field mask
#define NXMAC_PPDU_PRE_TYPE_MASK      ((uint32_t)0x00F00000)
/// PPDU_PRE_TYPE field LSB position
#define NXMAC_PPDU_PRE_TYPE_LSB       20
/// PPDU_PRE_TYPE field width
#define NXMAC_PPDU_PRE_TYPE_WIDTH     ((uint32_t)0x00000004)
...
/// PPDU_GI field reset value
#define NXMAC_PPDU_GI_RST             0x0
 ...
 * @param[in] ppdugi - The value to use for the ppduGI field.
 ...
 */
__INLINE void nxmac_time_on_air_param_1_pack(uint8_t ppdustbc, uint8_t ppdunumextnss, uint8_t ppdubw, uint8_t ppdugi, uint8_t ppdupretype, uint32_t ppdulength)
{
    ASSERT_ERR((((uint32_t)ppdustbc << 30) & ~((uint32_t)0xC0000000)) == 0);
    ASSERT_ERR((((uint32_t)ppdunumextnss << 28) & ~((uint32_t)0x30000000)) == 0);
    ASSERT_ERR((((uint32_t)ppdubw << 26) & ~((uint32_t)0x0C000000)) == 0);
    ASSERT_ERR((((uint32_t)ppdugi << 24) & ~((uint32_t)0x03000000)) == 0);
    ASSERT_ERR((((uint32_t)ppdupretype << 20) & ~((uint32_t)0x00F00000)) == 0);
    ASSERT_ERR((((uint32_t)ppdulength << 0) & ~((uint32_t)0x000FFFFF)) == 0);
    REG_PL_WR(NXMAC_TIME_ON_AIR_PARAM_1_ADDR,  ((uint32_t)ppdustbc << 30) | ((uint32_t)ppdunumextnss << 28) | ((uint32_t)ppdubw << 26) | ((uint32_t)ppdugi << 24) | ((uint32_t)ppdupretype << 20) | ((uint32_t)ppdulength << 0));
}
 ...
 * @param[out] ppdugi - Will be populated with the current value of this field from the register.
 ...
 */
__INLINE void nxmac_time_on_air_param_1_unpack(uint8_t* ppdustbc, uint8_t* ppdunumextnss, uint8_t* ppdubw, uint8_t* ppdugi, uint8_t* ppdupretype, uint32_t* ppdulength)
{
    ...
    *ppdubw = (localVal & ((uint32_t)0x0C000000)) >> 26;
    *ppdugi = (localVal & ((uint32_t)0x03000000)) >> 24;
    *ppdupretype = (localVal & ((uint32_t)0x00F00000)) >> 20;
...
{
    ASSERT_ERR((((uint32_t)ppdubw << 26) & ~((uint32_t)0x0C000000)) == 0);
    REG_PL_WR(NXMAC_TIME_ON_AIR_PARAM_1_ADDR, (REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_1_ADDR) & ~((uint32_t)0x0C000000)) | ((uint32_t)ppdubw << 26));
}

/**
 * @brief Returns the current value of the ppduGI field in the TIME_ON_AIR_PARAM_1 register.
 *
 * The TIME_ON_AIR_PARAM_1 register will be read and the ppduGI field's value will be returned.
 *
 * @return The current value of the ppduGI field in the TIME_ON_AIR_PARAM_1 register.
 */
__INLINE uint8_t nxmac_ppdu_gi_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_1_ADDR);
...
/**
 * @brief Sets the ppduGI field of the TIME_ON_AIR_PARAM_1 register.
 *
 * The TIME_ON_AIR_PARAM_1 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] ppdugi - The value to set the field to.
 */
__INLINE void nxmac_ppdu_gi_setf(uint8_t ppdugi)
{
    ASSERT_ERR((((uint32_t)ppdugi << 24) & ~((uint32_t)0x03000000)) == 0);
    REG_PL_WR(NXMAC_TIME_ON_AIR_PARAM_1_ADDR, (REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_1_ADDR) & ~((uint32_t)0x03000000)) | ((uint32_t)ppdugi << 24));
}
...
{
    ASSERT_ERR((((uint32_t)ppdupretype << 20) & ~((uint32_t)0x00F00000)) == 0);
    REG_PL_WR(NXMAC_TIME_ON_AIR_PARAM_1_ADDR, (REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_1_ADDR) & ~((uint32_t)0x00F00000)) | ((uint32_t)ppdupretype << 20));
}
 ...
 * <table>
 * <caption>TIME_ON_AIR_PARAM_2 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 30:28 <td>         ppduNumHeLtf <td> R <td> R/W <td> 0x0
 * <tr><td> 26:20 <td>            ppduNUser <td> R <td> R/W <td> 0x0
 * <tr><td> 18:16 <td>               ppduPE <td> R <td> R/W <td> 0x0
 * <tr><td> 15:13 <td>          ppduMCSSigB <td> R <td> R/W <td> 0x0
 * <tr><td> 12    <td>          ppduDCMSigB <td> R <td> R/W <td> 0
 * <tr><td> 11    <td>     ppduSigBCompMode <td> R <td> R/W <td> 0
 * <tr><td> 10:09 <td>        ppduHELTFType <td> R <td> R/W <td> 0x0
 * <tr><td> 08    <td>              ppduDCM <td> R <td> R/W <td> 0
 * <tr><td> 06:00 <td>         ppduMCSIndex <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_TIME_ON_AIR_PARAM_2_ADDR   0x24B08164
...
// field definitions
/// PPDU_NUM_HE_LTF field mask
#define NXMAC_PPDU_NUM_HE_LTF_MASK        ((uint32_t)0x70000000)
/// PPDU_NUM_HE_LTF field LSB position
#define NXMAC_PPDU_NUM_HE_LTF_LSB         28
/// PPDU_NUM_HE_LTF field width
#define NXMAC_PPDU_NUM_HE_LTF_WIDTH       ((uint32_t)0x00000003)
/// PPDU_N_USER field mask
#define NXMAC_PPDU_N_USER_MASK            ((uint32_t)0x07F00000)
/// PPDU_N_USER field LSB position
#define NXMAC_PPDU_N_USER_LSB             20
/// PPDU_N_USER field width
#define NXMAC_PPDU_N_USER_WIDTH           ((uint32_t)0x00000007)
/// PPDU_PE field mask
#define NXMAC_PPDU_PE_MASK                ((uint32_t)0x00070000)
/// PPDU_PE field LSB position
#define NXMAC_PPDU_PE_LSB                 16
/// PPDU_PE field width
#define NXMAC_PPDU_PE_WIDTH               ((uint32_t)0x00000003)
/// PPDU_MCS_SIG_B field mask
#define NXMAC_PPDU_MCS_SIG_B_MASK         ((uint32_t)0x0000E000)
/// PPDU_MCS_SIG_B field LSB position
#define NXMAC_PPDU_MCS_SIG_B_LSB          13
/// PPDU_MCS_SIG_B field width
#define NXMAC_PPDU_MCS_SIG_B_WIDTH        ((uint32_t)0x00000003)
/// PPDU_DCM_SIG_B field bit
#define NXMAC_PPDU_DCM_SIG_B_BIT          ((uint32_t)0x00001000)
/// PPDU_DCM_SIG_B field position
#define NXMAC_PPDU_DCM_SIG_B_POS          12
/// PPDU_SIG_B_COMP_MODE field bit
#define NXMAC_PPDU_SIG_B_COMP_MODE_BIT    ((uint32_t)0x00000800)
/// PPDU_SIG_B_COMP_MODE field position
#define NXMAC_PPDU_SIG_B_COMP_MODE_POS    11
/// PPDU_HELTF_TYPE field mask
#define NXMAC_PPDU_HELTF_TYPE_MASK        ((uint32_t)0x00000600)
/// PPDU_HELTF_TYPE field LSB position
#define NXMAC_PPDU_HELTF_TYPE_LSB         9
/// PPDU_HELTF_TYPE field width
#define NXMAC_PPDU_HELTF_TYPE_WIDTH       ((uint32_t)0x00000002)
/// PPDU_DCM field bit
#define NXMAC_PPDU_DCM_BIT                ((uint32_t)0x00000100)
/// PPDU_DCM field position
#define NXMAC_PPDU_DCM_POS                8
...
/// PPDU_NUM_HE_LTF field reset value
#define NXMAC_PPDU_NUM_HE_LTF_RST         0x0
/// PPDU_N_USER field reset value
#define NXMAC_PPDU_N_USER_RST             0x0
/// PPDU_PE field reset value
#define NXMAC_PPDU_PE_RST                 0x0
/// PPDU_MCS_SIG_B field reset value
#define NXMAC_PPDU_MCS_SIG_B_RST          0x0
/// PPDU_DCM_SIG_B field reset value
#define NXMAC_PPDU_DCM_SIG_B_RST          0x0
/// PPDU_SIG_B_COMP_MODE field reset value
#define NXMAC_PPDU_SIG_B_COMP_MODE_RST    0x0
/// PPDU_HELTF_TYPE field reset value
#define NXMAC_PPDU_HELTF_TYPE_RST         0x0
/// PPDU_DCM field reset value
#define NXMAC_PPDU_DCM_RST                0x0
/// PPDU_MCS_INDEX field reset value
#define NXMAC_PPDU_MCS_INDEX_RST          0x0

/**
 * @brief Constructs a value for the TIME_ON_AIR_PARAM_2 register given values for its fields
 * and writes the value to the register.
 *
 * @param[in] ppdunumheltf - The value to use for the ppduNumHeLtf field.
 * @param[in] ppdunuser - The value to use for the ppduNUser field.
 * @param[in] ppdupe - The value to use for the ppduPE field.
 * @param[in] ppdumcssigb - The value to use for the ppduMCSSigB field.
 * @param[in] ppdudcmsigb - The value to use for the ppduDCMSigB field.
 * @param[in] ppdusigbcompmode - The value to use for the ppduSigBCompMode field.
 * @param[in] ppduheltftype - The value to use for the ppduHELTFType field.
 * @param[in] ppdudcm - The value to use for the ppduDCM field.
 * @param[in] ppdumcsindex - The value to use for the ppduMCSIndex field.
 */
__INLINE void nxmac_time_on_air_param_2_pack(uint8_t ppdunumheltf, uint8_t ppdunuser, uint8_t ppdupe, uint8_t ppdumcssigb, uint8_t ppdudcmsigb, uint8_t ppdusigbcompmode, uint8_t ppduheltftype, uint8_t ppdudcm, uint8_t ppdumcsindex)
{
    ASSERT_ERR((((uint32_t)ppdunumheltf << 28) & ~((uint32_t)0x70000000)) == 0);
    ASSERT_ERR((((uint32_t)ppdunuser << 20) & ~((uint32_t)0x07F00000)) == 0);
    ASSERT_ERR((((uint32_t)ppdupe << 16) & ~((uint32_t)0x00070000)) == 0);
    ASSERT_ERR((((uint32_t)ppdumcssigb << 13) & ~((uint32_t)0x0000E000)) == 0);
    ASSERT_ERR((((uint32_t)ppdudcmsigb << 12) & ~((uint32_t)0x00001000)) == 0);
    ASSERT_ERR((((uint32_t)ppdusigbcompmode << 11) & ~((uint32_t)0x00000800)) == 0);
    ASSERT_ERR((((uint32_t)ppduheltftype << 9) & ~((uint32_t)0x00000600)) == 0);
    ASSERT_ERR((((uint32_t)ppdudcm << 8) & ~((uint32_t)0x00000100)) == 0);
    ASSERT_ERR((((uint32_t)ppdumcsindex << 0) & ~((uint32_t)0x0000007F)) == 0);
    REG_PL_WR(NXMAC_TIME_ON_AIR_PARAM_2_ADDR,  ((uint32_t)ppdunumheltf << 28) | ((uint32_t)ppdunuser << 20) | ((uint32_t)ppdupe << 16) | ((uint32_t)ppdumcssigb << 13) | ((uint32_t)ppdudcmsigb << 12) | ((uint32_t)ppdusigbcompmode << 11) | ((uint32_t)ppduheltftype << 9) | ((uint32_t)ppdudcm << 8) | ((uint32_t)ppdumcsindex << 0));
}

/**
 * @brief Unpacks TIME_ON_AIR_PARAM_2's fields from current value of the TIME_ON_AIR_PARAM_2 register.
 *
 * Reads the TIME_ON_AIR_PARAM_2 register and populates all the _field variables with the corresponding
 * values from the register.
 *
 * @param[out] ppdunumheltf - Will be populated with the current value of this field from the register.
 * @param[out] ppdunuser - Will be populated with the current value of this field from the register.
 * @param[out] ppdupe - Will be populated with the current value of this field from the register.
 * @param[out] ppdumcssigb - Will be populated with the current value of this field from the register.
 * @param[out] ppdudcmsigb - Will be populated with the current value of this field from the register.
 * @param[out] ppdusigbcompmode - Will be populated with the current value of this field from the register.
 * @param[out] ppduheltftype - Will be populated with the current value of this field from the register.
 * @param[out] ppdudcm - Will be populated with the current value of this field from the register.
 * @param[out] ppdumcsindex - Will be populated with the current value of this field from the register.
 */
__INLINE void nxmac_time_on_air_param_2_unpack(uint8_t* ppdunumheltf, uint8_t* ppdunuser, uint8_t* ppdupe, uint8_t* ppdumcssigb, uint8_t* ppdudcmsigb, uint8_t* ppdusigbcompmode, uint8_t* ppduheltftype, uint8_t* ppdudcm, uint8_t* ppdumcsindex)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_2_ADDR);

    *ppdunumheltf = (localVal & ((uint32_t)0x70000000)) >> 28;
    *ppdunuser = (localVal & ((uint32_t)0x07F00000)) >> 20;
    *ppdupe = (localVal & ((uint32_t)0x00070000)) >> 16;
    *ppdumcssigb = (localVal & ((uint32_t)0x0000E000)) >> 13;
    *ppdudcmsigb = (localVal & ((uint32_t)0x00001000)) >> 12;
    *ppdusigbcompmode = (localVal & ((uint32_t)0x00000800)) >> 11;
    *ppduheltftype = (localVal & ((uint32_t)0x00000600)) >> 9;
    *ppdudcm = (localVal & ((uint32_t)0x00000100)) >> 8;
    *ppdumcsindex = (localVal & ((uint32_t)0x0000007F)) >> 0;
}

/**
 * @brief Returns the current value of the ppduNumHeLtf field in the TIME_ON_AIR_PARAM_2 register.
 *
 * The TIME_ON_AIR_PARAM_2 register will be read and the ppduNumHeLtf field's value will be returned.
 *
 * @return The current value of the ppduNumHeLtf field in the TIME_ON_AIR_PARAM_2 register.
 */
__INLINE uint8_t nxmac_ppdu_num_he_ltf_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_2_ADDR);
...
/**
 * @brief Sets the ppduNumHeLtf field of the TIME_ON_AIR_PARAM_2 register.
 *
 * The TIME_ON_AIR_PARAM_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] ppdunumheltf - The value to set the field to.
 */
__INLINE void nxmac_ppdu_num_he_ltf_setf(uint8_t ppdunumheltf)
{
    ASSERT_ERR((((uint32_t)ppdunumheltf << 28) & ~((uint32_t)0x70000000)) == 0);
    REG_PL_WR(NXMAC_TIME_ON_AIR_PARAM_2_ADDR, (REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_2_ADDR) & ~((uint32_t)0x70000000)) | ((uint32_t)ppdunumheltf << 28));
}

/**
 * @brief Returns the current value of the ppduNUser field in the TIME_ON_AIR_PARAM_2 register.
 *
 * The TIME_ON_AIR_PARAM_2 register will be read and the ppduNUser field's value will be returned.
 *
 * @return The current value of the ppduNUser field in the TIME_ON_AIR_PARAM_2 register.
 */
__INLINE uint8_t nxmac_ppdu_n_user_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_2_ADDR);
...
/**
 * @brief Sets the ppduNUser field of the TIME_ON_AIR_PARAM_2 register.
 *
 * The TIME_ON_AIR_PARAM_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] ppdunuser - The value to set the field to.
 */
__INLINE void nxmac_ppdu_n_user_setf(uint8_t ppdunuser)
{
    ASSERT_ERR((((uint32_t)ppdunuser << 20) & ~((uint32_t)0x07F00000)) == 0);
    REG_PL_WR(NXMAC_TIME_ON_AIR_PARAM_2_ADDR, (REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_2_ADDR) & ~((uint32_t)0x07F00000)) | ((uint32_t)ppdunuser << 20));
}

/**
 * @brief Returns the current value of the ppduPE field in the TIME_ON_AIR_PARAM_2 register.
 *
 * The TIME_ON_AIR_PARAM_2 register will be read and the ppduPE field's value will be returned.
 *
 * @return The current value of the ppduPE field in the TIME_ON_AIR_PARAM_2 register.
 */
__INLINE uint8_t nxmac_ppdu_pe_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_2_ADDR);
...
/**
 * @brief Sets the ppduPE field of the TIME_ON_AIR_PARAM_2 register.
 *
 * The TIME_ON_AIR_PARAM_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] ppdupe - The value to set the field to.
 */
__INLINE void nxmac_ppdu_pe_setf(uint8_t ppdupe)
{
    ASSERT_ERR((((uint32_t)ppdupe << 16) & ~((uint32_t)0x00070000)) == 0);
    REG_PL_WR(NXMAC_TIME_ON_AIR_PARAM_2_ADDR, (REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_2_ADDR) & ~((uint32_t)0x00070000)) | ((uint32_t)ppdupe << 16));
}

/**
 * @brief Returns the current value of the ppduMCSSigB field in the TIME_ON_AIR_PARAM_2 register.
 *
 * The TIME_ON_AIR_PARAM_2 register will be read and the ppduMCSSigB field's value will be returned.
 *
 * @return The current value of the ppduMCSSigB field in the TIME_ON_AIR_PARAM_2 register.
 */
__INLINE uint8_t nxmac_ppdu_mcs_sig_b_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_2_ADDR);
...
/**
 * @brief Sets the ppduMCSSigB field of the TIME_ON_AIR_PARAM_2 register.
 *
 * The TIME_ON_AIR_PARAM_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] ppdumcssigb - The value to set the field to.
 */
__INLINE void nxmac_ppdu_mcs_sig_b_setf(uint8_t ppdumcssigb)
{
    ASSERT_ERR((((uint32_t)ppdumcssigb << 13) & ~((uint32_t)0x0000E000)) == 0);
    REG_PL_WR(NXMAC_TIME_ON_AIR_PARAM_2_ADDR, (REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_2_ADDR) & ~((uint32_t)0x0000E000)) | ((uint32_t)ppdumcssigb << 13));
}

/**
 * @brief Returns the current value of the ppduDCMSigB field in the TIME_ON_AIR_PARAM_2 register.
 *
 * The TIME_ON_AIR_PARAM_2 register will be read and the ppduDCMSigB field's value will be returned.
 *
 * @return The current value of the ppduDCMSigB field in the TIME_ON_AIR_PARAM_2 register.
 */
__INLINE uint8_t nxmac_ppdu_dcm_sig_b_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_2_ADDR);
    return ((localVal & ((uint32_t)0x00001000)) >> 12);
}
...
/**
 * @brief Sets the ppduDCMSigB field of the TIME_ON_AIR_PARAM_2 register.
 *
 * The TIME_ON_AIR_PARAM_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] ppdudcmsigb - The value to set the field to.
 */
__INLINE void nxmac_ppdu_dcm_sig_b_setf(uint8_t ppdudcmsigb)
{
    ASSERT_ERR((((uint32_t)ppdudcmsigb << 12) & ~((uint32_t)0x00001000)) == 0);
    REG_PL_WR(NXMAC_TIME_ON_AIR_PARAM_2_ADDR, (REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_2_ADDR) & ~((uint32_t)0x00001000)) | ((uint32_t)ppdudcmsigb << 12));
}

/**
 * @brief Returns the current value of the ppduSigBCompMode field in the TIME_ON_AIR_PARAM_2 register.
 *
 * The TIME_ON_AIR_PARAM_2 register will be read and the ppduSigBCompMode field's value will be returned.
 *
 * @return The current value of the ppduSigBCompMode field in the TIME_ON_AIR_PARAM_2 register.
 */
__INLINE uint8_t nxmac_ppdu_sig_b_comp_mode_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_2_ADDR);
    return ((localVal & ((uint32_t)0x00000800)) >> 11);
}
...
/**
 * @brief Sets the ppduSigBCompMode field of the TIME_ON_AIR_PARAM_2 register.
 *
 * The TIME_ON_AIR_PARAM_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] ppdusigbcompmode - The value to set the field to.
 */
__INLINE void nxmac_ppdu_sig_b_comp_mode_setf(uint8_t ppdusigbcompmode)
{
    ASSERT_ERR((((uint32_t)ppdusigbcompmode << 11) & ~((uint32_t)0x00000800)) == 0);
    REG_PL_WR(NXMAC_TIME_ON_AIR_PARAM_2_ADDR, (REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_2_ADDR) & ~((uint32_t)0x00000800)) | ((uint32_t)ppdusigbcompmode << 11));
}

/**
 * @brief Returns the current value of the ppduHELTFType field in the TIME_ON_AIR_PARAM_2 register.
 *
 * The TIME_ON_AIR_PARAM_2 register will be read and the ppduHELTFType field's value will be returned.
 *
 * @return The current value of the ppduHELTFType field in the TIME_ON_AIR_PARAM_2 register.
 */
__INLINE uint8_t nxmac_ppdu_heltf_type_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_2_ADDR);
...
/**
 * @brief Sets the ppduHELTFType field of the TIME_ON_AIR_PARAM_2 register.
 *
 * The TIME_ON_AIR_PARAM_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] ppduheltftype - The value to set the field to.
 */
__INLINE void nxmac_ppdu_heltf_type_setf(uint8_t ppduheltftype)
{
    ASSERT_ERR((((uint32_t)ppduheltftype << 9) & ~((uint32_t)0x00000600)) == 0);
    REG_PL_WR(NXMAC_TIME_ON_AIR_PARAM_2_ADDR, (REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_2_ADDR) & ~((uint32_t)0x00000600)) | ((uint32_t)ppduheltftype << 9));
}

/**
 * @brief Returns the current value of the ppduDCM field in the TIME_ON_AIR_PARAM_2 register.
 *
 * The TIME_ON_AIR_PARAM_2 register will be read and the ppduDCM field's value will be returned.
 *
 * @return The current value of the ppduDCM field in the TIME_ON_AIR_PARAM_2 register.
 */
__INLINE uint8_t nxmac_ppdu_dcm_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_2_ADDR);
    return ((localVal & ((uint32_t)0x00000100)) >> 8);
}
...
/**
 * @brief Sets the ppduDCM field of the TIME_ON_AIR_PARAM_2 register.
 *
 * The TIME_ON_AIR_PARAM_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] ppdudcm - The value to set the field to.
 */
__INLINE void nxmac_ppdu_dcm_setf(uint8_t ppdudcm)
{
    ASSERT_ERR((((uint32_t)ppdudcm << 8) & ~((uint32_t)0x00000100)) == 0);
    REG_PL_WR(NXMAC_TIME_ON_AIR_PARAM_2_ADDR, (REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_2_ADDR) & ~((uint32_t)0x00000100)) | ((uint32_t)ppdudcm << 8));
}
...
{
    ASSERT_ERR((((uint32_t)ppdumcsindex << 0) & ~((uint32_t)0x0000007F)) == 0);
    REG_PL_WR(NXMAC_TIME_ON_AIR_PARAM_2_ADDR, (REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_2_ADDR) & ~((uint32_t)0x0000007F)) | ((uint32_t)ppdumcsindex << 0));
}

/// @}

/**
 * @name TIME_ON_AIR_PARAM_3 register definitions
 * <table>
 * <caption>TIME_ON_AIR_PARAM_3 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 06:04 <td>   ppduRuType <td> R <td> R/W <td> 0x0
 * <tr><td> 01    <td>      ppduMma <td> R <td> R/W <td> 0
 * <tr><td> 00    <td>  ppduDoppler <td> R <td> R/W <td> 0
 * </table>
 *
 * @{
 */

/// Address of the TIME_ON_AIR_PARAM_3 register
#define NXMAC_TIME_ON_AIR_PARAM_3_ADDR   0x24B08168
/// Offset of the TIME_ON_AIR_PARAM_3 register from the base address
#define NXMAC_TIME_ON_AIR_PARAM_3_OFFSET 0x00000168
/// Index of the TIME_ON_AIR_PARAM_3 register
#define NXMAC_TIME_ON_AIR_PARAM_3_INDEX  0x0000005A
/// Reset value of the TIME_ON_AIR_PARAM_3 register
#define NXMAC_TIME_ON_AIR_PARAM_3_RESET  0x00000000

/**
 * @brief Returns the current value of the TIME_ON_AIR_PARAM_3 register.
 * The TIME_ON_AIR_PARAM_3 register will be read and its value returned.
 * @return The current value of the TIME_ON_AIR_PARAM_3 register.
 */
__INLINE uint32_t nxmac_time_on_air_param_3_get(void)
{
    return REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_3_ADDR);
}

/**
 * @brief Sets the TIME_ON_AIR_PARAM_3 register to a value.
 * The TIME_ON_AIR_PARAM_3 register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_time_on_air_param_3_set(uint32_t value)
{
    REG_PL_WR(NXMAC_TIME_ON_AIR_PARAM_3_ADDR, value);
}

// field definitions
/// PPDU_RU_TYPE field mask
#define NXMAC_PPDU_RU_TYPE_MASK   ((uint32_t)0x00000070)
/// PPDU_RU_TYPE field LSB position
#define NXMAC_PPDU_RU_TYPE_LSB    4
/// PPDU_RU_TYPE field width
#define NXMAC_PPDU_RU_TYPE_WIDTH  ((uint32_t)0x00000003)
/// PPDU_MMA field bit
#define NXMAC_PPDU_MMA_BIT        ((uint32_t)0x00000002)
/// PPDU_MMA field position
#define NXMAC_PPDU_MMA_POS        1
/// PPDU_DOPPLER field bit
#define NXMAC_PPDU_DOPPLER_BIT    ((uint32_t)0x00000001)
/// PPDU_DOPPLER field position
#define NXMAC_PPDU_DOPPLER_POS    0

/// PPDU_RU_TYPE field reset value
#define NXMAC_PPDU_RU_TYPE_RST    0x0
/// PPDU_MMA field reset value
#define NXMAC_PPDU_MMA_RST        0x0
/// PPDU_DOPPLER field reset value
#define NXMAC_PPDU_DOPPLER_RST    0x0

/**
 * @brief Constructs a value for the TIME_ON_AIR_PARAM_3 register given values for its fields
 * and writes the value to the register.
 *
 * @param[in] ppdurutype - The value to use for the ppduRuType field.
 * @param[in] ppdumma - The value to use for the ppduMma field.
 * @param[in] ppdudoppler - The value to use for the ppduDoppler field.
 */
__INLINE void nxmac_time_on_air_param_3_pack(uint8_t ppdurutype, uint8_t ppdumma, uint8_t ppdudoppler)
{
    ASSERT_ERR((((uint32_t)ppdurutype << 4) & ~((uint32_t)0x00000070)) == 0);
    ASSERT_ERR((((uint32_t)ppdumma << 1) & ~((uint32_t)0x00000002)) == 0);
    ASSERT_ERR((((uint32_t)ppdudoppler << 0) & ~((uint32_t)0x00000001)) == 0);
    REG_PL_WR(NXMAC_TIME_ON_AIR_PARAM_3_ADDR,  ((uint32_t)ppdurutype << 4) | ((uint32_t)ppdumma << 1) | ((uint32_t)ppdudoppler << 0));
}

/**
 * @brief Unpacks TIME_ON_AIR_PARAM_3's fields from current value of the TIME_ON_AIR_PARAM_3 register.
 *
 * Reads the TIME_ON_AIR_PARAM_3 register and populates all the _field variables with the corresponding
 * values from the register.
 *
 * @param[out] ppdurutype - Will be populated with the current value of this field from the register.
 * @param[out] ppdumma - Will be populated with the current value of this field from the register.
 * @param[out] ppdudoppler - Will be populated with the current value of this field from the register.
 */
__INLINE void nxmac_time_on_air_param_3_unpack(uint8_t* ppdurutype, uint8_t* ppdumma, uint8_t* ppdudoppler)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_3_ADDR);

    *ppdurutype = (localVal & ((uint32_t)0x00000070)) >> 4;
    *ppdumma = (localVal & ((uint32_t)0x00000002)) >> 1;
    *ppdudoppler = (localVal & ((uint32_t)0x00000001)) >> 0;
}

/**
 * @brief Returns the current value of the ppduRuType field in the TIME_ON_AIR_PARAM_3 register.
 *
 * The TIME_ON_AIR_PARAM_3 register will be read and the ppduRuType field's value will be returned.
 *
 * @return The current value of the ppduRuType field in the TIME_ON_AIR_PARAM_3 register.
 */
__INLINE uint8_t nxmac_ppdu_ru_type_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_3_ADDR);
...
/**
 * @brief Sets the ppduRuType field of the TIME_ON_AIR_PARAM_3 register.
 *
 * The TIME_ON_AIR_PARAM_3 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] ppdurutype - The value to set the field to.
 */
__INLINE void nxmac_ppdu_ru_type_setf(uint8_t ppdurutype)
{
    ASSERT_ERR((((uint32_t)ppdurutype << 4) & ~((uint32_t)0x00000070)) == 0);
    REG_PL_WR(NXMAC_TIME_ON_AIR_PARAM_3_ADDR, (REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_3_ADDR) & ~((uint32_t)0x00000070)) | ((uint32_t)ppdurutype << 4));
}

/**
 * @brief Returns the current value of the ppduMma field in the TIME_ON_AIR_PARAM_3 register.
 *
 * The TIME_ON_AIR_PARAM_3 register will be read and the ppduMma field's value will be returned.
 *
 * @return The current value of the ppduMma field in the TIME_ON_AIR_PARAM_3 register.
 */
__INLINE uint8_t nxmac_ppdu_mma_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_3_ADDR);
    return ((localVal & ((uint32_t)0x00000002)) >> 1);
}
...
/**
 * @brief Sets the ppduMma field of the TIME_ON_AIR_PARAM_3 register.
 *
 * The TIME_ON_AIR_PARAM_3 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] ppdumma - The value to set the field to.
 */
__INLINE void nxmac_ppdu_mma_setf(uint8_t ppdumma)
{
    ASSERT_ERR((((uint32_t)ppdumma << 1) & ~((uint32_t)0x00000002)) == 0);
    REG_PL_WR(NXMAC_TIME_ON_AIR_PARAM_3_ADDR, (REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_3_ADDR) & ~((uint32_t)0x00000002)) | ((uint32_t)ppdumma << 1));
}

/**
 * @brief Returns the current value of the ppduDoppler field in the TIME_ON_AIR_PARAM_3 register.
 *
 * The TIME_ON_AIR_PARAM_3 register will be read and the ppduDoppler field's value will be returned.
 *
 * @return The current value of the ppduDoppler field in the TIME_ON_AIR_PARAM_3 register.
 */
__INLINE uint8_t nxmac_ppdu_doppler_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_3_ADDR);
    return ((localVal & ((uint32_t)0x00000001)) >> 0);
}
...
/**
 * @brief Sets the ppduDoppler field of the TIME_ON_AIR_PARAM_3 register.
 *
 * The TIME_ON_AIR_PARAM_3 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] ppdudoppler - The value to set the field to.
 */
__INLINE void nxmac_ppdu_doppler_setf(uint8_t ppdudoppler)
{
    ASSERT_ERR((((uint32_t)ppdudoppler << 0) & ~((uint32_t)0x00000001)) == 0);
    REG_PL_WR(NXMAC_TIME_ON_AIR_PARAM_3_ADDR, (REG_PL_RD(NXMAC_TIME_ON_AIR_PARAM_3_ADDR) & ~((uint32_t)0x00000001)) | ((uint32_t)ppdudoppler << 0));
}
 ...
 * <table>
 * <caption>TIME_ON_AIR_VALUE bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31    <td>   computeDuration <td> R/W <td> R/W <td> 0
 * <tr><td> 30    <td>    timeOnAirValid <td> R <td> R <td> 0
 * <tr><td> 15:00 <td>         timeOnAir <td> R <td> R <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_TIME_ON_AIR_VALUE_ADDR   0x24B0816C
/// Offset of the TIME_ON_AIR_VALUE register from the base address
#define NXMAC_TIME_ON_AIR_VALUE_OFFSET 0x0000016C
/// Index of the TIME_ON_AIR_VALUE register
#define NXMAC_TIME_ON_AIR_VALUE_INDEX  0x0000005B
 ...
 * <table>
 * <caption>DMA_CNTRL_SET bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 20 <td>      haltTBAfterTXOP <td> R <td> S <td> 0
 * <tr><td> 19 <td>     haltAC3AfterTXOP <td> R <td> S <td> 0
 * <tr><td> 18 <td>     haltAC2AfterTXOP <td> R <td> S <td> 0
 * <tr><td> 17 <td>     haltAC1AfterTXOP <td> R <td> S <td> 0
 * <tr><td> 16 <td>     haltAC0AfterTXOP <td> R <td> S <td> 0
 * <tr><td> 15 <td>     haltBcnAfterTXOP <td> R <td> S <td> 0
 * <tr><td> 13 <td>          txTBNewHead <td> R <td> S <td> 0
 * <tr><td> 12 <td>         txAC3NewHead <td> R <td> S <td> 0
 * <tr><td> 11 <td>         txAC2NewHead <td> R <td> S <td> 0
 * <tr><td> 10 <td>         txAC1NewHead <td> R <td> S <td> 0
 * <tr><td> 09 <td>         txAC0NewHead <td> R <td> S <td> 0
 * <tr><td> 08 <td>         txBcnNewHead <td> R <td> S <td> 0
 * <tr><td> 04 <td>         txAC3NewTail <td> R <td> S <td> 0
 * <tr><td> 03 <td>         txAC2NewTail <td> R <td> S <td> 0
 * <tr><td> 02 <td>         txAC1NewTail <td> R <td> S <td> 0
 * <tr><td> 01 <td>         txAC0NewTail <td> R <td> S <td> 0
 * <tr><td> 00 <td>         txBcnNewTail <td> R <td> S <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_DMA_CNTRL_SET_ADDR   0x24B08180
...
// field definitions
/// HALT_TB_AFTER_TXOP field bit
#define NXMAC_HALT_TB_AFTER_TXOP_BIT      ((uint32_t)0x00100000)
/// HALT_TB_AFTER_TXOP field position
#define NXMAC_HALT_TB_AFTER_TXOP_POS      20
...
/// TX_TB_NEW_HEAD field bit
#define NXMAC_TX_TB_NEW_HEAD_BIT          ((uint32_t)0x00002000)
/// TX_TB_NEW_HEAD field position
#define NXMAC_TX_TB_NEW_HEAD_POS          13
...
/// HALT_TB_AFTER_TXOP field reset value
#define NXMAC_HALT_TB_AFTER_TXOP_RST      0x0
...
/// TX_TB_NEW_HEAD field reset value
#define NXMAC_TX_TB_NEW_HEAD_RST          0x0
 ...
 * and writes the value to the register.
 *
 * @param[in] halttbaftertxop - The value to use for the haltTBAfterTXOP field.
 ...
 * @param[in] txtbnewhead - The value to use for the txTBNewHead field.
 ...
 */
__INLINE void nxmac_dma_cntrl_set_pack(uint8_t halttbaftertxop, uint8_t haltac3aftertxop, uint8_t haltac2aftertxop, uint8_t haltac1aftertxop, uint8_t haltac0aftertxop, uint8_t haltbcnaftertxop, uint8_t txtbnewhead, uint8_t txac3newhead, uint8_t txac2newhead, uint8_t txac1newhead, uint8_t txac0newhead, uint8_t txbcnnewhead, uint8_t txac3newtail, uint8_t txac2newtail, uint8_t txac1newtail, uint8_t txac0newtail, uint8_t txbcnnewtail)
{
    ASSERT_ERR((((uint32_t)halttbaftertxop << 20) & ~((uint32_t)0x00100000)) == 0);
    ...
    ASSERT_ERR((((uint32_t)txtbnewhead << 13) & ~((uint32_t)0x00002000)) == 0);
    ...
    REG_PL_WR(NXMAC_DMA_CNTRL_SET_ADDR,  ((uint32_t)halttbaftertxop << 20) | ((uint32_t)haltac3aftertxop << 19) | ((uint32_t)haltac2aftertxop << 18) | ((uint32_t)haltac1aftertxop << 17) | ((uint32_t)haltac0aftertxop << 16) | ((uint32_t)haltbcnaftertxop << 15) | ((uint32_t)txtbnewhead << 13) | ((uint32_t)txac3newhead << 12) | ((uint32_t)txac2newhead << 11) | ((uint32_t)txac1newhead << 10) | ((uint32_t)txac0newhead << 9) | ((uint32_t)txbcnnewhead << 8) | ((uint32_t)txac3newtail << 4) | ((uint32_t)txac2newtail << 3) | ((uint32_t)txac1newtail << 2) | ((uint32_t)txac0newtail << 1) | ((uint32_t)txbcnnewtail << 0));
}
 ...
 * values from the register.
 *
 * @param[out] halttbaftertxop - Will be populated with the current value of this field from the register.
 ...
 * @param[out] txtbnewhead - Will be populated with the current value of this field from the register.
 ...
 */
__INLINE void nxmac_dma_cntrl_unpack(uint8_t* halttbaftertxop, uint8_t* haltac3aftertxop, uint8_t* haltac2aftertxop, uint8_t* haltac1aftertxop, uint8_t* haltac0aftertxop, uint8_t* haltbcnaftertxop, uint8_t* txtbnewhead, uint8_t* txac3newhead, uint8_t* txac2newhead, uint8_t* txac1newhead, uint8_t* txac0newhead, uint8_t* txbcnnewhead, uint8_t* txac3newtail, uint8_t* txac2newtail, uint8_t* txac1newtail, uint8_t* txac0newtail, uint8_t* txbcnnewtail)
{
    uint32_t localVal = REG_PL_RD(NXMAC_DMA_CNTRL_SET_ADDR);

    *halttbaftertxop = (localVal & ((uint32_t)0x00100000)) >> 20;
    ...
    *txtbnewhead = (localVal & ((uint32_t)0x00002000)) >> 13;
...
/**
 * @brief Returns the current value of the haltTBAfterTXOP field in the DMA_CNTRL_SET register.
 *
 * The DMA_CNTRL_SET register will be read and the haltTBAfterTXOP field's value will be returned.
 *
 * @return The current value of the haltTBAfterTXOP field in the DMA_CNTRL_SET register.
 */
__INLINE uint8_t nxmac_halt_tb_after_txop_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_DMA_CNTRL_SET_ADDR);
    return ((localVal & ((uint32_t)0x00100000)) >> 20);
}
...
/**
 * @brief Sets the haltTBAfterTXOP field of the DMA_CNTRL_SET register.
 *
 * The DMA_CNTRL_SET register will be read, modified to contain the new field value, and written.
 *
 * @param[in] halttbaftertxop - The value to set the field to.
 */
__INLINE void nxmac_halt_tb_after_txop_setf(uint8_t halttbaftertxop)
{
    ASSERT_ERR((((uint32_t)halttbaftertxop << 20) & ~((uint32_t)0x00100000)) == 0);
    REG_PL_WR(NXMAC_DMA_CNTRL_SET_ADDR, (uint32_t)halttbaftertxop << 20);
}
...
/**
 * @brief Returns the current value of the txTBNewHead field in the DMA_CNTRL_SET register.
 *
 * The DMA_CNTRL_SET register will be read and the txTBNewHead field's value will be returned.
 *
 * @return The current value of the txTBNewHead field in the DMA_CNTRL_SET register.
 */
__INLINE uint8_t nxmac_tx_tb_new_head_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_DMA_CNTRL_SET_ADDR);
    return ((localVal & ((uint32_t)0x00002000)) >> 13);
}
...
/**
 * @brief Sets the txTBNewHead field of the DMA_CNTRL_SET register.
 *
 * The DMA_CNTRL_SET register will be read, modified to contain the new field value, and written.
 *
 * @param[in] txtbnewhead - The value to set the field to.
 */
__INLINE void nxmac_tx_tb_new_head_setf(uint8_t txtbnewhead)
{
    ASSERT_ERR((((uint32_t)txtbnewhead << 13) & ~((uint32_t)0x00002000)) == 0);
    REG_PL_WR(NXMAC_DMA_CNTRL_SET_ADDR, (uint32_t)txtbnewhead << 13);
}
 ...
 * <table>
 * <caption>DMA_CNTRL_CLEAR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 20 <td>      haltTBAfterTXOP <td> R <td> C <td> 0
 * <tr><td> 19 <td>     haltAC3AfterTXOP <td> R <td> C <td> 0
 * <tr><td> 18 <td>     haltAC2AfterTXOP <td> R <td> C <td> 0
 * <tr><td> 17 <td>     haltAC1AfterTXOP <td> R <td> C <td> 0
 * <tr><td> 16 <td>     haltAC0AfterTXOP <td> R <td> C <td> 0
 * <tr><td> 15 <td>     haltBcnAfterTXOP <td> R <td> C <td> 0
 * <tr><td> 13 <td>          txTBNewHead <td> R <td> C <td> 0
 * <tr><td> 12 <td>         txAC3NewHead <td> R <td> C <td> 0
 * <tr><td> 11 <td>         txAC2NewHead <td> R <td> C <td> 0
 * <tr><td> 10 <td>         txAC1NewHead <td> R <td> C <td> 0
 * <tr><td> 09 <td>         txAC0NewHead <td> R <td> C <td> 0
 * <tr><td> 08 <td>         txBcnNewHead <td> R <td> C <td> 0
 * <tr><td> 04 <td>         txAC3NewTail <td> R <td> C <td> 0
 * <tr><td> 03 <td>         txAC2NewTail <td> R <td> C <td> 0
 * <tr><td> 02 <td>         txAC1NewTail <td> R <td> C <td> 0
 * <tr><td> 01 <td>         txAC0NewTail <td> R <td> C <td> 0
 * <tr><td> 00 <td>         txBcnNewTail <td> R <td> C <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_DMA_CNTRL_CLEAR_ADDR   0x24B08184
 ...
 * @param[in] txbcnnewtail - The value to use for the txBcnNewTail field.
 */
__INLINE void nxmac_dma_cntrl_clear_pack(uint8_t halttbaftertxop, uint8_t haltac3aftertxop, uint8_t haltac2aftertxop, uint8_t haltac1aftertxop, uint8_t haltac0aftertxop, uint8_t haltbcnaftertxop, uint8_t txtbnewhead, uint8_t txac3newhead, uint8_t txac2newhead, uint8_t txac1newhead, uint8_t txac0newhead, uint8_t txbcnnewhead, uint8_t txac3newtail, uint8_t txac2newtail, uint8_t txac1newtail, uint8_t txac0newtail, uint8_t txbcnnewtail)
{
    ASSERT_ERR((((uint32_t)halttbaftertxop << 20) & ~((uint32_t)0x00100000)) == 0);
    ASSERT_ERR((((uint32_t)haltac3aftertxop << 19) & ~((uint32_t)0x00080000)) == 0);
    ASSERT_ERR((((uint32_t)haltac2aftertxop << 18) & ~((uint32_t)0x00040000)) == 0);
    ...
    ASSERT_ERR((((uint32_t)txac0newtail << 1) & ~((uint32_t)0x00000002)) == 0);
    ASSERT_ERR((((uint32_t)txbcnnewtail << 0) & ~((uint32_t)0x00000001)) == 0);
    REG_PL_WR(NXMAC_DMA_CNTRL_CLEAR_ADDR,  ((uint32_t)halttbaftertxop << 20) | ((uint32_t)haltac3aftertxop << 19) | ((uint32_t)haltac2aftertxop << 18) | ((uint32_t)haltac1aftertxop << 17) | ((uint32_t)haltac0aftertxop << 16) | ((uint32_t)haltbcnaftertxop << 15) | ((uint32_t)txtbnewhead << 13) | ((uint32_t)txac3newhead << 12) | ((uint32_t)txac2newhead << 11) | ((uint32_t)txac1newhead << 10) | ((uint32_t)txac0newhead << 9) | ((uint32_t)txbcnnewhead << 8) | ((uint32_t)txac3newtail << 4) | ((uint32_t)txac2newtail << 3) | ((uint32_t)txac1newtail << 2) | ((uint32_t)txac0newtail << 1) | ((uint32_t)txbcnnewtail << 0));
}

/**
 * @brief Sets the haltTBAfterTXOP field of the DMA_CNTRL_CLEAR register.
 *
 * The DMA_CNTRL_CLEAR register will be read, modified to contain the new field value, and written.
 *
 * @param[in] halttbaftertxop - The value to set the field to.
 */
__INLINE void nxmac_halt_tb_after_txop_clearf(uint8_t halttbaftertxop)
{
    ASSERT_ERR((((uint32_t)halttbaftertxop << 20) & ~((uint32_t)0x00100000)) == 0);
    REG_PL_WR(NXMAC_DMA_CNTRL_CLEAR_ADDR, (uint32_t)halttbaftertxop << 20);
}
...
/**
 * @brief Sets the txTBNewHead field of the DMA_CNTRL_CLEAR register.
 *
 * The DMA_CNTRL_CLEAR register will be read, modified to contain the new field value, and written.
 *
 * @param[in] txtbnewhead - The value to set the field to.
 */
__INLINE void nxmac_tx_tb_new_head_clearf(uint8_t txtbnewhead)
{
    ASSERT_ERR((((uint32_t)txtbnewhead << 13) & ~((uint32_t)0x00002000)) == 0);
    REG_PL_WR(NXMAC_DMA_CNTRL_CLEAR_ADDR, (uint32_t)txtbnewhead << 13);
}
 ...
 * <table>
 * <caption>DMA_STATUS_1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 21:20 <td>     txTBState <td> W <td> R <td> 0x0
 * <tr><td> 17:16 <td>    txAC3State <td> W <td> R <td> 0x0
 * <tr><td> 13:12 <td>    txAC2State <td> W <td> R <td> 0x0
 * <tr><td> 09:08 <td>    txAC1State <td> W <td> R <td> 0x0
 * <tr><td> 05:04 <td>    txAC0State <td> W <td> R <td> 0x0
 * <tr><td> 01:00 <td>    txBcnState <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_DMA_STATUS_1_ADDR   0x24B08188
...
// field definitions
/// TX_TB_STATE field mask
#define NXMAC_TX_TB_STATE_MASK     ((uint32_t)0x00300000)
/// TX_TB_STATE field LSB position
#define NXMAC_TX_TB_STATE_LSB      20
/// TX_TB_STATE field width
#define NXMAC_TX_TB_STATE_WIDTH    ((uint32_t)0x00000002)
...
/// TX_TB_STATE field reset value
#define NXMAC_TX_TB_STATE_RST      0x0
 ...
 * values from the register.
 *
 * @param[out] txtbstate - Will be populated with the current value of this field from the register.
 ...
 */
__INLINE void nxmac_dma_status_1_unpack(uint8_t* txtbstate, uint8_t* txac3state, uint8_t* txac2state, uint8_t* txac1state, uint8_t* txac0state, uint8_t* txbcnstate)
{
    uint32_t localVal = REG_PL_RD(NXMAC_DMA_STATUS_1_ADDR);

    *txtbstate = (localVal & ((uint32_t)0x00300000)) >> 20;
...
/**
 * @brief Returns the current value of the txTBState field in the DMA_STATUS_1 register.
 *
 * The DMA_STATUS_1 register will be read and the txTBState field's value will be returned.
 *
 * @return The current value of the txTBState field in the DMA_STATUS_1 register.
 */
__INLINE uint8_t nxmac_tx_tb_state_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_DMA_STATUS_1_ADDR);
 ...
 * <table>
 * <caption>DMA_STATUS_2 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 05 <td>        txNewHeadErr <td> W <td> R <td> 0
 * <tr><td> 04 <td>            txBusErr <td> W <td> R <td> 0
 * <tr><td> 03 <td>      txPTAddressErr <td> W <td> R <td> 0
 * <tr><td> 02 <td>    txNextPointerErr <td> W <td> R <td> 0
 * <tr><td> 01 <td>       txUPatternErr <td> W <td> R <td> 0
 * <tr><td> 00 <td>       txLenMismatch <td> W <td> R <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_DMA_STATUS_2_ADDR   0x24B0818C
...
// field definitions
/// TX_NEW_HEAD_ERR field bit
#define NXMAC_TX_NEW_HEAD_ERR_BIT        ((uint32_t)0x00000020)
/// TX_NEW_HEAD_ERR field position
#define NXMAC_TX_NEW_HEAD_ERR_POS        5
/// TX_BUS_ERR field bit
#define NXMAC_TX_BUS_ERR_BIT             ((uint32_t)0x00000010)
/// TX_BUS_ERR field position
#define NXMAC_TX_BUS_ERR_POS             4
/// TX_PT_ADDRESS_ERR field bit
#define NXMAC_TX_PT_ADDRESS_ERR_BIT      ((uint32_t)0x00000008)
/// TX_PT_ADDRESS_ERR field position
#define NXMAC_TX_PT_ADDRESS_ERR_POS      3
/// TX_NEXT_POINTER_ERR field bit
#define NXMAC_TX_NEXT_POINTER_ERR_BIT    ((uint32_t)0x00000004)
/// TX_NEXT_POINTER_ERR field position
#define NXMAC_TX_NEXT_POINTER_ERR_POS    2
/// TX_U_PATTERN_ERR field bit
#define NXMAC_TX_U_PATTERN_ERR_BIT       ((uint32_t)0x00000002)
/// TX_U_PATTERN_ERR field position
#define NXMAC_TX_U_PATTERN_ERR_POS       1
/// TX_LEN_MISMATCH field bit
#define NXMAC_TX_LEN_MISMATCH_BIT        ((uint32_t)0x00000001)
/// TX_LEN_MISMATCH field position
#define NXMAC_TX_LEN_MISMATCH_POS        0

/// TX_NEW_HEAD_ERR field reset value
#define NXMAC_TX_NEW_HEAD_ERR_RST        0x0
/// TX_BUS_ERR field reset value
#define NXMAC_TX_BUS_ERR_RST             0x0
/// TX_PT_ADDRESS_ERR field reset value
#define NXMAC_TX_PT_ADDRESS_ERR_RST      0x0
/// TX_NEXT_POINTER_ERR field reset value
#define NXMAC_TX_NEXT_POINTER_ERR_RST    0x0
/// TX_U_PATTERN_ERR field reset value
#define NXMAC_TX_U_PATTERN_ERR_RST       0x0
/// TX_LEN_MISMATCH field reset value
#define NXMAC_TX_LEN_MISMATCH_RST        0x0
 ...
 * values from the register.
 *
 * @param[out] txnewheaderr - Will be populated with the current value of this field from the register.
 * @param[out] txbuserr - Will be populated with the current value of this field from the register.
 * @param[out] txptaddresserr - Will be populated with the current value of this field from the register.
 * @param[out] txnextpointererr - Will be populated with the current value of this field from the register.
 * @param[out] txupatternerr - Will be populated with the current value of this field from the register.
 * @param[out] txlenmismatch - Will be populated with the current value of this field from the register.
 */
__INLINE void nxmac_dma_status_2_unpack(uint8_t* txnewheaderr, uint8_t* txbuserr, uint8_t* txptaddresserr, uint8_t* txnextpointererr, uint8_t* txupatternerr, uint8_t* txlenmismatch)
{
    uint32_t localVal = REG_PL_RD(NXMAC_DMA_STATUS_2_ADDR);

    *txnewheaderr = (localVal & ((uint32_t)0x00000020)) >> 5;
    *txbuserr = (localVal & ((uint32_t)0x00000010)) >> 4;
    *txptaddresserr = (localVal & ((uint32_t)0x00000008)) >> 3;
    *txnextpointererr = (localVal & ((uint32_t)0x00000004)) >> 2;
    *txupatternerr = (localVal & ((uint32_t)0x00000002)) >> 1;
    *txlenmismatch = (localVal & ((uint32_t)0x00000001)) >> 0;
}

/**
 * @brief Returns the current value of the txNewHeadErr field in the DMA_STATUS_2 register.
 *
 * The DMA_STATUS_2 register will be read and the txNewHeadErr field's value will be returned.
 *
 * @return The current value of the txNewHeadErr field in the DMA_STATUS_2 register.
 */
__INLINE uint8_t nxmac_tx_new_head_err_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_DMA_STATUS_2_ADDR);
    return ((localVal & ((uint32_t)0x00000020)) >> 5);
}
...
/**
 * @brief Returns the current value of the txBusErr field in the DMA_STATUS_2 register.
 *
 * The DMA_STATUS_2 register will be read and the txBusErr field's value will be returned.
 *
 * @return The current value of the txBusErr field in the DMA_STATUS_2 register.
 */
__INLINE uint8_t nxmac_tx_bus_err_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_DMA_STATUS_2_ADDR);
    return ((localVal & ((uint32_t)0x00000010)) >> 4);
}
...
/**
 * @brief Returns the current value of the txPTAddressErr field in the DMA_STATUS_2 register.
 *
 * The DMA_STATUS_2 register will be read and the txPTAddressErr field's value will be returned.
 *
 * @return The current value of the txPTAddressErr field in the DMA_STATUS_2 register.
 */
__INLINE uint8_t nxmac_tx_pt_address_err_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_DMA_STATUS_2_ADDR);
    return ((localVal & ((uint32_t)0x00000008)) >> 3);
}
...
/**
 * @brief Returns the current value of the txNextPointerErr field in the DMA_STATUS_2 register.
 *
 * The DMA_STATUS_2 register will be read and the txNextPointerErr field's value will be returned.
 *
 * @return The current value of the txNextPointerErr field in the DMA_STATUS_2 register.
 */
__INLINE uint8_t nxmac_tx_next_pointer_err_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_DMA_STATUS_2_ADDR);
    return ((localVal & ((uint32_t)0x00000004)) >> 2);
}
...
/**
 * @brief Returns the current value of the txUPatternErr field in the DMA_STATUS_2 register.
 *
 * The DMA_STATUS_2 register will be read and the txUPatternErr field's value will be returned.
 *
 * @return The current value of the txUPatternErr field in the DMA_STATUS_2 register.
 */
__INLINE uint8_t nxmac_tx_u_pattern_err_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_DMA_STATUS_2_ADDR);
    return ((localVal & ((uint32_t)0x00000002)) >> 1);
}
...
/**
 * @brief Returns the current value of the txLenMismatch field in the DMA_STATUS_2 register.
 *
 * The DMA_STATUS_2 register will be read and the txLenMismatch field's value will be returned.
 *
 * @return The current value of the txLenMismatch field in the DMA_STATUS_2 register.
 */
__INLINE uint8_t nxmac_tx_len_mismatch_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_DMA_STATUS_2_ADDR);
    return ((localVal & ((uint32_t)0x00000001)) >> 0);
}
 ...
 * <table>
 * <caption>DMA_STATUS_3 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 05 <td>    rxPayBusErr <td> W <td> R <td> 0
 * <tr><td> 04 <td>    rxHdrBusErr <td> W <td> R <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_DMA_STATUS_3_ADDR   0x24B08190
 ...
 */
__INLINE void nxmac_dma_status_3_unpack(uint8_t* rxpaybuserr, uint8_t* rxhdrbuserr)
{
 ...
 * <table>
 * <caption>DMA_STATUS_4 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 15 <td>       txTBHaltAfterTXOP <td> W <td> R <td> 0
 * <tr><td> 14 <td>      txAC3HaltAfterTXOP <td> W <td> R <td> 0
 * <tr><td> 13 <td>      txAC2HaltAfterTXOP <td> W <td> R <td> 0
 * <tr><td> 12 <td>      txAC1HaltAfterTXOP <td> W <td> R <td> 0
 * <tr><td> 11 <td>      txAC0HaltAfterTXOP <td> W <td> R <td> 0
 * <tr><td> 10 <td>      txBcnHaltAfterTXOP <td> W <td> R <td> 0
 * <tr><td> 09 <td>               txAC3EndQ <td> W <td> R <td> 0
 * <tr><td> 08 <td>               txAC2EndQ <td> W <td> R <td> 0
 * <tr><td> 07 <td>               txAC1EndQ <td> W <td> R <td> 0
 * <tr><td> 06 <td>               txAC0EndQ <td> W <td> R <td> 0
 * <tr><td> 05 <td>               txBcnEndQ <td> W <td> R <td> 0
 * <tr><td> 04 <td>            txAC3Startup <td> W <td> R <td> 1
 * <tr><td> 03 <td>            txAC2Startup <td> W <td> R <td> 1
 * <tr><td> 02 <td>            txAC1Startup <td> W <td> R <td> 1
 * <tr><td> 01 <td>            txAC0Startup <td> W <td> R <td> 1
 * <tr><td> 00 <td>            txBcnStartup <td> W <td> R <td> 1
 * </table>
 *
 * @{
 */
...
#define NXMAC_DMA_STATUS_4_ADDR   0x24B08194
...
// field definitions
/// TX_TB_HALT_AFTER_TXOP field bit
#define NXMAC_TX_TB_HALT_AFTER_TXOP_BIT      ((uint32_t)0x00008000)
/// TX_TB_HALT_AFTER_TXOP field position
#define NXMAC_TX_TB_HALT_AFTER_TXOP_POS      15
...
/// TX_TB_HALT_AFTER_TXOP field reset value
#define NXMAC_TX_TB_HALT_AFTER_TXOP_RST      0x0
 ...
 * values from the register.
 *
 * @param[out] txtbhaltaftertxop - Will be populated with the current value of this field from the register.
...
/**
 * @brief Returns the current value of the txTBHaltAfterTXOP field in the DMA_STATUS_4 register.
 *
 * The DMA_STATUS_4 register will be read and the txTBHaltAfterTXOP field's value will be returned.
 *
 * @return The current value of the txTBHaltAfterTXOP field in the DMA_STATUS_4 register.
 */
__INLINE uint8_t nxmac_tx_tb_halt_after_txop_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_DMA_STATUS_4_ADDR);
    return ((localVal & ((uint32_t)0x00008000)) >> 15);
}
 ...
 * <table>
 * <caption>TX_BCN_HEAD_PTR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>    txBcnHeadPtr <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_TX_BCN_HEAD_PTR_ADDR   0x24B08198
 ...
 * <table>
 * <caption>TX_AC_0_HEAD_PTR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>     txAC0HeadPtr <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_TX_AC_0_HEAD_PTR_ADDR   0x24B0819C
 ...
 * <table>
 * <caption>TX_AC_1_HEAD_PTR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>     txAC1HeadPtr <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_TX_AC_1_HEAD_PTR_ADDR   0x24B081A0
 ...
 * <table>
 * <caption>TX_AC_2_HEAD_PTR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>     txAC2HeadPtr <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_TX_AC_2_HEAD_PTR_ADDR   0x24B081A4
 ...
 * <table>
 * <caption>TX_AC_3_HEAD_PTR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>     txAC3HeadPtr <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_TX_AC_3_HEAD_PTR_ADDR   0x24B081A8
...
/**
 * @name TX_TB_HEAD_PTR register definitions
 * <table>
 * <caption>TX_TB_HEAD_PTR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>    txTBHeadPtr <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the TX_TB_HEAD_PTR register
#define NXMAC_TX_TB_HEAD_PTR_ADDR   0x24B081AC
/// Offset of the TX_TB_HEAD_PTR register from the base address
#define NXMAC_TX_TB_HEAD_PTR_OFFSET 0x000001AC
/// Index of the TX_TB_HEAD_PTR register
#define NXMAC_TX_TB_HEAD_PTR_INDEX  0x0000006B
/// Reset value of the TX_TB_HEAD_PTR register
#define NXMAC_TX_TB_HEAD_PTR_RESET  0x00000000

/**
 * @brief Returns the current value of the TX_TB_HEAD_PTR register.
 * The TX_TB_HEAD_PTR register will be read and its value returned.
 * @return The current value of the TX_TB_HEAD_PTR register.
 */
__INLINE uint32_t nxmac_tx_tb_head_ptr_get(void)
{
    return REG_PL_RD(NXMAC_TX_TB_HEAD_PTR_ADDR);
}

/**
 * @brief Sets the TX_TB_HEAD_PTR register to a value.
 * The TX_TB_HEAD_PTR register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_tx_tb_head_ptr_set(uint32_t value)
{
    REG_PL_WR(NXMAC_TX_TB_HEAD_PTR_ADDR, value);
}

// field definitions
/// TX_TB_HEAD_PTR field mask
#define NXMAC_TX_TB_HEAD_PTR_MASK   ((uint32_t)0xFFFFFFFF)
/// TX_TB_HEAD_PTR field LSB position
#define NXMAC_TX_TB_HEAD_PTR_LSB    0
/// TX_TB_HEAD_PTR field width
#define NXMAC_TX_TB_HEAD_PTR_WIDTH  ((uint32_t)0x00000020)

/// TX_TB_HEAD_PTR field reset value
#define NXMAC_TX_TB_HEAD_PTR_RST    0x0

/**
 * @brief Returns the current value of the txTBHeadPtr field in the TX_TB_HEAD_PTR register.
 *
 * The TX_TB_HEAD_PTR register will be read and the txTBHeadPtr field's value will be returned.
 *
 * @return The current value of the txTBHeadPtr field in the TX_TB_HEAD_PTR register.
 */
__INLINE uint32_t nxmac_tx_tb_head_ptr_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TX_TB_HEAD_PTR_ADDR);
    ASSERT_ERR((localVal & ~((uint32_t)0xFFFFFFFF)) == 0);
    return (localVal >> 0);
}

/**
 * @brief Sets the txTBHeadPtr field of the TX_TB_HEAD_PTR register.
 *
 * The TX_TB_HEAD_PTR register will be read, modified to contain the new field value, and written.
 *
 * @param[in] txtbheadptr - The value to set the field to.
 */
__INLINE void nxmac_tx_tb_head_ptr_setf(uint32_t txtbheadptr)
{
    ASSERT_ERR((((uint32_t)txtbheadptr << 0) & ~((uint32_t)0xFFFFFFFF)) == 0);
    REG_PL_WR(NXMAC_TX_TB_HEAD_PTR_ADDR, (uint32_t)txtbheadptr << 0);
}
 ...
 * <table>
 * <caption>TX_STRUCT_SIZES bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 29:24 <td>    dmaRBDSize <td> R <td> R/W <td> 0x0
 * <tr><td> 23:18 <td>    dmaRHDSize <td> R <td> R/W <td> 0x0
 * <tr><td> 17:12 <td>    dmaTBDSize <td> R <td> R/W <td> 0x0
 * <tr><td> 11:06 <td>    dmaTHDSize <td> R <td> R/W <td> 0x0
 * <tr><td> 05:00 <td>   ptEntrySize <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_TX_STRUCT_SIZES_ADDR   0x24B081B0
/// Offset of the TX_STRUCT_SIZES register from the base address
#define NXMAC_TX_STRUCT_SIZES_OFFSET 0x000001B0
/// Index of the TX_STRUCT_SIZES register
#define NXMAC_TX_STRUCT_SIZES_INDEX  0x0000006C
 ...
 * <table>
 * <caption>DMA_THRESHOLD bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 23:16 <td>   rxFIFOThreshold <td> R <td> R/W <td> 0x10
 * <tr><td> 07:00 <td>   txFIFOThreshold <td> R <td> R/W <td> 0x10
 * </table>
 *
 * @{
 */
...
#define NXMAC_DMA_THRESHOLD_ADDR   0x24B081C0
...
/**
 * @name RX_HEADER_TF_PTR register definitions
 * <table>
 * <caption>RX_HEADER_TF_PTR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:02 <td>    rxHeaderTFPtr <td> R/W <td> R <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the RX_HEADER_TF_PTR register
#define NXMAC_RX_HEADER_TF_PTR_ADDR   0x24B081C4
/// Offset of the RX_HEADER_TF_PTR register from the base address
#define NXMAC_RX_HEADER_TF_PTR_OFFSET 0x000001C4
/// Index of the RX_HEADER_TF_PTR register
#define NXMAC_RX_HEADER_TF_PTR_INDEX  0x00000071
/// Reset value of the RX_HEADER_TF_PTR register
#define NXMAC_RX_HEADER_TF_PTR_RESET  0x00000000

/**
 * @brief Returns the current value of the RX_HEADER_TF_PTR register.
 * The RX_HEADER_TF_PTR register will be read and its value returned.
 * @return The current value of the RX_HEADER_TF_PTR register.
 */
__INLINE uint32_t nxmac_rx_header_tf_ptr_get(void)
{
    return REG_PL_RD(NXMAC_RX_HEADER_TF_PTR_ADDR);
}

// field definitions
/// RX_HEADER_TF_PTR field mask
#define NXMAC_RX_HEADER_TF_PTR_MASK   ((uint32_t)0xFFFFFFFC)
/// RX_HEADER_TF_PTR field LSB position
#define NXMAC_RX_HEADER_TF_PTR_LSB    2
/// RX_HEADER_TF_PTR field width
#define NXMAC_RX_HEADER_TF_PTR_WIDTH  ((uint32_t)0x0000001E)

/// RX_HEADER_TF_PTR field reset value
#define NXMAC_RX_HEADER_TF_PTR_RST    0x0

/**
 * @brief Returns the current value of the rxHeaderTFPtr field in the RX_HEADER_TF_PTR register.
 *
 * The RX_HEADER_TF_PTR register will be read and the rxHeaderTFPtr field's value will be returned.
 *
 * @return The current value of the rxHeaderTFPtr field in the RX_HEADER_TF_PTR register.
 */
__INLINE uint32_t nxmac_rx_header_tf_ptr_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HEADER_TF_PTR_ADDR);
    ASSERT_ERR((localVal & ~((uint32_t)0xFFFFFFFC)) == 0);
    return (localVal >> 2);
}
...
/**
 * @name RX_BUF_1_START_PTR register definitions
 * <table>
 * <caption>RX_BUF_1_START_PTR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 30:00 <td>     rxBuf1StartPtr <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the RX_BUF_1_START_PTR register
#define NXMAC_RX_BUF_1_START_PTR_ADDR   0x24B081C8
/// Offset of the RX_BUF_1_START_PTR register from the base address
#define NXMAC_RX_BUF_1_START_PTR_OFFSET 0x000001C8
/// Index of the RX_BUF_1_START_PTR register
#define NXMAC_RX_BUF_1_START_PTR_INDEX  0x00000072
/// Reset value of the RX_BUF_1_START_PTR register
#define NXMAC_RX_BUF_1_START_PTR_RESET  0x00000000

/**
 * @brief Returns the current value of the RX_BUF_1_START_PTR register.
 * The RX_BUF_1_START_PTR register will be read and its value returned.
 * @return The current value of the RX_BUF_1_START_PTR register.
 */
__INLINE uint32_t nxmac_rx_buf_1_start_ptr_get(void)
{
    return REG_PL_RD(NXMAC_RX_BUF_1_START_PTR_ADDR);
}

/**
 * @brief Sets the RX_BUF_1_START_PTR register to a value.
 * The RX_BUF_1_START_PTR register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_rx_buf_1_start_ptr_set(uint32_t value)
{
    REG_PL_WR(NXMAC_RX_BUF_1_START_PTR_ADDR, value);
}

// field definitions
/// RX_BUF_1_START_PTR field mask
#define NXMAC_RX_BUF_1_START_PTR_MASK   ((uint32_t)0x7FFFFFFF)
/// RX_BUF_1_START_PTR field LSB position
#define NXMAC_RX_BUF_1_START_PTR_LSB    0
/// RX_BUF_1_START_PTR field width
#define NXMAC_RX_BUF_1_START_PTR_WIDTH  ((uint32_t)0x0000001F)

/// RX_BUF_1_START_PTR field reset value
#define NXMAC_RX_BUF_1_START_PTR_RST    0x0

/**
 * @brief Returns the current value of the rxBuf1StartPtr field in the RX_BUF_1_START_PTR register.
 *
 * The RX_BUF_1_START_PTR register will be read and the rxBuf1StartPtr field's value will be returned.
 *
 * @return The current value of the rxBuf1StartPtr field in the RX_BUF_1_START_PTR register.
 */
__INLINE uint32_t nxmac_rx_buf_1_start_ptr_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_BUF_1_START_PTR_ADDR);
    ASSERT_ERR((localVal & ~((uint32_t)0x7FFFFFFF)) == 0);
    return (localVal >> 0);
}

/**
 * @brief Sets the rxBuf1StartPtr field of the RX_BUF_1_START_PTR register.
 *
 * The RX_BUF_1_START_PTR register will be read, modified to contain the new field value, and written.
 *
 * @param[in] rxbuf1startptr - The value to set the field to.
 */
__INLINE void nxmac_rx_buf_1_start_ptr_setf(uint32_t rxbuf1startptr)
{
    ASSERT_ERR((((uint32_t)rxbuf1startptr << 0) & ~((uint32_t)0x7FFFFFFF)) == 0);
    REG_PL_WR(NXMAC_RX_BUF_1_START_PTR_ADDR, (uint32_t)rxbuf1startptr << 0);
}

/// @}

/**
 * @name RX_BUF_1_END_PTR register definitions
 * <table>
 * <caption>RX_BUF_1_END_PTR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 30:00 <td>     rxBuf1EndPtr <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the RX_BUF_1_END_PTR register
#define NXMAC_RX_BUF_1_END_PTR_ADDR   0x24B081CC
/// Offset of the RX_BUF_1_END_PTR register from the base address
#define NXMAC_RX_BUF_1_END_PTR_OFFSET 0x000001CC
/// Index of the RX_BUF_1_END_PTR register
#define NXMAC_RX_BUF_1_END_PTR_INDEX  0x00000073
/// Reset value of the RX_BUF_1_END_PTR register
#define NXMAC_RX_BUF_1_END_PTR_RESET  0x00000000

/**
 * @brief Returns the current value of the RX_BUF_1_END_PTR register.
 * The RX_BUF_1_END_PTR register will be read and its value returned.
 * @return The current value of the RX_BUF_1_END_PTR register.
 */
__INLINE uint32_t nxmac_rx_buf_1_end_ptr_get(void)
{
    return REG_PL_RD(NXMAC_RX_BUF_1_END_PTR_ADDR);
}

/**
 * @brief Sets the RX_BUF_1_END_PTR register to a value.
 * The RX_BUF_1_END_PTR register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_rx_buf_1_end_ptr_set(uint32_t value)
{
    REG_PL_WR(NXMAC_RX_BUF_1_END_PTR_ADDR, value);
}

// field definitions
/// RX_BUF_1_END_PTR field mask
#define NXMAC_RX_BUF_1_END_PTR_MASK   ((uint32_t)0x7FFFFFFF)
/// RX_BUF_1_END_PTR field LSB position
#define NXMAC_RX_BUF_1_END_PTR_LSB    0
/// RX_BUF_1_END_PTR field width
#define NXMAC_RX_BUF_1_END_PTR_WIDTH  ((uint32_t)0x0000001F)

/// RX_BUF_1_END_PTR field reset value
#define NXMAC_RX_BUF_1_END_PTR_RST    0x0

/**
 * @brief Returns the current value of the rxBuf1EndPtr field in the RX_BUF_1_END_PTR register.
 *
 * The RX_BUF_1_END_PTR register will be read and the rxBuf1EndPtr field's value will be returned.
 *
 * @return The current value of the rxBuf1EndPtr field in the RX_BUF_1_END_PTR register.
 */
__INLINE uint32_t nxmac_rx_buf_1_end_ptr_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_BUF_1_END_PTR_ADDR);
    ASSERT_ERR((localVal & ~((uint32_t)0x7FFFFFFF)) == 0);
    return (localVal >> 0);
}

/**
 * @brief Sets the rxBuf1EndPtr field of the RX_BUF_1_END_PTR register.
 *
 * The RX_BUF_1_END_PTR register will be read, modified to contain the new field value, and written.
 *
 * @param[in] rxbuf1endptr - The value to set the field to.
 */
__INLINE void nxmac_rx_buf_1_end_ptr_setf(uint32_t rxbuf1endptr)
{
    ASSERT_ERR((((uint32_t)rxbuf1endptr << 0) & ~((uint32_t)0x7FFFFFFF)) == 0);
    REG_PL_WR(NXMAC_RX_BUF_1_END_PTR_ADDR, (uint32_t)rxbuf1endptr << 0);
}

/// @}

/**
 * @name RX_BUF_1_RD_PTR register definitions
 * <table>
 * <caption>RX_BUF_1_RD_PTR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>     rxBuf1RdPtr <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the RX_BUF_1_RD_PTR register
#define NXMAC_RX_BUF_1_RD_PTR_ADDR   0x24B081D0
/// Offset of the RX_BUF_1_RD_PTR register from the base address
#define NXMAC_RX_BUF_1_RD_PTR_OFFSET 0x000001D0
/// Index of the RX_BUF_1_RD_PTR register
#define NXMAC_RX_BUF_1_RD_PTR_INDEX  0x00000074
/// Reset value of the RX_BUF_1_RD_PTR register
#define NXMAC_RX_BUF_1_RD_PTR_RESET  0x00000000

/**
 * @brief Returns the current value of the RX_BUF_1_RD_PTR register.
 * The RX_BUF_1_RD_PTR register will be read and its value returned.
 * @return The current value of the RX_BUF_1_RD_PTR register.
 */
__INLINE uint32_t nxmac_rx_buf_1_rd_ptr_get(void)
{
    return REG_PL_RD(NXMAC_RX_BUF_1_RD_PTR_ADDR);
}

/**
 * @brief Sets the RX_BUF_1_RD_PTR register to a value.
 * The RX_BUF_1_RD_PTR register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_rx_buf_1_rd_ptr_set(uint32_t value)
{
    REG_PL_WR(NXMAC_RX_BUF_1_RD_PTR_ADDR, value);
}

// field definitions
/// RX_BUF_1_RD_PTR field mask
#define NXMAC_RX_BUF_1_RD_PTR_MASK   ((uint32_t)0xFFFFFFFF)
/// RX_BUF_1_RD_PTR field LSB position
#define NXMAC_RX_BUF_1_RD_PTR_LSB    0
/// RX_BUF_1_RD_PTR field width
#define NXMAC_RX_BUF_1_RD_PTR_WIDTH  ((uint32_t)0x00000020)

/// RX_BUF_1_RD_PTR field reset value
#define NXMAC_RX_BUF_1_RD_PTR_RST    0x0

/**
 * @brief Returns the current value of the rxBuf1RdPtr field in the RX_BUF_1_RD_PTR register.
 *
 * The RX_BUF_1_RD_PTR register will be read and the rxBuf1RdPtr field's value will be returned.
 *
 * @return The current value of the rxBuf1RdPtr field in the RX_BUF_1_RD_PTR register.
 */
__INLINE uint32_t nxmac_rx_buf_1_rd_ptr_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_BUF_1_RD_PTR_ADDR);
    ASSERT_ERR((localVal & ~((uint32_t)0xFFFFFFFF)) == 0);
    return (localVal >> 0);
}

/**
 * @brief Sets the rxBuf1RdPtr field of the RX_BUF_1_RD_PTR register.
 *
 * The RX_BUF_1_RD_PTR register will be read, modified to contain the new field value, and written.
 *
 * @param[in] rxbuf1rdptr - The value to set the field to.
 */
__INLINE void nxmac_rx_buf_1_rd_ptr_setf(uint32_t rxbuf1rdptr)
{
    ASSERT_ERR((((uint32_t)rxbuf1rdptr << 0) & ~((uint32_t)0xFFFFFFFF)) == 0);
    REG_PL_WR(NXMAC_RX_BUF_1_RD_PTR_ADDR, (uint32_t)rxbuf1rdptr << 0);
}

/// @}

/**
 * @name RX_BUF_1_WR_PTR register definitions
 * <table>
 * <caption>RX_BUF_1_WR_PTR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>     rxBuf1WrPtr <td> R/W <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the RX_BUF_1_WR_PTR register
#define NXMAC_RX_BUF_1_WR_PTR_ADDR   0x24B081D4
/// Offset of the RX_BUF_1_WR_PTR register from the base address
#define NXMAC_RX_BUF_1_WR_PTR_OFFSET 0x000001D4
/// Index of the RX_BUF_1_WR_PTR register
#define NXMAC_RX_BUF_1_WR_PTR_INDEX  0x00000075
/// Reset value of the RX_BUF_1_WR_PTR register
#define NXMAC_RX_BUF_1_WR_PTR_RESET  0x00000000

/**
 * @brief Returns the current value of the RX_BUF_1_WR_PTR register.
 * The RX_BUF_1_WR_PTR register will be read and its value returned.
 * @return The current value of the RX_BUF_1_WR_PTR register.
 */
__INLINE uint32_t nxmac_rx_buf_1_wr_ptr_get(void)
{
    return REG_PL_RD(NXMAC_RX_BUF_1_WR_PTR_ADDR);
}

/**
 * @brief Sets the RX_BUF_1_WR_PTR register to a value.
 * The RX_BUF_1_WR_PTR register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_rx_buf_1_wr_ptr_set(uint32_t value)
{
    REG_PL_WR(NXMAC_RX_BUF_1_WR_PTR_ADDR, value);
}

// field definitions
/// RX_BUF_1_WR_PTR field mask
#define NXMAC_RX_BUF_1_WR_PTR_MASK   ((uint32_t)0xFFFFFFFF)
/// RX_BUF_1_WR_PTR field LSB position
#define NXMAC_RX_BUF_1_WR_PTR_LSB    0
/// RX_BUF_1_WR_PTR field width
#define NXMAC_RX_BUF_1_WR_PTR_WIDTH  ((uint32_t)0x00000020)

/// RX_BUF_1_WR_PTR field reset value
#define NXMAC_RX_BUF_1_WR_PTR_RST    0x0

/**
 * @brief Returns the current value of the rxBuf1WrPtr field in the RX_BUF_1_WR_PTR register.
 *
 * The RX_BUF_1_WR_PTR register will be read and the rxBuf1WrPtr field's value will be returned.
 *
 * @return The current value of the rxBuf1WrPtr field in the RX_BUF_1_WR_PTR register.
 */
__INLINE uint32_t nxmac_rx_buf_1_wr_ptr_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_BUF_1_WR_PTR_ADDR);
    ASSERT_ERR((localVal & ~((uint32_t)0xFFFFFFFF)) == 0);
    return (localVal >> 0);
}

/**
 * @brief Sets the rxBuf1WrPtr field of the RX_BUF_1_WR_PTR register.
 *
 * The RX_BUF_1_WR_PTR register will be read, modified to contain the new field value, and written.
 *
 * @param[in] rxbuf1wrptr - The value to set the field to.
 */
__INLINE void nxmac_rx_buf_1_wr_ptr_setf(uint32_t rxbuf1wrptr)
{
    ASSERT_ERR((((uint32_t)rxbuf1wrptr << 0) & ~((uint32_t)0xFFFFFFFF)) == 0);
    REG_PL_WR(NXMAC_RX_BUF_1_WR_PTR_ADDR, (uint32_t)rxbuf1wrptr << 0);
}

/// @}

/**
 * @name RX_BUF_2_START_PTR register definitions
 * <table>
 * <caption>RX_BUF_2_START_PTR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 30:00 <td>     rxBuf2StartPtr <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the RX_BUF_2_START_PTR register
#define NXMAC_RX_BUF_2_START_PTR_ADDR   0x24B081D8
/// Offset of the RX_BUF_2_START_PTR register from the base address
#define NXMAC_RX_BUF_2_START_PTR_OFFSET 0x000001D8
/// Index of the RX_BUF_2_START_PTR register
#define NXMAC_RX_BUF_2_START_PTR_INDEX  0x00000076
/// Reset value of the RX_BUF_2_START_PTR register
#define NXMAC_RX_BUF_2_START_PTR_RESET  0x00000000

/**
 * @brief Returns the current value of the RX_BUF_2_START_PTR register.
 * The RX_BUF_2_START_PTR register will be read and its value returned.
 * @return The current value of the RX_BUF_2_START_PTR register.
 */
__INLINE uint32_t nxmac_rx_buf_2_start_ptr_get(void)
{
    return REG_PL_RD(NXMAC_RX_BUF_2_START_PTR_ADDR);
}

/**
 * @brief Sets the RX_BUF_2_START_PTR register to a value.
 * The RX_BUF_2_START_PTR register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_rx_buf_2_start_ptr_set(uint32_t value)
{
    REG_PL_WR(NXMAC_RX_BUF_2_START_PTR_ADDR, value);
}

// field definitions
/// RX_BUF_2_START_PTR field mask
#define NXMAC_RX_BUF_2_START_PTR_MASK   ((uint32_t)0x7FFFFFFF)
/// RX_BUF_2_START_PTR field LSB position
#define NXMAC_RX_BUF_2_START_PTR_LSB    0
/// RX_BUF_2_START_PTR field width
#define NXMAC_RX_BUF_2_START_PTR_WIDTH  ((uint32_t)0x0000001F)

/// RX_BUF_2_START_PTR field reset value
#define NXMAC_RX_BUF_2_START_PTR_RST    0x0

/**
 * @brief Returns the current value of the rxBuf2StartPtr field in the RX_BUF_2_START_PTR register.
 *
 * The RX_BUF_2_START_PTR register will be read and the rxBuf2StartPtr field's value will be returned.
 *
 * @return The current value of the rxBuf2StartPtr field in the RX_BUF_2_START_PTR register.
 */
__INLINE uint32_t nxmac_rx_buf_2_start_ptr_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_BUF_2_START_PTR_ADDR);
    ASSERT_ERR((localVal & ~((uint32_t)0x7FFFFFFF)) == 0);
    return (localVal >> 0);
}

/**
 * @brief Sets the rxBuf2StartPtr field of the RX_BUF_2_START_PTR register.
 *
 * The RX_BUF_2_START_PTR register will be read, modified to contain the new field value, and written.
 *
 * @param[in] rxbuf2startptr - The value to set the field to.
 */
__INLINE void nxmac_rx_buf_2_start_ptr_setf(uint32_t rxbuf2startptr)
{
    ASSERT_ERR((((uint32_t)rxbuf2startptr << 0) & ~((uint32_t)0x7FFFFFFF)) == 0);
    REG_PL_WR(NXMAC_RX_BUF_2_START_PTR_ADDR, (uint32_t)rxbuf2startptr << 0);
}

/// @}

/**
 * @name RX_BUF_2_END_PTR register definitions
 * <table>
 * <caption>RX_BUF_2_END_PTR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 30:00 <td>     rxBuf2EndPtr <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the RX_BUF_2_END_PTR register
#define NXMAC_RX_BUF_2_END_PTR_ADDR   0x24B081DC
/// Offset of the RX_BUF_2_END_PTR register from the base address
#define NXMAC_RX_BUF_2_END_PTR_OFFSET 0x000001DC
/// Index of the RX_BUF_2_END_PTR register
#define NXMAC_RX_BUF_2_END_PTR_INDEX  0x00000077
/// Reset value of the RX_BUF_2_END_PTR register
#define NXMAC_RX_BUF_2_END_PTR_RESET  0x00000000

/**
 * @brief Returns the current value of the RX_BUF_2_END_PTR register.
 * The RX_BUF_2_END_PTR register will be read and its value returned.
 * @return The current value of the RX_BUF_2_END_PTR register.
 */
__INLINE uint32_t nxmac_rx_buf_2_end_ptr_get(void)
{
    return REG_PL_RD(NXMAC_RX_BUF_2_END_PTR_ADDR);
}

/**
 * @brief Sets the RX_BUF_2_END_PTR register to a value.
 * The RX_BUF_2_END_PTR register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_rx_buf_2_end_ptr_set(uint32_t value)
{
    REG_PL_WR(NXMAC_RX_BUF_2_END_PTR_ADDR, value);
}

// field definitions
/// RX_BUF_2_END_PTR field mask
#define NXMAC_RX_BUF_2_END_PTR_MASK   ((uint32_t)0x7FFFFFFF)
/// RX_BUF_2_END_PTR field LSB position
#define NXMAC_RX_BUF_2_END_PTR_LSB    0
/// RX_BUF_2_END_PTR field width
#define NXMAC_RX_BUF_2_END_PTR_WIDTH  ((uint32_t)0x0000001F)

/// RX_BUF_2_END_PTR field reset value
#define NXMAC_RX_BUF_2_END_PTR_RST    0x0

/**
 * @brief Returns the current value of the rxBuf2EndPtr field in the RX_BUF_2_END_PTR register.
 *
 * The RX_BUF_2_END_PTR register will be read and the rxBuf2EndPtr field's value will be returned.
 *
 * @return The current value of the rxBuf2EndPtr field in the RX_BUF_2_END_PTR register.
 */
__INLINE uint32_t nxmac_rx_buf_2_end_ptr_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_BUF_2_END_PTR_ADDR);
    ASSERT_ERR((localVal & ~((uint32_t)0x7FFFFFFF)) == 0);
    return (localVal >> 0);
}

/**
 * @brief Sets the rxBuf2EndPtr field of the RX_BUF_2_END_PTR register.
 *
 * The RX_BUF_2_END_PTR register will be read, modified to contain the new field value, and written.
 *
 * @param[in] rxbuf2endptr - The value to set the field to.
 */
__INLINE void nxmac_rx_buf_2_end_ptr_setf(uint32_t rxbuf2endptr)
{
    ASSERT_ERR((((uint32_t)rxbuf2endptr << 0) & ~((uint32_t)0x7FFFFFFF)) == 0);
    REG_PL_WR(NXMAC_RX_BUF_2_END_PTR_ADDR, (uint32_t)rxbuf2endptr << 0);
}

/// @}

/**
 * @name RX_BUF_2_RD_PTR register definitions
 * <table>
 * <caption>RX_BUF_2_RD_PTR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>     rxBuf2RdPtr <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the RX_BUF_2_RD_PTR register
#define NXMAC_RX_BUF_2_RD_PTR_ADDR   0x24B081E0
/// Offset of the RX_BUF_2_RD_PTR register from the base address
#define NXMAC_RX_BUF_2_RD_PTR_OFFSET 0x000001E0
/// Index of the RX_BUF_2_RD_PTR register
#define NXMAC_RX_BUF_2_RD_PTR_INDEX  0x00000078
/// Reset value of the RX_BUF_2_RD_PTR register
#define NXMAC_RX_BUF_2_RD_PTR_RESET  0x00000000

/**
 * @brief Returns the current value of the RX_BUF_2_RD_PTR register.
 * The RX_BUF_2_RD_PTR register will be read and its value returned.
 * @return The current value of the RX_BUF_2_RD_PTR register.
 */
__INLINE uint32_t nxmac_rx_buf_2_rd_ptr_get(void)
{
    return REG_PL_RD(NXMAC_RX_BUF_2_RD_PTR_ADDR);
}

/**
 * @brief Sets the RX_BUF_2_RD_PTR register to a value.
 * The RX_BUF_2_RD_PTR register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_rx_buf_2_rd_ptr_set(uint32_t value)
{
    REG_PL_WR(NXMAC_RX_BUF_2_RD_PTR_ADDR, value);
}

// field definitions
/// RX_BUF_2_RD_PTR field mask
#define NXMAC_RX_BUF_2_RD_PTR_MASK   ((uint32_t)0xFFFFFFFF)
/// RX_BUF_2_RD_PTR field LSB position
#define NXMAC_RX_BUF_2_RD_PTR_LSB    0
/// RX_BUF_2_RD_PTR field width
#define NXMAC_RX_BUF_2_RD_PTR_WIDTH  ((uint32_t)0x00000020)

/// RX_BUF_2_RD_PTR field reset value
#define NXMAC_RX_BUF_2_RD_PTR_RST    0x0

/**
 * @brief Returns the current value of the rxBuf2RdPtr field in the RX_BUF_2_RD_PTR register.
 *
 * The RX_BUF_2_RD_PTR register will be read and the rxBuf2RdPtr field's value will be returned.
 *
 * @return The current value of the rxBuf2RdPtr field in the RX_BUF_2_RD_PTR register.
 */
__INLINE uint32_t nxmac_rx_buf_2_rd_ptr_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_BUF_2_RD_PTR_ADDR);
    ASSERT_ERR((localVal & ~((uint32_t)0xFFFFFFFF)) == 0);
    return (localVal >> 0);
}

/**
 * @brief Sets the rxBuf2RdPtr field of the RX_BUF_2_RD_PTR register.
 *
 * The RX_BUF_2_RD_PTR register will be read, modified to contain the new field value, and written.
 *
 * @param[in] rxbuf2rdptr - The value to set the field to.
 */
__INLINE void nxmac_rx_buf_2_rd_ptr_setf(uint32_t rxbuf2rdptr)
{
    ASSERT_ERR((((uint32_t)rxbuf2rdptr << 0) & ~((uint32_t)0xFFFFFFFF)) == 0);
    REG_PL_WR(NXMAC_RX_BUF_2_RD_PTR_ADDR, (uint32_t)rxbuf2rdptr << 0);
}

/// @}

/**
 * @name RX_BUF_2_WR_PTR register definitions
 * <table>
 * <caption>RX_BUF_2_WR_PTR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>     rxBuf2WrPtr <td> R/W <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the RX_BUF_2_WR_PTR register
#define NXMAC_RX_BUF_2_WR_PTR_ADDR   0x24B081E4
/// Offset of the RX_BUF_2_WR_PTR register from the base address
#define NXMAC_RX_BUF_2_WR_PTR_OFFSET 0x000001E4
/// Index of the RX_BUF_2_WR_PTR register
#define NXMAC_RX_BUF_2_WR_PTR_INDEX  0x00000079
/// Reset value of the RX_BUF_2_WR_PTR register
#define NXMAC_RX_BUF_2_WR_PTR_RESET  0x00000000

/**
 * @brief Returns the current value of the RX_BUF_2_WR_PTR register.
 * The RX_BUF_2_WR_PTR register will be read and its value returned.
 * @return The current value of the RX_BUF_2_WR_PTR register.
 */
__INLINE uint32_t nxmac_rx_buf_2_wr_ptr_get(void)
{
    return REG_PL_RD(NXMAC_RX_BUF_2_WR_PTR_ADDR);
}

/**
 * @brief Sets the RX_BUF_2_WR_PTR register to a value.
 * The RX_BUF_2_WR_PTR register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_rx_buf_2_wr_ptr_set(uint32_t value)
{
    REG_PL_WR(NXMAC_RX_BUF_2_WR_PTR_ADDR, value);
}

// field definitions
/// RX_BUF_2_WR_PTR field mask
#define NXMAC_RX_BUF_2_WR_PTR_MASK   ((uint32_t)0xFFFFFFFF)
/// RX_BUF_2_WR_PTR field LSB position
#define NXMAC_RX_BUF_2_WR_PTR_LSB    0
/// RX_BUF_2_WR_PTR field width
#define NXMAC_RX_BUF_2_WR_PTR_WIDTH  ((uint32_t)0x00000020)

/// RX_BUF_2_WR_PTR field reset value
#define NXMAC_RX_BUF_2_WR_PTR_RST    0x0

/**
 * @brief Returns the current value of the rxBuf2WrPtr field in the RX_BUF_2_WR_PTR register.
 *
 * The RX_BUF_2_WR_PTR register will be read and the rxBuf2WrPtr field's value will be returned.
 *
 * @return The current value of the rxBuf2WrPtr field in the RX_BUF_2_WR_PTR register.
 */
__INLINE uint32_t nxmac_rx_buf_2_wr_ptr_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_BUF_2_WR_PTR_ADDR);
    ASSERT_ERR((localVal & ~((uint32_t)0xFFFFFFFF)) == 0);
    return (localVal >> 0);
}

/**
 * @brief Sets the rxBuf2WrPtr field of the RX_BUF_2_WR_PTR register.
 *
 * The RX_BUF_2_WR_PTR register will be read, modified to contain the new field value, and written.
 *
 * @param[in] rxbuf2wrptr - The value to set the field to.
 */
__INLINE void nxmac_rx_buf_2_wr_ptr_setf(uint32_t rxbuf2wrptr)
{
    ASSERT_ERR((((uint32_t)rxbuf2wrptr << 0) & ~((uint32_t)0xFFFFFFFF)) == 0);
    REG_PL_WR(NXMAC_RX_BUF_2_WR_PTR_ADDR, (uint32_t)rxbuf2wrptr << 0);
}

/// @}

/**
 * @name RX_BUF_CONFIG register definitions
 * <table>
 * <caption>RX_BUF_CONFIG bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:24 <td>    rxBufRPDFooter <td> R <td> R/W <td> 0x0
 * <tr><td> 23:16 <td>    rxBufRPDHeader <td> R <td> R/W <td> 0x0
 * <tr><td> 15:08 <td>    rxBufRHDFooter <td> R <td> R/W <td> 0x0
 * <tr><td> 07:00 <td>    rxBufRHDHeader <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the RX_BUF_CONFIG register
#define NXMAC_RX_BUF_CONFIG_ADDR   0x24B081E8
/// Offset of the RX_BUF_CONFIG register from the base address
#define NXMAC_RX_BUF_CONFIG_OFFSET 0x000001E8
/// Index of the RX_BUF_CONFIG register
#define NXMAC_RX_BUF_CONFIG_INDEX  0x0000007A
/// Reset value of the RX_BUF_CONFIG register
#define NXMAC_RX_BUF_CONFIG_RESET  0x00000000

/**
 * @brief Returns the current value of the RX_BUF_CONFIG register.
 * The RX_BUF_CONFIG register will be read and its value returned.
 * @return The current value of the RX_BUF_CONFIG register.
 */
__INLINE uint32_t nxmac_rx_buf_config_get(void)
{
    return REG_PL_RD(NXMAC_RX_BUF_CONFIG_ADDR);
}

/**
 * @brief Sets the RX_BUF_CONFIG register to a value.
 * The RX_BUF_CONFIG register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_rx_buf_config_set(uint32_t value)
{
    REG_PL_WR(NXMAC_RX_BUF_CONFIG_ADDR, value);
}

// field definitions
/// RX_BUF_RPD_FOOTER field mask
#define NXMAC_RX_BUF_RPD_FOOTER_MASK   ((uint32_t)0xFF000000)
/// RX_BUF_RPD_FOOTER field LSB position
#define NXMAC_RX_BUF_RPD_FOOTER_LSB    24
/// RX_BUF_RPD_FOOTER field width
#define NXMAC_RX_BUF_RPD_FOOTER_WIDTH  ((uint32_t)0x00000008)
/// RX_BUF_RPD_HEADER field mask
#define NXMAC_RX_BUF_RPD_HEADER_MASK   ((uint32_t)0x00FF0000)
/// RX_BUF_RPD_HEADER field LSB position
#define NXMAC_RX_BUF_RPD_HEADER_LSB    16
/// RX_BUF_RPD_HEADER field width
#define NXMAC_RX_BUF_RPD_HEADER_WIDTH  ((uint32_t)0x00000008)
/// RX_BUF_RHD_FOOTER field mask
#define NXMAC_RX_BUF_RHD_FOOTER_MASK   ((uint32_t)0x0000FF00)
/// RX_BUF_RHD_FOOTER field LSB position
#define NXMAC_RX_BUF_RHD_FOOTER_LSB    8
/// RX_BUF_RHD_FOOTER field width
#define NXMAC_RX_BUF_RHD_FOOTER_WIDTH  ((uint32_t)0x00000008)
/// RX_BUF_RHD_HEADER field mask
#define NXMAC_RX_BUF_RHD_HEADER_MASK   ((uint32_t)0x000000FF)
/// RX_BUF_RHD_HEADER field LSB position
#define NXMAC_RX_BUF_RHD_HEADER_LSB    0
/// RX_BUF_RHD_HEADER field width
#define NXMAC_RX_BUF_RHD_HEADER_WIDTH  ((uint32_t)0x00000008)

/// RX_BUF_RPD_FOOTER field reset value
#define NXMAC_RX_BUF_RPD_FOOTER_RST    0x0
/// RX_BUF_RPD_HEADER field reset value
#define NXMAC_RX_BUF_RPD_HEADER_RST    0x0
/// RX_BUF_RHD_FOOTER field reset value
#define NXMAC_RX_BUF_RHD_FOOTER_RST    0x0
/// RX_BUF_RHD_HEADER field reset value
#define NXMAC_RX_BUF_RHD_HEADER_RST    0x0

/**
 * @brief Constructs a value for the RX_BUF_CONFIG register given values for its fields
 * and writes the value to the register.
 *
 * @param[in] rxbufrpdfooter - The value to use for the rxBufRPDFooter field.
 * @param[in] rxbufrpdheader - The value to use for the rxBufRPDHeader field.
 * @param[in] rxbufrhdfooter - The value to use for the rxBufRHDFooter field.
 * @param[in] rxbufrhdheader - The value to use for the rxBufRHDHeader field.
 */
__INLINE void nxmac_rx_buf_config_pack(uint8_t rxbufrpdfooter, uint8_t rxbufrpdheader, uint8_t rxbufrhdfooter, uint8_t rxbufrhdheader)
{
    ASSERT_ERR((((uint32_t)rxbufrpdfooter << 24) & ~((uint32_t)0xFF000000)) == 0);
    ASSERT_ERR((((uint32_t)rxbufrpdheader << 16) & ~((uint32_t)0x00FF0000)) == 0);
    ASSERT_ERR((((uint32_t)rxbufrhdfooter << 8) & ~((uint32_t)0x0000FF00)) == 0);
    ASSERT_ERR((((uint32_t)rxbufrhdheader << 0) & ~((uint32_t)0x000000FF)) == 0);
    REG_PL_WR(NXMAC_RX_BUF_CONFIG_ADDR,  ((uint32_t)rxbufrpdfooter << 24) | ((uint32_t)rxbufrpdheader << 16) | ((uint32_t)rxbufrhdfooter << 8) | ((uint32_t)rxbufrhdheader << 0));
}

/**
 * @brief Unpacks RX_BUF_CONFIG's fields from current value of the RX_BUF_CONFIG register.
 *
 * Reads the RX_BUF_CONFIG register and populates all the _field variables with the corresponding
 * values from the register.
 *
 * @param[out] rxbufrpdfooter - Will be populated with the current value of this field from the register.
 * @param[out] rxbufrpdheader - Will be populated with the current value of this field from the register.
 * @param[out] rxbufrhdfooter - Will be populated with the current value of this field from the register.
 * @param[out] rxbufrhdheader - Will be populated with the current value of this field from the register.
 */
__INLINE void nxmac_rx_buf_config_unpack(uint8_t* rxbufrpdfooter, uint8_t* rxbufrpdheader, uint8_t* rxbufrhdfooter, uint8_t* rxbufrhdheader)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_BUF_CONFIG_ADDR);

    *rxbufrpdfooter = (localVal & ((uint32_t)0xFF000000)) >> 24;
    *rxbufrpdheader = (localVal & ((uint32_t)0x00FF0000)) >> 16;
    *rxbufrhdfooter = (localVal & ((uint32_t)0x0000FF00)) >> 8;
    *rxbufrhdheader = (localVal & ((uint32_t)0x000000FF)) >> 0;
}

/**
 * @brief Returns the current value of the rxBufRPDFooter field in the RX_BUF_CONFIG register.
 *
 * The RX_BUF_CONFIG register will be read and the rxBufRPDFooter field's value will be returned.
 *
 * @return The current value of the rxBufRPDFooter field in the RX_BUF_CONFIG register.
 */
__INLINE uint8_t nxmac_rx_buf_rpd_footer_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_BUF_CONFIG_ADDR);
...
/**
 * @brief Sets the rxBufRPDFooter field of the RX_BUF_CONFIG register.
 *
 * The RX_BUF_CONFIG register will be read, modified to contain the new field value, and written.
 *
 * @param[in] rxbufrpdfooter - The value to set the field to.
 */
__INLINE void nxmac_rx_buf_rpd_footer_setf(uint8_t rxbufrpdfooter)
{
    ASSERT_ERR((((uint32_t)rxbufrpdfooter << 24) & ~((uint32_t)0xFF000000)) == 0);
    REG_PL_WR(NXMAC_RX_BUF_CONFIG_ADDR, (REG_PL_RD(NXMAC_RX_BUF_CONFIG_ADDR) & ~((uint32_t)0xFF000000)) | ((uint32_t)rxbufrpdfooter << 24));
}

/**
 * @brief Returns the current value of the rxBufRPDHeader field in the RX_BUF_CONFIG register.
 *
 * The RX_BUF_CONFIG register will be read and the rxBufRPDHeader field's value will be returned.
 *
 * @return The current value of the rxBufRPDHeader field in the RX_BUF_CONFIG register.
 */
__INLINE uint8_t nxmac_rx_buf_rpd_header_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_BUF_CONFIG_ADDR);
    return ((localVal & ((uint32_t)0x00FF0000)) >> 16);
}
...
/**
 * @brief Sets the rxBufRPDHeader field of the RX_BUF_CONFIG register.
 *
 * The RX_BUF_CONFIG register will be read, modified to contain the new field value, and written.
 *
 * @param[in] rxbufrpdheader - The value to set the field to.
 */
__INLINE void nxmac_rx_buf_rpd_header_setf(uint8_t rxbufrpdheader)
{
    ASSERT_ERR((((uint32_t)rxbufrpdheader << 16) & ~((uint32_t)0x00FF0000)) == 0);
    REG_PL_WR(NXMAC_RX_BUF_CONFIG_ADDR, (REG_PL_RD(NXMAC_RX_BUF_CONFIG_ADDR) & ~((uint32_t)0x00FF0000)) | ((uint32_t)rxbufrpdheader << 16));
}

/**
 * @brief Returns the current value of the rxBufRHDFooter field in the RX_BUF_CONFIG register.
 *
 * The RX_BUF_CONFIG register will be read and the rxBufRHDFooter field's value will be returned.
 *
 * @return The current value of the rxBufRHDFooter field in the RX_BUF_CONFIG register.
 */
__INLINE uint8_t nxmac_rx_buf_rhd_footer_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_BUF_CONFIG_ADDR);
...
/**
 * @brief Sets the rxBufRHDFooter field of the RX_BUF_CONFIG register.
 *
 * The RX_BUF_CONFIG register will be read, modified to contain the new field value, and written.
 *
 * @param[in] rxbufrhdfooter - The value to set the field to.
 */
__INLINE void nxmac_rx_buf_rhd_footer_setf(uint8_t rxbufrhdfooter)
{
    ASSERT_ERR((((uint32_t)rxbufrhdfooter << 8) & ~((uint32_t)0x0000FF00)) == 0);
    REG_PL_WR(NXMAC_RX_BUF_CONFIG_ADDR, (REG_PL_RD(NXMAC_RX_BUF_CONFIG_ADDR) & ~((uint32_t)0x0000FF00)) | ((uint32_t)rxbufrhdfooter << 8));
}

/**
 * @brief Returns the current value of the rxBufRHDHeader field in the RX_BUF_CONFIG register.
 *
 * The RX_BUF_CONFIG register will be read and the rxBufRHDHeader field's value will be returned.
 *
 * @return The current value of the rxBufRHDHeader field in the RX_BUF_CONFIG register.
 */
__INLINE uint8_t nxmac_rx_buf_rhd_header_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_BUF_CONFIG_ADDR);
    return ((localVal & ((uint32_t)0x000000FF)) >> 0);
}
...
/**
 * @brief Sets the rxBufRHDHeader field of the RX_BUF_CONFIG register.
 *
 * The RX_BUF_CONFIG register will be read, modified to contain the new field value, and written.
 *
 * @param[in] rxbufrhdheader - The value to set the field to.
 */
__INLINE void nxmac_rx_buf_rhd_header_setf(uint8_t rxbufrhdheader)
{
    ASSERT_ERR((((uint32_t)rxbufrhdheader << 0) & ~((uint32_t)0x000000FF)) == 0);
    REG_PL_WR(NXMAC_RX_BUF_CONFIG_ADDR, (REG_PL_RD(NXMAC_RX_BUF_CONFIG_ADDR) & ~((uint32_t)0x000000FF)) | ((uint32_t)rxbufrhdheader << 0));
}
 ...
 * <table>
 * <caption>MOT_1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:16 <td>  ac1MOT <td> W <td> R <td> 0x0
 * <tr><td> 15:00 <td>  ac0MOT <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_MOT_1_ADDR   0x24B08228
 ...
 * <table>
 * <caption>MOT_2 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:16 <td>  ac3MOT <td> W <td> R <td> 0x2F
 * <tr><td> 15:00 <td>  ac2MOT <td> W <td> R <td> 0x5E
 * </table>
 *
 * @{
 */
...
#define NXMAC_MOT_2_ADDR   0x24B0822C
 ...
 * <table>
 * <caption>TX_BW_DROP_INFO bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 01:00 <td>    txBWAfterDrop <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_TX_BW_DROP_INFO_ADDR   0x24B08330
...
/**
 * @name TX_HETB_INFO register definitions
 * <table>
 * <caption>TX_HETB_INFO bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:28 <td>    maxMCSInHETB <td> R <td> R/W <td> 0x7
 * <tr><td> 26:24 <td>            eOCW <td> R/W <td> R/W <td> 0x3
 * <tr><td> 22:20 <td>         eOCWMin <td> R <td> R/W <td> 0x3
 * <tr><td> 17    <td>        raRUType <td> R <td> R/W <td> 0
 * <tr><td> 16    <td>      raRUEnable <td> R <td> R/W <td> 0
 * <tr><td> 13:08 <td>    txHETBMaxDur <td> R <td> R/W <td> 0x1C
 * <tr><td> 05:00 <td>    txHETBRemDur <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the TX_HETB_INFO register
#define NXMAC_TX_HETB_INFO_ADDR   0x24B08354
/// Offset of the TX_HETB_INFO register from the base address
#define NXMAC_TX_HETB_INFO_OFFSET 0x00000354
/// Index of the TX_HETB_INFO register
#define NXMAC_TX_HETB_INFO_INDEX  0x000000D5
/// Reset value of the TX_HETB_INFO register
#define NXMAC_TX_HETB_INFO_RESET  0x73301C00

/**
 * @brief Returns the current value of the TX_HETB_INFO register.
 * The TX_HETB_INFO register will be read and its value returned.
 * @return The current value of the TX_HETB_INFO register.
 */
__INLINE uint32_t nxmac_tx_hetb_info_get(void)
{
    return REG_PL_RD(NXMAC_TX_HETB_INFO_ADDR);
}

/**
 * @brief Sets the TX_HETB_INFO register to a value.
 * The TX_HETB_INFO register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_tx_hetb_info_set(uint32_t value)
{
    REG_PL_WR(NXMAC_TX_HETB_INFO_ADDR, value);
}

// field definitions
/// MAX_MCS_IN_HETB field mask
#define NXMAC_MAX_MCS_IN_HETB_MASK   ((uint32_t)0xF0000000)
/// MAX_MCS_IN_HETB field LSB position
#define NXMAC_MAX_MCS_IN_HETB_LSB    28
/// MAX_MCS_IN_HETB field width
#define NXMAC_MAX_MCS_IN_HETB_WIDTH  ((uint32_t)0x00000004)
/// E_OCW field mask
#define NXMAC_E_OCW_MASK             ((uint32_t)0x07000000)
/// E_OCW field LSB position
#define NXMAC_E_OCW_LSB              24
/// E_OCW field width
#define NXMAC_E_OCW_WIDTH            ((uint32_t)0x00000003)
/// E_OCW_MIN field mask
#define NXMAC_E_OCW_MIN_MASK         ((uint32_t)0x00700000)
/// E_OCW_MIN field LSB position
#define NXMAC_E_OCW_MIN_LSB          20
/// E_OCW_MIN field width
#define NXMAC_E_OCW_MIN_WIDTH        ((uint32_t)0x00000003)
/// RA_RU_TYPE field bit
#define NXMAC_RA_RU_TYPE_BIT         ((uint32_t)0x00020000)
/// RA_RU_TYPE field position
#define NXMAC_RA_RU_TYPE_POS         17
/// RA_RU_ENABLE field bit
#define NXMAC_RA_RU_ENABLE_BIT       ((uint32_t)0x00010000)
/// RA_RU_ENABLE field position
#define NXMAC_RA_RU_ENABLE_POS       16
/// TX_HETB_MAX_DUR field mask
#define NXMAC_TX_HETB_MAX_DUR_MASK   ((uint32_t)0x00003F00)
/// TX_HETB_MAX_DUR field LSB position
#define NXMAC_TX_HETB_MAX_DUR_LSB    8
/// TX_HETB_MAX_DUR field width
#define NXMAC_TX_HETB_MAX_DUR_WIDTH  ((uint32_t)0x00000006)
/// TX_HETB_REM_DUR field mask
#define NXMAC_TX_HETB_REM_DUR_MASK   ((uint32_t)0x0000003F)
/// TX_HETB_REM_DUR field LSB position
#define NXMAC_TX_HETB_REM_DUR_LSB    0
/// TX_HETB_REM_DUR field width
#define NXMAC_TX_HETB_REM_DUR_WIDTH  ((uint32_t)0x00000006)

/// MAX_MCS_IN_HETB field reset value
#define NXMAC_MAX_MCS_IN_HETB_RST    0x7
/// E_OCW field reset value
#define NXMAC_E_OCW_RST              0x3
/// E_OCW_MIN field reset value
#define NXMAC_E_OCW_MIN_RST          0x3
/// RA_RU_TYPE field reset value
#define NXMAC_RA_RU_TYPE_RST         0x0
/// RA_RU_ENABLE field reset value
#define NXMAC_RA_RU_ENABLE_RST       0x0
/// TX_HETB_MAX_DUR field reset value
#define NXMAC_TX_HETB_MAX_DUR_RST    0x1C
/// TX_HETB_REM_DUR field reset value
#define NXMAC_TX_HETB_REM_DUR_RST    0x0

/**
 * @brief Constructs a value for the TX_HETB_INFO register given values for its fields
 * and writes the value to the register.
 *
 * @param[in] maxmcsinhetb - The value to use for the maxMCSInHETB field.
 * @param[in] eocw - The value to use for the eOCW field.
 * @param[in] eocwmin - The value to use for the eOCWMin field.
 * @param[in] rarutype - The value to use for the raRUType field.
 * @param[in] raruenable - The value to use for the raRUEnable field.
 * @param[in] txhetbmaxdur - The value to use for the txHETBMaxDur field.
 */
__INLINE void nxmac_tx_hetb_info_pack(uint8_t maxmcsinhetb, uint8_t eocw, uint8_t eocwmin, uint8_t rarutype, uint8_t raruenable, uint8_t txhetbmaxdur)
{
    ASSERT_ERR((((uint32_t)maxmcsinhetb << 28) & ~((uint32_t)0xF0000000)) == 0);
    ASSERT_ERR((((uint32_t)eocw << 24) & ~((uint32_t)0x07000000)) == 0);
    ASSERT_ERR((((uint32_t)eocwmin << 20) & ~((uint32_t)0x00700000)) == 0);
    ASSERT_ERR((((uint32_t)rarutype << 17) & ~((uint32_t)0x00020000)) == 0);
    ASSERT_ERR((((uint32_t)raruenable << 16) & ~((uint32_t)0x00010000)) == 0);
    ASSERT_ERR((((uint32_t)txhetbmaxdur << 8) & ~((uint32_t)0x00003F00)) == 0);
    REG_PL_WR(NXMAC_TX_HETB_INFO_ADDR,  ((uint32_t)maxmcsinhetb << 28) | ((uint32_t)eocw << 24) | ((uint32_t)eocwmin << 20) | ((uint32_t)rarutype << 17) | ((uint32_t)raruenable << 16) | ((uint32_t)txhetbmaxdur << 8));
}

/**
 * @brief Unpacks TX_HETB_INFO's fields from current value of the TX_HETB_INFO register.
 *
 * Reads the TX_HETB_INFO register and populates all the _field variables with the corresponding
 * values from the register.
 *
 * @param[out] maxmcsinhetb - Will be populated with the current value of this field from the register.
 * @param[out] eocw - Will be populated with the current value of this field from the register.
 * @param[out] eocwmin - Will be populated with the current value of this field from the register.
 * @param[out] rarutype - Will be populated with the current value of this field from the register.
 * @param[out] raruenable - Will be populated with the current value of this field from the register.
 * @param[out] txhetbmaxdur - Will be populated with the current value of this field from the register.
 * @param[out] txhetbremdur - Will be populated with the current value of this field from the register.
 */
__INLINE void nxmac_tx_hetb_info_unpack(uint8_t* maxmcsinhetb, uint8_t* eocw, uint8_t* eocwmin, uint8_t* rarutype, uint8_t* raruenable, uint8_t* txhetbmaxdur, uint8_t* txhetbremdur)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TX_HETB_INFO_ADDR);

    *maxmcsinhetb = (localVal & ((uint32_t)0xF0000000)) >> 28;
    *eocw = (localVal & ((uint32_t)0x07000000)) >> 24;
    *eocwmin = (localVal & ((uint32_t)0x00700000)) >> 20;
    *rarutype = (localVal & ((uint32_t)0x00020000)) >> 17;
    *raruenable = (localVal & ((uint32_t)0x00010000)) >> 16;
    *txhetbmaxdur = (localVal & ((uint32_t)0x00003F00)) >> 8;
    *txhetbremdur = (localVal & ((uint32_t)0x0000003F)) >> 0;
}

/**
 * @brief Returns the current value of the maxMCSInHETB field in the TX_HETB_INFO register.
 *
 * The TX_HETB_INFO register will be read and the maxMCSInHETB field's value will be returned.
 *
 * @return The current value of the maxMCSInHETB field in the TX_HETB_INFO register.
 */
__INLINE uint8_t nxmac_max_mcs_in_hetb_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TX_HETB_INFO_ADDR);
...
/**
 * @brief Sets the maxMCSInHETB field of the TX_HETB_INFO register.
 *
 * The TX_HETB_INFO register will be read, modified to contain the new field value, and written.
 *
 * @param[in] maxmcsinhetb - The value to set the field to.
 */
__INLINE void nxmac_max_mcs_in_hetb_setf(uint8_t maxmcsinhetb)
{
    ASSERT_ERR((((uint32_t)maxmcsinhetb << 28) & ~((uint32_t)0xF0000000)) == 0);
    REG_PL_WR(NXMAC_TX_HETB_INFO_ADDR, (REG_PL_RD(NXMAC_TX_HETB_INFO_ADDR) & ~((uint32_t)0xF0000000)) | ((uint32_t)maxmcsinhetb << 28));
}

/**
 * @brief Returns the current value of the eOCW field in the TX_HETB_INFO register.
 *
 * The TX_HETB_INFO register will be read and the eOCW field's value will be returned.
 *
 * @return The current value of the eOCW field in the TX_HETB_INFO register.
 */
__INLINE uint8_t nxmac_e_ocw_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TX_HETB_INFO_ADDR);
...
/**
 * @brief Sets the eOCW field of the TX_HETB_INFO register.
 *
 * The TX_HETB_INFO register will be read, modified to contain the new field value, and written.
 *
 * @param[in] eocw - The value to set the field to.
 */
__INLINE void nxmac_e_ocw_setf(uint8_t eocw)
{
    ASSERT_ERR((((uint32_t)eocw << 24) & ~((uint32_t)0x07000000)) == 0);
    REG_PL_WR(NXMAC_TX_HETB_INFO_ADDR, (REG_PL_RD(NXMAC_TX_HETB_INFO_ADDR) & ~((uint32_t)0x07000000)) | ((uint32_t)eocw << 24));
}

/**
 * @brief Returns the current value of the eOCWMin field in the TX_HETB_INFO register.
 *
 * The TX_HETB_INFO register will be read and the eOCWMin field's value will be returned.
 *
 * @return The current value of the eOCWMin field in the TX_HETB_INFO register.
 */
__INLINE uint8_t nxmac_e_ocw_min_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TX_HETB_INFO_ADDR);
...
/**
 * @brief Sets the eOCWMin field of the TX_HETB_INFO register.
 *
 * The TX_HETB_INFO register will be read, modified to contain the new field value, and written.
 *
 * @param[in] eocwmin - The value to set the field to.
 */
__INLINE void nxmac_e_ocw_min_setf(uint8_t eocwmin)
{
    ASSERT_ERR((((uint32_t)eocwmin << 20) & ~((uint32_t)0x00700000)) == 0);
    REG_PL_WR(NXMAC_TX_HETB_INFO_ADDR, (REG_PL_RD(NXMAC_TX_HETB_INFO_ADDR) & ~((uint32_t)0x00700000)) | ((uint32_t)eocwmin << 20));
}

/**
 * @brief Returns the current value of the raRUType field in the TX_HETB_INFO register.
 *
 * The TX_HETB_INFO register will be read and the raRUType field's value will be returned.
 *
 * @return The current value of the raRUType field in the TX_HETB_INFO register.
 */
__INLINE uint8_t nxmac_ra_ru_type_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TX_HETB_INFO_ADDR);
    return ((localVal & ((uint32_t)0x00020000)) >> 17);
}
...
/**
 * @brief Sets the raRUType field of the TX_HETB_INFO register.
 *
 * The TX_HETB_INFO register will be read, modified to contain the new field value, and written.
 *
 * @param[in] rarutype - The value to set the field to.
 */
__INLINE void nxmac_ra_ru_type_setf(uint8_t rarutype)
{
    ASSERT_ERR((((uint32_t)rarutype << 17) & ~((uint32_t)0x00020000)) == 0);
    REG_PL_WR(NXMAC_TX_HETB_INFO_ADDR, (REG_PL_RD(NXMAC_TX_HETB_INFO_ADDR) & ~((uint32_t)0x00020000)) | ((uint32_t)rarutype << 17));
}

/**
 * @brief Returns the current value of the raRUEnable field in the TX_HETB_INFO register.
 *
 * The TX_HETB_INFO register will be read and the raRUEnable field's value will be returned.
 *
 * @return The current value of the raRUEnable field in the TX_HETB_INFO register.
 */
__INLINE uint8_t nxmac_ra_ru_enable_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TX_HETB_INFO_ADDR);
    return ((localVal & ((uint32_t)0x00010000)) >> 16);
}
...
/**
 * @brief Sets the raRUEnable field of the TX_HETB_INFO register.
 *
 * The TX_HETB_INFO register will be read, modified to contain the new field value, and written.
 *
 * @param[in] raruenable - The value to set the field to.
 */
__INLINE void nxmac_ra_ru_enable_setf(uint8_t raruenable)
{
    ASSERT_ERR((((uint32_t)raruenable << 16) & ~((uint32_t)0x00010000)) == 0);
    REG_PL_WR(NXMAC_TX_HETB_INFO_ADDR, (REG_PL_RD(NXMAC_TX_HETB_INFO_ADDR) & ~((uint32_t)0x00010000)) | ((uint32_t)raruenable << 16));
}

/**
 * @brief Returns the current value of the txHETBMaxDur field in the TX_HETB_INFO register.
 *
 * The TX_HETB_INFO register will be read and the txHETBMaxDur field's value will be returned.
 *
 * @return The current value of the txHETBMaxDur field in the TX_HETB_INFO register.
 */
__INLINE uint8_t nxmac_tx_hetb_max_dur_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TX_HETB_INFO_ADDR);
...
/**
 * @brief Sets the txHETBMaxDur field of the TX_HETB_INFO register.
 *
 * The TX_HETB_INFO register will be read, modified to contain the new field value, and written.
 *
 * @param[in] txhetbmaxdur - The value to set the field to.
 */
__INLINE void nxmac_tx_hetb_max_dur_setf(uint8_t txhetbmaxdur)
{
    ASSERT_ERR((((uint32_t)txhetbmaxdur << 8) & ~((uint32_t)0x00003F00)) == 0);
    REG_PL_WR(NXMAC_TX_HETB_INFO_ADDR, (REG_PL_RD(NXMAC_TX_HETB_INFO_ADDR) & ~((uint32_t)0x00003F00)) | ((uint32_t)txhetbmaxdur << 8));
}

/**
 * @brief Returns the current value of the txHETBRemDur field in the TX_HETB_INFO register.
 *
 * The TX_HETB_INFO register will be read and the txHETBRemDur field's value will be returned.
 *
 * @return The current value of the txHETBRemDur field in the TX_HETB_INFO register.
 */
__INLINE uint8_t nxmac_tx_hetb_rem_dur_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_TX_HETB_INFO_ADDR);
    return ((localVal & ((uint32_t)0x0000003F)) >> 0);
}
...
/**
 * @name RX_HE_TRIG_COMMON_INFO register definitions
 * <table>
 * <caption>RX_HE_TRIG_COMMON_INFO bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 29    <td>            ulDoppler <td> W <td> R <td> 0
 * <tr><td> 28    <td>     ulPEDisambiguity <td> W <td> R <td> 0
 * <tr><td> 27:26 <td>      ulPreFecPadding <td> W <td> R <td> 0x0
 * <tr><td> 25    <td>       ulLDPCExtrSymb <td> W <td> R <td> 0
 * <tr><td> 24    <td>               ulSTBC <td> W <td> R <td> 0
 * <tr><td> 23:21 <td>    ulNLTFAndMidamble <td> W <td> R <td> 0x0
 * <tr><td> 20    <td>          ulMULTFMode <td> W <td> R <td> 0
 * <tr><td> 19:18 <td>          ulGILTFType <td> W <td> R <td> 0x0
 * <tr><td> 17:16 <td>                 ulBW <td> W <td> R <td> 0x0
 * <tr><td> 15:04 <td>             ulLength <td> W <td> R <td> 0x0
 * <tr><td> 03:00 <td>        ulTriggerType <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the RX_HE_TRIG_COMMON_INFO register
#define NXMAC_RX_HE_TRIG_COMMON_INFO_ADDR   0x24B08358
/// Offset of the RX_HE_TRIG_COMMON_INFO register from the base address
#define NXMAC_RX_HE_TRIG_COMMON_INFO_OFFSET 0x00000358
/// Index of the RX_HE_TRIG_COMMON_INFO register
#define NXMAC_RX_HE_TRIG_COMMON_INFO_INDEX  0x000000D6
/// Reset value of the RX_HE_TRIG_COMMON_INFO register
#define NXMAC_RX_HE_TRIG_COMMON_INFO_RESET  0x00000000

/**
 * @brief Returns the current value of the RX_HE_TRIG_COMMON_INFO register.
 * The RX_HE_TRIG_COMMON_INFO register will be read and its value returned.
 * @return The current value of the RX_HE_TRIG_COMMON_INFO register.
 */
__INLINE uint32_t nxmac_rx_he_trig_common_info_get(void)
{
    return REG_PL_RD(NXMAC_RX_HE_TRIG_COMMON_INFO_ADDR);
}

// field definitions
/// UL_DOPPLER field bit
#define NXMAC_UL_DOPPLER_BIT              ((uint32_t)0x20000000)
/// UL_DOPPLER field position
#define NXMAC_UL_DOPPLER_POS              29
/// UL_PE_DISAMBIGUITY field bit
#define NXMAC_UL_PE_DISAMBIGUITY_BIT      ((uint32_t)0x10000000)
/// UL_PE_DISAMBIGUITY field position
#define NXMAC_UL_PE_DISAMBIGUITY_POS      28
/// UL_PRE_FEC_PADDING field mask
#define NXMAC_UL_PRE_FEC_PADDING_MASK     ((uint32_t)0x0C000000)
/// UL_PRE_FEC_PADDING field LSB position
#define NXMAC_UL_PRE_FEC_PADDING_LSB      26
/// UL_PRE_FEC_PADDING field width
#define NXMAC_UL_PRE_FEC_PADDING_WIDTH    ((uint32_t)0x00000002)
/// UL_LDPC_EXTR_SYMB field bit
#define NXMAC_UL_LDPC_EXTR_SYMB_BIT       ((uint32_t)0x02000000)
/// UL_LDPC_EXTR_SYMB field position
#define NXMAC_UL_LDPC_EXTR_SYMB_POS       25
/// UL_STBC field bit
#define NXMAC_UL_STBC_BIT                 ((uint32_t)0x01000000)
/// UL_STBC field position
#define NXMAC_UL_STBC_POS                 24
/// UL_NLTF_AND_MIDAMBLE field mask
#define NXMAC_UL_NLTF_AND_MIDAMBLE_MASK   ((uint32_t)0x00E00000)
/// UL_NLTF_AND_MIDAMBLE field LSB position
#define NXMAC_UL_NLTF_AND_MIDAMBLE_LSB    21
/// UL_NLTF_AND_MIDAMBLE field width
#define NXMAC_UL_NLTF_AND_MIDAMBLE_WIDTH  ((uint32_t)0x00000003)
/// UL_MULTF_MODE field bit
#define NXMAC_UL_MULTF_MODE_BIT           ((uint32_t)0x00100000)
/// UL_MULTF_MODE field position
#define NXMAC_UL_MULTF_MODE_POS           20
/// UL_GILTF_TYPE field mask
#define NXMAC_UL_GILTF_TYPE_MASK          ((uint32_t)0x000C0000)
/// UL_GILTF_TYPE field LSB position
#define NXMAC_UL_GILTF_TYPE_LSB           18
/// UL_GILTF_TYPE field width
#define NXMAC_UL_GILTF_TYPE_WIDTH         ((uint32_t)0x00000002)
/// UL_BW field mask
#define NXMAC_UL_BW_MASK                  ((uint32_t)0x00030000)
/// UL_BW field LSB position
#define NXMAC_UL_BW_LSB                   16
/// UL_BW field width
#define NXMAC_UL_BW_WIDTH                 ((uint32_t)0x00000002)
/// UL_LENGTH field mask
#define NXMAC_UL_LENGTH_MASK              ((uint32_t)0x0000FFF0)
/// UL_LENGTH field LSB position
#define NXMAC_UL_LENGTH_LSB               4
/// UL_LENGTH field width
#define NXMAC_UL_LENGTH_WIDTH             ((uint32_t)0x0000000C)
/// UL_TRIGGER_TYPE field mask
#define NXMAC_UL_TRIGGER_TYPE_MASK        ((uint32_t)0x0000000F)
/// UL_TRIGGER_TYPE field LSB position
#define NXMAC_UL_TRIGGER_TYPE_LSB         0
/// UL_TRIGGER_TYPE field width
#define NXMAC_UL_TRIGGER_TYPE_WIDTH       ((uint32_t)0x00000004)

/// UL_DOPPLER field reset value
#define NXMAC_UL_DOPPLER_RST              0x0
/// UL_PE_DISAMBIGUITY field reset value
#define NXMAC_UL_PE_DISAMBIGUITY_RST      0x0
/// UL_PRE_FEC_PADDING field reset value
#define NXMAC_UL_PRE_FEC_PADDING_RST      0x0
/// UL_LDPC_EXTR_SYMB field reset value
#define NXMAC_UL_LDPC_EXTR_SYMB_RST       0x0
/// UL_STBC field reset value
#define NXMAC_UL_STBC_RST                 0x0
/// UL_NLTF_AND_MIDAMBLE field reset value
#define NXMAC_UL_NLTF_AND_MIDAMBLE_RST    0x0
/// UL_MULTF_MODE field reset value
#define NXMAC_UL_MULTF_MODE_RST           0x0
/// UL_GILTF_TYPE field reset value
#define NXMAC_UL_GILTF_TYPE_RST           0x0
/// UL_BW field reset value
#define NXMAC_UL_BW_RST                   0x0
/// UL_LENGTH field reset value
#define NXMAC_UL_LENGTH_RST               0x0
/// UL_TRIGGER_TYPE field reset value
#define NXMAC_UL_TRIGGER_TYPE_RST         0x0

/**
 * @brief Unpacks RX_HE_TRIG_COMMON_INFO's fields from current value of the RX_HE_TRIG_COMMON_INFO register.
 *
 * Reads the RX_HE_TRIG_COMMON_INFO register and populates all the _field variables with the corresponding
 * values from the register.
 *
 * @param[out] uldoppler - Will be populated with the current value of this field from the register.
 * @param[out] ulpedisambiguity - Will be populated with the current value of this field from the register.
 * @param[out] ulprefecpadding - Will be populated with the current value of this field from the register.
 * @param[out] ulldpcextrsymb - Will be populated with the current value of this field from the register.
 * @param[out] ulstbc - Will be populated with the current value of this field from the register.
 * @param[out] ulnltfandmidamble - Will be populated with the current value of this field from the register.
 * @param[out] ulmultfmode - Will be populated with the current value of this field from the register.
 * @param[out] ulgiltftype - Will be populated with the current value of this field from the register.
 * @param[out] ulbw - Will be populated with the current value of this field from the register.
 * @param[out] ullength - Will be populated with the current value of this field from the register.
 * @param[out] ultriggertype - Will be populated with the current value of this field from the register.
 */
__INLINE void nxmac_rx_he_trig_common_info_unpack(uint8_t* uldoppler, uint8_t* ulpedisambiguity, uint8_t* ulprefecpadding, uint8_t* ulldpcextrsymb, uint8_t* ulstbc, uint8_t* ulnltfandmidamble, uint8_t* ulmultfmode, uint8_t* ulgiltftype, uint8_t* ulbw, uint16_t* ullength, uint8_t* ultriggertype)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HE_TRIG_COMMON_INFO_ADDR);

    *uldoppler = (localVal & ((uint32_t)0x20000000)) >> 29;
    *ulpedisambiguity = (localVal & ((uint32_t)0x10000000)) >> 28;
    *ulprefecpadding = (localVal & ((uint32_t)0x0C000000)) >> 26;
    *ulldpcextrsymb = (localVal & ((uint32_t)0x02000000)) >> 25;
    *ulstbc = (localVal & ((uint32_t)0x01000000)) >> 24;
    *ulnltfandmidamble = (localVal & ((uint32_t)0x00E00000)) >> 21;
    *ulmultfmode = (localVal & ((uint32_t)0x00100000)) >> 20;
    *ulgiltftype = (localVal & ((uint32_t)0x000C0000)) >> 18;
    *ulbw = (localVal & ((uint32_t)0x00030000)) >> 16;
    *ullength = (localVal & ((uint32_t)0x0000FFF0)) >> 4;
    *ultriggertype = (localVal & ((uint32_t)0x0000000F)) >> 0;
}

/**
 * @brief Returns the current value of the ulDoppler field in the RX_HE_TRIG_COMMON_INFO register.
 *
 * The RX_HE_TRIG_COMMON_INFO register will be read and the ulDoppler field's value will be returned.
 *
 * @return The current value of the ulDoppler field in the RX_HE_TRIG_COMMON_INFO register.
 */
__INLINE uint8_t nxmac_ul_doppler_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HE_TRIG_COMMON_INFO_ADDR);
    return ((localVal & ((uint32_t)0x20000000)) >> 29);
}
...
/**
 * @brief Returns the current value of the ulPEDisambiguity field in the RX_HE_TRIG_COMMON_INFO register.
 *
 * The RX_HE_TRIG_COMMON_INFO register will be read and the ulPEDisambiguity field's value will be returned.
 *
 * @return The current value of the ulPEDisambiguity field in the RX_HE_TRIG_COMMON_INFO register.
 */
__INLINE uint8_t nxmac_ul_pe_disambiguity_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HE_TRIG_COMMON_INFO_ADDR);
    return ((localVal & ((uint32_t)0x10000000)) >> 28);
}
...
/**
 * @brief Returns the current value of the ulPreFecPadding field in the RX_HE_TRIG_COMMON_INFO register.
 *
 * The RX_HE_TRIG_COMMON_INFO register will be read and the ulPreFecPadding field's value will be returned.
 *
 * @return The current value of the ulPreFecPadding field in the RX_HE_TRIG_COMMON_INFO register.
 */
__INLINE uint8_t nxmac_ul_pre_fec_padding_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HE_TRIG_COMMON_INFO_ADDR);
    return ((localVal & ((uint32_t)0x0C000000)) >> 26);
}
...
/**
 * @brief Returns the current value of the ulLDPCExtrSymb field in the RX_HE_TRIG_COMMON_INFO register.
 *
 * The RX_HE_TRIG_COMMON_INFO register will be read and the ulLDPCExtrSymb field's value will be returned.
 *
 * @return The current value of the ulLDPCExtrSymb field in the RX_HE_TRIG_COMMON_INFO register.
 */
__INLINE uint8_t nxmac_ul_ldpc_extr_symb_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HE_TRIG_COMMON_INFO_ADDR);
    return ((localVal & ((uint32_t)0x02000000)) >> 25);
}
...
/**
 * @brief Returns the current value of the ulSTBC field in the RX_HE_TRIG_COMMON_INFO register.
 *
 * The RX_HE_TRIG_COMMON_INFO register will be read and the ulSTBC field's value will be returned.
 *
 * @return The current value of the ulSTBC field in the RX_HE_TRIG_COMMON_INFO register.
 */
__INLINE uint8_t nxmac_ul_stbc_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HE_TRIG_COMMON_INFO_ADDR);
    return ((localVal & ((uint32_t)0x01000000)) >> 24);
}
...
/**
 * @brief Returns the current value of the ulNLTFAndMidamble field in the RX_HE_TRIG_COMMON_INFO register.
 *
 * The RX_HE_TRIG_COMMON_INFO register will be read and the ulNLTFAndMidamble field's value will be returned.
 *
 * @return The current value of the ulNLTFAndMidamble field in the RX_HE_TRIG_COMMON_INFO register.
 */
__INLINE uint8_t nxmac_ul_nltf_and_midamble_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HE_TRIG_COMMON_INFO_ADDR);
...
/**
 * @brief Returns the current value of the ulMULTFMode field in the RX_HE_TRIG_COMMON_INFO register.
 *
 * The RX_HE_TRIG_COMMON_INFO register will be read and the ulMULTFMode field's value will be returned.
 *
 * @return The current value of the ulMULTFMode field in the RX_HE_TRIG_COMMON_INFO register.
 */
__INLINE uint8_t nxmac_ul_multf_mode_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HE_TRIG_COMMON_INFO_ADDR);
    return ((localVal & ((uint32_t)0x00100000)) >> 20);
}
...
/**
 * @brief Returns the current value of the ulGILTFType field in the RX_HE_TRIG_COMMON_INFO register.
 *
 * The RX_HE_TRIG_COMMON_INFO register will be read and the ulGILTFType field's value will be returned.
 *
 * @return The current value of the ulGILTFType field in the RX_HE_TRIG_COMMON_INFO register.
 */
__INLINE uint8_t nxmac_ul_giltf_type_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HE_TRIG_COMMON_INFO_ADDR);
...
/**
 * @brief Returns the current value of the ulBW field in the RX_HE_TRIG_COMMON_INFO register.
 *
 * The RX_HE_TRIG_COMMON_INFO register will be read and the ulBW field's value will be returned.
 *
 * @return The current value of the ulBW field in the RX_HE_TRIG_COMMON_INFO register.
 */
__INLINE uint8_t nxmac_ul_bw_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HE_TRIG_COMMON_INFO_ADDR);
    return ((localVal & ((uint32_t)0x00030000)) >> 16);
}
...
/**
 * @brief Returns the current value of the ulLength field in the RX_HE_TRIG_COMMON_INFO register.
 *
 * The RX_HE_TRIG_COMMON_INFO register will be read and the ulLength field's value will be returned.
 *
 * @return The current value of the ulLength field in the RX_HE_TRIG_COMMON_INFO register.
 */
__INLINE uint16_t nxmac_ul_length_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HE_TRIG_COMMON_INFO_ADDR);
...
/**
 * @brief Returns the current value of the ulTriggerType field in the RX_HE_TRIG_COMMON_INFO register.
 *
 * The RX_HE_TRIG_COMMON_INFO register will be read and the ulTriggerType field's value will be returned.
 *
 * @return The current value of the ulTriggerType field in the RX_HE_TRIG_COMMON_INFO register.
 */
__INLINE uint8_t nxmac_ul_trigger_type_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HE_TRIG_COMMON_INFO_ADDR);
...
/**
 * @name RX_HE_TRIG_USER_INFO register definitions
 * <table>
 * <caption>RX_HE_TRIG_USER_INFO bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:24 <td>    tdUserInfoSubfield <td> W <td> R <td> 0x0
 * <tr><td> 12    <td>              ulRUType <td> W <td> R <td> 0
 * <tr><td> 11:09 <td>                 ulNSS <td> W <td> R <td> 0x0
 * <tr><td> 08    <td>                 ulDCM <td> W <td> R <td> 0
 * <tr><td> 07:04 <td>                 ulMCS <td> W <td> R <td> 0x0
 * <tr><td> 03    <td>           ulFECCoding <td> W <td> R <td> 0
 * <tr><td> 02:00 <td>              ulRUSize <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the RX_HE_TRIG_USER_INFO register
#define NXMAC_RX_HE_TRIG_USER_INFO_ADDR   0x24B0835C
/// Offset of the RX_HE_TRIG_USER_INFO register from the base address
#define NXMAC_RX_HE_TRIG_USER_INFO_OFFSET 0x0000035C
/// Index of the RX_HE_TRIG_USER_INFO register
#define NXMAC_RX_HE_TRIG_USER_INFO_INDEX  0x000000D7
/// Reset value of the RX_HE_TRIG_USER_INFO register
#define NXMAC_RX_HE_TRIG_USER_INFO_RESET  0x00000000

/**
 * @brief Returns the current value of the RX_HE_TRIG_USER_INFO register.
 * The RX_HE_TRIG_USER_INFO register will be read and its value returned.
 * @return The current value of the RX_HE_TRIG_USER_INFO register.
 */
__INLINE uint32_t nxmac_rx_he_trig_user_info_get(void)
{
    return REG_PL_RD(NXMAC_RX_HE_TRIG_USER_INFO_ADDR);
}

// field definitions
/// TD_USER_INFO_SUBFIELD field mask
#define NXMAC_TD_USER_INFO_SUBFIELD_MASK   ((uint32_t)0xFF000000)
/// TD_USER_INFO_SUBFIELD field LSB position
#define NXMAC_TD_USER_INFO_SUBFIELD_LSB    24
/// TD_USER_INFO_SUBFIELD field width
#define NXMAC_TD_USER_INFO_SUBFIELD_WIDTH  ((uint32_t)0x00000008)
/// UL_RU_TYPE field bit
#define NXMAC_UL_RU_TYPE_BIT               ((uint32_t)0x00001000)
/// UL_RU_TYPE field position
#define NXMAC_UL_RU_TYPE_POS               12
/// UL_NSS field mask
#define NXMAC_UL_NSS_MASK                  ((uint32_t)0x00000E00)
/// UL_NSS field LSB position
#define NXMAC_UL_NSS_LSB                   9
/// UL_NSS field width
#define NXMAC_UL_NSS_WIDTH                 ((uint32_t)0x00000003)
/// UL_DCM field bit
#define NXMAC_UL_DCM_BIT                   ((uint32_t)0x00000100)
/// UL_DCM field position
#define NXMAC_UL_DCM_POS                   8
/// UL_MCS field mask
#define NXMAC_UL_MCS_MASK                  ((uint32_t)0x000000F0)
/// UL_MCS field LSB position
#define NXMAC_UL_MCS_LSB                   4
/// UL_MCS field width
#define NXMAC_UL_MCS_WIDTH                 ((uint32_t)0x00000004)
/// UL_FEC_CODING field bit
#define NXMAC_UL_FEC_CODING_BIT            ((uint32_t)0x00000008)
/// UL_FEC_CODING field position
#define NXMAC_UL_FEC_CODING_POS            3
/// UL_RU_SIZE field mask
#define NXMAC_UL_RU_SIZE_MASK              ((uint32_t)0x00000007)
/// UL_RU_SIZE field LSB position
#define NXMAC_UL_RU_SIZE_LSB               0
/// UL_RU_SIZE field width
#define NXMAC_UL_RU_SIZE_WIDTH             ((uint32_t)0x00000003)

/// TD_USER_INFO_SUBFIELD field reset value
#define NXMAC_TD_USER_INFO_SUBFIELD_RST    0x0
/// UL_RU_TYPE field reset value
#define NXMAC_UL_RU_TYPE_RST               0x0
/// UL_NSS field reset value
#define NXMAC_UL_NSS_RST                   0x0
/// UL_DCM field reset value
#define NXMAC_UL_DCM_RST                   0x0
/// UL_MCS field reset value
#define NXMAC_UL_MCS_RST                   0x0
/// UL_FEC_CODING field reset value
#define NXMAC_UL_FEC_CODING_RST            0x0
/// UL_RU_SIZE field reset value
#define NXMAC_UL_RU_SIZE_RST               0x0

/**
 * @brief Unpacks RX_HE_TRIG_USER_INFO's fields from current value of the RX_HE_TRIG_USER_INFO register.
 *
 * Reads the RX_HE_TRIG_USER_INFO register and populates all the _field variables with the corresponding
 * values from the register.
 *
 * @param[out] tduserinfosubfield - Will be populated with the current value of this field from the register.
 * @param[out] ulrutype - Will be populated with the current value of this field from the register.
 * @param[out] ulnss - Will be populated with the current value of this field from the register.
 * @param[out] uldcm - Will be populated with the current value of this field from the register.
 * @param[out] ulmcs - Will be populated with the current value of this field from the register.
 * @param[out] ulfeccoding - Will be populated with the current value of this field from the register.
 * @param[out] ulrusize - Will be populated with the current value of this field from the register.
 */
__INLINE void nxmac_rx_he_trig_user_info_unpack(uint8_t* tduserinfosubfield, uint8_t* ulrutype, uint8_t* ulnss, uint8_t* uldcm, uint8_t* ulmcs, uint8_t* ulfeccoding, uint8_t* ulrusize)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HE_TRIG_USER_INFO_ADDR);

    *tduserinfosubfield = (localVal & ((uint32_t)0xFF000000)) >> 24;
    *ulrutype = (localVal & ((uint32_t)0x00001000)) >> 12;
    *ulnss = (localVal & ((uint32_t)0x00000E00)) >> 9;
    *uldcm = (localVal & ((uint32_t)0x00000100)) >> 8;
    *ulmcs = (localVal & ((uint32_t)0x000000F0)) >> 4;
    *ulfeccoding = (localVal & ((uint32_t)0x00000008)) >> 3;
    *ulrusize = (localVal & ((uint32_t)0x00000007)) >> 0;
}

/**
 * @brief Returns the current value of the tdUserInfoSubfield field in the RX_HE_TRIG_USER_INFO register.
 *
 * The RX_HE_TRIG_USER_INFO register will be read and the tdUserInfoSubfield field's value will be returned.
 *
 * @return The current value of the tdUserInfoSubfield field in the RX_HE_TRIG_USER_INFO register.
 */
__INLINE uint8_t nxmac_td_user_info_subfield_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HE_TRIG_USER_INFO_ADDR);
    return ((localVal & ((uint32_t)0xFF000000)) >> 24);
}
...
/**
 * @brief Returns the current value of the ulRUType field in the RX_HE_TRIG_USER_INFO register.
 *
 * The RX_HE_TRIG_USER_INFO register will be read and the ulRUType field's value will be returned.
 *
 * @return The current value of the ulRUType field in the RX_HE_TRIG_USER_INFO register.
 */
__INLINE uint8_t nxmac_ul_ru_type_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HE_TRIG_USER_INFO_ADDR);
    return ((localVal & ((uint32_t)0x00001000)) >> 12);
}
...
/**
 * @brief Returns the current value of the ulNSS field in the RX_HE_TRIG_USER_INFO register.
 *
 * The RX_HE_TRIG_USER_INFO register will be read and the ulNSS field's value will be returned.
 *
 * @return The current value of the ulNSS field in the RX_HE_TRIG_USER_INFO register.
 */
__INLINE uint8_t nxmac_ul_nss_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HE_TRIG_USER_INFO_ADDR);
...
/**
 * @brief Returns the current value of the ulDCM field in the RX_HE_TRIG_USER_INFO register.
 *
 * The RX_HE_TRIG_USER_INFO register will be read and the ulDCM field's value will be returned.
 *
 * @return The current value of the ulDCM field in the RX_HE_TRIG_USER_INFO register.
 */
__INLINE uint8_t nxmac_ul_dcm_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HE_TRIG_USER_INFO_ADDR);
    return ((localVal & ((uint32_t)0x00000100)) >> 8);
}
...
/**
 * @brief Returns the current value of the ulMCS field in the RX_HE_TRIG_USER_INFO register.
 *
 * The RX_HE_TRIG_USER_INFO register will be read and the ulMCS field's value will be returned.
 *
 * @return The current value of the ulMCS field in the RX_HE_TRIG_USER_INFO register.
 */
__INLINE uint8_t nxmac_ul_mcs_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HE_TRIG_USER_INFO_ADDR);
...
/**
 * @brief Returns the current value of the ulFECCoding field in the RX_HE_TRIG_USER_INFO register.
 *
 * The RX_HE_TRIG_USER_INFO register will be read and the ulFECCoding field's value will be returned.
 *
 * @return The current value of the ulFECCoding field in the RX_HE_TRIG_USER_INFO register.
 */
__INLINE uint8_t nxmac_ul_fec_coding_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HE_TRIG_USER_INFO_ADDR);
    return ((localVal & ((uint32_t)0x00000008)) >> 3);
}
...
/**
 * @brief Returns the current value of the ulRUSize field in the RX_HE_TRIG_USER_INFO register.
 *
 * The RX_HE_TRIG_USER_INFO register will be read and the ulRUSize field's value will be returned.
 *
 * @return The current value of the ulRUSize field in the RX_HE_TRIG_USER_INFO register.
 */
__INLINE uint8_t nxmac_ul_ru_size_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HE_TRIG_USER_INFO_ADDR);
...
/**
 * @name RX_HE_TRIG_PSDU_LEN register definitions
 * <table>
 * <caption>RX_HE_TRIG_PSDU_LEN bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31    <td>    ulPSDULenValid <td> R/W <td> R <td> 0
 * <tr><td> 19:00 <td>         ulPSDULen <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the RX_HE_TRIG_PSDU_LEN register
#define NXMAC_RX_HE_TRIG_PSDU_LEN_ADDR   0x24B08360
/// Offset of the RX_HE_TRIG_PSDU_LEN register from the base address
#define NXMAC_RX_HE_TRIG_PSDU_LEN_OFFSET 0x00000360
/// Index of the RX_HE_TRIG_PSDU_LEN register
#define NXMAC_RX_HE_TRIG_PSDU_LEN_INDEX  0x000000D8
/// Reset value of the RX_HE_TRIG_PSDU_LEN register
#define NXMAC_RX_HE_TRIG_PSDU_LEN_RESET  0x00000000

/**
 * @brief Returns the current value of the RX_HE_TRIG_PSDU_LEN register.
 * The RX_HE_TRIG_PSDU_LEN register will be read and its value returned.
 * @return The current value of the RX_HE_TRIG_PSDU_LEN register.
 */
__INLINE uint32_t nxmac_rx_he_trig_psdu_len_get(void)
{
    return REG_PL_RD(NXMAC_RX_HE_TRIG_PSDU_LEN_ADDR);
}

// field definitions
/// UL_PSDU_LEN_VALID field bit
#define NXMAC_UL_PSDU_LEN_VALID_BIT    ((uint32_t)0x80000000)
/// UL_PSDU_LEN_VALID field position
#define NXMAC_UL_PSDU_LEN_VALID_POS    31
/// UL_PSDU_LEN field mask
#define NXMAC_UL_PSDU_LEN_MASK         ((uint32_t)0x000FFFFF)
/// UL_PSDU_LEN field LSB position
#define NXMAC_UL_PSDU_LEN_LSB          0
/// UL_PSDU_LEN field width
#define NXMAC_UL_PSDU_LEN_WIDTH        ((uint32_t)0x00000014)

/// UL_PSDU_LEN_VALID field reset value
#define NXMAC_UL_PSDU_LEN_VALID_RST    0x0
/// UL_PSDU_LEN field reset value
#define NXMAC_UL_PSDU_LEN_RST          0x0

/**
 * @brief Unpacks RX_HE_TRIG_PSDU_LEN's fields from current value of the RX_HE_TRIG_PSDU_LEN register.
 *
 * Reads the RX_HE_TRIG_PSDU_LEN register and populates all the _field variables with the corresponding
 * values from the register.
 *
 * @param[out] ulpsdulenvalid - Will be populated with the current value of this field from the register.
 * @param[out] ulpsdulen - Will be populated with the current value of this field from the register.
 */
__INLINE void nxmac_rx_he_trig_psdu_len_unpack(uint8_t* ulpsdulenvalid, uint32_t* ulpsdulen)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HE_TRIG_PSDU_LEN_ADDR);

    *ulpsdulenvalid = (localVal & ((uint32_t)0x80000000)) >> 31;
    *ulpsdulen = (localVal & ((uint32_t)0x000FFFFF)) >> 0;
}

/**
 * @brief Returns the current value of the ulPSDULenValid field in the RX_HE_TRIG_PSDU_LEN register.
 *
 * The RX_HE_TRIG_PSDU_LEN register will be read and the ulPSDULenValid field's value will be returned.
 *
 * @return The current value of the ulPSDULenValid field in the RX_HE_TRIG_PSDU_LEN register.
 */
__INLINE uint8_t nxmac_ul_psdu_len_valid_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HE_TRIG_PSDU_LEN_ADDR);
    return ((localVal & ((uint32_t)0x80000000)) >> 31);
}
...
/**
 * @brief Returns the current value of the ulPSDULen field in the RX_HE_TRIG_PSDU_LEN register.
 *
 * The RX_HE_TRIG_PSDU_LEN register will be read and the ulPSDULen field's value will be returned.
 *
 * @return The current value of the ulPSDULen field in the RX_HE_TRIG_PSDU_LEN register.
 */
__INLINE uint32_t nxmac_ul_psdu_len_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HE_TRIG_PSDU_LEN_ADDR);
    return ((localVal & ((uint32_t)0x000FFFFF)) >> 0);
}
...
/**
 * @name RX_HE_TRIG_PWR_INFO register definitions
 * <table>
 * <caption>RX_HE_TRIG_PWR_INFO bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:24 <td>   heTBUPHControl <td> W <td> R <td> 0x0
 * <tr><td> 14:08 <td>     ulTargetRSSI <td> W <td> R <td> 0x0
 * <tr><td> 05:00 <td>        apTXPower <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the RX_HE_TRIG_PWR_INFO register
#define NXMAC_RX_HE_TRIG_PWR_INFO_ADDR   0x24B08364
/// Offset of the RX_HE_TRIG_PWR_INFO register from the base address
#define NXMAC_RX_HE_TRIG_PWR_INFO_OFFSET 0x00000364
/// Index of the RX_HE_TRIG_PWR_INFO register
#define NXMAC_RX_HE_TRIG_PWR_INFO_INDEX  0x000000D9
/// Reset value of the RX_HE_TRIG_PWR_INFO register
#define NXMAC_RX_HE_TRIG_PWR_INFO_RESET  0x00000000

/**
 * @brief Returns the current value of the RX_HE_TRIG_PWR_INFO register.
 * The RX_HE_TRIG_PWR_INFO register will be read and its value returned.
 * @return The current value of the RX_HE_TRIG_PWR_INFO register.
 */
__INLINE uint32_t nxmac_rx_he_trig_pwr_info_get(void)
{
    return REG_PL_RD(NXMAC_RX_HE_TRIG_PWR_INFO_ADDR);
}

// field definitions
/// HE_TBUPH_CONTROL field mask
#define NXMAC_HE_TBUPH_CONTROL_MASK   ((uint32_t)0xFF000000)
/// HE_TBUPH_CONTROL field LSB position
#define NXMAC_HE_TBUPH_CONTROL_LSB    24
/// HE_TBUPH_CONTROL field width
#define NXMAC_HE_TBUPH_CONTROL_WIDTH  ((uint32_t)0x00000008)
/// UL_TARGET_RSSI field mask
#define NXMAC_UL_TARGET_RSSI_MASK     ((uint32_t)0x00007F00)
/// UL_TARGET_RSSI field LSB position
#define NXMAC_UL_TARGET_RSSI_LSB      8
/// UL_TARGET_RSSI field width
#define NXMAC_UL_TARGET_RSSI_WIDTH    ((uint32_t)0x00000007)
/// AP_TX_POWER field mask
#define NXMAC_AP_TX_POWER_MASK        ((uint32_t)0x0000003F)
/// AP_TX_POWER field LSB position
#define NXMAC_AP_TX_POWER_LSB         0
/// AP_TX_POWER field width
#define NXMAC_AP_TX_POWER_WIDTH       ((uint32_t)0x00000006)

/// HE_TBUPH_CONTROL field reset value
#define NXMAC_HE_TBUPH_CONTROL_RST    0x0
/// UL_TARGET_RSSI field reset value
#define NXMAC_UL_TARGET_RSSI_RST      0x0
/// AP_TX_POWER field reset value
#define NXMAC_AP_TX_POWER_RST         0x0

/**
 * @brief Unpacks RX_HE_TRIG_PWR_INFO's fields from current value of the RX_HE_TRIG_PWR_INFO register.
 *
 * Reads the RX_HE_TRIG_PWR_INFO register and populates all the _field variables with the corresponding
 * values from the register.
 *
 * @param[out] hetbuphcontrol - Will be populated with the current value of this field from the register.
 * @param[out] ultargetrssi - Will be populated with the current value of this field from the register.
 * @param[out] aptxpower - Will be populated with the current value of this field from the register.
 */
__INLINE void nxmac_rx_he_trig_pwr_info_unpack(uint8_t* hetbuphcontrol, uint8_t* ultargetrssi, uint8_t* aptxpower)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HE_TRIG_PWR_INFO_ADDR);

    *hetbuphcontrol = (localVal & ((uint32_t)0xFF000000)) >> 24;
    *ultargetrssi = (localVal & ((uint32_t)0x00007F00)) >> 8;
    *aptxpower = (localVal & ((uint32_t)0x0000003F)) >> 0;
}

/**
 * @brief Returns the current value of the heTBUPHControl field in the RX_HE_TRIG_PWR_INFO register.
 *
 * The RX_HE_TRIG_PWR_INFO register will be read and the heTBUPHControl field's value will be returned.
 *
 * @return The current value of the heTBUPHControl field in the RX_HE_TRIG_PWR_INFO register.
 */
__INLINE uint8_t nxmac_he_tbuph_control_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HE_TRIG_PWR_INFO_ADDR);
    return ((localVal & ((uint32_t)0xFF000000)) >> 24);
}
...
/**
 * @brief Returns the current value of the ulTargetRSSI field in the RX_HE_TRIG_PWR_INFO register.
 *
 * The RX_HE_TRIG_PWR_INFO register will be read and the ulTargetRSSI field's value will be returned.
 *
 * @return The current value of the ulTargetRSSI field in the RX_HE_TRIG_PWR_INFO register.
 */
__INLINE uint8_t nxmac_ul_target_rssi_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HE_TRIG_PWR_INFO_ADDR);
...
/**
 * @brief Returns the current value of the apTXPower field in the RX_HE_TRIG_PWR_INFO register.
 *
 * The RX_HE_TRIG_PWR_INFO register will be read and the apTXPower field's value will be returned.
 *
 * @return The current value of the apTXPower field in the RX_HE_TRIG_PWR_INFO register.
 */
__INLINE uint8_t nxmac_ap_tx_power_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_RX_HE_TRIG_PWR_INFO_ADDR);
    return ((localVal & ((uint32_t)0x0000003F)) >> 0);
}
 ...
 * <table>
 * <caption>SEC_USERS_TX_INT_EVENT_SET bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 23 <td>       secU3ac3TxBufTrigger <td> R/W <td> S <td> 0
 * <tr><td> 22 <td>       secU3ac2TxBufTrigger <td> R/W <td> S <td> 0
 * <tr><td> 21 <td>       secU3ac1TxBufTrigger <td> R/W <td> S <td> 0
 * <tr><td> 20 <td>       secU3ac0TxBufTrigger <td> R/W <td> S <td> 0
 * <tr><td> 19 <td>          secU3ac3TxTrigger <td> R/W <td> S <td> 0
 * <tr><td> 18 <td>          secU3ac2TxTrigger <td> R/W <td> S <td> 0
 * <tr><td> 17 <td>          secU3ac1TxTrigger <td> R/W <td> S <td> 0
 * <tr><td> 16 <td>          secU3ac0TxTrigger <td> R/W <td> S <td> 0
 * <tr><td> 15 <td>       secU2ac3TxBufTrigger <td> R/W <td> S <td> 0
 * <tr><td> 14 <td>       secU2ac2TxBufTrigger <td> R/W <td> S <td> 0
 * <tr><td> 13 <td>       secU2ac1TxBufTrigger <td> R/W <td> S <td> 0
 * <tr><td> 12 <td>       secU2ac0TxBufTrigger <td> R/W <td> S <td> 0
 * <tr><td> 11 <td>          secU2ac3TxTrigger <td> R/W <td> S <td> 0
 * <tr><td> 10 <td>          secU2ac2TxTrigger <td> R/W <td> S <td> 0
 * <tr><td> 09 <td>          secU2ac1TxTrigger <td> R/W <td> S <td> 0
 * <tr><td> 08 <td>          secU2ac0TxTrigger <td> R/W <td> S <td> 0
 * <tr><td> 07 <td>       secU1ac3TxBufTrigger <td> R/W <td> S <td> 0
 * <tr><td> 06 <td>       secU1ac2TxBufTrigger <td> R/W <td> S <td> 0
 * <tr><td> 05 <td>       secU1ac1TxBufTrigger <td> R/W <td> S <td> 0
 * <tr><td> 04 <td>       secU1ac0TxBufTrigger <td> R/W <td> S <td> 0
 * <tr><td> 03 <td>          secU1ac3TxTrigger <td> R/W <td> S <td> 0
 * <tr><td> 02 <td>          secU1ac2TxTrigger <td> R/W <td> S <td> 0
 * <tr><td> 01 <td>          secU1ac1TxTrigger <td> R/W <td> S <td> 0
 * <tr><td> 00 <td>          secU1ac0TxTrigger <td> R/W <td> S <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_SEC_USERS_TX_INT_EVENT_SET_ADDR   0x24B08368
/// Offset of the SEC_USERS_TX_INT_EVENT_SET register from the base address
#define NXMAC_SEC_USERS_TX_INT_EVENT_SET_OFFSET 0x00000368
/// Index of the SEC_USERS_TX_INT_EVENT_SET register
#define NXMAC_SEC_USERS_TX_INT_EVENT_SET_INDEX  0x000000DA
 ...
 * <table>
 * <caption>SEC_USERS_TX_INT_EVENT_CLEAR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 23 <td>       secU3ac3TxBufTrigger <td> R <td> C <td> 0
 * <tr><td> 22 <td>       secU3ac2TxBufTrigger <td> R <td> C <td> 0
 * <tr><td> 21 <td>       secU3ac1TxBufTrigger <td> R <td> C <td> 0
 * <tr><td> 20 <td>       secU3ac0TxBufTrigger <td> R <td> C <td> 0
 * <tr><td> 19 <td>          secU3ac3TxTrigger <td> R <td> C <td> 0
 * <tr><td> 18 <td>          secU3ac2TxTrigger <td> R <td> C <td> 0
 * <tr><td> 17 <td>          secU3ac1TxTrigger <td> R <td> C <td> 0
 * <tr><td> 16 <td>          secU3ac0TxTrigger <td> R <td> C <td> 0
 * <tr><td> 15 <td>       secU2ac3TxBufTrigger <td> R <td> C <td> 0
 * <tr><td> 14 <td>       secU2ac2TxBufTrigger <td> R <td> C <td> 0
 * <tr><td> 13 <td>       secU2ac1TxBufTrigger <td> R <td> C <td> 0
 * <tr><td> 12 <td>       secU2ac0TxBufTrigger <td> R <td> C <td> 0
 * <tr><td> 11 <td>          secU2ac3TxTrigger <td> R <td> C <td> 0
 * <tr><td> 10 <td>          secU2ac2TxTrigger <td> R <td> C <td> 0
 * <tr><td> 09 <td>          secU2ac1TxTrigger <td> R <td> C <td> 0
 * <tr><td> 08 <td>          secU2ac0TxTrigger <td> R <td> C <td> 0
 * <tr><td> 07 <td>       secU1ac3TxBufTrigger <td> R <td> C <td> 0
 * <tr><td> 06 <td>       secU1ac2TxBufTrigger <td> R <td> C <td> 0
 * <tr><td> 05 <td>       secU1ac1TxBufTrigger <td> R <td> C <td> 0
 * <tr><td> 04 <td>       secU1ac0TxBufTrigger <td> R <td> C <td> 0
 * <tr><td> 03 <td>          secU1ac3TxTrigger <td> R <td> C <td> 0
 * <tr><td> 02 <td>          secU1ac2TxTrigger <td> R <td> C <td> 0
 * <tr><td> 01 <td>          secU1ac1TxTrigger <td> R <td> C <td> 0
 * <tr><td> 00 <td>          secU1ac0TxTrigger <td> R <td> C <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_SEC_USERS_TX_INT_EVENT_CLEAR_ADDR   0x24B0836C
/// Offset of the SEC_USERS_TX_INT_EVENT_CLEAR register from the base address
#define NXMAC_SEC_USERS_TX_INT_EVENT_CLEAR_OFFSET 0x0000036C
/// Index of the SEC_USERS_TX_INT_EVENT_CLEAR register
#define NXMAC_SEC_USERS_TX_INT_EVENT_CLEAR_INDEX  0x000000DB
 ...
 * <table>
 * <caption>SEC_USERS_TX_INT_EVENT_UN_MASK bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31 <td>          masterSecUsersTxIntEn <td> R <td> R/W <td> 0
 * <tr><td> 23 <td>       masksecU3ac3TxBufTrigger <td> R <td> R/W <td> 0
 * <tr><td> 22 <td>       masksecU3ac2TxBufTrigger <td> R <td> R/W <td> 0
 * <tr><td> 21 <td>       masksecU3ac1TxBufTrigger <td> R <td> R/W <td> 0
 * <tr><td> 20 <td>       masksecU3ac0TxBufTrigger <td> R <td> R/W <td> 0
 * <tr><td> 19 <td>          masksecU3ac3TxTrigger <td> R <td> R/W <td> 0
 * <tr><td> 18 <td>          masksecU3ac2TxTrigger <td> R <td> R/W <td> 0
 * <tr><td> 17 <td>          masksecU3ac1TxTrigger <td> R <td> R/W <td> 0
 * <tr><td> 16 <td>          masksecU3ac0TxTrigger <td> R <td> R/W <td> 0
 * <tr><td> 15 <td>       masksecU2ac3TxBufTrigger <td> R <td> R/W <td> 0
 * <tr><td> 14 <td>       masksecU2ac2TxBufTrigger <td> R <td> R/W <td> 0
 * <tr><td> 13 <td>       masksecU2ac1TxBufTrigger <td> R <td> R/W <td> 0
 * <tr><td> 12 <td>       masksecU2ac0TxBufTrigger <td> R <td> R/W <td> 0
 * <tr><td> 11 <td>          masksecU2ac3TxTrigger <td> R <td> R/W <td> 0
 * <tr><td> 10 <td>          masksecU2ac2TxTrigger <td> R <td> R/W <td> 0
 * <tr><td> 09 <td>          masksecU2ac1TxTrigger <td> R <td> R/W <td> 0
 * <tr><td> 08 <td>          masksecU2ac0TxTrigger <td> R <td> R/W <td> 0
 * <tr><td> 07 <td>       masksecU1ac3TxBufTrigger <td> R <td> R/W <td> 0
 * <tr><td> 06 <td>       masksecU1ac2TxBufTrigger <td> R <td> R/W <td> 0
 * <tr><td> 05 <td>       masksecU1ac1TxBufTrigger <td> R <td> R/W <td> 0
 * <tr><td> 04 <td>       masksecU1ac0TxBufTrigger <td> R <td> R/W <td> 0
 * <tr><td> 03 <td>          masksecU1ac3TxTrigger <td> R <td> R/W <td> 0
 * <tr><td> 02 <td>          masksecU1ac2TxTrigger <td> R <td> R/W <td> 0
 * <tr><td> 01 <td>          masksecU1ac1TxTrigger <td> R <td> R/W <td> 0
 * <tr><td> 00 <td>          masksecU1ac0TxTrigger <td> R <td> R/W <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_SEC_USERS_TX_INT_EVENT_UN_MASK_ADDR   0x24B08370
/// Offset of the SEC_USERS_TX_INT_EVENT_UN_MASK register from the base address
#define NXMAC_SEC_USERS_TX_INT_EVENT_UN_MASK_OFFSET 0x00000370
/// Index of the SEC_USERS_TX_INT_EVENT_UN_MASK register
#define NXMAC_SEC_USERS_TX_INT_EVENT_UN_MASK_INDEX  0x000000DC
 ...
 * <table>
 * <caption>DEBUG_BCN_S_PTR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>   bcnStatusPointer <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_DEBUG_BCN_S_PTR_ADDR   0x24B08524
 ...
 * <table>
 * <caption>DEBUG_AC_0S_PTR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>    ac0StatusPointer <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_DEBUG_AC_0S_PTR_ADDR   0x24B08528
 ...
 * <table>
 * <caption>DEBUG_AC_1S_PTR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>    ac1StatusPointer <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_DEBUG_AC_1S_PTR_ADDR   0x24B0852C
 ...
 * <table>
 * <caption>DEBUG_AC_2S_PTR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>    ac2StatusPointer <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_DEBUG_AC_2S_PTR_ADDR   0x24B08530
 ...
 * <table>
 * <caption>DEBUG_AC_3S_PTR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>    ac3StatusPointer <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_DEBUG_AC_3S_PTR_ADDR   0x24B08534
...
/**
 * @name DEBUG_TBS_PTR register definitions
 * <table>
 * <caption>DEBUG_TBS_PTR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>   tbStatusPointer <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the DEBUG_TBS_PTR register
#define NXMAC_DEBUG_TBS_PTR_ADDR   0x24B08538
/// Offset of the DEBUG_TBS_PTR register from the base address
#define NXMAC_DEBUG_TBS_PTR_OFFSET 0x00000538
/// Index of the DEBUG_TBS_PTR register
#define NXMAC_DEBUG_TBS_PTR_INDEX  0x0000014E
/// Reset value of the DEBUG_TBS_PTR register
#define NXMAC_DEBUG_TBS_PTR_RESET  0x00000000

/**
 * @brief Returns the current value of the DEBUG_TBS_PTR register.
 * The DEBUG_TBS_PTR register will be read and its value returned.
 * @return The current value of the DEBUG_TBS_PTR register.
 */
__INLINE uint32_t nxmac_debug_tbs_ptr_get(void)
{
    return REG_PL_RD(NXMAC_DEBUG_TBS_PTR_ADDR);
}

/**
 * @brief Sets the DEBUG_TBS_PTR register to a value.
 * The DEBUG_TBS_PTR register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_debug_tbs_ptr_set(uint32_t value)
{
    REG_PL_WR(NXMAC_DEBUG_TBS_PTR_ADDR, value);
}

// field definitions
/// TB_STATUS_POINTER field mask
#define NXMAC_TB_STATUS_POINTER_MASK   ((uint32_t)0xFFFFFFFF)
/// TB_STATUS_POINTER field LSB position
#define NXMAC_TB_STATUS_POINTER_LSB    0
/// TB_STATUS_POINTER field width
#define NXMAC_TB_STATUS_POINTER_WIDTH  ((uint32_t)0x00000020)

/// TB_STATUS_POINTER field reset value
#define NXMAC_TB_STATUS_POINTER_RST    0x0

/**
 * @brief Returns the current value of the tbStatusPointer field in the DEBUG_TBS_PTR register.
 *
 * The DEBUG_TBS_PTR register will be read and the tbStatusPointer field's value will be returned.
 *
 * @return The current value of the tbStatusPointer field in the DEBUG_TBS_PTR register.
 */
__INLINE uint32_t nxmac_tb_status_pointer_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_DEBUG_TBS_PTR_ADDR);
    ASSERT_ERR((localVal & ~((uint32_t)0xFFFFFFFF)) == 0);
    return (localVal >> 0);
}
 ...
 * <table>
 * <caption>DEBUG_TX_C_PTR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>   txCurrentPointer <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_DEBUG_TX_C_PTR_ADDR   0x24B08540
 ...
 * <table>
 * <caption>SW_PROFILING bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31 <td>   swProf31 <td> R/W <td> R/W <td> 0
 * <tr><td> 30 <td>   swProf30 <td> R/W <td> R/W <td> 0
 * <tr><td> 29 <td>   swProf29 <td> R/W <td> R/W <td> 0
 * <tr><td> 28 <td>   swProf28 <td> R/W <td> R/W <td> 0
 * <tr><td> 27 <td>   swProf27 <td> R/W <td> R/W <td> 0
 * <tr><td> 26 <td>   swProf26 <td> R/W <td> R/W <td> 0
 * <tr><td> 25 <td>   swProf25 <td> R/W <td> R/W <td> 0
 * <tr><td> 24 <td>   swProf24 <td> R/W <td> R/W <td> 0
 * <tr><td> 23 <td>   swProf23 <td> R/W <td> R/W <td> 0
 * <tr><td> 22 <td>   swProf22 <td> R/W <td> R/W <td> 0
 * <tr><td> 21 <td>   swProf21 <td> R/W <td> R/W <td> 0
 * <tr><td> 20 <td>   swProf20 <td> R/W <td> R/W <td> 0
 * <tr><td> 19 <td>   swProf19 <td> R/W <td> R/W <td> 0
 * <tr><td> 18 <td>   swProf18 <td> R/W <td> R/W <td> 0
 * <tr><td> 17 <td>   swProf17 <td> R/W <td> R/W <td> 0
 * <tr><td> 16 <td>   swProf16 <td> R/W <td> R/W <td> 0
 * <tr><td> 15 <td>   swProf15 <td> R/W <td> R/W <td> 0
 * <tr><td> 14 <td>   swProf14 <td> R/W <td> R/W <td> 0
 * <tr><td> 13 <td>   swProf13 <td> R/W <td> R/W <td> 0
 * <tr><td> 12 <td>   swProf12 <td> R/W <td> R/W <td> 0
 * <tr><td> 11 <td>   swProf11 <td> R/W <td> R/W <td> 0
 * <tr><td> 10 <td>   swProf10 <td> R/W <td> R/W <td> 0
 * <tr><td> 09 <td>    swProf9 <td> R/W <td> R/W <td> 0
 * <tr><td> 08 <td>    swProf8 <td> R/W <td> R/W <td> 0
 * <tr><td> 07 <td>    swProf7 <td> R/W <td> R/W <td> 0
 * <tr><td> 06 <td>    swProf6 <td> R/W <td> R/W <td> 0
 * <tr><td> 05 <td>    swProf5 <td> R/W <td> R/W <td> 0
 * <tr><td> 04 <td>    swProf4 <td> R/W <td> R/W <td> 0
 * <tr><td> 03 <td>    swProf3 <td> R/W <td> R/W <td> 0
 * <tr><td> 02 <td>    swProf2 <td> R/W <td> R/W <td> 0
 * <tr><td> 01 <td>    swProf1 <td> R/W <td> R/W <td> 0
 * <tr><td> 00 <td>    swProf0 <td> R/W <td> R/W <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_SW_PROFILING_ADDR   0x24B08560
 ...
 * <table>
 * <caption>SW_SET_PROFILING bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31 <td>    swSetProf31 <td> R <td> S <td> 0
 * <tr><td> 30 <td>    swSetProf30 <td> R <td> S <td> 0
 * <tr><td> 29 <td>    swSetProf29 <td> R <td> S <td> 0
 * <tr><td> 28 <td>    swSetProf28 <td> R <td> S <td> 0
 * <tr><td> 27 <td>    swSetProf27 <td> R <td> S <td> 0
 * <tr><td> 26 <td>    swSetProf26 <td> R <td> S <td> 0
 * <tr><td> 25 <td>    swSetProf25 <td> R <td> S <td> 0
 * <tr><td> 24 <td>    swSetProf24 <td> R <td> S <td> 0
 * <tr><td> 23 <td>    swSetProf23 <td> R <td> S <td> 0
 * <tr><td> 22 <td>    swSetProf22 <td> R <td> S <td> 0
 * <tr><td> 21 <td>    swSetProf21 <td> R <td> S <td> 0
 * <tr><td> 20 <td>    swSetProf20 <td> R <td> S <td> 0
 * <tr><td> 19 <td>    swSetProf19 <td> R <td> S <td> 0
 * <tr><td> 18 <td>    swSetProf18 <td> R <td> S <td> 0
 * <tr><td> 17 <td>    swSetProf17 <td> R <td> S <td> 0
 * <tr><td> 16 <td>    swSetProf16 <td> R <td> S <td> 0
 * <tr><td> 15 <td>    swSetProf15 <td> R <td> S <td> 0
 * <tr><td> 14 <td>    swSetProf14 <td> R <td> S <td> 0
 * <tr><td> 13 <td>    swSetProf13 <td> R <td> S <td> 0
 * <tr><td> 12 <td>    swSetProf12 <td> R <td> S <td> 0
 * <tr><td> 11 <td>    swSetProf11 <td> R <td> S <td> 0
 * <tr><td> 10 <td>    swSetProf10 <td> R <td> S <td> 0
 * <tr><td> 09 <td>     swSetProf9 <td> R <td> S <td> 0
 * <tr><td> 08 <td>     swSetProf8 <td> R <td> S <td> 0
 * <tr><td> 07 <td>     swSetProf7 <td> R <td> S <td> 0
 * <tr><td> 06 <td>     swSetProf6 <td> R <td> S <td> 0
 * <tr><td> 05 <td>     swSetProf5 <td> R <td> S <td> 0
 * <tr><td> 04 <td>     swSetProf4 <td> R <td> S <td> 0
 * <tr><td> 03 <td>     swSetProf3 <td> R <td> S <td> 0
 * <tr><td> 02 <td>     swSetProf2 <td> R <td> S <td> 0
 * <tr><td> 01 <td>     swSetProf1 <td> R <td> S <td> 0
 * <tr><td> 00 <td>     swSetProf0 <td> R <td> S <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_SW_SET_PROFILING_ADDR   0x24B08564
 ...
 * <table>
 * <caption>SW_CLEAR_PROFILING bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31 <td>    swClearProf31 <td> R <td> C <td> 0
 * <tr><td> 30 <td>    swClearProf30 <td> R <td> C <td> 0
 * <tr><td> 29 <td>    swClearProf29 <td> R <td> C <td> 0
 * <tr><td> 28 <td>    swClearProf28 <td> R <td> C <td> 0
 * <tr><td> 27 <td>    swClearProf27 <td> R <td> C <td> 0
 * <tr><td> 26 <td>    swClearProf26 <td> R <td> C <td> 0
 * <tr><td> 25 <td>    swClearProf25 <td> R <td> C <td> 0
 * <tr><td> 24 <td>    swClearProf24 <td> R <td> C <td> 0
 * <tr><td> 23 <td>    swClearProf23 <td> R <td> C <td> 0
 * <tr><td> 22 <td>    swClearProf22 <td> R <td> C <td> 0
 * <tr><td> 21 <td>    swClearProf21 <td> R <td> C <td> 0
 * <tr><td> 20 <td>    swClearProf20 <td> R <td> C <td> 0
 * <tr><td> 19 <td>    swClearProf19 <td> R <td> C <td> 0
 * <tr><td> 18 <td>    swClearProf18 <td> R <td> C <td> 0
 * <tr><td> 17 <td>    swClearProf17 <td> R <td> C <td> 0
 * <tr><td> 16 <td>    swClearProf16 <td> R <td> C <td> 0
 * <tr><td> 15 <td>    swClearProf15 <td> R <td> C <td> 0
 * <tr><td> 14 <td>    swClearProf14 <td> R <td> C <td> 0
 * <tr><td> 13 <td>    swClearProf13 <td> R <td> C <td> 0
 * <tr><td> 12 <td>    swClearProf12 <td> R <td> C <td> 0
 * <tr><td> 11 <td>    swClearProf11 <td> R <td> C <td> 0
 * <tr><td> 10 <td>    swClearProf10 <td> R <td> C <td> 0
 * <tr><td> 09 <td>     swClearProf9 <td> R <td> C <td> 0
 * <tr><td> 08 <td>     swClearProf8 <td> R <td> C <td> 0
 * <tr><td> 07 <td>     swClearProf7 <td> R <td> C <td> 0
 * <tr><td> 06 <td>     swClearProf6 <td> R <td> C <td> 0
 * <tr><td> 05 <td>     swClearProf5 <td> R <td> C <td> 0
 * <tr><td> 04 <td>     swClearProf4 <td> R <td> C <td> 0
 * <tr><td> 03 <td>     swClearProf3 <td> R <td> C <td> 0
 * <tr><td> 02 <td>     swClearProf2 <td> R <td> C <td> 0
 * <tr><td> 01 <td>     swClearProf1 <td> R <td> C <td> 0
 * <tr><td> 00 <td>     swClearProf0 <td> R <td> C <td> 0
 * </table>
 *
 * @{
 */
...
#define NXMAC_SW_CLEAR_PROFILING_ADDR   0x24B08568
...
/**
 * @name SW_PROFILING_REG_2 register definitions
 * <table>
 * <caption>SW_PROFILING_REG_2 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31 <td>   swProf63 <td> R/W <td> R/W <td> 0
 * <tr><td> 30 <td>   swProf62 <td> R/W <td> R/W <td> 0
 * <tr><td> 29 <td>   swProf61 <td> R/W <td> R/W <td> 0
 * <tr><td> 28 <td>   swProf60 <td> R/W <td> R/W <td> 0
 * <tr><td> 27 <td>   swProf59 <td> R/W <td> R/W <td> 0
 * <tr><td> 26 <td>   swProf58 <td> R/W <td> R/W <td> 0
 * <tr><td> 25 <td>   swProf57 <td> R/W <td> R/W <td> 0
 * <tr><td> 24 <td>   swProf56 <td> R/W <td> R/W <td> 0
 * <tr><td> 23 <td>   swProf55 <td> R/W <td> R/W <td> 0
 * <tr><td> 22 <td>   swProf54 <td> R/W <td> R/W <td> 0
 * <tr><td> 21 <td>   swProf53 <td> R/W <td> R/W <td> 0
 * <tr><td> 20 <td>   swProf52 <td> R/W <td> R/W <td> 0
 * <tr><td> 19 <td>   swProf51 <td> R/W <td> R/W <td> 0
 * <tr><td> 18 <td>   swProf50 <td> R/W <td> R/W <td> 0
 * <tr><td> 17 <td>   swProf49 <td> R/W <td> R/W <td> 0
 * <tr><td> 16 <td>   swProf48 <td> R/W <td> R/W <td> 0
 * <tr><td> 15 <td>   swProf47 <td> R/W <td> R/W <td> 0
 * <tr><td> 14 <td>   swProf46 <td> R/W <td> R/W <td> 0
 * <tr><td> 13 <td>   swProf45 <td> R/W <td> R/W <td> 0
 * <tr><td> 12 <td>   swProf44 <td> R/W <td> R/W <td> 0
 * <tr><td> 11 <td>   swProf43 <td> R/W <td> R/W <td> 0
 * <tr><td> 10 <td>   swProf42 <td> R/W <td> R/W <td> 0
 * <tr><td> 09 <td>   swProf41 <td> R/W <td> R/W <td> 0
 * <tr><td> 08 <td>   swProf40 <td> R/W <td> R/W <td> 0
 * <tr><td> 07 <td>   swProf39 <td> R/W <td> R/W <td> 0
 * <tr><td> 06 <td>   swProf38 <td> R/W <td> R/W <td> 0
 * <tr><td> 05 <td>   swProf37 <td> R/W <td> R/W <td> 0
 * <tr><td> 04 <td>   swProf36 <td> R/W <td> R/W <td> 0
 * <tr><td> 03 <td>   swProf35 <td> R/W <td> R/W <td> 0
 * <tr><td> 02 <td>   swProf34 <td> R/W <td> R/W <td> 0
 * <tr><td> 01 <td>   swProf33 <td> R/W <td> R/W <td> 0
 * <tr><td> 00 <td>   swProf32 <td> R/W <td> R/W <td> 0
 * </table>
 *
 * @{
 */

/// Address of the SW_PROFILING_REG_2 register
#define NXMAC_SW_PROFILING_REG_2_ADDR   0x24B0856C
/// Offset of the SW_PROFILING_REG_2 register from the base address
#define NXMAC_SW_PROFILING_REG_2_OFFSET 0x0000056C
/// Index of the SW_PROFILING_REG_2 register
#define NXMAC_SW_PROFILING_REG_2_INDEX  0x0000015B
/// Reset value of the SW_PROFILING_REG_2 register
#define NXMAC_SW_PROFILING_REG_2_RESET  0x00000000

/**
 * @brief Returns the current value of the SW_PROFILING_REG_2 register.
 * The SW_PROFILING_REG_2 register will be read and its value returned.
 * @return The current value of the SW_PROFILING_REG_2 register.
 */
__INLINE uint32_t nxmac_sw_profiling_reg_2_get(void)
{
    return REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
}

/**
 * @brief Sets the SW_PROFILING_REG_2 register to a value.
 * The SW_PROFILING_REG_2 register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_sw_profiling_reg_2_set(uint32_t value)
{
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, value);
}

// field definitions
/// SW_PROF_63 field bit
#define NXMAC_SW_PROF_63_BIT    ((uint32_t)0x80000000)
/// SW_PROF_63 field position
#define NXMAC_SW_PROF_63_POS    31
/// SW_PROF_62 field bit
#define NXMAC_SW_PROF_62_BIT    ((uint32_t)0x40000000)
/// SW_PROF_62 field position
#define NXMAC_SW_PROF_62_POS    30
/// SW_PROF_61 field bit
#define NXMAC_SW_PROF_61_BIT    ((uint32_t)0x20000000)
/// SW_PROF_61 field position
#define NXMAC_SW_PROF_61_POS    29
/// SW_PROF_60 field bit
#define NXMAC_SW_PROF_60_BIT    ((uint32_t)0x10000000)
/// SW_PROF_60 field position
#define NXMAC_SW_PROF_60_POS    28
/// SW_PROF_59 field bit
#define NXMAC_SW_PROF_59_BIT    ((uint32_t)0x08000000)
/// SW_PROF_59 field position
#define NXMAC_SW_PROF_59_POS    27
/// SW_PROF_58 field bit
#define NXMAC_SW_PROF_58_BIT    ((uint32_t)0x04000000)
/// SW_PROF_58 field position
#define NXMAC_SW_PROF_58_POS    26
/// SW_PROF_57 field bit
#define NXMAC_SW_PROF_57_BIT    ((uint32_t)0x02000000)
/// SW_PROF_57 field position
#define NXMAC_SW_PROF_57_POS    25
/// SW_PROF_56 field bit
#define NXMAC_SW_PROF_56_BIT    ((uint32_t)0x01000000)
/// SW_PROF_56 field position
#define NXMAC_SW_PROF_56_POS    24
/// SW_PROF_55 field bit
#define NXMAC_SW_PROF_55_BIT    ((uint32_t)0x00800000)
/// SW_PROF_55 field position
#define NXMAC_SW_PROF_55_POS    23
/// SW_PROF_54 field bit
#define NXMAC_SW_PROF_54_BIT    ((uint32_t)0x00400000)
/// SW_PROF_54 field position
#define NXMAC_SW_PROF_54_POS    22
/// SW_PROF_53 field bit
#define NXMAC_SW_PROF_53_BIT    ((uint32_t)0x00200000)
/// SW_PROF_53 field position
#define NXMAC_SW_PROF_53_POS    21
/// SW_PROF_52 field bit
#define NXMAC_SW_PROF_52_BIT    ((uint32_t)0x00100000)
/// SW_PROF_52 field position
#define NXMAC_SW_PROF_52_POS    20
/// SW_PROF_51 field bit
#define NXMAC_SW_PROF_51_BIT    ((uint32_t)0x00080000)
/// SW_PROF_51 field position
#define NXMAC_SW_PROF_51_POS    19
/// SW_PROF_50 field bit
#define NXMAC_SW_PROF_50_BIT    ((uint32_t)0x00040000)
/// SW_PROF_50 field position
#define NXMAC_SW_PROF_50_POS    18
/// SW_PROF_49 field bit
#define NXMAC_SW_PROF_49_BIT    ((uint32_t)0x00020000)
/// SW_PROF_49 field position
#define NXMAC_SW_PROF_49_POS    17
/// SW_PROF_48 field bit
#define NXMAC_SW_PROF_48_BIT    ((uint32_t)0x00010000)
/// SW_PROF_48 field position
#define NXMAC_SW_PROF_48_POS    16
/// SW_PROF_47 field bit
#define NXMAC_SW_PROF_47_BIT    ((uint32_t)0x00008000)
/// SW_PROF_47 field position
#define NXMAC_SW_PROF_47_POS    15
/// SW_PROF_46 field bit
#define NXMAC_SW_PROF_46_BIT    ((uint32_t)0x00004000)
/// SW_PROF_46 field position
#define NXMAC_SW_PROF_46_POS    14
/// SW_PROF_45 field bit
#define NXMAC_SW_PROF_45_BIT    ((uint32_t)0x00002000)
/// SW_PROF_45 field position
#define NXMAC_SW_PROF_45_POS    13
/// SW_PROF_44 field bit
#define NXMAC_SW_PROF_44_BIT    ((uint32_t)0x00001000)
/// SW_PROF_44 field position
#define NXMAC_SW_PROF_44_POS    12
/// SW_PROF_43 field bit
#define NXMAC_SW_PROF_43_BIT    ((uint32_t)0x00000800)
/// SW_PROF_43 field position
#define NXMAC_SW_PROF_43_POS    11
/// SW_PROF_42 field bit
#define NXMAC_SW_PROF_42_BIT    ((uint32_t)0x00000400)
/// SW_PROF_42 field position
#define NXMAC_SW_PROF_42_POS    10
/// SW_PROF_41 field bit
#define NXMAC_SW_PROF_41_BIT    ((uint32_t)0x00000200)
/// SW_PROF_41 field position
#define NXMAC_SW_PROF_41_POS    9
/// SW_PROF_40 field bit
#define NXMAC_SW_PROF_40_BIT    ((uint32_t)0x00000100)
/// SW_PROF_40 field position
#define NXMAC_SW_PROF_40_POS    8
/// SW_PROF_39 field bit
#define NXMAC_SW_PROF_39_BIT    ((uint32_t)0x00000080)
/// SW_PROF_39 field position
#define NXMAC_SW_PROF_39_POS    7
/// SW_PROF_38 field bit
#define NXMAC_SW_PROF_38_BIT    ((uint32_t)0x00000040)
/// SW_PROF_38 field position
#define NXMAC_SW_PROF_38_POS    6
/// SW_PROF_37 field bit
#define NXMAC_SW_PROF_37_BIT    ((uint32_t)0x00000020)
/// SW_PROF_37 field position
#define NXMAC_SW_PROF_37_POS    5
/// SW_PROF_36 field bit
#define NXMAC_SW_PROF_36_BIT    ((uint32_t)0x00000010)
/// SW_PROF_36 field position
#define NXMAC_SW_PROF_36_POS    4
/// SW_PROF_35 field bit
#define NXMAC_SW_PROF_35_BIT    ((uint32_t)0x00000008)
/// SW_PROF_35 field position
#define NXMAC_SW_PROF_35_POS    3
/// SW_PROF_34 field bit
#define NXMAC_SW_PROF_34_BIT    ((uint32_t)0x00000004)
/// SW_PROF_34 field position
#define NXMAC_SW_PROF_34_POS    2
/// SW_PROF_33 field bit
#define NXMAC_SW_PROF_33_BIT    ((uint32_t)0x00000002)
/// SW_PROF_33 field position
#define NXMAC_SW_PROF_33_POS    1
/// SW_PROF_32 field bit
#define NXMAC_SW_PROF_32_BIT    ((uint32_t)0x00000001)
/// SW_PROF_32 field position
#define NXMAC_SW_PROF_32_POS    0

/// SW_PROF_63 field reset value
#define NXMAC_SW_PROF_63_RST    0x0
/// SW_PROF_62 field reset value
#define NXMAC_SW_PROF_62_RST    0x0
/// SW_PROF_61 field reset value
#define NXMAC_SW_PROF_61_RST    0x0
/// SW_PROF_60 field reset value
#define NXMAC_SW_PROF_60_RST    0x0
/// SW_PROF_59 field reset value
#define NXMAC_SW_PROF_59_RST    0x0
/// SW_PROF_58 field reset value
#define NXMAC_SW_PROF_58_RST    0x0
/// SW_PROF_57 field reset value
#define NXMAC_SW_PROF_57_RST    0x0
/// SW_PROF_56 field reset value
#define NXMAC_SW_PROF_56_RST    0x0
/// SW_PROF_55 field reset value
#define NXMAC_SW_PROF_55_RST    0x0
/// SW_PROF_54 field reset value
#define NXMAC_SW_PROF_54_RST    0x0
/// SW_PROF_53 field reset value
#define NXMAC_SW_PROF_53_RST    0x0
/// SW_PROF_52 field reset value
#define NXMAC_SW_PROF_52_RST    0x0
/// SW_PROF_51 field reset value
#define NXMAC_SW_PROF_51_RST    0x0
/// SW_PROF_50 field reset value
#define NXMAC_SW_PROF_50_RST    0x0
/// SW_PROF_49 field reset value
#define NXMAC_SW_PROF_49_RST    0x0
/// SW_PROF_48 field reset value
#define NXMAC_SW_PROF_48_RST    0x0
/// SW_PROF_47 field reset value
#define NXMAC_SW_PROF_47_RST    0x0
/// SW_PROF_46 field reset value
#define NXMAC_SW_PROF_46_RST    0x0
/// SW_PROF_45 field reset value
#define NXMAC_SW_PROF_45_RST    0x0
/// SW_PROF_44 field reset value
#define NXMAC_SW_PROF_44_RST    0x0
/// SW_PROF_43 field reset value
#define NXMAC_SW_PROF_43_RST    0x0
/// SW_PROF_42 field reset value
#define NXMAC_SW_PROF_42_RST    0x0
/// SW_PROF_41 field reset value
#define NXMAC_SW_PROF_41_RST    0x0
/// SW_PROF_40 field reset value
#define NXMAC_SW_PROF_40_RST    0x0
/// SW_PROF_39 field reset value
#define NXMAC_SW_PROF_39_RST    0x0
/// SW_PROF_38 field reset value
#define NXMAC_SW_PROF_38_RST    0x0
/// SW_PROF_37 field reset value
#define NXMAC_SW_PROF_37_RST    0x0
/// SW_PROF_36 field reset value
#define NXMAC_SW_PROF_36_RST    0x0
/// SW_PROF_35 field reset value
#define NXMAC_SW_PROF_35_RST    0x0
/// SW_PROF_34 field reset value
#define NXMAC_SW_PROF_34_RST    0x0
/// SW_PROF_33 field reset value
#define NXMAC_SW_PROF_33_RST    0x0
/// SW_PROF_32 field reset value
#define NXMAC_SW_PROF_32_RST    0x0

/**
 * @brief Constructs a value for the SW_PROFILING_REG_2 register given values for its fields
 * and writes the value to the register.
 *
 * @param[in] swprof63 - The value to use for the swProf63 field.
 * @param[in] swprof62 - The value to use for the swProf62 field.
 * @param[in] swprof61 - The value to use for the swProf61 field.
 * @param[in] swprof60 - The value to use for the swProf60 field.
 * @param[in] swprof59 - The value to use for the swProf59 field.
 * @param[in] swprof58 - The value to use for the swProf58 field.
 * @param[in] swprof57 - The value to use for the swProf57 field.
 * @param[in] swprof56 - The value to use for the swProf56 field.
 * @param[in] swprof55 - The value to use for the swProf55 field.
 * @param[in] swprof54 - The value to use for the swProf54 field.
 * @param[in] swprof53 - The value to use for the swProf53 field.
 * @param[in] swprof52 - The value to use for the swProf52 field.
 * @param[in] swprof51 - The value to use for the swProf51 field.
 * @param[in] swprof50 - The value to use for the swProf50 field.
 * @param[in] swprof49 - The value to use for the swProf49 field.
 * @param[in] swprof48 - The value to use for the swProf48 field.
 * @param[in] swprof47 - The value to use for the swProf47 field.
 * @param[in] swprof46 - The value to use for the swProf46 field.
 * @param[in] swprof45 - The value to use for the swProf45 field.
 * @param[in] swprof44 - The value to use for the swProf44 field.
 * @param[in] swprof43 - The value to use for the swProf43 field.
 * @param[in] swprof42 - The value to use for the swProf42 field.
 * @param[in] swprof41 - The value to use for the swProf41 field.
 * @param[in] swprof40 - The value to use for the swProf40 field.
 * @param[in] swprof39 - The value to use for the swProf39 field.
 * @param[in] swprof38 - The value to use for the swProf38 field.
 * @param[in] swprof37 - The value to use for the swProf37 field.
 * @param[in] swprof36 - The value to use for the swProf36 field.
 * @param[in] swprof35 - The value to use for the swProf35 field.
 * @param[in] swprof34 - The value to use for the swProf34 field.
 * @param[in] swprof33 - The value to use for the swProf33 field.
 * @param[in] swprof32 - The value to use for the swProf32 field.
 */
__INLINE void nxmac_sw_profiling_reg_2_pack(uint8_t swprof63, uint8_t swprof62, uint8_t swprof61, uint8_t swprof60, uint8_t swprof59, uint8_t swprof58, uint8_t swprof57, uint8_t swprof56, uint8_t swprof55, uint8_t swprof54, uint8_t swprof53, uint8_t swprof52, uint8_t swprof51, uint8_t swprof50, uint8_t swprof49, uint8_t swprof48, uint8_t swprof47, uint8_t swprof46, uint8_t swprof45, uint8_t swprof44, uint8_t swprof43, uint8_t swprof42, uint8_t swprof41, uint8_t swprof40, uint8_t swprof39, uint8_t swprof38, uint8_t swprof37, uint8_t swprof36, uint8_t swprof35, uint8_t swprof34, uint8_t swprof33, uint8_t swprof32)
{
    ASSERT_ERR((((uint32_t)swprof63 << 31) & ~((uint32_t)0x80000000)) == 0);
    ASSERT_ERR((((uint32_t)swprof62 << 30) & ~((uint32_t)0x40000000)) == 0);
    ASSERT_ERR((((uint32_t)swprof61 << 29) & ~((uint32_t)0x20000000)) == 0);
    ASSERT_ERR((((uint32_t)swprof60 << 28) & ~((uint32_t)0x10000000)) == 0);
    ASSERT_ERR((((uint32_t)swprof59 << 27) & ~((uint32_t)0x08000000)) == 0);
    ASSERT_ERR((((uint32_t)swprof58 << 26) & ~((uint32_t)0x04000000)) == 0);
    ASSERT_ERR((((uint32_t)swprof57 << 25) & ~((uint32_t)0x02000000)) == 0);
    ASSERT_ERR((((uint32_t)swprof56 << 24) & ~((uint32_t)0x01000000)) == 0);
    ASSERT_ERR((((uint32_t)swprof55 << 23) & ~((uint32_t)0x00800000)) == 0);
    ASSERT_ERR((((uint32_t)swprof54 << 22) & ~((uint32_t)0x00400000)) == 0);
    ASSERT_ERR((((uint32_t)swprof53 << 21) & ~((uint32_t)0x00200000)) == 0);
    ASSERT_ERR((((uint32_t)swprof52 << 20) & ~((uint32_t)0x00100000)) == 0);
    ASSERT_ERR((((uint32_t)swprof51 << 19) & ~((uint32_t)0x00080000)) == 0);
    ASSERT_ERR((((uint32_t)swprof50 << 18) & ~((uint32_t)0x00040000)) == 0);
    ASSERT_ERR((((uint32_t)swprof49 << 17) & ~((uint32_t)0x00020000)) == 0);
    ASSERT_ERR((((uint32_t)swprof48 << 16) & ~((uint32_t)0x00010000)) == 0);
    ASSERT_ERR((((uint32_t)swprof47 << 15) & ~((uint32_t)0x00008000)) == 0);
    ASSERT_ERR((((uint32_t)swprof46 << 14) & ~((uint32_t)0x00004000)) == 0);
    ASSERT_ERR((((uint32_t)swprof45 << 13) & ~((uint32_t)0x00002000)) == 0);
    ASSERT_ERR((((uint32_t)swprof44 << 12) & ~((uint32_t)0x00001000)) == 0);
    ASSERT_ERR((((uint32_t)swprof43 << 11) & ~((uint32_t)0x00000800)) == 0);
    ASSERT_ERR((((uint32_t)swprof42 << 10) & ~((uint32_t)0x00000400)) == 0);
    ASSERT_ERR((((uint32_t)swprof41 << 9) & ~((uint32_t)0x00000200)) == 0);
    ASSERT_ERR((((uint32_t)swprof40 << 8) & ~((uint32_t)0x00000100)) == 0);
    ASSERT_ERR((((uint32_t)swprof39 << 7) & ~((uint32_t)0x00000080)) == 0);
    ASSERT_ERR((((uint32_t)swprof38 << 6) & ~((uint32_t)0x00000040)) == 0);
    ASSERT_ERR((((uint32_t)swprof37 << 5) & ~((uint32_t)0x00000020)) == 0);
    ASSERT_ERR((((uint32_t)swprof36 << 4) & ~((uint32_t)0x00000010)) == 0);
    ASSERT_ERR((((uint32_t)swprof35 << 3) & ~((uint32_t)0x00000008)) == 0);
    ASSERT_ERR((((uint32_t)swprof34 << 2) & ~((uint32_t)0x00000004)) == 0);
    ASSERT_ERR((((uint32_t)swprof33 << 1) & ~((uint32_t)0x00000002)) == 0);
    ASSERT_ERR((((uint32_t)swprof32 << 0) & ~((uint32_t)0x00000001)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR,  ((uint32_t)swprof63 << 31) | ((uint32_t)swprof62 << 30) | ((uint32_t)swprof61 << 29) | ((uint32_t)swprof60 << 28) | ((uint32_t)swprof59 << 27) | ((uint32_t)swprof58 << 26) | ((uint32_t)swprof57 << 25) | ((uint32_t)swprof56 << 24) | ((uint32_t)swprof55 << 23) | ((uint32_t)swprof54 << 22) | ((uint32_t)swprof53 << 21) | ((uint32_t)swprof52 << 20) | ((uint32_t)swprof51 << 19) | ((uint32_t)swprof50 << 18) | ((uint32_t)swprof49 << 17) | ((uint32_t)swprof48 << 16) | ((uint32_t)swprof47 << 15) | ((uint32_t)swprof46 << 14) | ((uint32_t)swprof45 << 13) | ((uint32_t)swprof44 << 12) | ((uint32_t)swprof43 << 11) | ((uint32_t)swprof42 << 10) | ((uint32_t)swprof41 << 9) | ((uint32_t)swprof40 << 8) | ((uint32_t)swprof39 << 7) | ((uint32_t)swprof38 << 6) | ((uint32_t)swprof37 << 5) | ((uint32_t)swprof36 << 4) | ((uint32_t)swprof35 << 3) | ((uint32_t)swprof34 << 2) | ((uint32_t)swprof33 << 1) | ((uint32_t)swprof32 << 0));
}

/**
 * @brief Unpacks SW_PROFILING_REG_2's fields from current value of the SW_PROFILING_REG_2 register.
 *
 * Reads the SW_PROFILING_REG_2 register and populates all the _field variables with the corresponding
 * values from the register.
 *
 * @param[out] swprof63 - Will be populated with the current value of this field from the register.
 * @param[out] swprof62 - Will be populated with the current value of this field from the register.
 * @param[out] swprof61 - Will be populated with the current value of this field from the register.
 * @param[out] swprof60 - Will be populated with the current value of this field from the register.
 * @param[out] swprof59 - Will be populated with the current value of this field from the register.
 * @param[out] swprof58 - Will be populated with the current value of this field from the register.
 * @param[out] swprof57 - Will be populated with the current value of this field from the register.
 * @param[out] swprof56 - Will be populated with the current value of this field from the register.
 * @param[out] swprof55 - Will be populated with the current value of this field from the register.
 * @param[out] swprof54 - Will be populated with the current value of this field from the register.
 * @param[out] swprof53 - Will be populated with the current value of this field from the register.
 * @param[out] swprof52 - Will be populated with the current value of this field from the register.
 * @param[out] swprof51 - Will be populated with the current value of this field from the register.
 * @param[out] swprof50 - Will be populated with the current value of this field from the register.
 * @param[out] swprof49 - Will be populated with the current value of this field from the register.
 * @param[out] swprof48 - Will be populated with the current value of this field from the register.
 * @param[out] swprof47 - Will be populated with the current value of this field from the register.
 * @param[out] swprof46 - Will be populated with the current value of this field from the register.
 * @param[out] swprof45 - Will be populated with the current value of this field from the register.
 * @param[out] swprof44 - Will be populated with the current value of this field from the register.
 * @param[out] swprof43 - Will be populated with the current value of this field from the register.
 * @param[out] swprof42 - Will be populated with the current value of this field from the register.
 * @param[out] swprof41 - Will be populated with the current value of this field from the register.
 * @param[out] swprof40 - Will be populated with the current value of this field from the register.
 * @param[out] swprof39 - Will be populated with the current value of this field from the register.
 * @param[out] swprof38 - Will be populated with the current value of this field from the register.
 * @param[out] swprof37 - Will be populated with the current value of this field from the register.
 * @param[out] swprof36 - Will be populated with the current value of this field from the register.
 * @param[out] swprof35 - Will be populated with the current value of this field from the register.
 * @param[out] swprof34 - Will be populated with the current value of this field from the register.
 * @param[out] swprof33 - Will be populated with the current value of this field from the register.
 * @param[out] swprof32 - Will be populated with the current value of this field from the register.
 */
__INLINE void nxmac_sw_profiling_reg_2_unpack(uint8_t* swprof63, uint8_t* swprof62, uint8_t* swprof61, uint8_t* swprof60, uint8_t* swprof59, uint8_t* swprof58, uint8_t* swprof57, uint8_t* swprof56, uint8_t* swprof55, uint8_t* swprof54, uint8_t* swprof53, uint8_t* swprof52, uint8_t* swprof51, uint8_t* swprof50, uint8_t* swprof49, uint8_t* swprof48, uint8_t* swprof47, uint8_t* swprof46, uint8_t* swprof45, uint8_t* swprof44, uint8_t* swprof43, uint8_t* swprof42, uint8_t* swprof41, uint8_t* swprof40, uint8_t* swprof39, uint8_t* swprof38, uint8_t* swprof37, uint8_t* swprof36, uint8_t* swprof35, uint8_t* swprof34, uint8_t* swprof33, uint8_t* swprof32)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);

    *swprof63 = (localVal & ((uint32_t)0x80000000)) >> 31;
    *swprof62 = (localVal & ((uint32_t)0x40000000)) >> 30;
    *swprof61 = (localVal & ((uint32_t)0x20000000)) >> 29;
    *swprof60 = (localVal & ((uint32_t)0x10000000)) >> 28;
    *swprof59 = (localVal & ((uint32_t)0x08000000)) >> 27;
    *swprof58 = (localVal & ((uint32_t)0x04000000)) >> 26;
    *swprof57 = (localVal & ((uint32_t)0x02000000)) >> 25;
    *swprof56 = (localVal & ((uint32_t)0x01000000)) >> 24;
    *swprof55 = (localVal & ((uint32_t)0x00800000)) >> 23;
    *swprof54 = (localVal & ((uint32_t)0x00400000)) >> 22;
    *swprof53 = (localVal & ((uint32_t)0x00200000)) >> 21;
    *swprof52 = (localVal & ((uint32_t)0x00100000)) >> 20;
    *swprof51 = (localVal & ((uint32_t)0x00080000)) >> 19;
    *swprof50 = (localVal & ((uint32_t)0x00040000)) >> 18;
    *swprof49 = (localVal & ((uint32_t)0x00020000)) >> 17;
    *swprof48 = (localVal & ((uint32_t)0x00010000)) >> 16;
    *swprof47 = (localVal & ((uint32_t)0x00008000)) >> 15;
    *swprof46 = (localVal & ((uint32_t)0x00004000)) >> 14;
    *swprof45 = (localVal & ((uint32_t)0x00002000)) >> 13;
    *swprof44 = (localVal & ((uint32_t)0x00001000)) >> 12;
    *swprof43 = (localVal & ((uint32_t)0x00000800)) >> 11;
    *swprof42 = (localVal & ((uint32_t)0x00000400)) >> 10;
    *swprof41 = (localVal & ((uint32_t)0x00000200)) >> 9;
    *swprof40 = (localVal & ((uint32_t)0x00000100)) >> 8;
    *swprof39 = (localVal & ((uint32_t)0x00000080)) >> 7;
    *swprof38 = (localVal & ((uint32_t)0x00000040)) >> 6;
    *swprof37 = (localVal & ((uint32_t)0x00000020)) >> 5;
    *swprof36 = (localVal & ((uint32_t)0x00000010)) >> 4;
    *swprof35 = (localVal & ((uint32_t)0x00000008)) >> 3;
    *swprof34 = (localVal & ((uint32_t)0x00000004)) >> 2;
    *swprof33 = (localVal & ((uint32_t)0x00000002)) >> 1;
    *swprof32 = (localVal & ((uint32_t)0x00000001)) >> 0;
}

/**
 * @brief Returns the current value of the swProf63 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf63 field's value will be returned.
 *
 * @return The current value of the swProf63 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_63_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x80000000)) >> 31);
}
...
/**
 * @brief Sets the swProf63 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof63 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_63_setf(uint8_t swprof63)
{
    ASSERT_ERR((((uint32_t)swprof63 << 31) & ~((uint32_t)0x80000000)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x80000000)) | ((uint32_t)swprof63 << 31));
}

/**
 * @brief Returns the current value of the swProf62 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf62 field's value will be returned.
 *
 * @return The current value of the swProf62 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_62_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x40000000)) >> 30);
}
...
/**
 * @brief Sets the swProf62 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof62 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_62_setf(uint8_t swprof62)
{
    ASSERT_ERR((((uint32_t)swprof62 << 30) & ~((uint32_t)0x40000000)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x40000000)) | ((uint32_t)swprof62 << 30));
}

/**
 * @brief Returns the current value of the swProf61 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf61 field's value will be returned.
 *
 * @return The current value of the swProf61 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_61_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x20000000)) >> 29);
}
...
/**
 * @brief Sets the swProf61 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof61 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_61_setf(uint8_t swprof61)
{
    ASSERT_ERR((((uint32_t)swprof61 << 29) & ~((uint32_t)0x20000000)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x20000000)) | ((uint32_t)swprof61 << 29));
}

/**
 * @brief Returns the current value of the swProf60 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf60 field's value will be returned.
 *
 * @return The current value of the swProf60 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_60_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x10000000)) >> 28);
}
...
/**
 * @brief Sets the swProf60 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof60 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_60_setf(uint8_t swprof60)
{
    ASSERT_ERR((((uint32_t)swprof60 << 28) & ~((uint32_t)0x10000000)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x10000000)) | ((uint32_t)swprof60 << 28));
}

/**
 * @brief Returns the current value of the swProf59 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf59 field's value will be returned.
 *
 * @return The current value of the swProf59 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_59_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x08000000)) >> 27);
}
...
/**
 * @brief Sets the swProf59 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof59 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_59_setf(uint8_t swprof59)
{
    ASSERT_ERR((((uint32_t)swprof59 << 27) & ~((uint32_t)0x08000000)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x08000000)) | ((uint32_t)swprof59 << 27));
}

/**
 * @brief Returns the current value of the swProf58 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf58 field's value will be returned.
 *
 * @return The current value of the swProf58 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_58_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x04000000)) >> 26);
}
...
/**
 * @brief Sets the swProf58 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof58 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_58_setf(uint8_t swprof58)
{
    ASSERT_ERR((((uint32_t)swprof58 << 26) & ~((uint32_t)0x04000000)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x04000000)) | ((uint32_t)swprof58 << 26));
}

/**
 * @brief Returns the current value of the swProf57 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf57 field's value will be returned.
 *
 * @return The current value of the swProf57 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_57_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x02000000)) >> 25);
}
...
/**
 * @brief Sets the swProf57 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof57 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_57_setf(uint8_t swprof57)
{
    ASSERT_ERR((((uint32_t)swprof57 << 25) & ~((uint32_t)0x02000000)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x02000000)) | ((uint32_t)swprof57 << 25));
}

/**
 * @brief Returns the current value of the swProf56 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf56 field's value will be returned.
 *
 * @return The current value of the swProf56 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_56_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x01000000)) >> 24);
}
...
/**
 * @brief Sets the swProf56 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof56 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_56_setf(uint8_t swprof56)
{
    ASSERT_ERR((((uint32_t)swprof56 << 24) & ~((uint32_t)0x01000000)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x01000000)) | ((uint32_t)swprof56 << 24));
}

/**
 * @brief Returns the current value of the swProf55 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf55 field's value will be returned.
 *
 * @return The current value of the swProf55 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_55_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00800000)) >> 23);
}
...
/**
 * @brief Sets the swProf55 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof55 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_55_setf(uint8_t swprof55)
{
    ASSERT_ERR((((uint32_t)swprof55 << 23) & ~((uint32_t)0x00800000)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x00800000)) | ((uint32_t)swprof55 << 23));
}

/**
 * @brief Returns the current value of the swProf54 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf54 field's value will be returned.
 *
 * @return The current value of the swProf54 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_54_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00400000)) >> 22);
}
...
/**
 * @brief Sets the swProf54 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof54 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_54_setf(uint8_t swprof54)
{
    ASSERT_ERR((((uint32_t)swprof54 << 22) & ~((uint32_t)0x00400000)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x00400000)) | ((uint32_t)swprof54 << 22));
}

/**
 * @brief Returns the current value of the swProf53 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf53 field's value will be returned.
 *
 * @return The current value of the swProf53 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_53_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00200000)) >> 21);
}
...
/**
 * @brief Sets the swProf53 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof53 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_53_setf(uint8_t swprof53)
{
    ASSERT_ERR((((uint32_t)swprof53 << 21) & ~((uint32_t)0x00200000)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x00200000)) | ((uint32_t)swprof53 << 21));
}

/**
 * @brief Returns the current value of the swProf52 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf52 field's value will be returned.
 *
 * @return The current value of the swProf52 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_52_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00100000)) >> 20);
}
...
/**
 * @brief Sets the swProf52 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof52 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_52_setf(uint8_t swprof52)
{
    ASSERT_ERR((((uint32_t)swprof52 << 20) & ~((uint32_t)0x00100000)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x00100000)) | ((uint32_t)swprof52 << 20));
}

/**
 * @brief Returns the current value of the swProf51 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf51 field's value will be returned.
 *
 * @return The current value of the swProf51 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_51_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00080000)) >> 19);
}
...
/**
 * @brief Sets the swProf51 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof51 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_51_setf(uint8_t swprof51)
{
    ASSERT_ERR((((uint32_t)swprof51 << 19) & ~((uint32_t)0x00080000)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x00080000)) | ((uint32_t)swprof51 << 19));
}

/**
 * @brief Returns the current value of the swProf50 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf50 field's value will be returned.
 *
 * @return The current value of the swProf50 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_50_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00040000)) >> 18);
}
...
/**
 * @brief Sets the swProf50 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof50 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_50_setf(uint8_t swprof50)
{
    ASSERT_ERR((((uint32_t)swprof50 << 18) & ~((uint32_t)0x00040000)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x00040000)) | ((uint32_t)swprof50 << 18));
}

/**
 * @brief Returns the current value of the swProf49 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf49 field's value will be returned.
 *
 * @return The current value of the swProf49 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_49_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00020000)) >> 17);
}
...
/**
 * @brief Sets the swProf49 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof49 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_49_setf(uint8_t swprof49)
{
    ASSERT_ERR((((uint32_t)swprof49 << 17) & ~((uint32_t)0x00020000)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x00020000)) | ((uint32_t)swprof49 << 17));
}

/**
 * @brief Returns the current value of the swProf48 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf48 field's value will be returned.
 *
 * @return The current value of the swProf48 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_48_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00010000)) >> 16);
}
...
/**
 * @brief Sets the swProf48 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof48 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_48_setf(uint8_t swprof48)
{
    ASSERT_ERR((((uint32_t)swprof48 << 16) & ~((uint32_t)0x00010000)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x00010000)) | ((uint32_t)swprof48 << 16));
}

/**
 * @brief Returns the current value of the swProf47 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf47 field's value will be returned.
 *
 * @return The current value of the swProf47 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_47_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00008000)) >> 15);
}
...
/**
 * @brief Sets the swProf47 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof47 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_47_setf(uint8_t swprof47)
{
    ASSERT_ERR((((uint32_t)swprof47 << 15) & ~((uint32_t)0x00008000)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x00008000)) | ((uint32_t)swprof47 << 15));
}

/**
 * @brief Returns the current value of the swProf46 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf46 field's value will be returned.
 *
 * @return The current value of the swProf46 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_46_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00004000)) >> 14);
}
...
/**
 * @brief Sets the swProf46 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof46 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_46_setf(uint8_t swprof46)
{
    ASSERT_ERR((((uint32_t)swprof46 << 14) & ~((uint32_t)0x00004000)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x00004000)) | ((uint32_t)swprof46 << 14));
}

/**
 * @brief Returns the current value of the swProf45 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf45 field's value will be returned.
 *
 * @return The current value of the swProf45 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_45_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00002000)) >> 13);
}
...
/**
 * @brief Sets the swProf45 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof45 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_45_setf(uint8_t swprof45)
{
    ASSERT_ERR((((uint32_t)swprof45 << 13) & ~((uint32_t)0x00002000)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x00002000)) | ((uint32_t)swprof45 << 13));
}

/**
 * @brief Returns the current value of the swProf44 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf44 field's value will be returned.
 *
 * @return The current value of the swProf44 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_44_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00001000)) >> 12);
}
...
/**
 * @brief Sets the swProf44 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof44 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_44_setf(uint8_t swprof44)
{
    ASSERT_ERR((((uint32_t)swprof44 << 12) & ~((uint32_t)0x00001000)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x00001000)) | ((uint32_t)swprof44 << 12));
}

/**
 * @brief Returns the current value of the swProf43 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf43 field's value will be returned.
 *
 * @return The current value of the swProf43 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_43_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000800)) >> 11);
}
...
/**
 * @brief Sets the swProf43 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof43 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_43_setf(uint8_t swprof43)
{
    ASSERT_ERR((((uint32_t)swprof43 << 11) & ~((uint32_t)0x00000800)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x00000800)) | ((uint32_t)swprof43 << 11));
}

/**
 * @brief Returns the current value of the swProf42 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf42 field's value will be returned.
 *
 * @return The current value of the swProf42 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_42_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000400)) >> 10);
}
...
/**
 * @brief Sets the swProf42 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof42 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_42_setf(uint8_t swprof42)
{
    ASSERT_ERR((((uint32_t)swprof42 << 10) & ~((uint32_t)0x00000400)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x00000400)) | ((uint32_t)swprof42 << 10));
}

/**
 * @brief Returns the current value of the swProf41 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf41 field's value will be returned.
 *
 * @return The current value of the swProf41 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_41_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000200)) >> 9);
}
...
/**
 * @brief Sets the swProf41 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof41 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_41_setf(uint8_t swprof41)
{
    ASSERT_ERR((((uint32_t)swprof41 << 9) & ~((uint32_t)0x00000200)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x00000200)) | ((uint32_t)swprof41 << 9));
}

/**
 * @brief Returns the current value of the swProf40 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf40 field's value will be returned.
 *
 * @return The current value of the swProf40 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_40_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000100)) >> 8);
}
...
/**
 * @brief Sets the swProf40 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof40 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_40_setf(uint8_t swprof40)
{
    ASSERT_ERR((((uint32_t)swprof40 << 8) & ~((uint32_t)0x00000100)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x00000100)) | ((uint32_t)swprof40 << 8));
}

/**
 * @brief Returns the current value of the swProf39 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf39 field's value will be returned.
 *
 * @return The current value of the swProf39 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_39_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000080)) >> 7);
}
...
/**
 * @brief Sets the swProf39 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof39 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_39_setf(uint8_t swprof39)
{
    ASSERT_ERR((((uint32_t)swprof39 << 7) & ~((uint32_t)0x00000080)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x00000080)) | ((uint32_t)swprof39 << 7));
}

/**
 * @brief Returns the current value of the swProf38 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf38 field's value will be returned.
 *
 * @return The current value of the swProf38 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_38_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000040)) >> 6);
}
...
/**
 * @brief Sets the swProf38 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof38 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_38_setf(uint8_t swprof38)
{
    ASSERT_ERR((((uint32_t)swprof38 << 6) & ~((uint32_t)0x00000040)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x00000040)) | ((uint32_t)swprof38 << 6));
}

/**
 * @brief Returns the current value of the swProf37 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf37 field's value will be returned.
 *
 * @return The current value of the swProf37 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_37_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000020)) >> 5);
}
...
/**
 * @brief Sets the swProf37 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof37 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_37_setf(uint8_t swprof37)
{
    ASSERT_ERR((((uint32_t)swprof37 << 5) & ~((uint32_t)0x00000020)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x00000020)) | ((uint32_t)swprof37 << 5));
}

/**
 * @brief Returns the current value of the swProf36 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf36 field's value will be returned.
 *
 * @return The current value of the swProf36 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_36_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000010)) >> 4);
}
...
/**
 * @brief Sets the swProf36 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof36 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_36_setf(uint8_t swprof36)
{
    ASSERT_ERR((((uint32_t)swprof36 << 4) & ~((uint32_t)0x00000010)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x00000010)) | ((uint32_t)swprof36 << 4));
}

/**
 * @brief Returns the current value of the swProf35 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf35 field's value will be returned.
 *
 * @return The current value of the swProf35 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_35_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000008)) >> 3);
}
...
/**
 * @brief Sets the swProf35 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof35 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_35_setf(uint8_t swprof35)
{
    ASSERT_ERR((((uint32_t)swprof35 << 3) & ~((uint32_t)0x00000008)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x00000008)) | ((uint32_t)swprof35 << 3));
}

/**
 * @brief Returns the current value of the swProf34 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf34 field's value will be returned.
 *
 * @return The current value of the swProf34 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_34_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000004)) >> 2);
}
...
/**
 * @brief Sets the swProf34 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof34 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_34_setf(uint8_t swprof34)
{
    ASSERT_ERR((((uint32_t)swprof34 << 2) & ~((uint32_t)0x00000004)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x00000004)) | ((uint32_t)swprof34 << 2));
}

/**
 * @brief Returns the current value of the swProf33 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf33 field's value will be returned.
 *
 * @return The current value of the swProf33 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_33_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000002)) >> 1);
}
...
/**
 * @brief Sets the swProf33 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof33 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_33_setf(uint8_t swprof33)
{
    ASSERT_ERR((((uint32_t)swprof33 << 1) & ~((uint32_t)0x00000002)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x00000002)) | ((uint32_t)swprof33 << 1));
}

/**
 * @brief Returns the current value of the swProf32 field in the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read and the swProf32 field's value will be returned.
 *
 * @return The current value of the swProf32 field in the SW_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_prof_32_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000001)) >> 0);
}
...
/**
 * @brief Sets the swProf32 field of the SW_PROFILING_REG_2 register.
 *
 * The SW_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swprof32 - The value to set the field to.
 */
__INLINE void nxmac_sw_prof_32_setf(uint8_t swprof32)
{
    ASSERT_ERR((((uint32_t)swprof32 << 0) & ~((uint32_t)0x00000001)) == 0);
    REG_PL_WR(NXMAC_SW_PROFILING_REG_2_ADDR, (REG_PL_RD(NXMAC_SW_PROFILING_REG_2_ADDR) & ~((uint32_t)0x00000001)) | ((uint32_t)swprof32 << 0));
}

/// @}

/**
 * @name SW_SET_PROFILING_REG_2 register definitions
 * <table>
 * <caption>SW_SET_PROFILING_REG_2 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31 <td>    swSetProf63 <td> R <td> S <td> 0
 * <tr><td> 30 <td>    swSetProf62 <td> R <td> S <td> 0
 * <tr><td> 29 <td>    swSetProf61 <td> R <td> S <td> 0
 * <tr><td> 28 <td>    swSetProf60 <td> R <td> S <td> 0
 * <tr><td> 27 <td>    swSetProf59 <td> R <td> S <td> 0
 * <tr><td> 26 <td>    swSetProf58 <td> R <td> S <td> 0
 * <tr><td> 25 <td>    swSetProf57 <td> R <td> S <td> 0
 * <tr><td> 24 <td>    swSetProf56 <td> R <td> S <td> 0
 * <tr><td> 23 <td>    swSetProf55 <td> R <td> S <td> 0
 * <tr><td> 22 <td>    swSetProf54 <td> R <td> S <td> 0
 * <tr><td> 21 <td>    swSetProf53 <td> R <td> S <td> 0
 * <tr><td> 20 <td>    swSetProf52 <td> R <td> S <td> 0
 * <tr><td> 19 <td>    swSetProf51 <td> R <td> S <td> 0
 * <tr><td> 18 <td>    swSetProf50 <td> R <td> S <td> 0
 * <tr><td> 17 <td>    swSetProf49 <td> R <td> S <td> 0
 * <tr><td> 16 <td>    swSetProf48 <td> R <td> S <td> 0
 * <tr><td> 15 <td>    swSetProf47 <td> R <td> S <td> 0
 * <tr><td> 14 <td>    swSetProf46 <td> R <td> S <td> 0
 * <tr><td> 13 <td>    swSetProf45 <td> R <td> S <td> 0
 * <tr><td> 12 <td>    swSetProf44 <td> R <td> S <td> 0
 * <tr><td> 11 <td>    swSetProf43 <td> R <td> S <td> 0
 * <tr><td> 10 <td>    swSetProf42 <td> R <td> S <td> 0
 * <tr><td> 09 <td>    swSetProf41 <td> R <td> S <td> 0
 * <tr><td> 08 <td>    swSetProf40 <td> R <td> S <td> 0
 * <tr><td> 07 <td>    swSetProf39 <td> R <td> S <td> 0
 * <tr><td> 06 <td>    swSetProf38 <td> R <td> S <td> 0
 * <tr><td> 05 <td>    swSetProf37 <td> R <td> S <td> 0
 * <tr><td> 04 <td>    swSetProf36 <td> R <td> S <td> 0
 * <tr><td> 03 <td>    swSetProf35 <td> R <td> S <td> 0
 * <tr><td> 02 <td>    swSetProf34 <td> R <td> S <td> 0
 * <tr><td> 01 <td>    swSetProf33 <td> R <td> S <td> 0
 * <tr><td> 00 <td>    swSetProf32 <td> R <td> S <td> 0
 * </table>
 *
 * @{
 */

/// Address of the SW_SET_PROFILING_REG_2 register
#define NXMAC_SW_SET_PROFILING_REG_2_ADDR   0x24B08570
/// Offset of the SW_SET_PROFILING_REG_2 register from the base address
#define NXMAC_SW_SET_PROFILING_REG_2_OFFSET 0x00000570
/// Index of the SW_SET_PROFILING_REG_2 register
#define NXMAC_SW_SET_PROFILING_REG_2_INDEX  0x0000015C
/// Reset value of the SW_SET_PROFILING_REG_2 register
#define NXMAC_SW_SET_PROFILING_REG_2_RESET  0x00000000

/**
 * @brief Returns the current value of the SW_SET_PROFILING_REG_2 register.
 * The SW_SET_PROFILING_REG_2 register will be read and its value returned.
 * @return The current value of the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint32_t nxmac_sw_set_profiling_reg_2_get(void)
{
    return REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
}

/**
 * @brief Sets the SW_SET_PROFILING_REG_2 register to a value.
 * The SW_SET_PROFILING_REG_2 register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_sw_set_profiling_reg_2_set(uint32_t value)
{
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, value);
}

// field definitions
/// SW_SET_PROF_63 field bit
#define NXMAC_SW_SET_PROF_63_BIT    ((uint32_t)0x80000000)
/// SW_SET_PROF_63 field position
#define NXMAC_SW_SET_PROF_63_POS    31
/// SW_SET_PROF_62 field bit
#define NXMAC_SW_SET_PROF_62_BIT    ((uint32_t)0x40000000)
/// SW_SET_PROF_62 field position
#define NXMAC_SW_SET_PROF_62_POS    30
/// SW_SET_PROF_61 field bit
#define NXMAC_SW_SET_PROF_61_BIT    ((uint32_t)0x20000000)
/// SW_SET_PROF_61 field position
#define NXMAC_SW_SET_PROF_61_POS    29
/// SW_SET_PROF_60 field bit
#define NXMAC_SW_SET_PROF_60_BIT    ((uint32_t)0x10000000)
/// SW_SET_PROF_60 field position
#define NXMAC_SW_SET_PROF_60_POS    28
/// SW_SET_PROF_59 field bit
#define NXMAC_SW_SET_PROF_59_BIT    ((uint32_t)0x08000000)
/// SW_SET_PROF_59 field position
#define NXMAC_SW_SET_PROF_59_POS    27
/// SW_SET_PROF_58 field bit
#define NXMAC_SW_SET_PROF_58_BIT    ((uint32_t)0x04000000)
/// SW_SET_PROF_58 field position
#define NXMAC_SW_SET_PROF_58_POS    26
/// SW_SET_PROF_57 field bit
#define NXMAC_SW_SET_PROF_57_BIT    ((uint32_t)0x02000000)
/// SW_SET_PROF_57 field position
#define NXMAC_SW_SET_PROF_57_POS    25
/// SW_SET_PROF_56 field bit
#define NXMAC_SW_SET_PROF_56_BIT    ((uint32_t)0x01000000)
/// SW_SET_PROF_56 field position
#define NXMAC_SW_SET_PROF_56_POS    24
/// SW_SET_PROF_55 field bit
#define NXMAC_SW_SET_PROF_55_BIT    ((uint32_t)0x00800000)
/// SW_SET_PROF_55 field position
#define NXMAC_SW_SET_PROF_55_POS    23
/// SW_SET_PROF_54 field bit
#define NXMAC_SW_SET_PROF_54_BIT    ((uint32_t)0x00400000)
/// SW_SET_PROF_54 field position
#define NXMAC_SW_SET_PROF_54_POS    22
/// SW_SET_PROF_53 field bit
#define NXMAC_SW_SET_PROF_53_BIT    ((uint32_t)0x00200000)
/// SW_SET_PROF_53 field position
#define NXMAC_SW_SET_PROF_53_POS    21
/// SW_SET_PROF_52 field bit
#define NXMAC_SW_SET_PROF_52_BIT    ((uint32_t)0x00100000)
/// SW_SET_PROF_52 field position
#define NXMAC_SW_SET_PROF_52_POS    20
/// SW_SET_PROF_51 field bit
#define NXMAC_SW_SET_PROF_51_BIT    ((uint32_t)0x00080000)
/// SW_SET_PROF_51 field position
#define NXMAC_SW_SET_PROF_51_POS    19
/// SW_SET_PROF_50 field bit
#define NXMAC_SW_SET_PROF_50_BIT    ((uint32_t)0x00040000)
/// SW_SET_PROF_50 field position
#define NXMAC_SW_SET_PROF_50_POS    18
/// SW_SET_PROF_49 field bit
#define NXMAC_SW_SET_PROF_49_BIT    ((uint32_t)0x00020000)
/// SW_SET_PROF_49 field position
#define NXMAC_SW_SET_PROF_49_POS    17
/// SW_SET_PROF_48 field bit
#define NXMAC_SW_SET_PROF_48_BIT    ((uint32_t)0x00010000)
/// SW_SET_PROF_48 field position
#define NXMAC_SW_SET_PROF_48_POS    16
/// SW_SET_PROF_47 field bit
#define NXMAC_SW_SET_PROF_47_BIT    ((uint32_t)0x00008000)
/// SW_SET_PROF_47 field position
#define NXMAC_SW_SET_PROF_47_POS    15
/// SW_SET_PROF_46 field bit
#define NXMAC_SW_SET_PROF_46_BIT    ((uint32_t)0x00004000)
/// SW_SET_PROF_46 field position
#define NXMAC_SW_SET_PROF_46_POS    14
/// SW_SET_PROF_45 field bit
#define NXMAC_SW_SET_PROF_45_BIT    ((uint32_t)0x00002000)
/// SW_SET_PROF_45 field position
#define NXMAC_SW_SET_PROF_45_POS    13
/// SW_SET_PROF_44 field bit
#define NXMAC_SW_SET_PROF_44_BIT    ((uint32_t)0x00001000)
/// SW_SET_PROF_44 field position
#define NXMAC_SW_SET_PROF_44_POS    12
/// SW_SET_PROF_43 field bit
#define NXMAC_SW_SET_PROF_43_BIT    ((uint32_t)0x00000800)
/// SW_SET_PROF_43 field position
#define NXMAC_SW_SET_PROF_43_POS    11
/// SW_SET_PROF_42 field bit
#define NXMAC_SW_SET_PROF_42_BIT    ((uint32_t)0x00000400)
/// SW_SET_PROF_42 field position
#define NXMAC_SW_SET_PROF_42_POS    10
/// SW_SET_PROF_41 field bit
#define NXMAC_SW_SET_PROF_41_BIT    ((uint32_t)0x00000200)
/// SW_SET_PROF_41 field position
#define NXMAC_SW_SET_PROF_41_POS    9
/// SW_SET_PROF_40 field bit
#define NXMAC_SW_SET_PROF_40_BIT    ((uint32_t)0x00000100)
/// SW_SET_PROF_40 field position
#define NXMAC_SW_SET_PROF_40_POS    8
/// SW_SET_PROF_39 field bit
#define NXMAC_SW_SET_PROF_39_BIT    ((uint32_t)0x00000080)
/// SW_SET_PROF_39 field position
#define NXMAC_SW_SET_PROF_39_POS    7
/// SW_SET_PROF_38 field bit
#define NXMAC_SW_SET_PROF_38_BIT    ((uint32_t)0x00000040)
/// SW_SET_PROF_38 field position
#define NXMAC_SW_SET_PROF_38_POS    6
/// SW_SET_PROF_37 field bit
#define NXMAC_SW_SET_PROF_37_BIT    ((uint32_t)0x00000020)
/// SW_SET_PROF_37 field position
#define NXMAC_SW_SET_PROF_37_POS    5
/// SW_SET_PROF_36 field bit
#define NXMAC_SW_SET_PROF_36_BIT    ((uint32_t)0x00000010)
/// SW_SET_PROF_36 field position
#define NXMAC_SW_SET_PROF_36_POS    4
/// SW_SET_PROF_35 field bit
#define NXMAC_SW_SET_PROF_35_BIT    ((uint32_t)0x00000008)
/// SW_SET_PROF_35 field position
#define NXMAC_SW_SET_PROF_35_POS    3
/// SW_SET_PROF_34 field bit
#define NXMAC_SW_SET_PROF_34_BIT    ((uint32_t)0x00000004)
/// SW_SET_PROF_34 field position
#define NXMAC_SW_SET_PROF_34_POS    2
/// SW_SET_PROF_33 field bit
#define NXMAC_SW_SET_PROF_33_BIT    ((uint32_t)0x00000002)
/// SW_SET_PROF_33 field position
#define NXMAC_SW_SET_PROF_33_POS    1
/// SW_SET_PROF_32 field bit
#define NXMAC_SW_SET_PROF_32_BIT    ((uint32_t)0x00000001)
/// SW_SET_PROF_32 field position
#define NXMAC_SW_SET_PROF_32_POS    0

/// SW_SET_PROF_63 field reset value
#define NXMAC_SW_SET_PROF_63_RST    0x0
/// SW_SET_PROF_62 field reset value
#define NXMAC_SW_SET_PROF_62_RST    0x0
/// SW_SET_PROF_61 field reset value
#define NXMAC_SW_SET_PROF_61_RST    0x0
/// SW_SET_PROF_60 field reset value
#define NXMAC_SW_SET_PROF_60_RST    0x0
/// SW_SET_PROF_59 field reset value
#define NXMAC_SW_SET_PROF_59_RST    0x0
/// SW_SET_PROF_58 field reset value
#define NXMAC_SW_SET_PROF_58_RST    0x0
/// SW_SET_PROF_57 field reset value
#define NXMAC_SW_SET_PROF_57_RST    0x0
/// SW_SET_PROF_56 field reset value
#define NXMAC_SW_SET_PROF_56_RST    0x0
/// SW_SET_PROF_55 field reset value
#define NXMAC_SW_SET_PROF_55_RST    0x0
/// SW_SET_PROF_54 field reset value
#define NXMAC_SW_SET_PROF_54_RST    0x0
/// SW_SET_PROF_53 field reset value
#define NXMAC_SW_SET_PROF_53_RST    0x0
/// SW_SET_PROF_52 field reset value
#define NXMAC_SW_SET_PROF_52_RST    0x0
/// SW_SET_PROF_51 field reset value
#define NXMAC_SW_SET_PROF_51_RST    0x0
/// SW_SET_PROF_50 field reset value
#define NXMAC_SW_SET_PROF_50_RST    0x0
/// SW_SET_PROF_49 field reset value
#define NXMAC_SW_SET_PROF_49_RST    0x0
/// SW_SET_PROF_48 field reset value
#define NXMAC_SW_SET_PROF_48_RST    0x0
/// SW_SET_PROF_47 field reset value
#define NXMAC_SW_SET_PROF_47_RST    0x0
/// SW_SET_PROF_46 field reset value
#define NXMAC_SW_SET_PROF_46_RST    0x0
/// SW_SET_PROF_45 field reset value
#define NXMAC_SW_SET_PROF_45_RST    0x0
/// SW_SET_PROF_44 field reset value
#define NXMAC_SW_SET_PROF_44_RST    0x0
/// SW_SET_PROF_43 field reset value
#define NXMAC_SW_SET_PROF_43_RST    0x0
/// SW_SET_PROF_42 field reset value
#define NXMAC_SW_SET_PROF_42_RST    0x0
/// SW_SET_PROF_41 field reset value
#define NXMAC_SW_SET_PROF_41_RST    0x0
/// SW_SET_PROF_40 field reset value
#define NXMAC_SW_SET_PROF_40_RST    0x0
/// SW_SET_PROF_39 field reset value
#define NXMAC_SW_SET_PROF_39_RST    0x0
/// SW_SET_PROF_38 field reset value
#define NXMAC_SW_SET_PROF_38_RST    0x0
/// SW_SET_PROF_37 field reset value
#define NXMAC_SW_SET_PROF_37_RST    0x0
/// SW_SET_PROF_36 field reset value
#define NXMAC_SW_SET_PROF_36_RST    0x0
/// SW_SET_PROF_35 field reset value
#define NXMAC_SW_SET_PROF_35_RST    0x0
/// SW_SET_PROF_34 field reset value
#define NXMAC_SW_SET_PROF_34_RST    0x0
/// SW_SET_PROF_33 field reset value
#define NXMAC_SW_SET_PROF_33_RST    0x0
/// SW_SET_PROF_32 field reset value
#define NXMAC_SW_SET_PROF_32_RST    0x0

/**
 * @brief Constructs a value for the SW_SET_PROFILING_REG_2 register given values for its fields
 * and writes the value to the register.
 *
 * @param[in] swsetprof63 - The value to use for the swSetProf63 field.
 * @param[in] swsetprof62 - The value to use for the swSetProf62 field.
 * @param[in] swsetprof61 - The value to use for the swSetProf61 field.
 * @param[in] swsetprof60 - The value to use for the swSetProf60 field.
 * @param[in] swsetprof59 - The value to use for the swSetProf59 field.
 * @param[in] swsetprof58 - The value to use for the swSetProf58 field.
 * @param[in] swsetprof57 - The value to use for the swSetProf57 field.
 * @param[in] swsetprof56 - The value to use for the swSetProf56 field.
 * @param[in] swsetprof55 - The value to use for the swSetProf55 field.
 * @param[in] swsetprof54 - The value to use for the swSetProf54 field.
 * @param[in] swsetprof53 - The value to use for the swSetProf53 field.
 * @param[in] swsetprof52 - The value to use for the swSetProf52 field.
 * @param[in] swsetprof51 - The value to use for the swSetProf51 field.
 * @param[in] swsetprof50 - The value to use for the swSetProf50 field.
 * @param[in] swsetprof49 - The value to use for the swSetProf49 field.
 * @param[in] swsetprof48 - The value to use for the swSetProf48 field.
 * @param[in] swsetprof47 - The value to use for the swSetProf47 field.
 * @param[in] swsetprof46 - The value to use for the swSetProf46 field.
 * @param[in] swsetprof45 - The value to use for the swSetProf45 field.
 * @param[in] swsetprof44 - The value to use for the swSetProf44 field.
 * @param[in] swsetprof43 - The value to use for the swSetProf43 field.
 * @param[in] swsetprof42 - The value to use for the swSetProf42 field.
 * @param[in] swsetprof41 - The value to use for the swSetProf41 field.
 * @param[in] swsetprof40 - The value to use for the swSetProf40 field.
 * @param[in] swsetprof39 - The value to use for the swSetProf39 field.
 * @param[in] swsetprof38 - The value to use for the swSetProf38 field.
 * @param[in] swsetprof37 - The value to use for the swSetProf37 field.
 * @param[in] swsetprof36 - The value to use for the swSetProf36 field.
 * @param[in] swsetprof35 - The value to use for the swSetProf35 field.
 * @param[in] swsetprof34 - The value to use for the swSetProf34 field.
 * @param[in] swsetprof33 - The value to use for the swSetProf33 field.
 * @param[in] swsetprof32 - The value to use for the swSetProf32 field.
 */
__INLINE void nxmac_sw_set_profiling_reg_2_pack(uint8_t swsetprof63, uint8_t swsetprof62, uint8_t swsetprof61, uint8_t swsetprof60, uint8_t swsetprof59, uint8_t swsetprof58, uint8_t swsetprof57, uint8_t swsetprof56, uint8_t swsetprof55, uint8_t swsetprof54, uint8_t swsetprof53, uint8_t swsetprof52, uint8_t swsetprof51, uint8_t swsetprof50, uint8_t swsetprof49, uint8_t swsetprof48, uint8_t swsetprof47, uint8_t swsetprof46, uint8_t swsetprof45, uint8_t swsetprof44, uint8_t swsetprof43, uint8_t swsetprof42, uint8_t swsetprof41, uint8_t swsetprof40, uint8_t swsetprof39, uint8_t swsetprof38, uint8_t swsetprof37, uint8_t swsetprof36, uint8_t swsetprof35, uint8_t swsetprof34, uint8_t swsetprof33, uint8_t swsetprof32)
{
    ASSERT_ERR((((uint32_t)swsetprof63 << 31) & ~((uint32_t)0x80000000)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof62 << 30) & ~((uint32_t)0x40000000)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof61 << 29) & ~((uint32_t)0x20000000)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof60 << 28) & ~((uint32_t)0x10000000)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof59 << 27) & ~((uint32_t)0x08000000)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof58 << 26) & ~((uint32_t)0x04000000)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof57 << 25) & ~((uint32_t)0x02000000)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof56 << 24) & ~((uint32_t)0x01000000)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof55 << 23) & ~((uint32_t)0x00800000)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof54 << 22) & ~((uint32_t)0x00400000)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof53 << 21) & ~((uint32_t)0x00200000)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof52 << 20) & ~((uint32_t)0x00100000)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof51 << 19) & ~((uint32_t)0x00080000)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof50 << 18) & ~((uint32_t)0x00040000)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof49 << 17) & ~((uint32_t)0x00020000)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof48 << 16) & ~((uint32_t)0x00010000)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof47 << 15) & ~((uint32_t)0x00008000)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof46 << 14) & ~((uint32_t)0x00004000)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof45 << 13) & ~((uint32_t)0x00002000)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof44 << 12) & ~((uint32_t)0x00001000)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof43 << 11) & ~((uint32_t)0x00000800)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof42 << 10) & ~((uint32_t)0x00000400)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof41 << 9) & ~((uint32_t)0x00000200)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof40 << 8) & ~((uint32_t)0x00000100)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof39 << 7) & ~((uint32_t)0x00000080)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof38 << 6) & ~((uint32_t)0x00000040)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof37 << 5) & ~((uint32_t)0x00000020)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof36 << 4) & ~((uint32_t)0x00000010)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof35 << 3) & ~((uint32_t)0x00000008)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof34 << 2) & ~((uint32_t)0x00000004)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof33 << 1) & ~((uint32_t)0x00000002)) == 0);
    ASSERT_ERR((((uint32_t)swsetprof32 << 0) & ~((uint32_t)0x00000001)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR,  ((uint32_t)swsetprof63 << 31) | ((uint32_t)swsetprof62 << 30) | ((uint32_t)swsetprof61 << 29) | ((uint32_t)swsetprof60 << 28) | ((uint32_t)swsetprof59 << 27) | ((uint32_t)swsetprof58 << 26) | ((uint32_t)swsetprof57 << 25) | ((uint32_t)swsetprof56 << 24) | ((uint32_t)swsetprof55 << 23) | ((uint32_t)swsetprof54 << 22) | ((uint32_t)swsetprof53 << 21) | ((uint32_t)swsetprof52 << 20) | ((uint32_t)swsetprof51 << 19) | ((uint32_t)swsetprof50 << 18) | ((uint32_t)swsetprof49 << 17) | ((uint32_t)swsetprof48 << 16) | ((uint32_t)swsetprof47 << 15) | ((uint32_t)swsetprof46 << 14) | ((uint32_t)swsetprof45 << 13) | ((uint32_t)swsetprof44 << 12) | ((uint32_t)swsetprof43 << 11) | ((uint32_t)swsetprof42 << 10) | ((uint32_t)swsetprof41 << 9) | ((uint32_t)swsetprof40 << 8) | ((uint32_t)swsetprof39 << 7) | ((uint32_t)swsetprof38 << 6) | ((uint32_t)swsetprof37 << 5) | ((uint32_t)swsetprof36 << 4) | ((uint32_t)swsetprof35 << 3) | ((uint32_t)swsetprof34 << 2) | ((uint32_t)swsetprof33 << 1) | ((uint32_t)swsetprof32 << 0));
}

/**
 * @brief Unpacks SW_SET_PROFILING_REG_2's fields from current value of the SW_SET_PROFILING_REG_2 register.
 *
 * Reads the SW_SET_PROFILING_REG_2 register and populates all the _field variables with the corresponding
 * values from the register.
 *
 * @param[out] swsetprof63 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof62 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof61 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof60 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof59 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof58 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof57 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof56 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof55 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof54 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof53 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof52 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof51 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof50 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof49 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof48 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof47 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof46 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof45 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof44 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof43 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof42 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof41 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof40 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof39 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof38 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof37 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof36 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof35 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof34 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof33 - Will be populated with the current value of this field from the register.
 * @param[out] swsetprof32 - Will be populated with the current value of this field from the register.
 */
__INLINE void nxmac_sw_set_profiling_reg_2_unpack(uint8_t* swsetprof63, uint8_t* swsetprof62, uint8_t* swsetprof61, uint8_t* swsetprof60, uint8_t* swsetprof59, uint8_t* swsetprof58, uint8_t* swsetprof57, uint8_t* swsetprof56, uint8_t* swsetprof55, uint8_t* swsetprof54, uint8_t* swsetprof53, uint8_t* swsetprof52, uint8_t* swsetprof51, uint8_t* swsetprof50, uint8_t* swsetprof49, uint8_t* swsetprof48, uint8_t* swsetprof47, uint8_t* swsetprof46, uint8_t* swsetprof45, uint8_t* swsetprof44, uint8_t* swsetprof43, uint8_t* swsetprof42, uint8_t* swsetprof41, uint8_t* swsetprof40, uint8_t* swsetprof39, uint8_t* swsetprof38, uint8_t* swsetprof37, uint8_t* swsetprof36, uint8_t* swsetprof35, uint8_t* swsetprof34, uint8_t* swsetprof33, uint8_t* swsetprof32)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);

    *swsetprof63 = (localVal & ((uint32_t)0x80000000)) >> 31;
    *swsetprof62 = (localVal & ((uint32_t)0x40000000)) >> 30;
    *swsetprof61 = (localVal & ((uint32_t)0x20000000)) >> 29;
    *swsetprof60 = (localVal & ((uint32_t)0x10000000)) >> 28;
    *swsetprof59 = (localVal & ((uint32_t)0x08000000)) >> 27;
    *swsetprof58 = (localVal & ((uint32_t)0x04000000)) >> 26;
    *swsetprof57 = (localVal & ((uint32_t)0x02000000)) >> 25;
    *swsetprof56 = (localVal & ((uint32_t)0x01000000)) >> 24;
    *swsetprof55 = (localVal & ((uint32_t)0x00800000)) >> 23;
    *swsetprof54 = (localVal & ((uint32_t)0x00400000)) >> 22;
    *swsetprof53 = (localVal & ((uint32_t)0x00200000)) >> 21;
    *swsetprof52 = (localVal & ((uint32_t)0x00100000)) >> 20;
    *swsetprof51 = (localVal & ((uint32_t)0x00080000)) >> 19;
    *swsetprof50 = (localVal & ((uint32_t)0x00040000)) >> 18;
    *swsetprof49 = (localVal & ((uint32_t)0x00020000)) >> 17;
    *swsetprof48 = (localVal & ((uint32_t)0x00010000)) >> 16;
    *swsetprof47 = (localVal & ((uint32_t)0x00008000)) >> 15;
    *swsetprof46 = (localVal & ((uint32_t)0x00004000)) >> 14;
    *swsetprof45 = (localVal & ((uint32_t)0x00002000)) >> 13;
    *swsetprof44 = (localVal & ((uint32_t)0x00001000)) >> 12;
    *swsetprof43 = (localVal & ((uint32_t)0x00000800)) >> 11;
    *swsetprof42 = (localVal & ((uint32_t)0x00000400)) >> 10;
    *swsetprof41 = (localVal & ((uint32_t)0x00000200)) >> 9;
    *swsetprof40 = (localVal & ((uint32_t)0x00000100)) >> 8;
    *swsetprof39 = (localVal & ((uint32_t)0x00000080)) >> 7;
    *swsetprof38 = (localVal & ((uint32_t)0x00000040)) >> 6;
    *swsetprof37 = (localVal & ((uint32_t)0x00000020)) >> 5;
    *swsetprof36 = (localVal & ((uint32_t)0x00000010)) >> 4;
    *swsetprof35 = (localVal & ((uint32_t)0x00000008)) >> 3;
    *swsetprof34 = (localVal & ((uint32_t)0x00000004)) >> 2;
    *swsetprof33 = (localVal & ((uint32_t)0x00000002)) >> 1;
    *swsetprof32 = (localVal & ((uint32_t)0x00000001)) >> 0;
}

/**
 * @brief Returns the current value of the swSetProf63 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf63 field's value will be returned.
 *
 * @return The current value of the swSetProf63 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_63_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x80000000)) >> 31);
}
...
/**
 * @brief Sets the swSetProf63 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof63 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_63_setf(uint8_t swsetprof63)
{
    ASSERT_ERR((((uint32_t)swsetprof63 << 31) & ~((uint32_t)0x80000000)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof63 << 31);
}

/**
 * @brief Returns the current value of the swSetProf62 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf62 field's value will be returned.
 *
 * @return The current value of the swSetProf62 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_62_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x40000000)) >> 30);
}
...
/**
 * @brief Sets the swSetProf62 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof62 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_62_setf(uint8_t swsetprof62)
{
    ASSERT_ERR((((uint32_t)swsetprof62 << 30) & ~((uint32_t)0x40000000)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof62 << 30);
}

/**
 * @brief Returns the current value of the swSetProf61 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf61 field's value will be returned.
 *
 * @return The current value of the swSetProf61 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_61_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x20000000)) >> 29);
}
...
/**
 * @brief Sets the swSetProf61 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof61 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_61_setf(uint8_t swsetprof61)
{
    ASSERT_ERR((((uint32_t)swsetprof61 << 29) & ~((uint32_t)0x20000000)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof61 << 29);
}

/**
 * @brief Returns the current value of the swSetProf60 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf60 field's value will be returned.
 *
 * @return The current value of the swSetProf60 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_60_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x10000000)) >> 28);
}
...
/**
 * @brief Sets the swSetProf60 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof60 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_60_setf(uint8_t swsetprof60)
{
    ASSERT_ERR((((uint32_t)swsetprof60 << 28) & ~((uint32_t)0x10000000)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof60 << 28);
}

/**
 * @brief Returns the current value of the swSetProf59 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf59 field's value will be returned.
 *
 * @return The current value of the swSetProf59 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_59_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x08000000)) >> 27);
}
...
/**
 * @brief Sets the swSetProf59 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof59 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_59_setf(uint8_t swsetprof59)
{
    ASSERT_ERR((((uint32_t)swsetprof59 << 27) & ~((uint32_t)0x08000000)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof59 << 27);
}

/**
 * @brief Returns the current value of the swSetProf58 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf58 field's value will be returned.
 *
 * @return The current value of the swSetProf58 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_58_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x04000000)) >> 26);
}
...
/**
 * @brief Sets the swSetProf58 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof58 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_58_setf(uint8_t swsetprof58)
{
    ASSERT_ERR((((uint32_t)swsetprof58 << 26) & ~((uint32_t)0x04000000)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof58 << 26);
}

/**
 * @brief Returns the current value of the swSetProf57 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf57 field's value will be returned.
 *
 * @return The current value of the swSetProf57 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_57_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x02000000)) >> 25);
}
...
/**
 * @brief Sets the swSetProf57 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof57 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_57_setf(uint8_t swsetprof57)
{
    ASSERT_ERR((((uint32_t)swsetprof57 << 25) & ~((uint32_t)0x02000000)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof57 << 25);
}

/**
 * @brief Returns the current value of the swSetProf56 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf56 field's value will be returned.
 *
 * @return The current value of the swSetProf56 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_56_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x01000000)) >> 24);
}
...
/**
 * @brief Sets the swSetProf56 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof56 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_56_setf(uint8_t swsetprof56)
{
    ASSERT_ERR((((uint32_t)swsetprof56 << 24) & ~((uint32_t)0x01000000)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof56 << 24);
}

/**
 * @brief Returns the current value of the swSetProf55 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf55 field's value will be returned.
 *
 * @return The current value of the swSetProf55 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_55_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00800000)) >> 23);
}
...
/**
 * @brief Sets the swSetProf55 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof55 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_55_setf(uint8_t swsetprof55)
{
    ASSERT_ERR((((uint32_t)swsetprof55 << 23) & ~((uint32_t)0x00800000)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof55 << 23);
}

/**
 * @brief Returns the current value of the swSetProf54 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf54 field's value will be returned.
 *
 * @return The current value of the swSetProf54 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_54_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00400000)) >> 22);
}
...
/**
 * @brief Sets the swSetProf54 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof54 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_54_setf(uint8_t swsetprof54)
{
    ASSERT_ERR((((uint32_t)swsetprof54 << 22) & ~((uint32_t)0x00400000)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof54 << 22);
}

/**
 * @brief Returns the current value of the swSetProf53 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf53 field's value will be returned.
 *
 * @return The current value of the swSetProf53 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_53_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00200000)) >> 21);
}
...
/**
 * @brief Sets the swSetProf53 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof53 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_53_setf(uint8_t swsetprof53)
{
    ASSERT_ERR((((uint32_t)swsetprof53 << 21) & ~((uint32_t)0x00200000)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof53 << 21);
}

/**
 * @brief Returns the current value of the swSetProf52 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf52 field's value will be returned.
 *
 * @return The current value of the swSetProf52 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_52_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00100000)) >> 20);
}
...
/**
 * @brief Sets the swSetProf52 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof52 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_52_setf(uint8_t swsetprof52)
{
    ASSERT_ERR((((uint32_t)swsetprof52 << 20) & ~((uint32_t)0x00100000)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof52 << 20);
}

/**
 * @brief Returns the current value of the swSetProf51 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf51 field's value will be returned.
 *
 * @return The current value of the swSetProf51 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_51_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00080000)) >> 19);
}
...
/**
 * @brief Sets the swSetProf51 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof51 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_51_setf(uint8_t swsetprof51)
{
    ASSERT_ERR((((uint32_t)swsetprof51 << 19) & ~((uint32_t)0x00080000)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof51 << 19);
}

/**
 * @brief Returns the current value of the swSetProf50 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf50 field's value will be returned.
 *
 * @return The current value of the swSetProf50 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_50_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00040000)) >> 18);
}
...
/**
 * @brief Sets the swSetProf50 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof50 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_50_setf(uint8_t swsetprof50)
{
    ASSERT_ERR((((uint32_t)swsetprof50 << 18) & ~((uint32_t)0x00040000)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof50 << 18);
}

/**
 * @brief Returns the current value of the swSetProf49 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf49 field's value will be returned.
 *
 * @return The current value of the swSetProf49 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_49_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00020000)) >> 17);
}
...
/**
 * @brief Sets the swSetProf49 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof49 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_49_setf(uint8_t swsetprof49)
{
    ASSERT_ERR((((uint32_t)swsetprof49 << 17) & ~((uint32_t)0x00020000)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof49 << 17);
}

/**
 * @brief Returns the current value of the swSetProf48 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf48 field's value will be returned.
 *
 * @return The current value of the swSetProf48 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_48_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00010000)) >> 16);
}
...
/**
 * @brief Sets the swSetProf48 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof48 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_48_setf(uint8_t swsetprof48)
{
    ASSERT_ERR((((uint32_t)swsetprof48 << 16) & ~((uint32_t)0x00010000)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof48 << 16);
}

/**
 * @brief Returns the current value of the swSetProf47 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf47 field's value will be returned.
 *
 * @return The current value of the swSetProf47 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_47_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00008000)) >> 15);
}
...
/**
 * @brief Sets the swSetProf47 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof47 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_47_setf(uint8_t swsetprof47)
{
    ASSERT_ERR((((uint32_t)swsetprof47 << 15) & ~((uint32_t)0x00008000)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof47 << 15);
}

/**
 * @brief Returns the current value of the swSetProf46 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf46 field's value will be returned.
 *
 * @return The current value of the swSetProf46 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_46_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00004000)) >> 14);
}
...
/**
 * @brief Sets the swSetProf46 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof46 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_46_setf(uint8_t swsetprof46)
{
    ASSERT_ERR((((uint32_t)swsetprof46 << 14) & ~((uint32_t)0x00004000)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof46 << 14);
}

/**
 * @brief Returns the current value of the swSetProf45 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf45 field's value will be returned.
 *
 * @return The current value of the swSetProf45 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_45_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00002000)) >> 13);
}
...
/**
 * @brief Sets the swSetProf45 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof45 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_45_setf(uint8_t swsetprof45)
{
    ASSERT_ERR((((uint32_t)swsetprof45 << 13) & ~((uint32_t)0x00002000)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof45 << 13);
}

/**
 * @brief Returns the current value of the swSetProf44 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf44 field's value will be returned.
 *
 * @return The current value of the swSetProf44 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_44_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00001000)) >> 12);
}
...
/**
 * @brief Sets the swSetProf44 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof44 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_44_setf(uint8_t swsetprof44)
{
    ASSERT_ERR((((uint32_t)swsetprof44 << 12) & ~((uint32_t)0x00001000)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof44 << 12);
}

/**
 * @brief Returns the current value of the swSetProf43 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf43 field's value will be returned.
 *
 * @return The current value of the swSetProf43 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_43_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000800)) >> 11);
}
...
/**
 * @brief Sets the swSetProf43 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof43 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_43_setf(uint8_t swsetprof43)
{
    ASSERT_ERR((((uint32_t)swsetprof43 << 11) & ~((uint32_t)0x00000800)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof43 << 11);
}

/**
 * @brief Returns the current value of the swSetProf42 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf42 field's value will be returned.
 *
 * @return The current value of the swSetProf42 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_42_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000400)) >> 10);
}
...
/**
 * @brief Sets the swSetProf42 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof42 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_42_setf(uint8_t swsetprof42)
{
    ASSERT_ERR((((uint32_t)swsetprof42 << 10) & ~((uint32_t)0x00000400)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof42 << 10);
}

/**
 * @brief Returns the current value of the swSetProf41 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf41 field's value will be returned.
 *
 * @return The current value of the swSetProf41 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_41_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000200)) >> 9);
}
...
/**
 * @brief Sets the swSetProf41 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof41 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_41_setf(uint8_t swsetprof41)
{
    ASSERT_ERR((((uint32_t)swsetprof41 << 9) & ~((uint32_t)0x00000200)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof41 << 9);
}

/**
 * @brief Returns the current value of the swSetProf40 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf40 field's value will be returned.
 *
 * @return The current value of the swSetProf40 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_40_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000100)) >> 8);
}
...
/**
 * @brief Sets the swSetProf40 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof40 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_40_setf(uint8_t swsetprof40)
{
    ASSERT_ERR((((uint32_t)swsetprof40 << 8) & ~((uint32_t)0x00000100)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof40 << 8);
}

/**
 * @brief Returns the current value of the swSetProf39 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf39 field's value will be returned.
 *
 * @return The current value of the swSetProf39 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_39_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000080)) >> 7);
}
...
/**
 * @brief Sets the swSetProf39 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof39 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_39_setf(uint8_t swsetprof39)
{
    ASSERT_ERR((((uint32_t)swsetprof39 << 7) & ~((uint32_t)0x00000080)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof39 << 7);
}

/**
 * @brief Returns the current value of the swSetProf38 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf38 field's value will be returned.
 *
 * @return The current value of the swSetProf38 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_38_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000040)) >> 6);
}
...
/**
 * @brief Sets the swSetProf38 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof38 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_38_setf(uint8_t swsetprof38)
{
    ASSERT_ERR((((uint32_t)swsetprof38 << 6) & ~((uint32_t)0x00000040)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof38 << 6);
}

/**
 * @brief Returns the current value of the swSetProf37 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf37 field's value will be returned.
 *
 * @return The current value of the swSetProf37 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_37_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000020)) >> 5);
}
...
/**
 * @brief Sets the swSetProf37 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof37 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_37_setf(uint8_t swsetprof37)
{
    ASSERT_ERR((((uint32_t)swsetprof37 << 5) & ~((uint32_t)0x00000020)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof37 << 5);
}

/**
 * @brief Returns the current value of the swSetProf36 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf36 field's value will be returned.
 *
 * @return The current value of the swSetProf36 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_36_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000010)) >> 4);
}
...
/**
 * @brief Sets the swSetProf36 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof36 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_36_setf(uint8_t swsetprof36)
{
    ASSERT_ERR((((uint32_t)swsetprof36 << 4) & ~((uint32_t)0x00000010)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof36 << 4);
}

/**
 * @brief Returns the current value of the swSetProf35 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf35 field's value will be returned.
 *
 * @return The current value of the swSetProf35 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_35_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000008)) >> 3);
}
...
/**
 * @brief Sets the swSetProf35 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof35 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_35_setf(uint8_t swsetprof35)
{
    ASSERT_ERR((((uint32_t)swsetprof35 << 3) & ~((uint32_t)0x00000008)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof35 << 3);
}

/**
 * @brief Returns the current value of the swSetProf34 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf34 field's value will be returned.
 *
 * @return The current value of the swSetProf34 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_34_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000004)) >> 2);
}
...
/**
 * @brief Sets the swSetProf34 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof34 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_34_setf(uint8_t swsetprof34)
{
    ASSERT_ERR((((uint32_t)swsetprof34 << 2) & ~((uint32_t)0x00000004)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof34 << 2);
}

/**
 * @brief Returns the current value of the swSetProf33 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf33 field's value will be returned.
 *
 * @return The current value of the swSetProf33 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_33_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000002)) >> 1);
}
...
/**
 * @brief Sets the swSetProf33 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof33 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_33_setf(uint8_t swsetprof33)
{
    ASSERT_ERR((((uint32_t)swsetprof33 << 1) & ~((uint32_t)0x00000002)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof33 << 1);
}

/**
 * @brief Returns the current value of the swSetProf32 field in the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read and the swSetProf32 field's value will be returned.
 *
 * @return The current value of the swSetProf32 field in the SW_SET_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_set_prof_32_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_SET_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000001)) >> 0);
}
...
/**
 * @brief Sets the swSetProf32 field of the SW_SET_PROFILING_REG_2 register.
 *
 * The SW_SET_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swsetprof32 - The value to set the field to.
 */
__INLINE void nxmac_sw_set_prof_32_setf(uint8_t swsetprof32)
{
    ASSERT_ERR((((uint32_t)swsetprof32 << 0) & ~((uint32_t)0x00000001)) == 0);
    REG_PL_WR(NXMAC_SW_SET_PROFILING_REG_2_ADDR, (uint32_t)swsetprof32 << 0);
}

/// @}

/**
 * @name SW_CLEAR_PROFILING_REG_2 register definitions
 * <table>
 * <caption>SW_CLEAR_PROFILING_REG_2 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31 <td>    swClearProf63 <td> R <td> C <td> 0
 * <tr><td> 30 <td>    swClearProf62 <td> R <td> C <td> 0
 * <tr><td> 29 <td>    swClearProf61 <td> R <td> C <td> 0
 * <tr><td> 28 <td>    swClearProf60 <td> R <td> C <td> 0
 * <tr><td> 27 <td>    swClearProf59 <td> R <td> C <td> 0
 * <tr><td> 26 <td>    swClearProf58 <td> R <td> C <td> 0
 * <tr><td> 25 <td>    swClearProf57 <td> R <td> C <td> 0
 * <tr><td> 24 <td>    swClearProf56 <td> R <td> C <td> 0
 * <tr><td> 23 <td>    swClearProf55 <td> R <td> C <td> 0
 * <tr><td> 22 <td>    swClearProf54 <td> R <td> C <td> 0
 * <tr><td> 21 <td>    swClearProf53 <td> R <td> C <td> 0
 * <tr><td> 20 <td>    swClearProf52 <td> R <td> C <td> 0
 * <tr><td> 19 <td>    swClearProf51 <td> R <td> C <td> 0
 * <tr><td> 18 <td>    swClearProf50 <td> R <td> C <td> 0
 * <tr><td> 17 <td>    swClearProf49 <td> R <td> C <td> 0
 * <tr><td> 16 <td>    swClearProf48 <td> R <td> C <td> 0
 * <tr><td> 15 <td>    swClearProf47 <td> R <td> C <td> 0
 * <tr><td> 14 <td>    swClearProf46 <td> R <td> C <td> 0
 * <tr><td> 13 <td>    swClearProf45 <td> R <td> C <td> 0
 * <tr><td> 12 <td>    swClearProf44 <td> R <td> C <td> 0
 * <tr><td> 11 <td>    swClearProf43 <td> R <td> C <td> 0
 * <tr><td> 10 <td>    swClearProf42 <td> R <td> C <td> 0
 * <tr><td> 09 <td>    swClearProf41 <td> R <td> C <td> 0
 * <tr><td> 08 <td>    swClearProf40 <td> R <td> C <td> 0
 * <tr><td> 07 <td>    swClearProf39 <td> R <td> C <td> 0
 * <tr><td> 06 <td>    swClearProf38 <td> R <td> C <td> 0
 * <tr><td> 05 <td>    swClearProf37 <td> R <td> C <td> 0
 * <tr><td> 04 <td>    swClearProf36 <td> R <td> C <td> 0
 * <tr><td> 03 <td>    swClearProf35 <td> R <td> C <td> 0
 * <tr><td> 02 <td>    swClearProf34 <td> R <td> C <td> 0
 * <tr><td> 01 <td>    swClearProf33 <td> R <td> C <td> 0
 * <tr><td> 00 <td>    swClearProf32 <td> R <td> C <td> 0
 * </table>
 *
 * @{
 */

/// Address of the SW_CLEAR_PROFILING_REG_2 register
#define NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR   0x24B08574
/// Offset of the SW_CLEAR_PROFILING_REG_2 register from the base address
#define NXMAC_SW_CLEAR_PROFILING_REG_2_OFFSET 0x00000574
/// Index of the SW_CLEAR_PROFILING_REG_2 register
#define NXMAC_SW_CLEAR_PROFILING_REG_2_INDEX  0x0000015D
/// Reset value of the SW_CLEAR_PROFILING_REG_2 register
#define NXMAC_SW_CLEAR_PROFILING_REG_2_RESET  0x00000000

/**
 * @brief Returns the current value of the SW_CLEAR_PROFILING_REG_2 register.
 * The SW_CLEAR_PROFILING_REG_2 register will be read and its value returned.
 * @return The current value of the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint32_t nxmac_sw_clear_profiling_reg_2_get(void)
{
    return REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
}

/**
 * @brief Sets the SW_CLEAR_PROFILING_REG_2 register to a value.
 * The SW_CLEAR_PROFILING_REG_2 register will be written.
 * @param value - The value to write.
 */
__INLINE void nxmac_sw_clear_profiling_reg_2_clear(uint32_t value)
{
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, value);
}

// field definitions
/// SW_CLEAR_PROF_63 field bit
#define NXMAC_SW_CLEAR_PROF_63_BIT    ((uint32_t)0x80000000)
/// SW_CLEAR_PROF_63 field position
#define NXMAC_SW_CLEAR_PROF_63_POS    31
/// SW_CLEAR_PROF_62 field bit
#define NXMAC_SW_CLEAR_PROF_62_BIT    ((uint32_t)0x40000000)
/// SW_CLEAR_PROF_62 field position
#define NXMAC_SW_CLEAR_PROF_62_POS    30
/// SW_CLEAR_PROF_61 field bit
#define NXMAC_SW_CLEAR_PROF_61_BIT    ((uint32_t)0x20000000)
/// SW_CLEAR_PROF_61 field position
#define NXMAC_SW_CLEAR_PROF_61_POS    29
/// SW_CLEAR_PROF_60 field bit
#define NXMAC_SW_CLEAR_PROF_60_BIT    ((uint32_t)0x10000000)
/// SW_CLEAR_PROF_60 field position
#define NXMAC_SW_CLEAR_PROF_60_POS    28
/// SW_CLEAR_PROF_59 field bit
#define NXMAC_SW_CLEAR_PROF_59_BIT    ((uint32_t)0x08000000)
/// SW_CLEAR_PROF_59 field position
#define NXMAC_SW_CLEAR_PROF_59_POS    27
/// SW_CLEAR_PROF_58 field bit
#define NXMAC_SW_CLEAR_PROF_58_BIT    ((uint32_t)0x04000000)
/// SW_CLEAR_PROF_58 field position
#define NXMAC_SW_CLEAR_PROF_58_POS    26
/// SW_CLEAR_PROF_57 field bit
#define NXMAC_SW_CLEAR_PROF_57_BIT    ((uint32_t)0x02000000)
/// SW_CLEAR_PROF_57 field position
#define NXMAC_SW_CLEAR_PROF_57_POS    25
/// SW_CLEAR_PROF_56 field bit
#define NXMAC_SW_CLEAR_PROF_56_BIT    ((uint32_t)0x01000000)
/// SW_CLEAR_PROF_56 field position
#define NXMAC_SW_CLEAR_PROF_56_POS    24
/// SW_CLEAR_PROF_55 field bit
#define NXMAC_SW_CLEAR_PROF_55_BIT    ((uint32_t)0x00800000)
/// SW_CLEAR_PROF_55 field position
#define NXMAC_SW_CLEAR_PROF_55_POS    23
/// SW_CLEAR_PROF_54 field bit
#define NXMAC_SW_CLEAR_PROF_54_BIT    ((uint32_t)0x00400000)
/// SW_CLEAR_PROF_54 field position
#define NXMAC_SW_CLEAR_PROF_54_POS    22
/// SW_CLEAR_PROF_53 field bit
#define NXMAC_SW_CLEAR_PROF_53_BIT    ((uint32_t)0x00200000)
/// SW_CLEAR_PROF_53 field position
#define NXMAC_SW_CLEAR_PROF_53_POS    21
/// SW_CLEAR_PROF_52 field bit
#define NXMAC_SW_CLEAR_PROF_52_BIT    ((uint32_t)0x00100000)
/// SW_CLEAR_PROF_52 field position
#define NXMAC_SW_CLEAR_PROF_52_POS    20
/// SW_CLEAR_PROF_51 field bit
#define NXMAC_SW_CLEAR_PROF_51_BIT    ((uint32_t)0x00080000)
/// SW_CLEAR_PROF_51 field position
#define NXMAC_SW_CLEAR_PROF_51_POS    19
/// SW_CLEAR_PROF_50 field bit
#define NXMAC_SW_CLEAR_PROF_50_BIT    ((uint32_t)0x00040000)
/// SW_CLEAR_PROF_50 field position
#define NXMAC_SW_CLEAR_PROF_50_POS    18
/// SW_CLEAR_PROF_49 field bit
#define NXMAC_SW_CLEAR_PROF_49_BIT    ((uint32_t)0x00020000)
/// SW_CLEAR_PROF_49 field position
#define NXMAC_SW_CLEAR_PROF_49_POS    17
/// SW_CLEAR_PROF_48 field bit
#define NXMAC_SW_CLEAR_PROF_48_BIT    ((uint32_t)0x00010000)
/// SW_CLEAR_PROF_48 field position
#define NXMAC_SW_CLEAR_PROF_48_POS    16
/// SW_CLEAR_PROF_47 field bit
#define NXMAC_SW_CLEAR_PROF_47_BIT    ((uint32_t)0x00008000)
/// SW_CLEAR_PROF_47 field position
#define NXMAC_SW_CLEAR_PROF_47_POS    15
/// SW_CLEAR_PROF_46 field bit
#define NXMAC_SW_CLEAR_PROF_46_BIT    ((uint32_t)0x00004000)
/// SW_CLEAR_PROF_46 field position
#define NXMAC_SW_CLEAR_PROF_46_POS    14
/// SW_CLEAR_PROF_45 field bit
#define NXMAC_SW_CLEAR_PROF_45_BIT    ((uint32_t)0x00002000)
/// SW_CLEAR_PROF_45 field position
#define NXMAC_SW_CLEAR_PROF_45_POS    13
/// SW_CLEAR_PROF_44 field bit
#define NXMAC_SW_CLEAR_PROF_44_BIT    ((uint32_t)0x00001000)
/// SW_CLEAR_PROF_44 field position
#define NXMAC_SW_CLEAR_PROF_44_POS    12
/// SW_CLEAR_PROF_43 field bit
#define NXMAC_SW_CLEAR_PROF_43_BIT    ((uint32_t)0x00000800)
/// SW_CLEAR_PROF_43 field position
#define NXMAC_SW_CLEAR_PROF_43_POS    11
/// SW_CLEAR_PROF_42 field bit
#define NXMAC_SW_CLEAR_PROF_42_BIT    ((uint32_t)0x00000400)
/// SW_CLEAR_PROF_42 field position
#define NXMAC_SW_CLEAR_PROF_42_POS    10
/// SW_CLEAR_PROF_41 field bit
#define NXMAC_SW_CLEAR_PROF_41_BIT    ((uint32_t)0x00000200)
/// SW_CLEAR_PROF_41 field position
#define NXMAC_SW_CLEAR_PROF_41_POS    9
/// SW_CLEAR_PROF_40 field bit
#define NXMAC_SW_CLEAR_PROF_40_BIT    ((uint32_t)0x00000100)
/// SW_CLEAR_PROF_40 field position
#define NXMAC_SW_CLEAR_PROF_40_POS    8
/// SW_CLEAR_PROF_39 field bit
#define NXMAC_SW_CLEAR_PROF_39_BIT    ((uint32_t)0x00000080)
/// SW_CLEAR_PROF_39 field position
#define NXMAC_SW_CLEAR_PROF_39_POS    7
/// SW_CLEAR_PROF_38 field bit
#define NXMAC_SW_CLEAR_PROF_38_BIT    ((uint32_t)0x00000040)
/// SW_CLEAR_PROF_38 field position
#define NXMAC_SW_CLEAR_PROF_38_POS    6
/// SW_CLEAR_PROF_37 field bit
#define NXMAC_SW_CLEAR_PROF_37_BIT    ((uint32_t)0x00000020)
/// SW_CLEAR_PROF_37 field position
#define NXMAC_SW_CLEAR_PROF_37_POS    5
/// SW_CLEAR_PROF_36 field bit
#define NXMAC_SW_CLEAR_PROF_36_BIT    ((uint32_t)0x00000010)
/// SW_CLEAR_PROF_36 field position
#define NXMAC_SW_CLEAR_PROF_36_POS    4
/// SW_CLEAR_PROF_35 field bit
#define NXMAC_SW_CLEAR_PROF_35_BIT    ((uint32_t)0x00000008)
/// SW_CLEAR_PROF_35 field position
#define NXMAC_SW_CLEAR_PROF_35_POS    3
/// SW_CLEAR_PROF_34 field bit
#define NXMAC_SW_CLEAR_PROF_34_BIT    ((uint32_t)0x00000004)
/// SW_CLEAR_PROF_34 field position
#define NXMAC_SW_CLEAR_PROF_34_POS    2
/// SW_CLEAR_PROF_33 field bit
#define NXMAC_SW_CLEAR_PROF_33_BIT    ((uint32_t)0x00000002)
/// SW_CLEAR_PROF_33 field position
#define NXMAC_SW_CLEAR_PROF_33_POS    1
/// SW_CLEAR_PROF_32 field bit
#define NXMAC_SW_CLEAR_PROF_32_BIT    ((uint32_t)0x00000001)
/// SW_CLEAR_PROF_32 field position
#define NXMAC_SW_CLEAR_PROF_32_POS    0

/// SW_CLEAR_PROF_63 field reset value
#define NXMAC_SW_CLEAR_PROF_63_RST    0x0
/// SW_CLEAR_PROF_62 field reset value
#define NXMAC_SW_CLEAR_PROF_62_RST    0x0
/// SW_CLEAR_PROF_61 field reset value
#define NXMAC_SW_CLEAR_PROF_61_RST    0x0
/// SW_CLEAR_PROF_60 field reset value
#define NXMAC_SW_CLEAR_PROF_60_RST    0x0
/// SW_CLEAR_PROF_59 field reset value
#define NXMAC_SW_CLEAR_PROF_59_RST    0x0
/// SW_CLEAR_PROF_58 field reset value
#define NXMAC_SW_CLEAR_PROF_58_RST    0x0
/// SW_CLEAR_PROF_57 field reset value
#define NXMAC_SW_CLEAR_PROF_57_RST    0x0
/// SW_CLEAR_PROF_56 field reset value
#define NXMAC_SW_CLEAR_PROF_56_RST    0x0
/// SW_CLEAR_PROF_55 field reset value
#define NXMAC_SW_CLEAR_PROF_55_RST    0x0
/// SW_CLEAR_PROF_54 field reset value
#define NXMAC_SW_CLEAR_PROF_54_RST    0x0
/// SW_CLEAR_PROF_53 field reset value
#define NXMAC_SW_CLEAR_PROF_53_RST    0x0
/// SW_CLEAR_PROF_52 field reset value
#define NXMAC_SW_CLEAR_PROF_52_RST    0x0
/// SW_CLEAR_PROF_51 field reset value
#define NXMAC_SW_CLEAR_PROF_51_RST    0x0
/// SW_CLEAR_PROF_50 field reset value
#define NXMAC_SW_CLEAR_PROF_50_RST    0x0
/// SW_CLEAR_PROF_49 field reset value
#define NXMAC_SW_CLEAR_PROF_49_RST    0x0
/// SW_CLEAR_PROF_48 field reset value
#define NXMAC_SW_CLEAR_PROF_48_RST    0x0
/// SW_CLEAR_PROF_47 field reset value
#define NXMAC_SW_CLEAR_PROF_47_RST    0x0
/// SW_CLEAR_PROF_46 field reset value
#define NXMAC_SW_CLEAR_PROF_46_RST    0x0
/// SW_CLEAR_PROF_45 field reset value
#define NXMAC_SW_CLEAR_PROF_45_RST    0x0
/// SW_CLEAR_PROF_44 field reset value
#define NXMAC_SW_CLEAR_PROF_44_RST    0x0
/// SW_CLEAR_PROF_43 field reset value
#define NXMAC_SW_CLEAR_PROF_43_RST    0x0
/// SW_CLEAR_PROF_42 field reset value
#define NXMAC_SW_CLEAR_PROF_42_RST    0x0
/// SW_CLEAR_PROF_41 field reset value
#define NXMAC_SW_CLEAR_PROF_41_RST    0x0
/// SW_CLEAR_PROF_40 field reset value
#define NXMAC_SW_CLEAR_PROF_40_RST    0x0
/// SW_CLEAR_PROF_39 field reset value
#define NXMAC_SW_CLEAR_PROF_39_RST    0x0
/// SW_CLEAR_PROF_38 field reset value
#define NXMAC_SW_CLEAR_PROF_38_RST    0x0
/// SW_CLEAR_PROF_37 field reset value
#define NXMAC_SW_CLEAR_PROF_37_RST    0x0
/// SW_CLEAR_PROF_36 field reset value
#define NXMAC_SW_CLEAR_PROF_36_RST    0x0
/// SW_CLEAR_PROF_35 field reset value
#define NXMAC_SW_CLEAR_PROF_35_RST    0x0
/// SW_CLEAR_PROF_34 field reset value
#define NXMAC_SW_CLEAR_PROF_34_RST    0x0
/// SW_CLEAR_PROF_33 field reset value
#define NXMAC_SW_CLEAR_PROF_33_RST    0x0
/// SW_CLEAR_PROF_32 field reset value
#define NXMAC_SW_CLEAR_PROF_32_RST    0x0

/**
 * @brief Constructs a value for the SW_CLEAR_PROFILING_REG_2 register given values for its fields
 * and writes the value to the register.
 *
 * @param[in] swclearprof63 - The value to use for the swClearProf63 field.
 * @param[in] swclearprof62 - The value to use for the swClearProf62 field.
 * @param[in] swclearprof61 - The value to use for the swClearProf61 field.
 * @param[in] swclearprof60 - The value to use for the swClearProf60 field.
 * @param[in] swclearprof59 - The value to use for the swClearProf59 field.
 * @param[in] swclearprof58 - The value to use for the swClearProf58 field.
 * @param[in] swclearprof57 - The value to use for the swClearProf57 field.
 * @param[in] swclearprof56 - The value to use for the swClearProf56 field.
 * @param[in] swclearprof55 - The value to use for the swClearProf55 field.
 * @param[in] swclearprof54 - The value to use for the swClearProf54 field.
 * @param[in] swclearprof53 - The value to use for the swClearProf53 field.
 * @param[in] swclearprof52 - The value to use for the swClearProf52 field.
 * @param[in] swclearprof51 - The value to use for the swClearProf51 field.
 * @param[in] swclearprof50 - The value to use for the swClearProf50 field.
 * @param[in] swclearprof49 - The value to use for the swClearProf49 field.
 * @param[in] swclearprof48 - The value to use for the swClearProf48 field.
 * @param[in] swclearprof47 - The value to use for the swClearProf47 field.
 * @param[in] swclearprof46 - The value to use for the swClearProf46 field.
 * @param[in] swclearprof45 - The value to use for the swClearProf45 field.
 * @param[in] swclearprof44 - The value to use for the swClearProf44 field.
 * @param[in] swclearprof43 - The value to use for the swClearProf43 field.
 * @param[in] swclearprof42 - The value to use for the swClearProf42 field.
 * @param[in] swclearprof41 - The value to use for the swClearProf41 field.
 * @param[in] swclearprof40 - The value to use for the swClearProf40 field.
 * @param[in] swclearprof39 - The value to use for the swClearProf39 field.
 * @param[in] swclearprof38 - The value to use for the swClearProf38 field.
 * @param[in] swclearprof37 - The value to use for the swClearProf37 field.
 * @param[in] swclearprof36 - The value to use for the swClearProf36 field.
 * @param[in] swclearprof35 - The value to use for the swClearProf35 field.
 * @param[in] swclearprof34 - The value to use for the swClearProf34 field.
 * @param[in] swclearprof33 - The value to use for the swClearProf33 field.
 * @param[in] swclearprof32 - The value to use for the swClearProf32 field.
 */
__INLINE void nxmac_sw_clear_profiling_reg_2_pack(uint8_t swclearprof63, uint8_t swclearprof62, uint8_t swclearprof61, uint8_t swclearprof60, uint8_t swclearprof59, uint8_t swclearprof58, uint8_t swclearprof57, uint8_t swclearprof56, uint8_t swclearprof55, uint8_t swclearprof54, uint8_t swclearprof53, uint8_t swclearprof52, uint8_t swclearprof51, uint8_t swclearprof50, uint8_t swclearprof49, uint8_t swclearprof48, uint8_t swclearprof47, uint8_t swclearprof46, uint8_t swclearprof45, uint8_t swclearprof44, uint8_t swclearprof43, uint8_t swclearprof42, uint8_t swclearprof41, uint8_t swclearprof40, uint8_t swclearprof39, uint8_t swclearprof38, uint8_t swclearprof37, uint8_t swclearprof36, uint8_t swclearprof35, uint8_t swclearprof34, uint8_t swclearprof33, uint8_t swclearprof32)
{
    ASSERT_ERR((((uint32_t)swclearprof63 << 31) & ~((uint32_t)0x80000000)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof62 << 30) & ~((uint32_t)0x40000000)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof61 << 29) & ~((uint32_t)0x20000000)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof60 << 28) & ~((uint32_t)0x10000000)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof59 << 27) & ~((uint32_t)0x08000000)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof58 << 26) & ~((uint32_t)0x04000000)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof57 << 25) & ~((uint32_t)0x02000000)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof56 << 24) & ~((uint32_t)0x01000000)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof55 << 23) & ~((uint32_t)0x00800000)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof54 << 22) & ~((uint32_t)0x00400000)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof53 << 21) & ~((uint32_t)0x00200000)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof52 << 20) & ~((uint32_t)0x00100000)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof51 << 19) & ~((uint32_t)0x00080000)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof50 << 18) & ~((uint32_t)0x00040000)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof49 << 17) & ~((uint32_t)0x00020000)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof48 << 16) & ~((uint32_t)0x00010000)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof47 << 15) & ~((uint32_t)0x00008000)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof46 << 14) & ~((uint32_t)0x00004000)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof45 << 13) & ~((uint32_t)0x00002000)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof44 << 12) & ~((uint32_t)0x00001000)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof43 << 11) & ~((uint32_t)0x00000800)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof42 << 10) & ~((uint32_t)0x00000400)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof41 << 9) & ~((uint32_t)0x00000200)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof40 << 8) & ~((uint32_t)0x00000100)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof39 << 7) & ~((uint32_t)0x00000080)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof38 << 6) & ~((uint32_t)0x00000040)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof37 << 5) & ~((uint32_t)0x00000020)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof36 << 4) & ~((uint32_t)0x00000010)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof35 << 3) & ~((uint32_t)0x00000008)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof34 << 2) & ~((uint32_t)0x00000004)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof33 << 1) & ~((uint32_t)0x00000002)) == 0);
    ASSERT_ERR((((uint32_t)swclearprof32 << 0) & ~((uint32_t)0x00000001)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR,  ((uint32_t)swclearprof63 << 31) | ((uint32_t)swclearprof62 << 30) | ((uint32_t)swclearprof61 << 29) | ((uint32_t)swclearprof60 << 28) | ((uint32_t)swclearprof59 << 27) | ((uint32_t)swclearprof58 << 26) | ((uint32_t)swclearprof57 << 25) | ((uint32_t)swclearprof56 << 24) | ((uint32_t)swclearprof55 << 23) | ((uint32_t)swclearprof54 << 22) | ((uint32_t)swclearprof53 << 21) | ((uint32_t)swclearprof52 << 20) | ((uint32_t)swclearprof51 << 19) | ((uint32_t)swclearprof50 << 18) | ((uint32_t)swclearprof49 << 17) | ((uint32_t)swclearprof48 << 16) | ((uint32_t)swclearprof47 << 15) | ((uint32_t)swclearprof46 << 14) | ((uint32_t)swclearprof45 << 13) | ((uint32_t)swclearprof44 << 12) | ((uint32_t)swclearprof43 << 11) | ((uint32_t)swclearprof42 << 10) | ((uint32_t)swclearprof41 << 9) | ((uint32_t)swclearprof40 << 8) | ((uint32_t)swclearprof39 << 7) | ((uint32_t)swclearprof38 << 6) | ((uint32_t)swclearprof37 << 5) | ((uint32_t)swclearprof36 << 4) | ((uint32_t)swclearprof35 << 3) | ((uint32_t)swclearprof34 << 2) | ((uint32_t)swclearprof33 << 1) | ((uint32_t)swclearprof32 << 0));
}

/**
 * @brief Unpacks SW_CLEAR_PROFILING_REG_2's fields from current value of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * Reads the SW_CLEAR_PROFILING_REG_2 register and populates all the _field variables with the corresponding
 * values from the register.
 *
 * @param[out] swclearprof63 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof62 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof61 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof60 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof59 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof58 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof57 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof56 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof55 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof54 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof53 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof52 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof51 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof50 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof49 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof48 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof47 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof46 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof45 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof44 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof43 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof42 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof41 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof40 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof39 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof38 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof37 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof36 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof35 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof34 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof33 - Will be populated with the current value of this field from the register.
 * @param[out] swclearprof32 - Will be populated with the current value of this field from the register.
 */
__INLINE void nxmac_sw_clear_profiling_reg_2_unpack(uint8_t* swclearprof63, uint8_t* swclearprof62, uint8_t* swclearprof61, uint8_t* swclearprof60, uint8_t* swclearprof59, uint8_t* swclearprof58, uint8_t* swclearprof57, uint8_t* swclearprof56, uint8_t* swclearprof55, uint8_t* swclearprof54, uint8_t* swclearprof53, uint8_t* swclearprof52, uint8_t* swclearprof51, uint8_t* swclearprof50, uint8_t* swclearprof49, uint8_t* swclearprof48, uint8_t* swclearprof47, uint8_t* swclearprof46, uint8_t* swclearprof45, uint8_t* swclearprof44, uint8_t* swclearprof43, uint8_t* swclearprof42, uint8_t* swclearprof41, uint8_t* swclearprof40, uint8_t* swclearprof39, uint8_t* swclearprof38, uint8_t* swclearprof37, uint8_t* swclearprof36, uint8_t* swclearprof35, uint8_t* swclearprof34, uint8_t* swclearprof33, uint8_t* swclearprof32)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);

    *swclearprof63 = (localVal & ((uint32_t)0x80000000)) >> 31;
    *swclearprof62 = (localVal & ((uint32_t)0x40000000)) >> 30;
    *swclearprof61 = (localVal & ((uint32_t)0x20000000)) >> 29;
    *swclearprof60 = (localVal & ((uint32_t)0x10000000)) >> 28;
    *swclearprof59 = (localVal & ((uint32_t)0x08000000)) >> 27;
    *swclearprof58 = (localVal & ((uint32_t)0x04000000)) >> 26;
    *swclearprof57 = (localVal & ((uint32_t)0x02000000)) >> 25;
    *swclearprof56 = (localVal & ((uint32_t)0x01000000)) >> 24;
    *swclearprof55 = (localVal & ((uint32_t)0x00800000)) >> 23;
    *swclearprof54 = (localVal & ((uint32_t)0x00400000)) >> 22;
    *swclearprof53 = (localVal & ((uint32_t)0x00200000)) >> 21;
    *swclearprof52 = (localVal & ((uint32_t)0x00100000)) >> 20;
    *swclearprof51 = (localVal & ((uint32_t)0x00080000)) >> 19;
    *swclearprof50 = (localVal & ((uint32_t)0x00040000)) >> 18;
    *swclearprof49 = (localVal & ((uint32_t)0x00020000)) >> 17;
    *swclearprof48 = (localVal & ((uint32_t)0x00010000)) >> 16;
    *swclearprof47 = (localVal & ((uint32_t)0x00008000)) >> 15;
    *swclearprof46 = (localVal & ((uint32_t)0x00004000)) >> 14;
    *swclearprof45 = (localVal & ((uint32_t)0x00002000)) >> 13;
    *swclearprof44 = (localVal & ((uint32_t)0x00001000)) >> 12;
    *swclearprof43 = (localVal & ((uint32_t)0x00000800)) >> 11;
    *swclearprof42 = (localVal & ((uint32_t)0x00000400)) >> 10;
    *swclearprof41 = (localVal & ((uint32_t)0x00000200)) >> 9;
    *swclearprof40 = (localVal & ((uint32_t)0x00000100)) >> 8;
    *swclearprof39 = (localVal & ((uint32_t)0x00000080)) >> 7;
    *swclearprof38 = (localVal & ((uint32_t)0x00000040)) >> 6;
    *swclearprof37 = (localVal & ((uint32_t)0x00000020)) >> 5;
    *swclearprof36 = (localVal & ((uint32_t)0x00000010)) >> 4;
    *swclearprof35 = (localVal & ((uint32_t)0x00000008)) >> 3;
    *swclearprof34 = (localVal & ((uint32_t)0x00000004)) >> 2;
    *swclearprof33 = (localVal & ((uint32_t)0x00000002)) >> 1;
    *swclearprof32 = (localVal & ((uint32_t)0x00000001)) >> 0;
}

/**
 * @brief Returns the current value of the swClearProf63 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf63 field's value will be returned.
 *
 * @return The current value of the swClearProf63 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_63_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x80000000)) >> 31);
}
...
/**
 * @brief Sets the swClearProf63 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof63 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_63_clearf(uint8_t swclearprof63)
{
    ASSERT_ERR((((uint32_t)swclearprof63 << 31) & ~((uint32_t)0x80000000)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof63 << 31);
}

/**
 * @brief Returns the current value of the swClearProf62 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf62 field's value will be returned.
 *
 * @return The current value of the swClearProf62 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_62_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x40000000)) >> 30);
}
...
/**
 * @brief Sets the swClearProf62 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof62 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_62_clearf(uint8_t swclearprof62)
{
    ASSERT_ERR((((uint32_t)swclearprof62 << 30) & ~((uint32_t)0x40000000)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof62 << 30);
}

/**
 * @brief Returns the current value of the swClearProf61 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf61 field's value will be returned.
 *
 * @return The current value of the swClearProf61 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_61_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x20000000)) >> 29);
}
...
/**
 * @brief Sets the swClearProf61 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof61 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_61_clearf(uint8_t swclearprof61)
{
    ASSERT_ERR((((uint32_t)swclearprof61 << 29) & ~((uint32_t)0x20000000)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof61 << 29);
}

/**
 * @brief Returns the current value of the swClearProf60 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf60 field's value will be returned.
 *
 * @return The current value of the swClearProf60 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_60_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x10000000)) >> 28);
}
...
/**
 * @brief Sets the swClearProf60 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof60 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_60_clearf(uint8_t swclearprof60)
{
    ASSERT_ERR((((uint32_t)swclearprof60 << 28) & ~((uint32_t)0x10000000)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof60 << 28);
}

/**
 * @brief Returns the current value of the swClearProf59 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf59 field's value will be returned.
 *
 * @return The current value of the swClearProf59 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_59_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x08000000)) >> 27);
}
...
/**
 * @brief Sets the swClearProf59 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof59 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_59_clearf(uint8_t swclearprof59)
{
    ASSERT_ERR((((uint32_t)swclearprof59 << 27) & ~((uint32_t)0x08000000)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof59 << 27);
}

/**
 * @brief Returns the current value of the swClearProf58 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf58 field's value will be returned.
 *
 * @return The current value of the swClearProf58 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_58_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x04000000)) >> 26);
}
...
/**
 * @brief Sets the swClearProf58 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof58 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_58_clearf(uint8_t swclearprof58)
{
    ASSERT_ERR((((uint32_t)swclearprof58 << 26) & ~((uint32_t)0x04000000)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof58 << 26);
}

/**
 * @brief Returns the current value of the swClearProf57 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf57 field's value will be returned.
 *
 * @return The current value of the swClearProf57 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_57_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x02000000)) >> 25);
}
...
/**
 * @brief Sets the swClearProf57 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof57 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_57_clearf(uint8_t swclearprof57)
{
    ASSERT_ERR((((uint32_t)swclearprof57 << 25) & ~((uint32_t)0x02000000)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof57 << 25);
}

/**
 * @brief Returns the current value of the swClearProf56 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf56 field's value will be returned.
 *
 * @return The current value of the swClearProf56 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_56_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x01000000)) >> 24);
}
...
/**
 * @brief Sets the swClearProf56 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof56 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_56_clearf(uint8_t swclearprof56)
{
    ASSERT_ERR((((uint32_t)swclearprof56 << 24) & ~((uint32_t)0x01000000)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof56 << 24);
}

/**
 * @brief Returns the current value of the swClearProf55 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf55 field's value will be returned.
 *
 * @return The current value of the swClearProf55 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_55_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00800000)) >> 23);
}
...
/**
 * @brief Sets the swClearProf55 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof55 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_55_clearf(uint8_t swclearprof55)
{
    ASSERT_ERR((((uint32_t)swclearprof55 << 23) & ~((uint32_t)0x00800000)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof55 << 23);
}

/**
 * @brief Returns the current value of the swClearProf54 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf54 field's value will be returned.
 *
 * @return The current value of the swClearProf54 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_54_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00400000)) >> 22);
}
...
/**
 * @brief Sets the swClearProf54 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof54 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_54_clearf(uint8_t swclearprof54)
{
    ASSERT_ERR((((uint32_t)swclearprof54 << 22) & ~((uint32_t)0x00400000)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof54 << 22);
}

/**
 * @brief Returns the current value of the swClearProf53 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf53 field's value will be returned.
 *
 * @return The current value of the swClearProf53 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_53_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00200000)) >> 21);
}
...
/**
 * @brief Sets the swClearProf53 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof53 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_53_clearf(uint8_t swclearprof53)
{
    ASSERT_ERR((((uint32_t)swclearprof53 << 21) & ~((uint32_t)0x00200000)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof53 << 21);
}

/**
 * @brief Returns the current value of the swClearProf52 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf52 field's value will be returned.
 *
 * @return The current value of the swClearProf52 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_52_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00100000)) >> 20);
}
...
/**
 * @brief Sets the swClearProf52 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof52 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_52_clearf(uint8_t swclearprof52)
{
    ASSERT_ERR((((uint32_t)swclearprof52 << 20) & ~((uint32_t)0x00100000)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof52 << 20);
}

/**
 * @brief Returns the current value of the swClearProf51 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf51 field's value will be returned.
 *
 * @return The current value of the swClearProf51 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_51_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00080000)) >> 19);
}
...
/**
 * @brief Sets the swClearProf51 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof51 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_51_clearf(uint8_t swclearprof51)
{
    ASSERT_ERR((((uint32_t)swclearprof51 << 19) & ~((uint32_t)0x00080000)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof51 << 19);
}

/**
 * @brief Returns the current value of the swClearProf50 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf50 field's value will be returned.
 *
 * @return The current value of the swClearProf50 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_50_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00040000)) >> 18);
}
...
/**
 * @brief Sets the swClearProf50 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof50 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_50_clearf(uint8_t swclearprof50)
{
    ASSERT_ERR((((uint32_t)swclearprof50 << 18) & ~((uint32_t)0x00040000)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof50 << 18);
}

/**
 * @brief Returns the current value of the swClearProf49 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf49 field's value will be returned.
 *
 * @return The current value of the swClearProf49 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_49_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00020000)) >> 17);
}
...
/**
 * @brief Sets the swClearProf49 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof49 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_49_clearf(uint8_t swclearprof49)
{
    ASSERT_ERR((((uint32_t)swclearprof49 << 17) & ~((uint32_t)0x00020000)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof49 << 17);
}

/**
 * @brief Returns the current value of the swClearProf48 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf48 field's value will be returned.
 *
 * @return The current value of the swClearProf48 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_48_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00010000)) >> 16);
}
...
/**
 * @brief Sets the swClearProf48 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof48 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_48_clearf(uint8_t swclearprof48)
{
    ASSERT_ERR((((uint32_t)swclearprof48 << 16) & ~((uint32_t)0x00010000)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof48 << 16);
}

/**
 * @brief Returns the current value of the swClearProf47 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf47 field's value will be returned.
 *
 * @return The current value of the swClearProf47 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_47_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00008000)) >> 15);
}
...
/**
 * @brief Sets the swClearProf47 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof47 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_47_clearf(uint8_t swclearprof47)
{
    ASSERT_ERR((((uint32_t)swclearprof47 << 15) & ~((uint32_t)0x00008000)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof47 << 15);
}

/**
 * @brief Returns the current value of the swClearProf46 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf46 field's value will be returned.
 *
 * @return The current value of the swClearProf46 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_46_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00004000)) >> 14);
}
...
/**
 * @brief Sets the swClearProf46 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof46 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_46_clearf(uint8_t swclearprof46)
{
    ASSERT_ERR((((uint32_t)swclearprof46 << 14) & ~((uint32_t)0x00004000)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof46 << 14);
}

/**
 * @brief Returns the current value of the swClearProf45 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf45 field's value will be returned.
 *
 * @return The current value of the swClearProf45 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_45_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00002000)) >> 13);
}
...
/**
 * @brief Sets the swClearProf45 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof45 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_45_clearf(uint8_t swclearprof45)
{
    ASSERT_ERR((((uint32_t)swclearprof45 << 13) & ~((uint32_t)0x00002000)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof45 << 13);
}

/**
 * @brief Returns the current value of the swClearProf44 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf44 field's value will be returned.
 *
 * @return The current value of the swClearProf44 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_44_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00001000)) >> 12);
}
...
/**
 * @brief Sets the swClearProf44 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof44 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_44_clearf(uint8_t swclearprof44)
{
    ASSERT_ERR((((uint32_t)swclearprof44 << 12) & ~((uint32_t)0x00001000)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof44 << 12);
}

/**
 * @brief Returns the current value of the swClearProf43 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf43 field's value will be returned.
 *
 * @return The current value of the swClearProf43 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_43_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000800)) >> 11);
}
...
/**
 * @brief Sets the swClearProf43 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof43 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_43_clearf(uint8_t swclearprof43)
{
    ASSERT_ERR((((uint32_t)swclearprof43 << 11) & ~((uint32_t)0x00000800)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof43 << 11);
}

/**
 * @brief Returns the current value of the swClearProf42 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf42 field's value will be returned.
 *
 * @return The current value of the swClearProf42 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_42_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000400)) >> 10);
}
...
/**
 * @brief Sets the swClearProf42 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof42 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_42_clearf(uint8_t swclearprof42)
{
    ASSERT_ERR((((uint32_t)swclearprof42 << 10) & ~((uint32_t)0x00000400)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof42 << 10);
}

/**
 * @brief Returns the current value of the swClearProf41 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf41 field's value will be returned.
 *
 * @return The current value of the swClearProf41 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_41_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000200)) >> 9);
}
...
/**
 * @brief Sets the swClearProf41 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof41 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_41_clearf(uint8_t swclearprof41)
{
    ASSERT_ERR((((uint32_t)swclearprof41 << 9) & ~((uint32_t)0x00000200)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof41 << 9);
}

/**
 * @brief Returns the current value of the swClearProf40 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf40 field's value will be returned.
 *
 * @return The current value of the swClearProf40 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_40_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000100)) >> 8);
}
...
/**
 * @brief Sets the swClearProf40 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof40 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_40_clearf(uint8_t swclearprof40)
{
    ASSERT_ERR((((uint32_t)swclearprof40 << 8) & ~((uint32_t)0x00000100)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof40 << 8);
}

/**
 * @brief Returns the current value of the swClearProf39 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf39 field's value will be returned.
 *
 * @return The current value of the swClearProf39 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_39_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000080)) >> 7);
}
...
/**
 * @brief Sets the swClearProf39 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof39 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_39_clearf(uint8_t swclearprof39)
{
    ASSERT_ERR((((uint32_t)swclearprof39 << 7) & ~((uint32_t)0x00000080)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof39 << 7);
}

/**
 * @brief Returns the current value of the swClearProf38 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf38 field's value will be returned.
 *
 * @return The current value of the swClearProf38 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_38_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000040)) >> 6);
}
...
/**
 * @brief Sets the swClearProf38 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof38 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_38_clearf(uint8_t swclearprof38)
{
    ASSERT_ERR((((uint32_t)swclearprof38 << 6) & ~((uint32_t)0x00000040)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof38 << 6);
}

/**
 * @brief Returns the current value of the swClearProf37 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf37 field's value will be returned.
 *
 * @return The current value of the swClearProf37 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_37_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000020)) >> 5);
}
...
/**
 * @brief Sets the swClearProf37 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof37 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_37_clearf(uint8_t swclearprof37)
{
    ASSERT_ERR((((uint32_t)swclearprof37 << 5) & ~((uint32_t)0x00000020)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof37 << 5);
}

/**
 * @brief Returns the current value of the swClearProf36 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf36 field's value will be returned.
 *
 * @return The current value of the swClearProf36 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_36_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000010)) >> 4);
}
...
/**
 * @brief Sets the swClearProf36 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof36 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_36_clearf(uint8_t swclearprof36)
{
    ASSERT_ERR((((uint32_t)swclearprof36 << 4) & ~((uint32_t)0x00000010)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof36 << 4);
}

/**
 * @brief Returns the current value of the swClearProf35 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf35 field's value will be returned.
 *
 * @return The current value of the swClearProf35 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_35_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000008)) >> 3);
}
...
/**
 * @brief Sets the swClearProf35 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof35 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_35_clearf(uint8_t swclearprof35)
{
    ASSERT_ERR((((uint32_t)swclearprof35 << 3) & ~((uint32_t)0x00000008)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof35 << 3);
}

/**
 * @brief Returns the current value of the swClearProf34 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf34 field's value will be returned.
 *
 * @return The current value of the swClearProf34 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_34_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000004)) >> 2);
}
...
/**
 * @brief Sets the swClearProf34 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof34 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_34_clearf(uint8_t swclearprof34)
{
    ASSERT_ERR((((uint32_t)swclearprof34 << 2) & ~((uint32_t)0x00000004)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof34 << 2);
}

/**
 * @brief Returns the current value of the swClearProf33 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf33 field's value will be returned.
 *
 * @return The current value of the swClearProf33 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_33_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000002)) >> 1);
}
...
/**
 * @brief Sets the swClearProf33 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof33 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_33_clearf(uint8_t swclearprof33)
{
    ASSERT_ERR((((uint32_t)swclearprof33 << 1) & ~((uint32_t)0x00000002)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof33 << 1);
}

/**
 * @brief Returns the current value of the swClearProf32 field in the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read and the swClearProf32 field's value will be returned.
 *
 * @return The current value of the swClearProf32 field in the SW_CLEAR_PROFILING_REG_2 register.
 */
__INLINE uint8_t nxmac_sw_clear_prof_32_getf(void)
{
    uint32_t localVal = REG_PL_RD(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR);
    return ((localVal & ((uint32_t)0x00000001)) >> 0);
}
...
/**
 * @brief Sets the swClearProf32 field of the SW_CLEAR_PROFILING_REG_2 register.
 *
 * The SW_CLEAR_PROFILING_REG_2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] swclearprof32 - The value to set the field to.
 */
__INLINE void nxmac_sw_clear_prof_32_clearf(uint8_t swclearprof32)
{
    ASSERT_ERR((((uint32_t)swclearprof32 << 0) & ~((uint32_t)0x00000001)) == 0);
    REG_PL_WR(NXMAC_SW_CLEAR_PROFILING_REG_2_ADDR, (uint32_t)swclearprof32 << 0);
}
 ...
 * <table>
 * <caption>DEBUG_SEC_U_1_TX_C_PTR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>      secU1TxCurrentPointer <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_DEBUG_SEC_U_1_TX_C_PTR_ADDR   0x24B08590
/// Offset of the DEBUG_SEC_U_1_TX_C_PTR register from the base address
#define NXMAC_DEBUG_SEC_U_1_TX_C_PTR_OFFSET 0x00000590
/// Index of the DEBUG_SEC_U_1_TX_C_PTR register
#define NXMAC_DEBUG_SEC_U_1_TX_C_PTR_INDEX  0x00000164
 ...
 * <table>
 * <caption>DEBUG_SEC_U_2_TX_C_PTR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>      secU2TxCurrentPointer <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_DEBUG_SEC_U_2_TX_C_PTR_ADDR   0x24B08594
/// Offset of the DEBUG_SEC_U_2_TX_C_PTR register from the base address
#define NXMAC_DEBUG_SEC_U_2_TX_C_PTR_OFFSET 0x00000594
/// Index of the DEBUG_SEC_U_2_TX_C_PTR register
#define NXMAC_DEBUG_SEC_U_2_TX_C_PTR_INDEX  0x00000165
 ...
 * <table>
 * <caption>DEBUG_SEC_U_3_TX_C_PTR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:00 <td>      secU3TxCurrentPointer <td> W <td> R <td> 0x0
 * </table>
 *
 * @{
 */
...
#define NXMAC_DEBUG_SEC_U_3_TX_C_PTR_ADDR   0x24B08598
/// Offset of the DEBUG_SEC_U_3_TX_C_PTR register from the base address
#define NXMAC_DEBUG_SEC_U_3_TX_C_PTR_OFFSET 0x00000598
/// Index of the DEBUG_SEC_U_3_TX_C_PTR register
#define NXMAC_DEBUG_SEC_U_3_TX_C_PTR_INDEX  0x00000166
