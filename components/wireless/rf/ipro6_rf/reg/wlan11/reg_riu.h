 ...
 * <table>
 * <caption>RWNXVERSION bitfields</caption>
...
#define RIU_RWNXVERSION_ADDR   0x24C0B000
 ...
 * <table>
 * <caption>RWNXSTATICCONFIG bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXSTATICCONFIG_ADDR   0x24C0B004
 ...
 * <table>
 * <caption>RWNXDYNAMICCONFIG bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXDYNAMICCONFIG_ADDR   0x24C0B008
 ...
 * <table>
 * <caption>RWNXIQCTRL bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXIQCTRL_ADDR   0x24C0B01C
 ...
 * <table>
 * <caption>RWNXMACSTATICCONFIG bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXMACSTATICCONFIG_ADDR   0x24C0B080
 ...
 * <table>
 * <caption>RWNXFECTRL0 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 22:16 <td> TX80DIGGAINLIN0 <td> R <td> R/W <td> 0x40
 * <tr><td> 14:08 <td> TX40DIGGAINLIN0 <td> R <td> R/W <td> 0x40
...
#define RIU_RWNXFECTRL0_ADDR   0x24C0B100
...
#define RIU_RWNXFECTRL0_RESET  0x00404040
...
#define RIU_TX80DIGGAINLIN0_RST    0x40
/// TX40DIGGAINLIN0 field reset value
#define RIU_TX40DIGGAINLIN0_RST    0x40
 ...
 * <table>
 * <caption>RWNXFECTRL1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 22:16 <td> TX80DIGGAINLIN1 <td> R <td> R/W <td> 0x40
 * <tr><td> 14:08 <td> TX40DIGGAINLIN1 <td> R <td> R/W <td> 0x40
...
#define RIU_RWNXFECTRL1_ADDR   0x24C0B104
...
#define RIU_RWNXFECTRL1_RESET  0x00404040
...
#define RIU_TX80DIGGAINLIN1_RST    0x40
/// TX40DIGGAINLIN1 field reset value
#define RIU_TX40DIGGAINLIN1_RST    0x40
 ...
 * <table>
 * <caption>RWNXFETXIQCOMP0 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFETXIQCOMP0_ADDR   0x24C0B108
...
{
    ASSERT_ERR((((uint32_t)txiqphasecompen0 << 29) & ~((uint32_t)0x20000000)) == 0);
    ASSERT_ERR((((uint32_t)txiqgaincompen0 << 28) & ~((uint32_t)0x10000000)) == 0);
    ASSERT_ERR((((uint32_t)txiqphase0 << 16) & ~((uint32_t)0x01FF0000)) == 0);
    ASSERT_ERR((((uint32_t)txiqgain0 << 0) & ~((uint32_t)0x000007FF)) == 0);
 ...
 * <table>
 * <caption>RWNXFETXIQCOMP1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFETXIQCOMP1_ADDR   0x24C0B10C
...
{
    ASSERT_ERR((((uint32_t)txiqphasecompen1 << 29) & ~((uint32_t)0x20000000)) == 0);
    ASSERT_ERR((((uint32_t)txiqgaincompen1 << 28) & ~((uint32_t)0x10000000)) == 0);
    ASSERT_ERR((((uint32_t)txiqphase1 << 16) & ~((uint32_t)0x01FF0000)) == 0);
    ASSERT_ERR((((uint32_t)txiqgain1 << 0) & ~((uint32_t)0x000007FF)) == 0);
 ...
 * <table>
 * <caption>RWNXFERXIQESTCTRL bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:24 <td>      IQESTFOMIN <td> R <td> R/W <td> 0x0
 * <tr><td> 22:20 <td>     IQESTBWLIST <td> R <td> R/W <td> 0x7
 * <tr><td> 18:16 <td> RXIQESTSTARTDEL <td> R <td> R/W <td> 0x0
 * <tr><td> 15:12 <td>     IQESTMCSMIN <td> R <td> R/W <td> 0x0
 * <tr><td> 11:04 <td>     IQESTSNRMIN <td> R <td> R/W <td> 0xA
...
#define RIU_RWNXFERXIQESTCTRL_ADDR   0x24C0B110
...
#define RIU_RWNXFERXIQESTCTRL_RESET  0x007000A0
...
/// RXIQESTSTARTDEL field mask
#define RIU_RXIQESTSTARTDEL_MASK   ((uint32_t)0x00070000)
/// RXIQESTSTARTDEL field LSB position
#define RIU_RXIQESTSTARTDEL_LSB    16
/// RXIQESTSTARTDEL field width
#define RIU_RXIQESTSTARTDEL_WIDTH  ((uint32_t)0x00000003)
...
/// RXIQESTSTARTDEL field reset value
#define RIU_RXIQESTSTARTDEL_RST    0x0
/// IQESTMCSMIN field reset value
#define RIU_IQESTMCSMIN_RST        0x0
/// IQESTSNRMIN field reset value
#define RIU_IQESTSNRMIN_RST        0xA
 ...
 * @param[in] rxiqeststartdel - The value to use for the RXIQESTSTARTDEL field.
 ...
 */
__INLINE void riu_rwnxferxiqestctrl_pack(uint8_t iqestfomin, uint8_t iqestbwlist, uint8_t rxiqeststartdel, uint8_t iqestmcsmin, uint8_t iqestsnrmin, uint8_t rxiqphaseesten, uint8_t rxiqgainesten, uint8_t rxiqphasecompen, uint8_t rxiqgaincompen)
{
    ASSERT_ERR((((uint32_t)iqestfomin << 24) & ~((uint32_t)0xFF000000)) == 0);
    ASSERT_ERR((((uint32_t)iqestbwlist << 20) & ~((uint32_t)0x00700000)) == 0);
    ASSERT_ERR((((uint32_t)rxiqeststartdel << 16) & ~((uint32_t)0x00070000)) == 0);
    ASSERT_ERR((((uint32_t)iqestmcsmin << 12) & ~((uint32_t)0x0000F000)) == 0);
    ASSERT_ERR((((uint32_t)iqestsnrmin << 4) & ~((uint32_t)0x00000FF0)) == 0);
    ASSERT_ERR((((uint32_t)rxiqphaseesten << 3) & ~((uint32_t)0x00000008)) == 0);
    ASSERT_ERR((((uint32_t)rxiqgainesten << 2) & ~((uint32_t)0x00000004)) == 0);
    ASSERT_ERR((((uint32_t)rxiqphasecompen << 1) & ~((uint32_t)0x00000002)) == 0);
    ASSERT_ERR((((uint32_t)rxiqgaincompen << 0) & ~((uint32_t)0x00000001)) == 0);
    REG_PL_WR(RIU_RWNXFERXIQESTCTRL_ADDR,  ((uint32_t)iqestfomin << 24) | ((uint32_t)iqestbwlist << 20) | ((uint32_t)rxiqeststartdel << 16) | ((uint32_t)iqestmcsmin << 12) | ((uint32_t)iqestsnrmin << 4) | ((uint32_t)rxiqphaseesten << 3) | ((uint32_t)rxiqgainesten << 2) | ((uint32_t)rxiqphasecompen << 1) | ((uint32_t)rxiqgaincompen << 0));
}
 ...
 * @param[out] rxiqeststartdel - Will be populated with the current value of this field from the register.
 ...
 */
__INLINE void riu_rwnxferxiqestctrl_unpack(uint8_t* iqestfomin, uint8_t* iqestbwlist, uint8_t* rxiqeststartdel, uint8_t* iqestmcsmin, uint8_t* iqestsnrmin, uint8_t* rxiqphaseesten, uint8_t* rxiqgainesten, uint8_t* rxiqphasecompen, uint8_t* rxiqgaincompen)
{
    ...
    *rxiqeststartdel = (localVal & ((uint32_t)0x00070000)) >> 16;
...
/**
 * @brief Returns the current value of the RXIQESTSTARTDEL field in the RWNXFERXIQESTCTRL register.
 *
 * The RWNXFERXIQESTCTRL register will be read and the RXIQESTSTARTDEL field's value will be returned.
 *
 * @return The current value of the RXIQESTSTARTDEL field in the RWNXFERXIQESTCTRL register.
 */
__INLINE uint8_t riu_rxiqeststartdel_getf(void)
{
    uint32_t localVal = REG_PL_RD(RIU_RWNXFERXIQESTCTRL_ADDR);
...
/**
 * @brief Sets the RXIQESTSTARTDEL field of the RWNXFERXIQESTCTRL register.
 *
 * The RWNXFERXIQESTCTRL register will be read, modified to contain the new field value, and written.
 *
 * @param[in] rxiqeststartdel - The value to set the field to.
 */
__INLINE void riu_rxiqeststartdel_setf(uint8_t rxiqeststartdel)
{
    ASSERT_ERR((((uint32_t)rxiqeststartdel << 16) & ~((uint32_t)0x00070000)) == 0);
    REG_PL_WR(RIU_RWNXFERXIQESTCTRL_ADDR, (REG_PL_RD(RIU_RWNXFERXIQESTCTRL_ADDR) & ~((uint32_t)0x00070000)) | ((uint32_t)rxiqeststartdel << 16));
}
 ...
 * <table>
 * <caption>RWNXFERXIQESTLOOP bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFERXIQESTLOOP_ADDR   0x24C0B114
...
{
    ASSERT_ERR((((uint32_t)rxiqeststep4 << 28) & ~((uint32_t)0x70000000)) == 0);
    ASSERT_ERR((((uint32_t)rxiqeststep3 << 25) & ~((uint32_t)0x0E000000)) == 0);
    ASSERT_ERR((((uint32_t)rxiqeststep2 << 22) & ~((uint32_t)0x01C00000)) == 0);
    ASSERT_ERR((((uint32_t)rxiqeststep1 << 19) & ~((uint32_t)0x00380000)) == 0);
    ASSERT_ERR((((uint32_t)rxiqeststep0 << 16) & ~((uint32_t)0x00070000)) == 0);
    ASSERT_ERR((((uint32_t)rxiqestphasestepstop << 13) & ~((uint32_t)0x0000E000)) == 0);
    ASSERT_ERR((((uint32_t)rxiqestphasestepinit << 10) & ~((uint32_t)0x00001C00)) == 0);
    ASSERT_ERR((((uint32_t)rxiqestgainstepstop << 7) & ~((uint32_t)0x00000380)) == 0);
    ASSERT_ERR((((uint32_t)rxiqestgainstepinit << 4) & ~((uint32_t)0x00000070)) == 0);
    ASSERT_ERR((((uint32_t)rxiqestdel << 0) & ~((uint32_t)0x00000007)) == 0);
 ...
 * <table>
 * <caption>RWNXFERXIQESTCLR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFERXIQESTCLR_ADDR   0x24C0B118
...
{
    ASSERT_ERR((((uint32_t)iqestiterclr << 0) & ~((uint32_t)0x00000001)) == 0);
 ...
 * <table>
 * <caption>RWNXFERXIQCOMP0 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFERXIQCOMP0_ADDR   0x24C0B11C
...
{
    ASSERT_ERR((((uint32_t)rxiqphase0 << 16) & ~((uint32_t)0x01FF0000)) == 0);
    ASSERT_ERR((((uint32_t)rxiqgain0 << 0) & ~((uint32_t)0x000007FF)) == 0);
 ...
 * <table>
 * <caption>RWNXFERXIQCOMP1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFERXIQCOMP1_ADDR   0x24C0B120
...
{
    ASSERT_ERR((((uint32_t)rxiqphase1 << 16) & ~((uint32_t)0x01FF0000)) == 0);
    ASSERT_ERR((((uint32_t)rxiqgain1 << 0) & ~((uint32_t)0x000007FF)) == 0);
 ...
 * <table>
 * <caption>RWNXFEFIQCTRL bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFEFIQCTRL_ADDR   0x24C0B124
...
{
    ASSERT_ERR((((uint32_t)fiqpathsel << 12) & ~((uint32_t)0x00001000)) == 0);
    ASSERT_ERR((((uint32_t)fiqtxrx << 8) & ~((uint32_t)0x00000100)) == 0);
    ASSERT_ERR((((uint32_t)fiqrxbypass << 2) & ~((uint32_t)0x00000004)) == 0);
    ASSERT_ERR((((uint32_t)fiqtxbypass << 1) & ~((uint32_t)0x00000002)) == 0);
    ASSERT_ERR((((uint32_t)fiqcalen << 0) & ~((uint32_t)0x00000001)) == 0);
 ...
 * <table>
 * <caption>RWNXFEFIQCOLL bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFEFIQCOLL_ADDR   0x24C0B128
...
{
    ASSERT_ERR((((uint32_t)fiqcollwroffset << 24) & ~((uint32_t)0xFF000000)) == 0);
    ASSERT_ERR((((uint32_t)fiqcollrdoffset << 16) & ~((uint32_t)0x00FF0000)) == 0);
    ASSERT_ERR((((uint32_t)fiqcollsize << 8) & ~((uint32_t)0x0000FF00)) == 0);
    ASSERT_ERR((((uint32_t)fiqcollpath << 0) & ~((uint32_t)0x00000001)) == 0);
 ...
 * <table>
 * <caption>RWNXFEFIQEST0 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFEFIQEST0_ADDR   0x24C0B12C
...
{
    ASSERT_ERR((((uint32_t)fiqestqoffset << 24) & ~((uint32_t)0xFF000000)) == 0);
    ASSERT_ERR((((uint32_t)fiqestioffset << 16) & ~((uint32_t)0x00FF0000)) == 0);
    ASSERT_ERR((((uint32_t)fiqestsize << 0) & ~((uint32_t)0x000000FF)) == 0);
 ...
 * <table>
 * <caption>RWNXFEFIQEST1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFEFIQEST1_ADDR   0x24C0B130
...
{
    ASSERT_ERR((((uint32_t)fiqeststep << 16) & ~((uint32_t)0x000F0000)) == 0);
    ASSERT_ERR((((uint32_t)fiqestnite << 0) & ~((uint32_t)0x0000FFFF)) == 0);
 ...
 * <table>
 * <caption>RWNXFEFIQDEL bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFEFIQDEL_ADDR   0x24C0B134
...
{
    ASSERT_ERR((((uint32_t)fiqrxdel << 24) & ~((uint32_t)0x1F000000)) == 0);
    ASSERT_ERR((((uint32_t)fiqtxdel << 16) & ~((uint32_t)0x001F0000)) == 0);
    ASSERT_ERR((((uint32_t)fiqcolldel << 0) & ~((uint32_t)0x000000FF)) == 0);
 ...
 * <table>
 * <caption>RWNXFEFIQCOEFF bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFEFIQCOEFF_ADDR   0x24C0B138
...
{
    ASSERT_ERR(reg_idx <= 19);
    ASSERT_ERR((((uint32_t)fiqcoeff << 0) & ~((uint32_t)0x0000FFFF)) == 0);
 ...
 * <table>
 * <caption>RWNXFEFIQCOEFFUPDATE bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFEFIQCOEFFUPDATE_ADDR   0x24C0B188
...
{
    ASSERT_ERR((((uint32_t)fiqcoeffupdate << 0) & ~((uint32_t)0x00000001)) == 0);
 ...
 * <table>
 * <caption>RWNXFEFIQCOEFFREQ bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFEFIQCOEFFREQ_ADDR   0x24C0B18C
...
{
    ASSERT_ERR((((uint32_t)fiqcoeffreq << 0) & ~((uint32_t)0x00000001)) == 0);
 ...
 * <table>
 * <caption>RWNXFEFIQSTART bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFEFIQSTART_ADDR   0x24C0B190
...
{
    ASSERT_ERR((((uint32_t)fiqeststart << 16) & ~((uint32_t)0x00010000)) == 0);
    ASSERT_ERR((((uint32_t)fiqcollstart << 0) & ~((uint32_t)0x00000001)) == 0);
...
/**
 * @name RWNXFERXRESAMPLER register definitions
 * <table>
 * <caption>RWNXFERXRESAMPLER bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 12 <td> CFGBW80RXCOEFSEL <td> R <td> R/W <td> 1
 * <tr><td> 08 <td> CFGBW40RXCOEFSEL <td> R <td> R/W <td> 1
 * <tr><td> 04 <td> CFGBW20RXCOEFSEL <td> R <td> R/W <td> 0
 * <tr><td> 00 <td>      RXSFOBYPASS <td> R <td> R/W <td> 0
 * </table>
 *
 * @{
 */

/// Address of the RWNXFERXRESAMPLER register
#define RIU_RWNXFERXRESAMPLER_ADDR   0x24C0B194
/// Offset of the RWNXFERXRESAMPLER register from the base address
#define RIU_RWNXFERXRESAMPLER_OFFSET 0x00000194
/// Index of the RWNXFERXRESAMPLER register
#define RIU_RWNXFERXRESAMPLER_INDEX  0x00000065
/// Reset value of the RWNXFERXRESAMPLER register
#define RIU_RWNXFERXRESAMPLER_RESET  0x00001100

/**
 * @brief Returns the current value of the RWNXFERXRESAMPLER register.
 * The RWNXFERXRESAMPLER register will be read and its value returned.
 * @return The current value of the RWNXFERXRESAMPLER register.
 */
__INLINE uint32_t riu_rwnxferxresampler_get(void)
{
    return REG_PL_RD(RIU_RWNXFERXRESAMPLER_ADDR);
}

/**
 * @brief Sets the RWNXFERXRESAMPLER register to a value.
 * The RWNXFERXRESAMPLER register will be written.
 * @param value - The value to write.
 */
__INLINE void riu_rwnxferxresampler_set(uint32_t value)
{
    REG_PL_WR(RIU_RWNXFERXRESAMPLER_ADDR, value);
}

// field definitions
/// CFGBW80RXCOEFSEL field bit
#define RIU_CFGBW80RXCOEFSEL_BIT    ((uint32_t)0x00001000)
/// CFGBW80RXCOEFSEL field position
#define RIU_CFGBW80RXCOEFSEL_POS    12
/// CFGBW40RXCOEFSEL field bit
#define RIU_CFGBW40RXCOEFSEL_BIT    ((uint32_t)0x00000100)
/// CFGBW40RXCOEFSEL field position
#define RIU_CFGBW40RXCOEFSEL_POS    8
/// CFGBW20RXCOEFSEL field bit
#define RIU_CFGBW20RXCOEFSEL_BIT    ((uint32_t)0x00000010)
/// CFGBW20RXCOEFSEL field position
#define RIU_CFGBW20RXCOEFSEL_POS    4
/// RXSFOBYPASS field bit
#define RIU_RXSFOBYPASS_BIT         ((uint32_t)0x00000001)
/// RXSFOBYPASS field position
#define RIU_RXSFOBYPASS_POS         0

/// CFGBW80RXCOEFSEL field reset value
#define RIU_CFGBW80RXCOEFSEL_RST    0x1
/// CFGBW40RXCOEFSEL field reset value
#define RIU_CFGBW40RXCOEFSEL_RST    0x1
/// CFGBW20RXCOEFSEL field reset value
#define RIU_CFGBW20RXCOEFSEL_RST    0x0
/// RXSFOBYPASS field reset value
#define RIU_RXSFOBYPASS_RST         0x0

/**
 * @brief Constructs a value for the RWNXFERXRESAMPLER register given values for its fields
 * and writes the value to the register.
 *
 * @param[in] cfgbw80rxcoefsel - The value to use for the CFGBW80RXCOEFSEL field.
 * @param[in] cfgbw40rxcoefsel - The value to use for the CFGBW40RXCOEFSEL field.
 * @param[in] cfgbw20rxcoefsel - The value to use for the CFGBW20RXCOEFSEL field.
 * @param[in] rxsfobypass - The value to use for the RXSFOBYPASS field.
 */
__INLINE void riu_rwnxferxresampler_pack(uint8_t cfgbw80rxcoefsel, uint8_t cfgbw40rxcoefsel, uint8_t cfgbw20rxcoefsel, uint8_t rxsfobypass)
{
    ASSERT_ERR((((uint32_t)cfgbw80rxcoefsel << 12) & ~((uint32_t)0x00001000)) == 0);
    ASSERT_ERR((((uint32_t)cfgbw40rxcoefsel << 8) & ~((uint32_t)0x00000100)) == 0);
    ASSERT_ERR((((uint32_t)cfgbw20rxcoefsel << 4) & ~((uint32_t)0x00000010)) == 0);
    ASSERT_ERR((((uint32_t)rxsfobypass << 0) & ~((uint32_t)0x00000001)) == 0);
    REG_PL_WR(RIU_RWNXFERXRESAMPLER_ADDR,  ((uint32_t)cfgbw80rxcoefsel << 12) | ((uint32_t)cfgbw40rxcoefsel << 8) | ((uint32_t)cfgbw20rxcoefsel << 4) | ((uint32_t)rxsfobypass << 0));
}

/**
 * @brief Unpacks RWNXFERXRESAMPLER's fields from current value of the RWNXFERXRESAMPLER register.
 *
 * Reads the RWNXFERXRESAMPLER register and populates all the _field variables with the corresponding
 * values from the register.
 *
 * @param[out] cfgbw80rxcoefsel - Will be populated with the current value of this field from the register.
 * @param[out] cfgbw40rxcoefsel - Will be populated with the current value of this field from the register.
 * @param[out] cfgbw20rxcoefsel - Will be populated with the current value of this field from the register.
 * @param[out] rxsfobypass - Will be populated with the current value of this field from the register.
 */
__INLINE void riu_rwnxferxresampler_unpack(uint8_t* cfgbw80rxcoefsel, uint8_t* cfgbw40rxcoefsel, uint8_t* cfgbw20rxcoefsel, uint8_t* rxsfobypass)
{
    uint32_t localVal = REG_PL_RD(RIU_RWNXFERXRESAMPLER_ADDR);

    *cfgbw80rxcoefsel = (localVal & ((uint32_t)0x00001000)) >> 12;
    *cfgbw40rxcoefsel = (localVal & ((uint32_t)0x00000100)) >> 8;
    *cfgbw20rxcoefsel = (localVal & ((uint32_t)0x00000010)) >> 4;
    *rxsfobypass = (localVal & ((uint32_t)0x00000001)) >> 0;
}

/**
 * @brief Returns the current value of the CFGBW80RXCOEFSEL field in the RWNXFERXRESAMPLER register.
 *
 * The RWNXFERXRESAMPLER register will be read and the CFGBW80RXCOEFSEL field's value will be returned.
 *
 * @return The current value of the CFGBW80RXCOEFSEL field in the RWNXFERXRESAMPLER register.
 */
__INLINE uint8_t riu_cfgbw80rxcoefsel_getf(void)
{
    uint32_t localVal = REG_PL_RD(RIU_RWNXFERXRESAMPLER_ADDR);
    return ((localVal & ((uint32_t)0x00001000)) >> 12);
}
...
/**
 * @brief Sets the CFGBW80RXCOEFSEL field of the RWNXFERXRESAMPLER register.
 *
 * The RWNXFERXRESAMPLER register will be read, modified to contain the new field value, and written.
 *
 * @param[in] cfgbw80rxcoefsel - The value to set the field to.
 */
__INLINE void riu_cfgbw80rxcoefsel_setf(uint8_t cfgbw80rxcoefsel)
{
    ASSERT_ERR((((uint32_t)cfgbw80rxcoefsel << 12) & ~((uint32_t)0x00001000)) == 0);
    REG_PL_WR(RIU_RWNXFERXRESAMPLER_ADDR, (REG_PL_RD(RIU_RWNXFERXRESAMPLER_ADDR) & ~((uint32_t)0x00001000)) | ((uint32_t)cfgbw80rxcoefsel << 12));
}

/**
 * @brief Returns the current value of the CFGBW40RXCOEFSEL field in the RWNXFERXRESAMPLER register.
 *
 * The RWNXFERXRESAMPLER register will be read and the CFGBW40RXCOEFSEL field's value will be returned.
 *
 * @return The current value of the CFGBW40RXCOEFSEL field in the RWNXFERXRESAMPLER register.
 */
__INLINE uint8_t riu_cfgbw40rxcoefsel_getf(void)
{
    uint32_t localVal = REG_PL_RD(RIU_RWNXFERXRESAMPLER_ADDR);
    return ((localVal & ((uint32_t)0x00000100)) >> 8);
}
...
/**
 * @brief Sets the CFGBW40RXCOEFSEL field of the RWNXFERXRESAMPLER register.
 *
 * The RWNXFERXRESAMPLER register will be read, modified to contain the new field value, and written.
 *
 * @param[in] cfgbw40rxcoefsel - The value to set the field to.
 */
__INLINE void riu_cfgbw40rxcoefsel_setf(uint8_t cfgbw40rxcoefsel)
{
    ASSERT_ERR((((uint32_t)cfgbw40rxcoefsel << 8) & ~((uint32_t)0x00000100)) == 0);
    REG_PL_WR(RIU_RWNXFERXRESAMPLER_ADDR, (REG_PL_RD(RIU_RWNXFERXRESAMPLER_ADDR) & ~((uint32_t)0x00000100)) | ((uint32_t)cfgbw40rxcoefsel << 8));
}

/**
 * @brief Returns the current value of the CFGBW20RXCOEFSEL field in the RWNXFERXRESAMPLER register.
 *
 * The RWNXFERXRESAMPLER register will be read and the CFGBW20RXCOEFSEL field's value will be returned.
 *
 * @return The current value of the CFGBW20RXCOEFSEL field in the RWNXFERXRESAMPLER register.
 */
__INLINE uint8_t riu_cfgbw20rxcoefsel_getf(void)
{
    uint32_t localVal = REG_PL_RD(RIU_RWNXFERXRESAMPLER_ADDR);
    return ((localVal & ((uint32_t)0x00000010)) >> 4);
}
...
/**
 * @brief Sets the CFGBW20RXCOEFSEL field of the RWNXFERXRESAMPLER register.
 *
 * The RWNXFERXRESAMPLER register will be read, modified to contain the new field value, and written.
 *
 * @param[in] cfgbw20rxcoefsel - The value to set the field to.
 */
__INLINE void riu_cfgbw20rxcoefsel_setf(uint8_t cfgbw20rxcoefsel)
{
    ASSERT_ERR((((uint32_t)cfgbw20rxcoefsel << 4) & ~((uint32_t)0x00000010)) == 0);
    REG_PL_WR(RIU_RWNXFERXRESAMPLER_ADDR, (REG_PL_RD(RIU_RWNXFERXRESAMPLER_ADDR) & ~((uint32_t)0x00000010)) | ((uint32_t)cfgbw20rxcoefsel << 4));
}

/**
 * @brief Returns the current value of the RXSFOBYPASS field in the RWNXFERXRESAMPLER register.
 *
 * The RWNXFERXRESAMPLER register will be read and the RXSFOBYPASS field's value will be returned.
 *
 * @return The current value of the RXSFOBYPASS field in the RWNXFERXRESAMPLER register.
 */
__INLINE uint8_t riu_rxsfobypass_getf(void)
{
    uint32_t localVal = REG_PL_RD(RIU_RWNXFERXRESAMPLER_ADDR);
    return ((localVal & ((uint32_t)0x00000001)) >> 0);
}
...
/**
 * @brief Sets the RXSFOBYPASS field of the RWNXFERXRESAMPLER register.
 *
 * The RWNXFERXRESAMPLER register will be read, modified to contain the new field value, and written.
 *
 * @param[in] rxsfobypass - The value to set the field to.
 */
__INLINE void riu_rxsfobypass_setf(uint8_t rxsfobypass)
{
    ASSERT_ERR((((uint32_t)rxsfobypass << 0) & ~((uint32_t)0x00000001)) == 0);
    REG_PL_WR(RIU_RWNXFERXRESAMPLER_ADDR, (REG_PL_RD(RIU_RWNXFERXRESAMPLER_ADDR) & ~((uint32_t)0x00000001)) | ((uint32_t)rxsfobypass << 0));
}

/// @}

/**
 * @name RWNXFETXRESAMPLER register definitions
 * <table>
 * <caption>RWNXFETXRESAMPLER bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 13 <td>    CFGBW80TXOSX4 <td> R <td> R/W <td> 0
 * <tr><td> 12 <td> CFGBW80TXCOEFSEL <td> R <td> R/W <td> 1
 * <tr><td> 09 <td>    CFGBW40TXOSX4 <td> R <td> R/W <td> 0
 * <tr><td> 08 <td> CFGBW40TXCOEFSEL <td> R <td> R/W <td> 1
 * <tr><td> 05 <td>    CFGBW20TXOSX4 <td> R <td> R/W <td> 0
 * <tr><td> 04 <td> CFGBW20TXCOEFSEL <td> R <td> R/W <td> 0
 * </table>
 *
 * @{
 */

/// Address of the RWNXFETXRESAMPLER register
#define RIU_RWNXFETXRESAMPLER_ADDR   0x24C0B198
/// Offset of the RWNXFETXRESAMPLER register from the base address
#define RIU_RWNXFETXRESAMPLER_OFFSET 0x00000198
/// Index of the RWNXFETXRESAMPLER register
#define RIU_RWNXFETXRESAMPLER_INDEX  0x00000066
/// Reset value of the RWNXFETXRESAMPLER register
#define RIU_RWNXFETXRESAMPLER_RESET  0x00001100

/**
 * @brief Returns the current value of the RWNXFETXRESAMPLER register.
 * The RWNXFETXRESAMPLER register will be read and its value returned.
 * @return The current value of the RWNXFETXRESAMPLER register.
 */
__INLINE uint32_t riu_rwnxfetxresampler_get(void)
{
    return REG_PL_RD(RIU_RWNXFETXRESAMPLER_ADDR);
}

/**
 * @brief Sets the RWNXFETXRESAMPLER register to a value.
 * The RWNXFETXRESAMPLER register will be written.
 * @param value - The value to write.
 */
__INLINE void riu_rwnxfetxresampler_set(uint32_t value)
{
    REG_PL_WR(RIU_RWNXFETXRESAMPLER_ADDR, value);
}

// field definitions
/// CFGBW80TXOSX4 field bit
#define RIU_CFGBW80TXOSX4_BIT       ((uint32_t)0x00002000)
/// CFGBW80TXOSX4 field position
#define RIU_CFGBW80TXOSX4_POS       13
/// CFGBW80TXCOEFSEL field bit
#define RIU_CFGBW80TXCOEFSEL_BIT    ((uint32_t)0x00001000)
/// CFGBW80TXCOEFSEL field position
#define RIU_CFGBW80TXCOEFSEL_POS    12
/// CFGBW40TXOSX4 field bit
#define RIU_CFGBW40TXOSX4_BIT       ((uint32_t)0x00000200)
/// CFGBW40TXOSX4 field position
#define RIU_CFGBW40TXOSX4_POS       9
/// CFGBW40TXCOEFSEL field bit
#define RIU_CFGBW40TXCOEFSEL_BIT    ((uint32_t)0x00000100)
/// CFGBW40TXCOEFSEL field position
#define RIU_CFGBW40TXCOEFSEL_POS    8
/// CFGBW20TXOSX4 field bit
#define RIU_CFGBW20TXOSX4_BIT       ((uint32_t)0x00000020)
/// CFGBW20TXOSX4 field position
#define RIU_CFGBW20TXOSX4_POS       5
/// CFGBW20TXCOEFSEL field bit
#define RIU_CFGBW20TXCOEFSEL_BIT    ((uint32_t)0x00000010)
/// CFGBW20TXCOEFSEL field position
#define RIU_CFGBW20TXCOEFSEL_POS    4

/// CFGBW80TXOSX4 field reset value
#define RIU_CFGBW80TXOSX4_RST       0x0
/// CFGBW80TXCOEFSEL field reset value
#define RIU_CFGBW80TXCOEFSEL_RST    0x1
/// CFGBW40TXOSX4 field reset value
#define RIU_CFGBW40TXOSX4_RST       0x0
/// CFGBW40TXCOEFSEL field reset value
#define RIU_CFGBW40TXCOEFSEL_RST    0x1
/// CFGBW20TXOSX4 field reset value
#define RIU_CFGBW20TXOSX4_RST       0x0
/// CFGBW20TXCOEFSEL field reset value
#define RIU_CFGBW20TXCOEFSEL_RST    0x0

/**
 * @brief Constructs a value for the RWNXFETXRESAMPLER register given values for its fields
 * and writes the value to the register.
 *
 * @param[in] cfgbw80txosx4 - The value to use for the CFGBW80TXOSX4 field.
 * @param[in] cfgbw80txcoefsel - The value to use for the CFGBW80TXCOEFSEL field.
 * @param[in] cfgbw40txosx4 - The value to use for the CFGBW40TXOSX4 field.
 * @param[in] cfgbw40txcoefsel - The value to use for the CFGBW40TXCOEFSEL field.
 * @param[in] cfgbw20txosx4 - The value to use for the CFGBW20TXOSX4 field.
 * @param[in] cfgbw20txcoefsel - The value to use for the CFGBW20TXCOEFSEL field.
 */
__INLINE void riu_rwnxfetxresampler_pack(uint8_t cfgbw80txosx4, uint8_t cfgbw80txcoefsel, uint8_t cfgbw40txosx4, uint8_t cfgbw40txcoefsel, uint8_t cfgbw20txosx4, uint8_t cfgbw20txcoefsel)
{
    ASSERT_ERR((((uint32_t)cfgbw80txosx4 << 13) & ~((uint32_t)0x00002000)) == 0);
    ASSERT_ERR((((uint32_t)cfgbw80txcoefsel << 12) & ~((uint32_t)0x00001000)) == 0);
    ASSERT_ERR((((uint32_t)cfgbw40txosx4 << 9) & ~((uint32_t)0x00000200)) == 0);
    ASSERT_ERR((((uint32_t)cfgbw40txcoefsel << 8) & ~((uint32_t)0x00000100)) == 0);
    ASSERT_ERR((((uint32_t)cfgbw20txosx4 << 5) & ~((uint32_t)0x00000020)) == 0);
    ASSERT_ERR((((uint32_t)cfgbw20txcoefsel << 4) & ~((uint32_t)0x00000010)) == 0);
    REG_PL_WR(RIU_RWNXFETXRESAMPLER_ADDR,  ((uint32_t)cfgbw80txosx4 << 13) | ((uint32_t)cfgbw80txcoefsel << 12) | ((uint32_t)cfgbw40txosx4 << 9) | ((uint32_t)cfgbw40txcoefsel << 8) | ((uint32_t)cfgbw20txosx4 << 5) | ((uint32_t)cfgbw20txcoefsel << 4));
}

/**
 * @brief Unpacks RWNXFETXRESAMPLER's fields from current value of the RWNXFETXRESAMPLER register.
 *
 * Reads the RWNXFETXRESAMPLER register and populates all the _field variables with the corresponding
 * values from the register.
 *
 * @param[out] cfgbw80txosx4 - Will be populated with the current value of this field from the register.
 * @param[out] cfgbw80txcoefsel - Will be populated with the current value of this field from the register.
 * @param[out] cfgbw40txosx4 - Will be populated with the current value of this field from the register.
 * @param[out] cfgbw40txcoefsel - Will be populated with the current value of this field from the register.
 * @param[out] cfgbw20txosx4 - Will be populated with the current value of this field from the register.
 * @param[out] cfgbw20txcoefsel - Will be populated with the current value of this field from the register.
 */
__INLINE void riu_rwnxfetxresampler_unpack(uint8_t* cfgbw80txosx4, uint8_t* cfgbw80txcoefsel, uint8_t* cfgbw40txosx4, uint8_t* cfgbw40txcoefsel, uint8_t* cfgbw20txosx4, uint8_t* cfgbw20txcoefsel)
{
    uint32_t localVal = REG_PL_RD(RIU_RWNXFETXRESAMPLER_ADDR);

    *cfgbw80txosx4 = (localVal & ((uint32_t)0x00002000)) >> 13;
    *cfgbw80txcoefsel = (localVal & ((uint32_t)0x00001000)) >> 12;
    *cfgbw40txosx4 = (localVal & ((uint32_t)0x00000200)) >> 9;
    *cfgbw40txcoefsel = (localVal & ((uint32_t)0x00000100)) >> 8;
    *cfgbw20txosx4 = (localVal & ((uint32_t)0x00000020)) >> 5;
    *cfgbw20txcoefsel = (localVal & ((uint32_t)0x00000010)) >> 4;
}

/**
 * @brief Returns the current value of the CFGBW80TXOSX4 field in the RWNXFETXRESAMPLER register.
 *
 * The RWNXFETXRESAMPLER register will be read and the CFGBW80TXOSX4 field's value will be returned.
 *
 * @return The current value of the CFGBW80TXOSX4 field in the RWNXFETXRESAMPLER register.
 */
__INLINE uint8_t riu_cfgbw80txosx4_getf(void)
{
    uint32_t localVal = REG_PL_RD(RIU_RWNXFETXRESAMPLER_ADDR);
    return ((localVal & ((uint32_t)0x00002000)) >> 13);
}
...
/**
 * @brief Sets the CFGBW80TXOSX4 field of the RWNXFETXRESAMPLER register.
 *
 * The RWNXFETXRESAMPLER register will be read, modified to contain the new field value, and written.
 *
 * @param[in] cfgbw80txosx4 - The value to set the field to.
 */
__INLINE void riu_cfgbw80txosx4_setf(uint8_t cfgbw80txosx4)
{
    ASSERT_ERR((((uint32_t)cfgbw80txosx4 << 13) & ~((uint32_t)0x00002000)) == 0);
    REG_PL_WR(RIU_RWNXFETXRESAMPLER_ADDR, (REG_PL_RD(RIU_RWNXFETXRESAMPLER_ADDR) & ~((uint32_t)0x00002000)) | ((uint32_t)cfgbw80txosx4 << 13));
}

/**
 * @brief Returns the current value of the CFGBW80TXCOEFSEL field in the RWNXFETXRESAMPLER register.
 *
 * The RWNXFETXRESAMPLER register will be read and the CFGBW80TXCOEFSEL field's value will be returned.
 *
 * @return The current value of the CFGBW80TXCOEFSEL field in the RWNXFETXRESAMPLER register.
 */
__INLINE uint8_t riu_cfgbw80txcoefsel_getf(void)
{
    uint32_t localVal = REG_PL_RD(RIU_RWNXFETXRESAMPLER_ADDR);
    return ((localVal & ((uint32_t)0x00001000)) >> 12);
}
...
/**
 * @brief Sets the CFGBW80TXCOEFSEL field of the RWNXFETXRESAMPLER register.
 *
 * The RWNXFETXRESAMPLER register will be read, modified to contain the new field value, and written.
 *
 * @param[in] cfgbw80txcoefsel - The value to set the field to.
 */
__INLINE void riu_cfgbw80txcoefsel_setf(uint8_t cfgbw80txcoefsel)
{
    ASSERT_ERR((((uint32_t)cfgbw80txcoefsel << 12) & ~((uint32_t)0x00001000)) == 0);
    REG_PL_WR(RIU_RWNXFETXRESAMPLER_ADDR, (REG_PL_RD(RIU_RWNXFETXRESAMPLER_ADDR) & ~((uint32_t)0x00001000)) | ((uint32_t)cfgbw80txcoefsel << 12));
}

/**
 * @brief Returns the current value of the CFGBW40TXOSX4 field in the RWNXFETXRESAMPLER register.
 *
 * The RWNXFETXRESAMPLER register will be read and the CFGBW40TXOSX4 field's value will be returned.
 *
 * @return The current value of the CFGBW40TXOSX4 field in the RWNXFETXRESAMPLER register.
 */
__INLINE uint8_t riu_cfgbw40txosx4_getf(void)
{
    uint32_t localVal = REG_PL_RD(RIU_RWNXFETXRESAMPLER_ADDR);
...
/**
 * @brief Sets the CFGBW40TXOSX4 field of the RWNXFETXRESAMPLER register.
 *
 * The RWNXFETXRESAMPLER register will be read, modified to contain the new field value, and written.
 *
 * @param[in] cfgbw40txosx4 - The value to set the field to.
 */
__INLINE void riu_cfgbw40txosx4_setf(uint8_t cfgbw40txosx4)
{
    ASSERT_ERR((((uint32_t)cfgbw40txosx4 << 9) & ~((uint32_t)0x00000200)) == 0);
    REG_PL_WR(RIU_RWNXFETXRESAMPLER_ADDR, (REG_PL_RD(RIU_RWNXFETXRESAMPLER_ADDR) & ~((uint32_t)0x00000200)) | ((uint32_t)cfgbw40txosx4 << 9));
}

/**
 * @brief Returns the current value of the CFGBW40TXCOEFSEL field in the RWNXFETXRESAMPLER register.
 *
 * The RWNXFETXRESAMPLER register will be read and the CFGBW40TXCOEFSEL field's value will be returned.
 *
 * @return The current value of the CFGBW40TXCOEFSEL field in the RWNXFETXRESAMPLER register.
 */
__INLINE uint8_t riu_cfgbw40txcoefsel_getf(void)
{
    uint32_t localVal = REG_PL_RD(RIU_RWNXFETXRESAMPLER_ADDR);
    return ((localVal & ((uint32_t)0x00000100)) >> 8);
}
...
/**
 * @brief Sets the CFGBW40TXCOEFSEL field of the RWNXFETXRESAMPLER register.
 *
 * The RWNXFETXRESAMPLER register will be read, modified to contain the new field value, and written.
 *
 * @param[in] cfgbw40txcoefsel - The value to set the field to.
 */
__INLINE void riu_cfgbw40txcoefsel_setf(uint8_t cfgbw40txcoefsel)
{
    ASSERT_ERR((((uint32_t)cfgbw40txcoefsel << 8) & ~((uint32_t)0x00000100)) == 0);
    REG_PL_WR(RIU_RWNXFETXRESAMPLER_ADDR, (REG_PL_RD(RIU_RWNXFETXRESAMPLER_ADDR) & ~((uint32_t)0x00000100)) | ((uint32_t)cfgbw40txcoefsel << 8));
}

/**
 * @brief Returns the current value of the CFGBW20TXOSX4 field in the RWNXFETXRESAMPLER register.
 *
 * The RWNXFETXRESAMPLER register will be read and the CFGBW20TXOSX4 field's value will be returned.
 *
 * @return The current value of the CFGBW20TXOSX4 field in the RWNXFETXRESAMPLER register.
 */
__INLINE uint8_t riu_cfgbw20txosx4_getf(void)
{
    uint32_t localVal = REG_PL_RD(RIU_RWNXFETXRESAMPLER_ADDR);
    return ((localVal & ((uint32_t)0x00000020)) >> 5);
}
...
/**
 * @brief Sets the CFGBW20TXOSX4 field of the RWNXFETXRESAMPLER register.
 *
 * The RWNXFETXRESAMPLER register will be read, modified to contain the new field value, and written.
 *
 * @param[in] cfgbw20txosx4 - The value to set the field to.
 */
__INLINE void riu_cfgbw20txosx4_setf(uint8_t cfgbw20txosx4)
{
    ASSERT_ERR((((uint32_t)cfgbw20txosx4 << 5) & ~((uint32_t)0x00000020)) == 0);
    REG_PL_WR(RIU_RWNXFETXRESAMPLER_ADDR, (REG_PL_RD(RIU_RWNXFETXRESAMPLER_ADDR) & ~((uint32_t)0x00000020)) | ((uint32_t)cfgbw20txosx4 << 5));
}

/**
 * @brief Returns the current value of the CFGBW20TXCOEFSEL field in the RWNXFETXRESAMPLER register.
 *
 * The RWNXFETXRESAMPLER register will be read and the CFGBW20TXCOEFSEL field's value will be returned.
 *
 * @return The current value of the CFGBW20TXCOEFSEL field in the RWNXFETXRESAMPLER register.
 */
__INLINE uint8_t riu_cfgbw20txcoefsel_getf(void)
{
    uint32_t localVal = REG_PL_RD(RIU_RWNXFETXRESAMPLER_ADDR);
    return ((localVal & ((uint32_t)0x00000010)) >> 4);
}
...
/**
 * @brief Sets the CFGBW20TXCOEFSEL field of the RWNXFETXRESAMPLER register.
 *
 * The RWNXFETXRESAMPLER register will be read, modified to contain the new field value, and written.
 *
 * @param[in] cfgbw20txcoefsel - The value to set the field to.
 */
__INLINE void riu_cfgbw20txcoefsel_setf(uint8_t cfgbw20txcoefsel)
{
    ASSERT_ERR((((uint32_t)cfgbw20txcoefsel << 4) & ~((uint32_t)0x00000010)) == 0);
    REG_PL_WR(RIU_RWNXFETXRESAMPLER_ADDR, (REG_PL_RD(RIU_RWNXFETXRESAMPLER_ADDR) & ~((uint32_t)0x00000010)) | ((uint32_t)cfgbw20txcoefsel << 4));
}
 ...
 * <table>
 * <caption>AGCGAINSTAT bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_AGCGAINSTAT_ADDR   0x24C0B200
 ...
 * <table>
 * <caption>AGCADCPOWSTAT bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_AGCADCPOWSTAT_ADDR   0x24C0B208
 ...
 * <table>
 * <caption>AGCINBDPOW20PSTAT bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_AGCINBDPOW20PSTAT_ADDR   0x24C0B20C
 ...
 * <table>
 * <caption>AGCDIGGAIN0STAT bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_AGCDIGGAIN0STAT_ADDR   0x24C0B210
 ...
 * <table>
 * <caption>AGCDIGGAIN1STAT bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_AGCDIGGAIN1STAT_ADDR   0x24C0B214
 ...
 * <table>
 * <caption>RADARFIFOSTAT bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RADARFIFOSTAT_ADDR   0x24C0B220
 ...
 * <table>
 * <caption>AGCINBDPOW20PNOISESTAT bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_AGCINBDPOW20PNOISESTAT_ADDR   0x24C0B228
 ...
 * <table>
 * <caption>AGCINBDPOWSECSTAT bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_AGCINBDPOWSECSTAT_ADDR   0x24C0B22C
 ...
 * <table>
 * <caption>AGCINBDPOWSECNOISESTAT bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_AGCINBDPOWSECNOISESTAT_ADDR   0x24C0B230
 ...
 * <table>
 * <caption>RWNXFERXIQSTATVARI0 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFERXIQSTATVARI0_ADDR   0x24C0B240
 ...
 * <table>
 * <caption>RWNXFERXIQSTATVARQ0 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFERXIQSTATVARQ0_ADDR   0x24C0B244
 ...
 * <table>
 * <caption>RWNXFERXIQSTATMIQ0 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFERXIQSTATMIQ0_ADDR   0x24C0B248
 ...
 * <table>
 * <caption>RWNXFERXIQSTAT0 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFERXIQSTAT0_ADDR   0x24C0B24C
 ...
 * <table>
 * <caption>RWNXFERXIQSTATVARI1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFERXIQSTATVARI1_ADDR   0x24C0B250
 ...
 * <table>
 * <caption>RWNXFERXIQSTATVARQ1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFERXIQSTATVARQ1_ADDR   0x24C0B254
 ...
 * <table>
 * <caption>RWNXFERXIQSTATMIQ1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFERXIQSTATMIQ1_ADDR   0x24C0B258
 ...
 * <table>
 * <caption>RWNXFERXIQSTAT1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFERXIQSTAT1_ADDR   0x24C0B25C
 ...
 * <table>
 * <caption>RWNXFEFIQDONE bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFEFIQDONE_ADDR   0x24C0B260
 ...
 * <table>
 * <caption>RWNXFEFIQSTAT0 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFEFIQSTAT0_ADDR   0x24C0B264
 ...
 * <table>
 * <caption>RWNXFEFIQSTAT1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFEFIQSTAT1_ADDR   0x24C0B268
 ...
 * <table>
 * <caption>RWNXFEFIQSTATCOEFF bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFEFIQSTATCOEFF_ADDR   0x24C0B26C
 ...
 * <table>
 * <caption>RWNXAGCANTLOSS bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCANTLOSS_ADDR   0x24C0B300
 ...
 * <table>
 * <caption>RWNXAGCGAINRANGE bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCGAINRANGE_ADDR   0x24C0B304
 ...
 * <table>
 * <caption>RWNXAGCDIGGAINCONF bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCDIGGAINCONF_ADDR   0x24C0B308
 ...
 * <table>
 * <caption>RWNXAGCNOISECONF bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 16 <td>       SNRMEASSEL <td> R <td> R/W <td> 0
 * <tr><td> 00 <td> NOISEPOWESTACIEN <td> R <td> R/W <td> 1
 * </table>
 *
 * @{
 */
...
#define RIU_RWNXAGCNOISECONF_ADDR   0x24C0B30C
...
#define RIU_RWNXAGCNOISECONF_RESET  0x00000001
...
/// NOISEPOWESTACIEN field bit
#define RIU_NOISEPOWESTACIEN_BIT    ((uint32_t)0x00000001)
/// NOISEPOWESTACIEN field position
#define RIU_NOISEPOWESTACIEN_POS    0

/// SNRMEASSEL field reset value
#define RIU_SNRMEASSEL_RST          0x0
/// NOISEPOWESTACIEN field reset value
#define RIU_NOISEPOWESTACIEN_RST    0x1
 ...
 * @param[in] noisepowestacien - The value to use for the NOISEPOWESTACIEN field.
 */
__INLINE void riu_rwnxagcnoiseconf_pack(uint8_t snrmeassel, uint8_t noisepowestacien)
{
    ASSERT_ERR((((uint32_t)snrmeassel << 16) & ~((uint32_t)0x00010000)) == 0);
    ASSERT_ERR((((uint32_t)noisepowestacien << 0) & ~((uint32_t)0x00000001)) == 0);
    REG_PL_WR(RIU_RWNXAGCNOISECONF_ADDR,  ((uint32_t)snrmeassel << 16) | ((uint32_t)noisepowestacien << 0));
}
 ...
 * @param[out] noisepowestacien - Will be populated with the current value of this field from the register.
 */
__INLINE void riu_rwnxagcnoiseconf_unpack(uint8_t* snrmeassel, uint8_t* noisepowestacien)
{
    uint32_t localVal = REG_PL_RD(RIU_RWNXAGCNOISECONF_ADDR);

    *snrmeassel = (localVal & ((uint32_t)0x00010000)) >> 16;
    *noisepowestacien = (localVal & ((uint32_t)0x00000001)) >> 0;
}
...
/**
 * @brief Returns the current value of the NOISEPOWESTACIEN field in the RWNXAGCNOISECONF register.
 *
 * The RWNXAGCNOISECONF register will be read and the NOISEPOWESTACIEN field's value will be returned.
 *
 * @return The current value of the NOISEPOWESTACIEN field in the RWNXAGCNOISECONF register.
 */
__INLINE uint8_t riu_noisepowestacien_getf(void)
{
    uint32_t localVal = REG_PL_RD(RIU_RWNXAGCNOISECONF_ADDR);
    return ((localVal & ((uint32_t)0x00000001)) >> 0);
}
...
/**
 * @brief Sets the NOISEPOWESTACIEN field of the RWNXAGCNOISECONF register.
 *
 * The RWNXAGCNOISECONF register will be read, modified to contain the new field value, and written.
 *
 * @param[in] noisepowestacien - The value to set the field to.
 */
__INLINE void riu_noisepowestacien_setf(uint8_t noisepowestacien)
{
    ASSERT_ERR((((uint32_t)noisepowestacien << 0) & ~((uint32_t)0x00000001)) == 0);
    REG_PL_WR(RIU_RWNXAGCNOISECONF_ADDR, (REG_PL_RD(RIU_RWNXAGCNOISECONF_ADDR) & ~((uint32_t)0x00000001)) | ((uint32_t)noisepowestacien << 0));
}
...
/**
 * @name RWNXACIVARSCALING register definitions
 * <table>
 * <caption>RWNXACIVARSCALING bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 30:24 <td> ACIVARSCALING4020P20S <td> R <td> R/W <td> 0x0
 * <tr><td> 22:16 <td> ACIVARSCALING8040P40S <td> R <td> R/W <td> 0x11
 * <tr><td> 14:08 <td> ACIVARSCALING8020P20S <td> R <td> R/W <td> 0x20
 * <tr><td> 06:00 <td> ACIVARSCALING8020P40S <td> R <td> R/W <td> 0x12
 * </table>
 *
 * @{
 */

/// Address of the RWNXACIVARSCALING register
#define RIU_RWNXACIVARSCALING_ADDR   0x24C0B310
/// Offset of the RWNXACIVARSCALING register from the base address
#define RIU_RWNXACIVARSCALING_OFFSET 0x00000310
/// Index of the RWNXACIVARSCALING register
#define RIU_RWNXACIVARSCALING_INDEX  0x000000C4
/// Reset value of the RWNXACIVARSCALING register
#define RIU_RWNXACIVARSCALING_RESET  0x00112012

/**
 * @brief Returns the current value of the RWNXACIVARSCALING register.
 * The RWNXACIVARSCALING register will be read and its value returned.
 * @return The current value of the RWNXACIVARSCALING register.
 */
__INLINE uint32_t riu_rwnxacivarscaling_get(void)
{
    return REG_PL_RD(RIU_RWNXACIVARSCALING_ADDR);
}

/**
 * @brief Sets the RWNXACIVARSCALING register to a value.
 * The RWNXACIVARSCALING register will be written.
 * @param value - The value to write.
 */
__INLINE void riu_rwnxacivarscaling_set(uint32_t value)
{
    REG_PL_WR(RIU_RWNXACIVARSCALING_ADDR, value);
}

// field definitions
/// ACIVARSCALING4020P20S field mask
#define RIU_ACIVARSCALING4020P20S_MASK   ((uint32_t)0x7F000000)
/// ACIVARSCALING4020P20S field LSB position
#define RIU_ACIVARSCALING4020P20S_LSB    24
/// ACIVARSCALING4020P20S field width
#define RIU_ACIVARSCALING4020P20S_WIDTH  ((uint32_t)0x00000007)
/// ACIVARSCALING8040P40S field mask
#define RIU_ACIVARSCALING8040P40S_MASK   ((uint32_t)0x007F0000)
/// ACIVARSCALING8040P40S field LSB position
#define RIU_ACIVARSCALING8040P40S_LSB    16
/// ACIVARSCALING8040P40S field width
#define RIU_ACIVARSCALING8040P40S_WIDTH  ((uint32_t)0x00000007)
/// ACIVARSCALING8020P20S field mask
#define RIU_ACIVARSCALING8020P20S_MASK   ((uint32_t)0x00007F00)
/// ACIVARSCALING8020P20S field LSB position
#define RIU_ACIVARSCALING8020P20S_LSB    8
/// ACIVARSCALING8020P20S field width
#define RIU_ACIVARSCALING8020P20S_WIDTH  ((uint32_t)0x00000007)
/// ACIVARSCALING8020P40S field mask
#define RIU_ACIVARSCALING8020P40S_MASK   ((uint32_t)0x0000007F)
/// ACIVARSCALING8020P40S field LSB position
#define RIU_ACIVARSCALING8020P40S_LSB    0
/// ACIVARSCALING8020P40S field width
#define RIU_ACIVARSCALING8020P40S_WIDTH  ((uint32_t)0x00000007)

/// ACIVARSCALING4020P20S field reset value
#define RIU_ACIVARSCALING4020P20S_RST    0x0
/// ACIVARSCALING8040P40S field reset value
#define RIU_ACIVARSCALING8040P40S_RST    0x11
/// ACIVARSCALING8020P20S field reset value
#define RIU_ACIVARSCALING8020P20S_RST    0x20
/// ACIVARSCALING8020P40S field reset value
#define RIU_ACIVARSCALING8020P40S_RST    0x12

/**
 * @brief Constructs a value for the RWNXACIVARSCALING register given values for its fields
 * and writes the value to the register.
 *
 * @param[in] acivarscaling4020p20s - The value to use for the ACIVARSCALING4020P20S field.
 * @param[in] acivarscaling8040p40s - The value to use for the ACIVARSCALING8040P40S field.
 * @param[in] acivarscaling8020p20s - The value to use for the ACIVARSCALING8020P20S field.
 * @param[in] acivarscaling8020p40s - The value to use for the ACIVARSCALING8020P40S field.
 */
__INLINE void riu_rwnxacivarscaling_pack(uint8_t acivarscaling4020p20s, uint8_t acivarscaling8040p40s, uint8_t acivarscaling8020p20s, uint8_t acivarscaling8020p40s)
{
    ASSERT_ERR((((uint32_t)acivarscaling4020p20s << 24) & ~((uint32_t)0x7F000000)) == 0);
    ASSERT_ERR((((uint32_t)acivarscaling8040p40s << 16) & ~((uint32_t)0x007F0000)) == 0);
    ASSERT_ERR((((uint32_t)acivarscaling8020p20s << 8) & ~((uint32_t)0x00007F00)) == 0);
    ASSERT_ERR((((uint32_t)acivarscaling8020p40s << 0) & ~((uint32_t)0x0000007F)) == 0);
    REG_PL_WR(RIU_RWNXACIVARSCALING_ADDR,  ((uint32_t)acivarscaling4020p20s << 24) | ((uint32_t)acivarscaling8040p40s << 16) | ((uint32_t)acivarscaling8020p20s << 8) | ((uint32_t)acivarscaling8020p40s << 0));
}

/**
 * @brief Unpacks RWNXACIVARSCALING's fields from current value of the RWNXACIVARSCALING register.
 *
 * Reads the RWNXACIVARSCALING register and populates all the _field variables with the corresponding
 * values from the register.
 *
 * @param[out] acivarscaling4020p20s - Will be populated with the current value of this field from the register.
 * @param[out] acivarscaling8040p40s - Will be populated with the current value of this field from the register.
 * @param[out] acivarscaling8020p20s - Will be populated with the current value of this field from the register.
 * @param[out] acivarscaling8020p40s - Will be populated with the current value of this field from the register.
 */
__INLINE void riu_rwnxacivarscaling_unpack(uint8_t* acivarscaling4020p20s, uint8_t* acivarscaling8040p40s, uint8_t* acivarscaling8020p20s, uint8_t* acivarscaling8020p40s)
{
    uint32_t localVal = REG_PL_RD(RIU_RWNXACIVARSCALING_ADDR);

    *acivarscaling4020p20s = (localVal & ((uint32_t)0x7F000000)) >> 24;
    *acivarscaling8040p40s = (localVal & ((uint32_t)0x007F0000)) >> 16;
    *acivarscaling8020p20s = (localVal & ((uint32_t)0x00007F00)) >> 8;
    *acivarscaling8020p40s = (localVal & ((uint32_t)0x0000007F)) >> 0;
}

/**
 * @brief Returns the current value of the ACIVARSCALING4020P20S field in the RWNXACIVARSCALING register.
 *
 * The RWNXACIVARSCALING register will be read and the ACIVARSCALING4020P20S field's value will be returned.
 *
 * @return The current value of the ACIVARSCALING4020P20S field in the RWNXACIVARSCALING register.
 */
__INLINE uint8_t riu_acivarscaling4020p20s_getf(void)
{
    uint32_t localVal = REG_PL_RD(RIU_RWNXACIVARSCALING_ADDR);
    return ((localVal & ((uint32_t)0x7F000000)) >> 24);
}
...
/**
 * @brief Sets the ACIVARSCALING4020P20S field of the RWNXACIVARSCALING register.
 *
 * The RWNXACIVARSCALING register will be read, modified to contain the new field value, and written.
 *
 * @param[in] acivarscaling4020p20s - The value to set the field to.
 */
__INLINE void riu_acivarscaling4020p20s_setf(uint8_t acivarscaling4020p20s)
{
    ASSERT_ERR((((uint32_t)acivarscaling4020p20s << 24) & ~((uint32_t)0x7F000000)) == 0);
    REG_PL_WR(RIU_RWNXACIVARSCALING_ADDR, (REG_PL_RD(RIU_RWNXACIVARSCALING_ADDR) & ~((uint32_t)0x7F000000)) | ((uint32_t)acivarscaling4020p20s << 24));
}

/**
 * @brief Returns the current value of the ACIVARSCALING8040P40S field in the RWNXACIVARSCALING register.
 *
 * The RWNXACIVARSCALING register will be read and the ACIVARSCALING8040P40S field's value will be returned.
 *
 * @return The current value of the ACIVARSCALING8040P40S field in the RWNXACIVARSCALING register.
 */
__INLINE uint8_t riu_acivarscaling8040p40s_getf(void)
{
    uint32_t localVal = REG_PL_RD(RIU_RWNXACIVARSCALING_ADDR);
    return ((localVal & ((uint32_t)0x007F0000)) >> 16);
}
...
/**
 * @brief Sets the ACIVARSCALING8040P40S field of the RWNXACIVARSCALING register.
 *
 * The RWNXACIVARSCALING register will be read, modified to contain the new field value, and written.
 *
 * @param[in] acivarscaling8040p40s - The value to set the field to.
 */
__INLINE void riu_acivarscaling8040p40s_setf(uint8_t acivarscaling8040p40s)
{
    ASSERT_ERR((((uint32_t)acivarscaling8040p40s << 16) & ~((uint32_t)0x007F0000)) == 0);
    REG_PL_WR(RIU_RWNXACIVARSCALING_ADDR, (REG_PL_RD(RIU_RWNXACIVARSCALING_ADDR) & ~((uint32_t)0x007F0000)) | ((uint32_t)acivarscaling8040p40s << 16));
}

/**
 * @brief Returns the current value of the ACIVARSCALING8020P20S field in the RWNXACIVARSCALING register.
 *
 * The RWNXACIVARSCALING register will be read and the ACIVARSCALING8020P20S field's value will be returned.
 *
 * @return The current value of the ACIVARSCALING8020P20S field in the RWNXACIVARSCALING register.
 */
__INLINE uint8_t riu_acivarscaling8020p20s_getf(void)
{
    uint32_t localVal = REG_PL_RD(RIU_RWNXACIVARSCALING_ADDR);
    return ((localVal & ((uint32_t)0x00007F00)) >> 8);
}
...
/**
 * @brief Sets the ACIVARSCALING8020P20S field of the RWNXACIVARSCALING register.
 *
 * The RWNXACIVARSCALING register will be read, modified to contain the new field value, and written.
 *
 * @param[in] acivarscaling8020p20s - The value to set the field to.
 */
__INLINE void riu_acivarscaling8020p20s_setf(uint8_t acivarscaling8020p20s)
{
    ASSERT_ERR((((uint32_t)acivarscaling8020p20s << 8) & ~((uint32_t)0x00007F00)) == 0);
    REG_PL_WR(RIU_RWNXACIVARSCALING_ADDR, (REG_PL_RD(RIU_RWNXACIVARSCALING_ADDR) & ~((uint32_t)0x00007F00)) | ((uint32_t)acivarscaling8020p20s << 8));
}

/**
 * @brief Returns the current value of the ACIVARSCALING8020P40S field in the RWNXACIVARSCALING register.
 *
 * The RWNXACIVARSCALING register will be read and the ACIVARSCALING8020P40S field's value will be returned.
 *
 * @return The current value of the ACIVARSCALING8020P40S field in the RWNXACIVARSCALING register.
 */
__INLINE uint8_t riu_acivarscaling8020p40s_getf(void)
{
    uint32_t localVal = REG_PL_RD(RIU_RWNXACIVARSCALING_ADDR);
    return ((localVal & ((uint32_t)0x0000007F)) >> 0);
}
...
/**
 * @brief Sets the ACIVARSCALING8020P40S field of the RWNXACIVARSCALING register.
 *
 * The RWNXACIVARSCALING register will be read, modified to contain the new field value, and written.
 *
 * @param[in] acivarscaling8020p40s - The value to set the field to.
 */
__INLINE void riu_acivarscaling8020p40s_setf(uint8_t acivarscaling8020p40s)
{
    ASSERT_ERR((((uint32_t)acivarscaling8020p40s << 0) & ~((uint32_t)0x0000007F)) == 0);
    REG_PL_WR(RIU_RWNXACIVARSCALING_ADDR, (REG_PL_RD(RIU_RWNXACIVARSCALING_ADDR) & ~((uint32_t)0x0000007F)) | ((uint32_t)acivarscaling8020p40s << 0));
}
 ...
 * <table>
 * <caption>RWNXAGCACI20MARG0 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCACI20MARG0_ADDR   0x24C0B340
 ...
 * <table>
 * <caption>RWNXAGCACI20MARG1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCACI20MARG1_ADDR   0x24C0B344
 ...
 * <table>
 * <caption>RWNXAGCACI20MARG2 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCACI20MARG2_ADDR   0x24C0B348
 ...
 * <table>
 * <caption>RWNXAGCACI40MARG0 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCACI40MARG0_ADDR   0x24C0B34C
 ...
 * <table>
 * <caption>RWNXAGCACI40MARG1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCACI40MARG1_ADDR   0x24C0B350
 ...
 * <table>
 * <caption>RWNXAGCACI40MARG2 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCACI40MARG2_ADDR   0x24C0B354
 ...
 * <table>
 * <caption>RWNXAGCACI80MARG0 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCACI80MARG0_ADDR   0x24C0B358
 ...
 * <table>
 * <caption>RWNXAGCACI80MARG1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCACI80MARG1_ADDR   0x24C0B35C
 ...
 * <table>
 * <caption>RWNXAGCACI80MARG2 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCACI80MARG2_ADDR   0x24C0B360
 ...
 * <table>
 * <caption>RWNXAGCSAT bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCSAT_ADDR   0x24C0B364
 ...
 * <table>
 * <caption>RWNXAGCCROSS bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCCROSS_ADDR   0x24C0B368
 ...
 * <table>
 * <caption>RWNXAGCRAMP bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCRAMP_ADDR   0x24C0B36C
 ...
 * <table>
 * <caption>RWNXAGCSTABDIS bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCSTABDIS_ADDR   0x24C0B370
 ...
 * <table>
 * <caption>RWNXAGCDCCOMP0 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCDCCOMP0_ADDR   0x24C0B374
 ...
 * <table>
 * <caption>RWNXAGCDCCOMP1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCDCCOMP1_ADDR   0x24C0B378
 ...
 * <table>
 * <caption>RWNXAGCDCCOMP2 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCDCCOMP2_ADDR   0x24C0B37C
 ...
 * <table>
 * <caption>RWNXAGCEVT0 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:26 <td>      EVT0OP1 <td> R <td> R/W <td> 0x7
 * <tr><td> 25:20 <td>      EVT0OP2 <td> R <td> R/W <td> 0xE
 ...
 * <tr><td> 09    <td>    EVT0PGSEL <td> R <td> R/W <td> 1
...
#define RIU_RWNXAGCEVT0_ADDR   0x24C0B380
...
/// EVT0PGSEL field bit
#define RIU_EVT0PGSEL_BIT       ((uint32_t)0x00000200)
/// EVT0PGSEL field position
#define RIU_EVT0PGSEL_POS       9
...
#define RIU_EVT0OP1_RST         0x7
/// EVT0OP2 field reset value
#define RIU_EVT0OP2_RST         0xE
...
/// EVT0PGSEL field reset value
#define RIU_EVT0PGSEL_RST       0x1
 ...
 * @param[in] evt0pgsel - The value to use for the EVT0PGSEL field. [ new]
 * @param[in] evt0tgtadd - The value to use for the EVT0TGTADD field.
 */
__INLINE void riu_rwnxagcevt0_pack(uint8_t evt0op1, uint8_t evt0op2, uint8_t evt0op3, uint8_t evt0pathcomb, uint8_t evt0opcomb, uint8_t evt0pgsel, uint16_t evt0tgtadd)
{
    ...
    ASSERT_ERR((((uint32_t)evt0pgsel << 9) & ~((uint32_t)0x00000200)) == 0);
    ASSERT_ERR((((uint32_t)evt0tgtadd << 0) & ~((uint32_t)0x000001FF)) == 0);
    REG_PL_WR(RIU_RWNXAGCEVT0_ADDR,  ((uint32_t)evt0op1 << 26) | ((uint32_t)evt0op2 << 20) | ((uint32_t)evt0op3 << 14) | ((uint32_t)evt0pathcomb << 13) | ((uint32_t)evt0opcomb << 10) | ((uint32_t)evt0pgsel << 9) | ((uint32_t)evt0tgtadd << 0));
}
 ...
 * @param[out] evt0pgsel - Will be populated with the current value of this field from the register. [ new]
 * @param[out] evt0tgtadd - Will be populated with the current value of this field from the register.
 */
__INLINE void riu_rwnxagcevt0_unpack(uint8_t* evt0op1, uint8_t* evt0op2, uint8_t* evt0op3, uint8_t* evt0pathcomb, uint8_t* evt0opcomb, uint8_t* evt0pgsel, uint16_t* evt0tgtadd)
{
    ...
    *evt0pgsel = (localVal & ((uint32_t)0x00000200)) >> 9;
...
/**
 * @brief Returns the current value of the EVT0PGSEL field in the RWNXAGCEVT0 register.
 *
 * The RWNXAGCEVT0 register will be read and the EVT0PGSEL field's value will be returned.
 *
 * @return The current value of the EVT0PGSEL field in the RWNXAGCEVT0 register.
 */
__INLINE uint8_t riu_evt0pgsel_getf(void)
{
    uint32_t localVal = REG_PL_RD(RIU_RWNXAGCEVT0_ADDR);
    return ((localVal & ((uint32_t)0x00000200)) >> 9);
}
...
/**
 * @brief Sets the EVT0PGSEL field of the RWNXAGCEVT0 register.
 *
 * The RWNXAGCEVT0 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] evt0pgsel - The value to set the field to.
 */
__INLINE void riu_evt0pgsel_setf(uint8_t evt0pgsel)
{
    ASSERT_ERR((((uint32_t)evt0pgsel << 9) & ~((uint32_t)0x00000200)) == 0);
    REG_PL_WR(RIU_RWNXAGCEVT0_ADDR, (REG_PL_RD(RIU_RWNXAGCEVT0_ADDR) & ~((uint32_t)0x00000200)) | ((uint32_t)evt0pgsel << 9));
}
 ...
 * <table>
 * <caption>RWNXAGCEVT1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:26 <td>      EVT1OP1 <td> R <td> R/W <td> 0x11
 * <tr><td> 25:20 <td>      EVT1OP2 <td> R <td> R/W <td> 0xE
 * <tr><td> 19:14 <td>      EVT1OP3 <td> R <td> R/W <td> 0x4
 * <tr><td> 13    <td> EVT1PATHCOMB <td> R <td> R/W <td> 0
 * <tr><td> 12:10 <td>   EVT1OPCOMB <td> R <td> R/W <td> 0x2
 * <tr><td> 09    <td>    EVT1PGSEL <td> R <td> R/W <td> 1
 * <tr><td> 08:00 <td>   EVT1TGTADD <td> R <td> R/W <td> 0x6
 * </table>
 *
 * @{
 */
...
#define RIU_RWNXAGCEVT1_ADDR   0x24C0B384
...
/// EVT1PGSEL field bit
#define RIU_EVT1PGSEL_BIT       ((uint32_t)0x00000200)
/// EVT1PGSEL field position
#define RIU_EVT1PGSEL_POS       9
 ...
 * @param[in] evt1pgsel - The value to use for the EVT1PGSEL field. [ new]
 * @param[in] evt1tgtadd - The value to use for the EVT1TGTADD field.
 */
__INLINE void riu_rwnxagcevt1_pack(uint8_t evt1op1, uint8_t evt1op2, uint8_t evt1op3, uint8_t evt1pathcomb, uint8_t evt1opcomb, uint8_t evt1pgsel, uint16_t evt1tgtadd)
{
    ...
    ASSERT_ERR((((uint32_t)evt1pgsel << 9) & ~((uint32_t)0x00000200)) == 0);
    ASSERT_ERR((((uint32_t)evt1tgtadd << 0) & ~((uint32_t)0x000001FF)) == 0);
    REG_PL_WR(RIU_RWNXAGCEVT1_ADDR,  ((uint32_t)evt1op1 << 26) | ((uint32_t)evt1op2 << 20) | ((uint32_t)evt1op3 << 14) | ((uint32_t)evt1pathcomb << 13) | ((uint32_t)evt1opcomb << 10) | ((uint32_t)evt1pgsel << 9) | ((uint32_t)evt1tgtadd << 0));
}
 ...
 * @param[out] evt1pgsel - Will be populated with the current value of this field from the register. [ new]
 * @param[out] evt1tgtadd - Will be populated with the current value of this field from the register.
 */
__INLINE void riu_rwnxagcevt1_unpack(uint8_t* evt1op1, uint8_t* evt1op2, uint8_t* evt1op3, uint8_t* evt1pathcomb, uint8_t* evt1opcomb, uint8_t* evt1pgsel, uint16_t* evt1tgtadd)
{
    ...
    *evt1pgsel = (localVal & ((uint32_t)0x00000200)) >> 9;
...
/**
 * @brief Returns the current value of the EVT1PGSEL field in the RWNXAGCEVT1 register.
 *
 * The RWNXAGCEVT1 register will be read and the EVT1PGSEL field's value will be returned.
 *
 * @return The current value of the EVT1PGSEL field in the RWNXAGCEVT1 register.
 */
__INLINE uint8_t riu_evt1pgsel_getf(void)
{
    uint32_t localVal = REG_PL_RD(RIU_RWNXAGCEVT1_ADDR);
    return ((localVal & ((uint32_t)0x00000200)) >> 9);
}
...
/**
 * @brief Sets the EVT1PGSEL field of the RWNXAGCEVT1 register.
 *
 * The RWNXAGCEVT1 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] evt1pgsel - The value to set the field to.
 */
__INLINE void riu_evt1pgsel_setf(uint8_t evt1pgsel)
{
    ASSERT_ERR((((uint32_t)evt1pgsel << 9) & ~((uint32_t)0x00000200)) == 0);
    REG_PL_WR(RIU_RWNXAGCEVT1_ADDR, (REG_PL_RD(RIU_RWNXAGCEVT1_ADDR) & ~((uint32_t)0x00000200)) | ((uint32_t)evt1pgsel << 9));
}
 ...
 * <table>
 * <caption>RWNXAGCEVT2 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:26 <td>      EVT2OP1 <td> R <td> R/W <td> 0xF
 * <tr><td> 25:20 <td>      EVT2OP2 <td> R <td> R/W <td> 0x17
 * <tr><td> 19:14 <td>      EVT2OP3 <td> R <td> R/W <td> 0x2A
 * <tr><td> 13    <td> EVT2PATHCOMB <td> R <td> R/W <td> 0
 * <tr><td> 12:10 <td>   EVT2OPCOMB <td> R <td> R/W <td> 0x5
 * <tr><td> 09    <td>    EVT2PGSEL <td> R <td> R/W <td> 0
 * <tr><td> 08:00 <td>   EVT2TGTADD <td> R <td> R/W <td> 0x9
 * </table>
 *
 * @{
 */
...
#define RIU_RWNXAGCEVT2_ADDR   0x24C0B388
...
/// EVT2PGSEL field bit
#define RIU_EVT2PGSEL_BIT       ((uint32_t)0x00000200)
/// EVT2PGSEL field position
#define RIU_EVT2PGSEL_POS       9
...
#define RIU_EVT2OP1_RST         0xF
/// EVT2OP2 field reset value
#define RIU_EVT2OP2_RST         0x17
/// EVT2OP3 field reset value
#define RIU_EVT2OP3_RST         0x2A
/// EVT2PATHCOMB field reset value
#define RIU_EVT2PATHCOMB_RST    0x0
/// EVT2OPCOMB field reset value
#define RIU_EVT2OPCOMB_RST      0x5
/// EVT2PGSEL field reset value
#define RIU_EVT2PGSEL_RST       0x0
/// EVT2TGTADD field reset value
#define RIU_EVT2TGTADD_RST      0x9
 ...
 * @param[in] evt2pgsel - The value to use for the EVT2PGSEL field. [ new]
 * @param[in] evt2tgtadd - The value to use for the EVT2TGTADD field.
 */
__INLINE void riu_rwnxagcevt2_pack(uint8_t evt2op1, uint8_t evt2op2, uint8_t evt2op3, uint8_t evt2pathcomb, uint8_t evt2opcomb, uint8_t evt2pgsel, uint16_t evt2tgtadd)
{
    ...
    ASSERT_ERR((((uint32_t)evt2pgsel << 9) & ~((uint32_t)0x00000200)) == 0);
    ASSERT_ERR((((uint32_t)evt2tgtadd << 0) & ~((uint32_t)0x000001FF)) == 0);
    REG_PL_WR(RIU_RWNXAGCEVT2_ADDR,  ((uint32_t)evt2op1 << 26) | ((uint32_t)evt2op2 << 20) | ((uint32_t)evt2op3 << 14) | ((uint32_t)evt2pathcomb << 13) | ((uint32_t)evt2opcomb << 10) | ((uint32_t)evt2pgsel << 9) | ((uint32_t)evt2tgtadd << 0));
}
 ...
 * @param[out] evt2pgsel - Will be populated with the current value of this field from the register. [ new]
 * @param[out] evt2tgtadd - Will be populated with the current value of this field from the register.
 */
__INLINE void riu_rwnxagcevt2_unpack(uint8_t* evt2op1, uint8_t* evt2op2, uint8_t* evt2op3, uint8_t* evt2pathcomb, uint8_t* evt2opcomb, uint8_t* evt2pgsel, uint16_t* evt2tgtadd)
{
    ...
    *evt2pgsel = (localVal & ((uint32_t)0x00000200)) >> 9;
...
/**
 * @brief Returns the current value of the EVT2PGSEL field in the RWNXAGCEVT2 register.
 *
 * The RWNXAGCEVT2 register will be read and the EVT2PGSEL field's value will be returned.
 *
 * @return The current value of the EVT2PGSEL field in the RWNXAGCEVT2 register.
 */
__INLINE uint8_t riu_evt2pgsel_getf(void)
{
    uint32_t localVal = REG_PL_RD(RIU_RWNXAGCEVT2_ADDR);
    return ((localVal & ((uint32_t)0x00000200)) >> 9);
}
...
/**
 * @brief Sets the EVT2PGSEL field of the RWNXAGCEVT2 register.
 *
 * The RWNXAGCEVT2 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] evt2pgsel - The value to set the field to.
 */
__INLINE void riu_evt2pgsel_setf(uint8_t evt2pgsel)
{
    ASSERT_ERR((((uint32_t)evt2pgsel << 9) & ~((uint32_t)0x00000200)) == 0);
    REG_PL_WR(RIU_RWNXAGCEVT2_ADDR, (REG_PL_RD(RIU_RWNXAGCEVT2_ADDR) & ~((uint32_t)0x00000200)) | ((uint32_t)evt2pgsel << 9));
}
 ...
 * <table>
 * <caption>RWNXAGCEVT3 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 31:26 <td>      EVT3OP1 <td> R <td> R/W <td> 0x19
 * <tr><td> 25:20 <td>      EVT3OP2 <td> R <td> R/W <td> 0x18
 * <tr><td> 19:14 <td>      EVT3OP3 <td> R <td> R/W <td> 0xE
 * <tr><td> 13    <td> EVT3PATHCOMB <td> R <td> R/W <td> 1
 * <tr><td> 12:10 <td>   EVT3OPCOMB <td> R <td> R/W <td> 0x2
 * <tr><td> 09    <td>    EVT3PGSEL <td> R <td> R/W <td> 0
 * <tr><td> 08:00 <td>   EVT3TGTADD <td> R <td> R/W <td> 0xC
 * </table>
 *
 * @{
 */
...
#define RIU_RWNXAGCEVT3_ADDR   0x24C0B38C
...
/// EVT3PGSEL field bit
#define RIU_EVT3PGSEL_BIT       ((uint32_t)0x00000200)
/// EVT3PGSEL field position
#define RIU_EVT3PGSEL_POS       9
...
#define RIU_EVT3OP1_RST         0x19
/// EVT3OP2 field reset value
#define RIU_EVT3OP2_RST         0x18
/// EVT3OP3 field reset value
#define RIU_EVT3OP3_RST         0xE
/// EVT3PATHCOMB field reset value
#define RIU_EVT3PATHCOMB_RST    0x1
/// EVT3OPCOMB field reset value
#define RIU_EVT3OPCOMB_RST      0x2
/// EVT3PGSEL field reset value
#define RIU_EVT3PGSEL_RST       0x0
/// EVT3TGTADD field reset value
#define RIU_EVT3TGTADD_RST      0xC
 ...
 * @param[in] evt3pgsel - The value to use for the EVT3PGSEL field. [ new]
 * @param[in] evt3tgtadd - The value to use for the EVT3TGTADD field.
 */
__INLINE void riu_rwnxagcevt3_pack(uint8_t evt3op1, uint8_t evt3op2, uint8_t evt3op3, uint8_t evt3pathcomb, uint8_t evt3opcomb, uint8_t evt3pgsel, uint16_t evt3tgtadd)
{
    ...
    ASSERT_ERR((((uint32_t)evt3pgsel << 9) & ~((uint32_t)0x00000200)) == 0);
    ASSERT_ERR((((uint32_t)evt3tgtadd << 0) & ~((uint32_t)0x000001FF)) == 0);
    REG_PL_WR(RIU_RWNXAGCEVT3_ADDR,  ((uint32_t)evt3op1 << 26) | ((uint32_t)evt3op2 << 20) | ((uint32_t)evt3op3 << 14) | ((uint32_t)evt3pathcomb << 13) | ((uint32_t)evt3opcomb << 10) | ((uint32_t)evt3pgsel << 9) | ((uint32_t)evt3tgtadd << 0));
}
 ...
 * @param[out] evt3pgsel - Will be populated with the current value of this field from the register. [ new]
 * @param[out] evt3tgtadd - Will be populated with the current value of this field from the register.
 */
__INLINE void riu_rwnxagcevt3_unpack(uint8_t* evt3op1, uint8_t* evt3op2, uint8_t* evt3op3, uint8_t* evt3pathcomb, uint8_t* evt3opcomb, uint8_t* evt3pgsel, uint16_t* evt3tgtadd)
{
    ...
    *evt3pgsel = (localVal & ((uint32_t)0x00000200)) >> 9;
...
/**
 * @brief Returns the current value of the EVT3PGSEL field in the RWNXAGCEVT3 register.
 *
 * The RWNXAGCEVT3 register will be read and the EVT3PGSEL field's value will be returned.
 *
 * @return The current value of the EVT3PGSEL field in the RWNXAGCEVT3 register.
 */
__INLINE uint8_t riu_evt3pgsel_getf(void)
{
    uint32_t localVal = REG_PL_RD(RIU_RWNXAGCEVT3_ADDR);
    return ((localVal & ((uint32_t)0x00000200)) >> 9);
}
...
/**
 * @brief Sets the EVT3PGSEL field of the RWNXAGCEVT3 register.
 *
 * The RWNXAGCEVT3 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] evt3pgsel - The value to set the field to.
 */
__INLINE void riu_evt3pgsel_setf(uint8_t evt3pgsel)
{
    ASSERT_ERR((((uint32_t)evt3pgsel << 9) & ~((uint32_t)0x00000200)) == 0);
    REG_PL_WR(RIU_RWNXAGCEVT3_ADDR, (REG_PL_RD(RIU_RWNXAGCEVT3_ADDR) & ~((uint32_t)0x00000200)) | ((uint32_t)evt3pgsel << 9));
}
 ...
 * <table>
 * <caption>RWNXAGCCNTL bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCCNTL_ADDR   0x24C0B390
 ...
 * <table>
 * <caption>RWNXAGCDSP0 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCDSP0_ADDR   0x24C0B394
 ...
 * <table>
 * <caption>RWNXAGCDSP1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCDSP1_ADDR   0x24C0B398
 ...
 * <table>
 * <caption>RWNXAGCDSP2 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCDSP2_ADDR   0x24C0B39C
...
#define RIU_RWNXAGCDSP3_ADDR   0x24C0B3A0
...
#define RIU_RWNXAGCDSP3_RESET  0x0BF3109C
...
/// INBDACIFILTEREN field bit
#define RIU_INBDACIFILTEREN_BIT    ((uint32_t)0x00001000)
/// INBDACIFILTEREN field position
#define RIU_INBDACIFILTEREN_POS    12
...
/// INBDACIFILTEREN field reset value
#define RIU_INBDACIFILTEREN_RST    0x1
 ...
 * @param[in] inbdacifilteren - The value to use for the INBDACIFILTEREN field.
 * @param[in] inbdpowmindbm - The value to use for the INBDPOWMINDBM field.
 */
__INLINE void riu_rwnxagcdsp3_pack(uint8_t inbdpowmindbv, uint8_t inbdrnd, uint8_t inbdacifilteren, uint8_t inbdpowmindbm)
{
    ASSERT_ERR((((uint32_t)inbdpowmindbv << 20) & ~((uint32_t)0x0FF00000)) == 0);
    ASSERT_ERR((((uint32_t)inbdrnd << 16) & ~((uint32_t)0x00030000)) == 0);
    ASSERT_ERR((((uint32_t)inbdacifilteren << 12) & ~((uint32_t)0x00001000)) == 0);
    ASSERT_ERR((((uint32_t)inbdpowmindbm << 0) & ~((uint32_t)0x000000FF)) == 0);
    REG_PL_WR(RIU_RWNXAGCDSP3_ADDR,  ((uint32_t)inbdpowmindbv << 20) | ((uint32_t)inbdrnd << 16) | ((uint32_t)inbdacifilteren << 12) | ((uint32_t)inbdpowmindbm << 0));
}
 ...
 * @param[out] inbdacifilteren - Will be populated with the current value of this field from the register.
 * @param[out] inbdpowmindbm - Will be populated with the current value of this field from the register.
 */
__INLINE void riu_rwnxagcdsp3_unpack(uint8_t* inbdpowmindbv, uint8_t* inbdrnd, uint8_t* inbdacifilteren, uint8_t* inbdpowmindbm)
{
    ...
    *inbdacifilteren = (localVal & ((uint32_t)0x00001000)) >> 12;
...
/**
 * @brief Returns the current value of the INBDACIFILTEREN field in the RWNXAGCDSP3 register.
 *
 * The RWNXAGCDSP3 register will be read and the INBDACIFILTEREN field's value will be returned.
 *
 * @return The current value of the INBDACIFILTEREN field in the RWNXAGCDSP3 register.
 */
__INLINE uint8_t riu_inbdacifilteren_getf(void)
{
    uint32_t localVal = REG_PL_RD(RIU_RWNXAGCDSP3_ADDR);
    return ((localVal & ((uint32_t)0x00001000)) >> 12);
}
...
/**
 * @brief Sets the INBDACIFILTEREN field of the RWNXAGCDSP3 register.
 *
 * The RWNXAGCDSP3 register will be read, modified to contain the new field value, and written.
 *
 * @param[in] inbdacifilteren - The value to set the field to.
 */
__INLINE void riu_inbdacifilteren_setf(uint8_t inbdacifilteren)
{
    ASSERT_ERR((((uint32_t)inbdacifilteren << 12) & ~((uint32_t)0x00001000)) == 0);
    REG_PL_WR(RIU_RWNXAGCDSP3_ADDR, (REG_PL_RD(RIU_RWNXAGCDSP3_ADDR) & ~((uint32_t)0x00001000)) | ((uint32_t)inbdacifilteren << 12));
}
 ...
 * <table>
 * <caption>RWNXAGCDSP4 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCDSP4_ADDR   0x24C0B3A4
 ...
 * <table>
 * <caption>RWNXAGCCCA0 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCCCA0_ADDR   0x24C0B3A8
 ...
 * <table>
 * <caption>RWNXAGCCCA1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCCCA1_ADDR   0x24C0B3AC
...
{
    ASSERT_ERR((((uint32_t)inbdcca20ppowmindbm << 20) & ~((uint32_t)0x1FF00000)) == 0);
    ASSERT_ERR((((uint32_t)cca20pfallthrdbm << 12) & ~((uint32_t)0x000FF000)) == 0);
    ASSERT_ERR((((uint32_t)disccaen << 9) & ~((uint32_t)0x00000200)) == 0);
    ASSERT_ERR((((uint32_t)satccaen << 8) & ~((uint32_t)0x00000100)) == 0);
    ASSERT_ERR((((uint32_t)cca20prisethrdbm << 0) & ~((uint32_t)0x000000FF)) == 0);
 ...
 * <table>
 * <caption>RWNXAGCCCACTRL bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCCCACTRL_ADDR   0x24C0B3B0
 ...
 * <table>
 * <caption>RWNXAGCCCASTATE0 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCCCASTATE0_ADDR   0x24C0B3B4
 ...
 * <table>
 * <caption>RWNXAGCCCASTATE1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCCCASTATE1_ADDR   0x24C0B3B8
 ...
 * <table>
 * <caption>RWNXAGCCCATIMEOUT bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCCCATIMEOUT_ADDR   0x24C0B3BC
 ...
 * <table>
 * <caption>RWNXAGCCOMP0 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCCOMP0_ADDR   0x24C0B3C0
 ...
 * <table>
 * <caption>RWNXAGCCOMP1 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCCOMP1_ADDR   0x24C0B3C4
 ...
 * <table>
 * <caption>RWNXAGCRADAR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCRADAR_ADDR   0x24C0B3C8
 ...
 * <table>
 * <caption>RWNXAGCRADARTIM bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCRADARTIM_ADDR   0x24C0B3CC
 ...
 * <table>
 * <caption>RWNXAGCDCCOMPRADAR bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCDCCOMPRADAR_ADDR   0x24C0B3D0
 ...
 * <table>
 * <caption>RWNXAGCCCA2 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCCCA2_ADDR   0x24C0B3D4
...
{
    ASSERT_ERR((((uint32_t)inbdcca20spowmindbm << 20) & ~((uint32_t)0x1FF00000)) == 0);
    ASSERT_ERR((((uint32_t)cca20sfallthrdbm << 12) & ~((uint32_t)0x000FF000)) == 0);
    ASSERT_ERR((((uint32_t)cca20srisethrdbm << 0) & ~((uint32_t)0x000000FF)) == 0);
 ...
 * <table>
 * <caption>RWNXAGCCCA3 bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXAGCCCA3_ADDR   0x24C0B3D8
...
{
    ASSERT_ERR((((uint32_t)inbdcca40spowmindbm << 20) & ~((uint32_t)0x1FF00000)) == 0);
    ASSERT_ERR((((uint32_t)cca40sfallthrdbm << 12) & ~((uint32_t)0x000FF000)) == 0);
    ASSERT_ERR((((uint32_t)cca40srisethrdbm << 0) & ~((uint32_t)0x000000FF)) == 0);
...
/**
 * @name RWNXRSSIOFFSET register definitions
 * <table>
 * <caption>RWNXRSSIOFFSET bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td> 09:00 <td> RSSIOFFSET <td> R <td> R/W <td> 0x0
 * </table>
 *
 * @{
 */

/// Address of the RWNXRSSIOFFSET register
#define RIU_RWNXRSSIOFFSET_ADDR   0x24C0B3DC
/// Offset of the RWNXRSSIOFFSET register from the base address
#define RIU_RWNXRSSIOFFSET_OFFSET 0x000003DC
/// Index of the RWNXRSSIOFFSET register
#define RIU_RWNXRSSIOFFSET_INDEX  0x000000F7
/// Reset value of the RWNXRSSIOFFSET register
#define RIU_RWNXRSSIOFFSET_RESET  0x00000000

/**
 * @brief Returns the current value of the RWNXRSSIOFFSET register.
 * The RWNXRSSIOFFSET register will be read and its value returned.
 * @return The current value of the RWNXRSSIOFFSET register.
 */
__INLINE uint32_t riu_rwnxrssioffset_get(void)
{
    return REG_PL_RD(RIU_RWNXRSSIOFFSET_ADDR);
}

/**
 * @brief Sets the RWNXRSSIOFFSET register to a value.
 * The RWNXRSSIOFFSET register will be written.
 * @param value - The value to write.
 */
__INLINE void riu_rwnxrssioffset_set(uint32_t value)
{
    REG_PL_WR(RIU_RWNXRSSIOFFSET_ADDR, value);
}

// field definitions
/// RSSIOFFSET field mask
#define RIU_RSSIOFFSET_MASK   ((uint32_t)0x000003FF)
/// RSSIOFFSET field LSB position
#define RIU_RSSIOFFSET_LSB    0
/// RSSIOFFSET field width
#define RIU_RSSIOFFSET_WIDTH  ((uint32_t)0x0000000A)

/// RSSIOFFSET field reset value
#define RIU_RSSIOFFSET_RST    0x0

/**
 * @brief Returns the current value of the RSSIOFFSET field in the RWNXRSSIOFFSET register.
 *
 * The RWNXRSSIOFFSET register will be read and the RSSIOFFSET field's value will be returned.
 *
 * @return The current value of the RSSIOFFSET field in the RWNXRSSIOFFSET register.
 */
__INLINE uint16_t riu_rssioffset_getf(void)
{
    uint32_t localVal = REG_PL_RD(RIU_RWNXRSSIOFFSET_ADDR);
    ASSERT_ERR((localVal & ~((uint32_t)0x000003FF)) == 0);
    return (localVal >> 0);
}

/**
 * @brief Sets the RSSIOFFSET field of the RWNXRSSIOFFSET register.
 *
 * The RWNXRSSIOFFSET register will be read, modified to contain the new field value, and written.
 *
 * @param[in] rssioffset - The value to set the field to.
 */
__INLINE void riu_rssioffset_setf(uint16_t rssioffset)
{
    ASSERT_ERR((((uint32_t)rssioffset << 0) & ~((uint32_t)0x000003FF)) == 0);
    REG_PL_WR(RIU_RWNXRSSIOFFSET_ADDR, (uint32_t)rssioffset << 0);
}
 ...
 * <table>
 * <caption>RWNXMACINTEN bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXMACINTEN_ADDR   0x24C0B414
 ...
 * <table>
 * <caption>RWNXMACINTSTATRAW bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXMACINTSTATRAW_ADDR   0x24C0B418
 ...
 * <table>
 * <caption>RWNXMACINTSTATMASKED bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXMACINTSTATMASKED_ADDR   0x24C0B41C
 ...
 * <table>
 * <caption>RWNXMACINTACK bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXMACINTACK_ADDR   0x24C0B420
 ...
 * <table>
 * <caption>RWNXMACINTGEN bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXMACINTGEN_ADDR   0x24C0B424
 ...
 * <table>
 * <caption>RWNXFEDSSSCCKCNTL bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
...
#define RIU_RWNXFEDSSSCCKCNTL_ADDR   0x24C0B500
