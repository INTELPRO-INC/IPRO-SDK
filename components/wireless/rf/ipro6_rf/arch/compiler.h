 ...
 ****************************************************************************************
 *
 * @file riscvgcc/compiler.h
 *
 * @brief Definitions of compiler specific directives.
 *
 * Copyright (C) IPRO 2024
 *
 * History: 2018-07 crealted by jli @ Shanghai
 *
 ****************************************************************************************
 */
...
//#define __IRQ __attribute__((interrupt("SiFive-CLIC-preemptible")))
#define __IRQ __attribute__((interrupt))

/// define the 64-byte aligned IRQ handler attribute for this compiler
//#define __IRQ_ALIGN64 __attribute__((interrupt("SiFive-CLIC-preemptible"),aligned(64)))
#define __IRQ_ALIGN64 __attribute__((interrupt,aligned(64)))

/// define the BLE IRQ handler attribute for this compiler
//#define __BTIRQ __attribute__((interrupt("SiFive-CLIC-preemptible")))
#define __BTIRQ __attribute__((interrupt))

/// define the BLE IRQ handler attribute for this compiler
//#define __BLEIRQ __attribute__((interrupt("SiFive-CLIC-preemptible")))
#define __BLEIRQ __attribute__((interrupt))

/// define the FIQ handler attribute for this compiler
//#define __FIQ __attribute__((interrupt("SiFive-CLIC-preemptible")))
...
#define __PACKED16 __attribute__ ((__packed__)) // FIXME: not defined by default in riscv compiler.h
