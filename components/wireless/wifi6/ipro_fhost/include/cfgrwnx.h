...
enum cfgrwnx_msg_index {
    ...
    /// GET ME PARAM(param: @ref cfgrwnx_me_param)
    CFGRWNX_ME_PARAM_CMD,
    /// Response to CFGRWNX_ME_PARAM_CMD (param: @ref cfgrwnx_resp)
    CFGRWNX_ME_PARAM_RESP,
...
enum CFGRWNX_ME_PARAM_CMD_E {
    CFGRWNX_ME_PARAM_CMD_SET,
    CFGRWNX_ME_PARAM_CMD_GET,
};
/// structure for CFGRWNX_ME_PARAM_CMD
struct cfgrwnx_me_param {
    /// header
    struct cfgrwnx_msg_hdr hdr;
    /// me param
 ...
 * @param[in] discardable whether is discardable
 *
 * @return 0 on success and != 0 if error occurred.
 ****************************************************************************************
 */
