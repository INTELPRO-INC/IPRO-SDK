...
/**
 ****************************************************************************************
 * @brief Whether the caller is running in interrupt context.
 *
 * For the callers that genuinely cannot know — a fault/recovery path reached from
 * both an ISR and a task — so that the `isr` argument above stops being a guess.
 *
 * @return true if called from an exception/interrupt handler.
 ****************************************************************************************
 */
