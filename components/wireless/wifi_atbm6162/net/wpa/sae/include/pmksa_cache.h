...
int atbm_pmksa_cache_set_current(struct atbmwifi_wpa_sm *sm, const atbm_uint8 *pmkid,
			    ...
			    int akmp);
struct rsn_pmksa_cache_entry *
atbm_pmksa_cache_get_opportunistic(struct rsn_pmksa_cache *pmksa,
...
static inline void atbm_pmksa_cache_deinit(struct rsn_pmksa_cache *pmksa)
{
}

static inline struct rsn_pmksa_cache_entry *
atbm_pmksa_cache_get(struct rsn_pmksa_cache *pmksa, const atbm_uint8 *aa, const atbm_uint8 *pmkid,
...
static inline struct rsn_pmksa_cache_entry *
atbm_pmksa_cache_get_current(struct wpa_sm *sm)
{
	return NULL;
}
...
static inline struct rsn_pmksa_cache_entry *
atbm_pmksa_cache_head(struct rsn_pmksa_cache *pmksa)
{
	return NULL;
}
...
static inline void atbm_pmksa_cache_clear_current(struct wpa_sm *sm)
{
}

static inline int atbm_pmksa_cache_set_current(struct wpa_sm *sm, const atbm_uint8 *pmkid,
...
static inline void atbm_pmksa_cache_flush(struct rsn_pmksa_cache *pmksa,
				     void *network_ctx,
				     const atbm_uint8 *pmk, atbm_size_t pmk_len)
{
}
