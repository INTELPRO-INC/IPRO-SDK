 ...
 * @mask: 0 (ATBM_FALSE) or -1 (ATBM_TRUE) to identify which value to select
 * @true_val: Value to select for the ATBM_TRUE case
 * @false_val: Value to select for the ATBM_FALSE case
...
/**
 * const_time_select_u8 - Constant time atbm_uint8 selection
 * @mask: 0 (ATBM_FALSE) or -1 (ATBM_TRUE) to identify which value to select
 * @true_val: Value to select for the ATBM_TRUE case
 * @false_val: Value to select for the ATBM_FALSE case
 * Returns: true_val if mask == -1, false_val if mask == 0
...
/**
 * const_time_select_s8 - Constant time atbm_int8 selection
 * @mask: 0 (ATBM_FALSE) or -1 (ATBM_TRUE) to identify which value to select
 * @true_val: Value to select for the ATBM_TRUE case
 * @false_val: Value to select for the ATBM_FALSE case
 * Returns: true_val if mask == -1, false_val if mask == 0
 ...
 * @mask: 0 (ATBM_FALSE) or -1 (ATBM_TRUE) to identify which value to copy
 * @true_val: Buffer to copy for the ATBM_TRUE case
 * @false_val: Buffer to copy for the ATBM_FALSE case
