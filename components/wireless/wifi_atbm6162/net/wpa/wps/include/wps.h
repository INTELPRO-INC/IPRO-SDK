...
struct wpabuf * atbm_wps_build_assoc_resp_ie(void);
...
struct wps_context {
	...
	/**
	 * registrar - Pointer to WPS registrar data from atbm_wps_registrar_init()
	 */
...
void atbm_wps_registrar_deinit(struct wps_registrar *reg);
...
void atbm_wps_registrar_complete(struct wps_registrar *registrar, const atbm_uint8 *uuid_e,
