...
#define P2P_DEV_PROBE_REQ_ONLY ATBM_BIT(0)
#define P2P_DEV_REPORTED ATBM_BIT(1)
#define P2P_DEV_NOT_YET_READY ATBM_BIT(2)
#define P2P_DEV_PD_PEER_DISPLAY ATBM_BIT(5)
#define P2P_DEV_PD_PEER_KEYPAD ATBM_BIT(6)
#define P2P_DEV_USER_REJECTED ATBM_BIT(7)
#define P2P_DEV_PEER_WAITING_RESPONSE ATBM_BIT(8)
#define P2P_DEV_PREFER_PERSISTENT_GROUP ATBM_BIT(9)
#define P2P_DEV_WAIT_GO_NEG_RESPONSE ATBM_BIT(10)
#define P2P_DEV_WAIT_GO_NEG_CONFIRM ATBM_BIT(11)
#define P2P_DEV_GROUP_CLIENT_ONLY ATBM_BIT(12)
#define P2P_DEV_FORCE_FREQ ATBM_BIT(13)
#define P2P_DEV_PD_FOR_JOIN ATBM_BIT(14)
#define P2P_DEV_REPORTED_ONCE ATBM_BIT(15)
#define P2P_DEV_PREFER_PERSISTENT_RECONN ATBM_BIT(16)
#define P2P_DEV_PD_BEFORE_GO_NEG ATBM_BIT(17)
#define P2P_DEV_NO_PREF_CHAN ATBM_BIT(18)
#define P2P_DEV_WAIT_INV_REQ_ACK ATBM_BIT(19)
#define P2P_DEV_P2PS_REPORTED ATBM_BIT(20)
#define P2P_DEV_PD_PEER_P2PS ATBM_BIT(21)
#define P2P_DEV_LAST_SEEN_AS_GROUP_CLIENT ATBM_BIT(22)
