...
#define P2P_DEV_CAPAB_SERVICE_DISCOVERY ATBM_BIT(0)
#define P2P_DEV_CAPAB_CLIENT_DISCOVERABILITY ATBM_BIT(1)
#define P2P_DEV_CAPAB_CONCURRENT_OPER ATBM_BIT(2)
#define P2P_DEV_CAPAB_INFRA_MANAGED ATBM_BIT(3)
#define P2P_DEV_CAPAB_DEVICE_LIMIT ATBM_BIT(4)
#define P2P_DEV_CAPAB_INVITATION_PROCEDURE ATBM_BIT(5)

/* P2P Capability - Group Capability bitmap */
#define P2P_GROUP_CAPAB_GROUP_OWNER ATBM_BIT(0)
#define P2P_GROUP_CAPAB_PERSISTENT_GROUP ATBM_BIT(1)
#define P2P_GROUP_CAPAB_GROUP_LIMIT ATBM_BIT(2)
#define P2P_GROUP_CAPAB_INTRA_BSS_DIST ATBM_BIT(3)
#define P2P_GROUP_CAPAB_CROSS_CONN ATBM_BIT(4)
#define P2P_GROUP_CAPAB_PERSISTENT_RECONN ATBM_BIT(5)
#define P2P_GROUP_CAPAB_GROUP_FORMATION ATBM_BIT(6)
#define P2P_GROUP_CAPAB_IP_ADDR_ALLOCATION ATBM_BIT(7)

/* P2PS Coordination Protocol Transport Bitmap */
#define P2PS_FEATURE_CAPAB_UDP_TRANSPORT ATBM_BIT(0)
#define P2PS_FEATURE_CAPAB_MAC_TRANSPORT ATBM_BIT(1)
...
/* Invitation Flags */
#define P2P_INVITATION_FLAGS_TYPE ATBM_BIT(0)

/* P2P Manageability */
#define P2P_MAN_DEVICE_MANAGEMENT ATBM_BIT(0)
#define P2P_MAN_CROSS_CONNECTION_PERMITTED ATBM_BIT(1)
#define P2P_MAN_COEXISTENCE_OPTIONAL ATBM_BIT(2)
...
enum wpa_radio_work_band {
	BAND_2_4_GHZ = ATBM_BIT(0),
	BAND_5_GHZ = ATBM_BIT(1),
	BAND_60_GHZ = ATBM_BIT(2),
};
