...
atbm_void atbm_wpa_hexdump(atbm_int32 level, const char *title, const atbm_uint8 *buf, atbm_size_t len)
{
...
atbm_void atbm_wpa_hexdump_key(int level, const char *title, const void *buf, atbm_size_t len)
{
	_wpa_hexdump(level, title, buf, len, 1);
}


static atbm_void _wpa_hexdump_ascii(atbm_int32 level, const char *title, const atbm_uint8 *buf, atbm_size_t len, atbm_uint32 show)
{
	atbm_size_t i, llen;
...
atbm_void atbm_wpa_hexdump_ascii(atbm_int32 level, const char *title, const atbm_uint8 *buf, atbm_size_t len)
{
...
atbm_void atbm_wpa_hexdump_ascii_key(int level, const char *title, const void *buf,
			   atbm_size_t len)
{
	_wpa_hexdump_ascii(level, title, buf, len, 1);
}
