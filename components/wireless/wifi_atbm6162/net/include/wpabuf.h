...
#define WPABUF_FLAG_EXT_DATA ATBM_BIT(0)
...
int atbm_wpabuf_resize(struct wpabuf **buf, atbm_size_t add_len);
...
void atbm_wpabuf_free(struct wpabuf *buf);
void atbm_wpabuf_clear_free(struct wpabuf *buf);
void * atbm_wpabuf_put(struct wpabuf *buf, atbm_size_t len);
