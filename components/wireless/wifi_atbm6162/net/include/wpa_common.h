...
extern atbm_uint32 atbm_wpa_cipher_to_suite(int proto, int cipher);
extern int atbm_wpa_parse_wpa_ie_wpa(const atbm_uint8 *wpa_ie, atbm_size_t wpa_ie_len,
				struct atbmwifi_wpa_ie_data *data);
extern int atbm_wpa_eapol_key_mic(const atbm_uint8 *key, int ver, const atbm_uint8 *buf, atbm_size_t len,
		      atbm_uint8 *mic);
extern int wpa_parse_generic(const atbm_uint8 *pos, const atbm_uint8 *end,
			     struct wpa_eapol_ie_parse *ie);

extern atbm_void atbm_wpa_pmk_to_ptk(const atbm_uint8 *pmk, atbm_size_t pmk_len, const char *label,
...
extern int atbm_wpa_compare_rsn_ie(int ft_initial_assoc,
