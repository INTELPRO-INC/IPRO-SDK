...
/* STA flags */
#define WLAN_STA_AUTH ATBM_BIT(0)
#define WLAN_STA_ASSOC ATBM_BIT(1)
#define WLAN_STA_PS ATBM_BIT(2)
#define WLAN_STA_TIM ATBM_BIT(3)
#define WLAN_STA_PERM ATBM_BIT(4)
#define WLAN_STA_AUTHORIZED ATBM_BIT(5)
#define WLAN_STA_PENDING_POLL ATBM_BIT(6) /* pending activity poll not ACKed */
#define WLAN_STA_SHORT_PREAMBLE ATBM_BIT(7)
#define WLAN_STA_PREAUTH ATBM_BIT(8)
#define WLAN_STA_WMM ATBM_BIT(9)
#define WLAN_STA_MFP ATBM_BIT(10)
#define WLAN_STA_HT ATBM_BIT(11)
#define WLAN_STA_WPS ATBM_BIT(12)
#define WLAN_STA_MAYBE_WPS ATBM_BIT(13)
#define WLAN_STA_WDS ATBM_BIT(14)
#define WLAN_STA_ASSOC_REQ_OK ATBM_BIT(15)
#define WLAN_STA_BLOCK_BA ATBM_BIT(16)
#define WLAN_STA_GAS ATBM_BIT(17)
#define WLAN_STA_VHT ATBM_BIT(18)
#define WLAN_STA_SP ATBM_BIT(19)
#define WLAN_STA_UAPSD ATBM_BIT(20)
#define WLAN_STA_PS_DRIVER ATBM_BIT(21)
#define WLAN_STA_EOSP ATBM_BIT(22)
#define WLAN_STA_PENDING_DISASSOC_CB ATBM_BIT(29)
#define WLAN_STA_PENDING_DEAUTH_CB ATBM_BIT(30)
#define WLAN_STA_NONERP ATBM_BIT(31)
...
//	struct eapol_state_machine *eapol_sm;
	...
	struct atbmwifi_wpa_state_machine atbmwifi_wpa_sm_bufs;
...
struct hostapd_sta_info * atbm_ap_sta_add(struct hostapd_data *hapd, const atbm_uint8 *addr);
