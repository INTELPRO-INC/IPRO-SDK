...
struct atbmwifi_ieee80211_msrment_ie {
	...
	atbm_uint8 mode;
	atbm_uint8 type;
	atbm_uint8 request[ATBM_ZEROSIZE];
}  atbm_packed ;
...
struct atbmwifi_ieee80211_mgmt {
	...
	union {
		struct {
			...
			atbm_uint8 variable[ATBM_ZEROSIZE];
		}   atbm_packed auth;
		struct {
...
struct atbm_ieee80211_vht_operation {
	atbm_uint8 chan_width;
	atbm_uint8 center_freq_seg0_idx;
	atbm_uint8 center_freq_seg1_idx;
	atbm_uint16 basic_mcs_set;
} atbm_packed;
/**
...
struct atbm_ieee80211_vht_mcs_info {
	atbm_uint16 rx_mcs_map;
	atbm_uint16 rx_highest;
	atbm_uint16 tx_mcs_map;
	atbm_uint16 tx_highest;
} atbm_packed;
...
#define ATBM_WLAN_EID_EXT_UORA 37
#define ATBM_WLAN_EID_EXT_HE_MU_EDCA_PARAMS 38
#define ATBM_WLAN_EID_EXT_SPATIAL_REUSE 39
#define ATBM_WLAN_EID_EXT_NDP_FEEDBACK_REPORT_PARAMSET 41
#define ATBM_WLAN_EID_EXT_BSS_COLOR_CHG_ANN 42
#define ATBM_WLAN_EID_EXT_QUIET_TIME_PERIOD_SETUP 43
#define ATBM_WLAN_EID_EXT_ESS_REPORT 45
#define ATBM_WLAN_EID_EXT_OPS 46
#define ATBM_WLAN_EID_EXT_HE_BSS_LOAD 47
#define ATBM_WLAN_EID_EXT_MAX_CHANNEL_SWITCH_TIME 52
#define ATBM_WLAN_EID_EXT_MULTIPLE_BSSID_CONFIGURATION 55
#define ATBM_WLAN_EID_EXT_NON_INHERITANCE 56
#define ATBM_WLAN_EID_EXT_KNOWN_BSSID 57
#define ATBM_WLAN_EID_EXT_SHORT_SSID_LIST 58
#define ATBM_WLAN_EID_EXT_HE_6GHZ_CAPA 59
#define ATBM_WLAN_EID_EXT_UL_MU_POWER_CAPA 60
 ...
 */
#define ATBM_WLAN_EXT_CAPA1_EXT_CHANNEL_SWITCHING	ATBM_BIT(2)

/* Multiple BSSID capability is set in the 6th bit of 3rd byte of the
 * @WLAN_EID_EXT_CAPABILITY information element
 */
#define ATBM_WLAN_EXT_CAPA3_MULTI_BSSID_SUPPORT	ATBM_BIT(6)
 ...
 */
#define ATBM_WLAN_EXT_CAPA3_TIMING_MEASUREMENT_SUPPORT	ATBM_BIT(7)

/* TDLS capabilities in the 4th byte of @WLAN_EID_EXT_CAPABILITY */
#define ATBM_WLAN_EXT_CAPA4_TDLS_BUFFER_STA		ATBM_BIT(4)
#define ATBM_WLAN_EXT_CAPA4_TDLS_PEER_PSM		ATBM_BIT(5)
#define ATBM_WLAN_EXT_CAPA4_TDLS_CHAN_SWITCH		ATBM_BIT(6)

/* Interworking capabilities are set in 7th bit of 4th byte of the
 * @WLAN_EID_EXT_CAPABILITY information element
 */
#define ATBM_WLAN_EXT_CAPA4_INTERWORKING_ENABLED	ATBM_BIT(7)

/*
 * TDLS capabililites to be enabled in the 5th byte of the
 * @WLAN_EID_EXT_CAPABILITY information element
 */
#define ATBM_WLAN_EXT_CAPA5_TDLS_ENABLED	ATBM_BIT(5)
#define ATBM_WLAN_EXT_CAPA5_TDLS_PROHIBITED	ATBM_BIT(6)
#define ATBM_WLAN_EXT_CAPA5_TDLS_CH_SW_PROHIBITED	ATBM_BIT(7)

#define ATBM_WLAN_EXT_CAPA8_TDLS_WIDE_BW_ENABLED	ATBM_BIT(5)
#define ATBM_WLAN_EXT_CAPA8_OPMODE_NOTIF	ATBM_BIT(6)

/* Defines the maximal number of MSDUs in an A-MSDU. */
#define ATBM_WLAN_EXT_CAPA8_MAX_MSDU_IN_AMSDU_LSB	ATBM_BIT(7)
#define ATBM_WLAN_EXT_CAPA9_MAX_MSDU_IN_AMSDU_MSB	ATBM_BIT(0)

/*
 * Fine Timing Measurement Initiator - bit 71 of @WLAN_EID_EXT_CAPABILITY
 * information element
 */
#define ATBM_WLAN_EXT_CAPA9_FTM_INITIATOR	ATBM_BIT(7)

/* Defines support for TWT Requester and TWT Responder */
#define ATBM_WLAN_EXT_CAPA10_TWT_REQUESTER_SUPPORT	ATBM_BIT(5)
#define ATBM_WLAN_EXT_CAPA10_TWT_RESPONDER_SUPPORT	ATBM_BIT(6)
 ...
 */
#define ATBM_WLAN_EXT_CAPA10_OBSS_NARROW_BW_RU_TOLERANCE_SUPPORT ATBM_BIT(7)

/* Defines support for enhanced multi-bssid advertisement*/
#define ATBM_WLAN_EXT_CAPA11_EMA_SUPPORT	ATBM_BIT(3)
...
struct atbmwifi_ieee80211_htc_om
{
	atbm_uint32 ht_control : 2,
		control_id : 4,
		rx_nss : 3,
		channel_width : 2,
		ul_mu_disable : 1,
...
struct atbmwifi_ieee802_11_elems {
	...
	const atbm_uint8 *he_cap;
	atbm_uint8 he_cap_len;
	...
	const atbm_uint8 *uora_element;
	const atbm_uint8 *max_channel_switch_time;
};
...
struct ieee80211_ble_status {
	enum ieee80211_ble_msg_type msg_type;
};
...
{
	const char *name;
	atbm_thread_internal_t *thread;
	unsigned long			flags;
	unsigned long           wakeup_period;
	int (*thread_fn)(struct ieee80211_ble_thread *thread, int wakeup_state);
...
struct ieee80211_ble_local{
	ATBM_BOOL ble_started;
	atbm_spinlock_t  ble_spin_lock;
	atbm_mutex	ble_mutex_lock;
	int  (*ble_recv_callback)(struct atbmwifi_common *, atbm_uint8* buff, atbm_size_t buff_size, enum ieee80211_ble_msg_type msg_type);
	struct atbm_buff_head ble_xmit_queue;
	struct atbm_buff_head ble_recv_queue;
...
struct  ieee80211_ble_buff{
	...
	atbm_uint8 mem[0] __attribute__((__aligned__(64)));
};
