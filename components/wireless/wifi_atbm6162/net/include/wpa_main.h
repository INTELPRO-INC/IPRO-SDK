...
#define ATBM_WPA_SCAN_QUAL_INVALID		ATBM_BIT(0)
#define ATBM_WPA_SCAN_NOISE_INVALID		ATBM_BIT(1)
#define ATBM_WPA_SCAN_LEVEL_INVALID		ATBM_BIT(2)
#define ATBM_WPA_SCAN_LEVEL_DBM		ATBM_BIT(3)
#define ATBM_WPA_SCAN_AUTHENTICATED		ATBM_BIT(4)
#define ATBM_WPA_SCAN_ASSOCIATED		ATBM_BIT(5)
...
#define ATBM_WPA_CAPABILITY_PREAUTH ATBM_BIT(0)
#define ATBM_WPA_CAPABILITY_NO_PAIRWISE ATBM_BIT(1)
/* B2-B3: PTKSA Replay Counter */
/* B4-B5: GTKSA Replay Counter */
#define ATBM_WPA_CAPABILITY_MFPR ATBM_BIT(6)
#define ATBM_WPA_CAPABILITY_MFPC ATBM_BIT(7)
#define ATBM_WPA_CAPABILITY_PEERKEY_ENABLED ATBM_BIT(9)
...
#define ATBM_WPA_KEY_INFO_TYPE_MASK ((atbm_uint16) (ATBM_BIT(0) | ATBM_BIT(1) | ATBM_BIT(2)))
#define ATBM_WPA_KEY_INFO_TYPE_AKM_DEFINED 0
#define ATBM_WPA_KEY_INFO_TYPE_HMAC_MD5_RC4 ATBM_BIT(0)
#define ATBM_WPA_KEY_INFO_TYPE_HMAC_SHA1_AES ATBM_BIT(1)
#define ATBM_WPA_KEY_INFO_TYPE_AES_128_CMAC 3
#define ATBM_WPA_KEY_INFO_KEY_TYPE ATBM_BIT(3) /* 1 = Pairwise, 0 = Group key */
/* bit4..5 is used in WPA, but is reserved in IEEE 802.11i/RSN */
#define ATBM_WPA_KEY_INFO_KEY_INDEX_MASK (ATBM_BIT(4) | ATBM_BIT(5))
#define ATBM_WPA_KEY_INFO_KEY_INDEX_SHIFT 4
#define ATBM_WPA_KEY_INFO_INSTALL ATBM_BIT(6) /* pairwise */
#define ATBM_WPA_KEY_INFO_TXRX ATBM_BIT(6) /* group */
#define ATBM_WPA_KEY_INFO_ACK ATBM_BIT(7)
#define ATBM_WPA_KEY_INFO_MIC ATBM_BIT(8)
#define ATBM_WPA_KEY_INFO_SECURE ATBM_BIT(9)
#define ATBM_WPA_KEY_INFO_ERROR ATBM_BIT(10)
#define ATBM_WPA_KEY_INFO_REQUEST ATBM_BIT(11)
#define ATBM_WPA_KEY_INFO_ENCR_KEY_DATA ATBM_BIT(12) /* IEEE 802.11i/RSN only */
#define ATBM_WPA_KEY_INFO_SMK_MESSAGE ATBM_BIT(13)
...
#define ATBM_EAPOL_FLAG_REQUIRE_KEY_UNICAST ATBM_BIT(0)
#define ATBM_EAPOL_FLAG_REQUIRE_KEY_BROADCAST ATBM_BIT(1)
...
#define ATBM_RSN_FT_CAPAB_FT_OVER_DS ATBM_BIT(0)
#define ATBM_RSN_FT_CAPAB_FT_RESOURCE_REQ_SUPP ATBM_BIT(1)
