...
#define ATBM_ZEROSIZE		0
#define ATBM_MAX_BSS_LIST_SIZE   	2   //ʵֻᱣһ
...
#define ATBM_WPA_CIPHER_NONE ATBM_BIT(0)
#define ATBM_WPA_CIPHER_WEP40 ATBM_BIT(1)
#define ATBM_WPA_CIPHER_WEP104 ATBM_BIT(2)
#define ATBM_WPA_CIPHER_TKIP ATBM_BIT(3)
#define ATBM_WPA_CIPHER_CCMP ATBM_BIT(4)
#define ATBM_WPA_CIPHER_AES_128_CMAC ATBM_BIT(5)
#define ATBM_WPA_CIPHER_GCMP ATBM_BIT(6)
#ifdef CONFIG_WAPI
#define ATBM_WPA_CIPHER_SMS4 ATBM_BIT(7)
#endif

#define ATBM_WPA_KEY_MGMT_IEEE8021X ATBM_BIT(0)
#define ATBM_WPA_KEY_MGMT_PSK ATBM_BIT(1)
#define ATBM_WPA_KEY_MGMT_NONE ATBM_BIT(2)
#define ATBM_WPA_KEY_MGMT_IEEE8021X_NO_WPA ATBM_BIT(3)
#define ATBM_WPA_KEY_MGMT_WPA_NONE ATBM_BIT(4)
#define ATBM_WPA_KEY_MGMT_FT_IEEE8021X ATBM_BIT(5)
#define ATBM_WPA_KEY_MGMT_FT_PSK ATBM_BIT(6)
#define ATBM_WPA_KEY_MGMT_IEEE8021X_SHA256 ATBM_BIT(7)
#define ATBM_WPA_KEY_MGMT_PSK_SHA256 ATBM_BIT(8)
#define ATBM_WPA_KEY_MGMT_WPS ATBM_BIT(9)
#define ATBM_WPA_KEY_MGMT_SAE ATBM_BIT(10)
#define ATBM_WPA_KEY_MGMT_FT_SAE ATBM_BIT(11)
#define ATBM_WPA_KEY_MGMT_WEP ATBM_BIT(12)
...
#define ATBM_WPA_PROTO_WPA ATBM_BIT(0)
#define ATBM_WPA_PROTO_RSN ATBM_BIT(1)

#define ATBM_WPA_AUTH_ALG_OPEN ATBM_BIT(0)
#define ATBM_WPA_AUTH_ALG_SHARED ATBM_BIT(1)
#define ATBM_WPA_AUTH_ALG_LEAP ATBM_BIT(2)
#define ATBM_WPA_AUTH_ALG_FT ATBM_BIT(3)
#define ATBM_WPA_AUTH_ALG_SAE ATBM_BIT(4)
#define ATBM_WPA_AUTH_ALG_FILS ATBM_BIT(5)
#define ATBM_WPA_AUTH_ALG_FILS_SK_PFS ATBM_BIT(6)
