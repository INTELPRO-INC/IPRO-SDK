...
#define ATBM_HWBUF_EXTERN_HEADROM_LEN 	88
...
struct atbm_net_device{
	...
	atbm_uint8  drv_priv[ATBM_ZEROSIZE]; /*struct atbmwifi_vif **/
};
...
struct atbm_buff {  
  ...
  struct atbm_buff *parent;
#endif
#if ATBM_SKB_DEBUG
  struct atbm_list_head skb_list;
#if ATBM_RX_REUSE_PACKET
  struct atbm_list_head reuse_list;
#endif
#endif
...
void atbm_init_skb_lock(void);
#if ATBM_SKB_DEBUG
void dump_skb_status(void);
#else
static __INLINE void dump_skb_status(){}
#endif
