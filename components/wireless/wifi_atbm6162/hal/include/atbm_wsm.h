...
#define HW_INSERT_DUMMY			ATBM_BIT(15)
#define ENC_DATA_LEN_MASK		0x3fff

#define ENC_CMD_ENCRYPT				ATBM_BIT(0)
#define ENC_CMD_DECRYPT				ATBM_BIT(1)
#define CHKSUM_ENABLE				ATBM_BIT(2)
#define CHKSUM_ENABLE_OPT			ATBM_BIT(3)
#define CHKSUM_ENABLE_ICMP			ATBM_BIT(4)
...
#define ENC_FORCE_PROTECT			ATBM_BIT(20)
#define ENC_FORCE_PROTECT_MGMT		ATBM_BIT(21)
#define ENC_PROTECT_AUTH			ATBM_BIT(22)
#define ENC_ENABLE_11W				ATBM_BIT(23)

#define ENC_WB_PROC_DONE			ATBM_BIT(0)
#define ENC_WB_PROC_SUCCESS			ATBM_BIT(1)
#define ENC_WB_MIC_VERIFY_ERR		ATBM_BIT(2)
#define ENC_WB_WEP_CRC_ERR			ATBM_BIT(3)
#define ENC_WB_FIND_KEY_FAIL_ERR	ATBM_BIT(4)
#define ENC_WB_KEY_MISSING_ERR		ATBM_BIT(5)
#define ENC_WB_KEYTYPE_ERR			ATBM_BIT(6)
#define ENC_WB_KEYTABLE_ILLEGAL_ERR	ATBM_BIT(7)
#define ENC_WB_BIP_MIC_FAIL			ATBM_BIT(8)
#define ENC_WB_CCMP_FIAL			ATBM_BIT(9)
#define ENC_WB_CHECKSUM_SUCCESS		ATBM_BIT(14)

#define ENC_WB_KEYTYPE_OFFSET		28


struct hw_enc_hdr{	
	atbm_uint16 total_len;
	atbm_uint16 flag;
	atbm_uint32 DestAddr;
	atbm_uint32 EncFlags;
	atbm_uint32 EncWriteBack;
	atbm_uint32 EncWriteBack1;
}atbm_packed;
...
/* background scan. */
#define WSM_SCAN_FLAG_FORCE_BACKGROUND	(ATBM_BIT(0))

/* The WLAN device scans one channel at a time so */
/* that disturbance to the data traffic is minimized. */
#define WSM_SCAN_FLAG_SPLIT_METHOD	(ATBM_BIT(1))

/* Preamble Type. Long if not set. */
#define WSM_SCAN_FLAG_SHORT_PREAMBLE	(ATBM_BIT(2))

/* 11n Tx Mode. Mixed if not set. */
#define WSM_SCAN_FLAG_11N_GREENFIELD	(ATBM_BIT(3))

#define WSM_FLAG_MAC_INSTANCE_1	(ATBM_BIT(4))
#define WSM_FLAG_JOIN_F_FORCE_JOIN       (ATBM_BIT(2))            

#define WSM_FLAG_MAC_INSTANCE_0	(~(ATBM_BIT(4)))

#define WSM_FLAG_START_SMARTCONFIG		 (ATBM_BIT(5))

#define WSM_FLAG_AP_BEST_CHANNEL    (ATBM_BIT(6))
...
#define WSM_TX_FLAG_EXPIRY_TIME		(ATBM_BIT(0))
...
/* 802.11 PS mode */
#define WSM_PSM_PS			ATBM_BIT(0)

/* Fast Power Save bit */
#define WSM_PSM_FAST_PS_FLAG		ATBM_BIT(7)

/* Dynamic aka Fast power save */
#define WSM_PSM_FAST_PS			(ATBM_BIT(0) | ATBM_BIT(7))

/* Undetermined */
/* Note : Undetermined status is reported when the */
/* NULL data frame used to advertise the PM mode to */
/* the AP at Pre or Post Background Scan is not Acknowledged */
#define WSM_PSM_UNKNOWN			ATBM_BIT(1)
...
/* Mixed format */
#define WSM_HT_TX_MIXED			ATBM_BIT(0)


/* Greenfield format */
#define WSM_HT_TX_GREENFIELD		(2)
#define WSM_HT_TX_MODE				(ATBM_BIT(0)|ATBM_BIT(1))//mix,notht,greenfile
#define WSM_HT_TX_SGI				(ATBM_BIT(2))
#define WSM_HT_TX_WIDTH_40M			(ATBM_BIT(3))
#define WSM_HT_TX_USE_FIXED_RATE		(ATBM_BIT(4))
#define WSM_HT_TX_LONG_PREAMBLE		(ATBM_BIT(5))
/* STBC allowed */
#define WSM_HT_TX_STBC			(ATBM_BIT(7))
#define WSM_HT_TX_NEED_CONFIRM		(ATBM_BIT(8))
#define WSM_HT_AGGR_EN			(ATBM_BIT(9))
#define WSM_HT_NEED_SEQ			(ATBM_BIT(10))
#define WSM_TX_HT_LDPC				(ATBM_BIT(11))
#define WSM_NEED_TX_RATE_CONFIRM		(ATBM_BIT(12))



/*he param*/
#define WSM_TX_HE_HTC					(ATBM_BIT(0))
/*
bit [2:1]
00: 1x
01: 2x
10: 4x
*/
#define WSM_TX_HE_LTF_2X				(ATBM_BIT(1))
#define WSM_TX_HE_LTF_4X				(ATBM_BIT(2))
/*
GI[4:3]
00:0.8 us
01:1.6 us
10:3.2 us
*/
#define WSM_TX_HE_GI_16				(ATBM_BIT(3))
#define WSM_TX_HE_GI_32				(ATBM_BIT(4))
#define WSM_TX_HE_DCM_USED			(ATBM_BIT(5))
#define WSM_TX_HE_NORM_PAD8			(ATBM_BIT(6))
#define WSM_TX_HE_NORM_PAD16		(ATBM_BIT(7))
#define WSM_TX_HE_LDPC				(ATBM_BIT(8))
#define WSM_TX_HE_ER_106			(ATBM_BIT(9))
#define WSM_TX_HE_SMPDU				(ATBM_BIT(10))
#define WSM_TX_HE_SUPPORT_DCM	    (ATBM_BIT(11))   //support DCM, LMAC can set DCM flag.
#define WSM_TX_HE_DOWN_TO_11B		(ATBM_BIT(12))
...
#define WSM_TX_STATUS_AGGREGATION	(ATBM_BIT(0))

/* Host should requeue this frame later. */
/* Valid only when status is WSM_REQUEUE. */
#define WSM_TX_STATUS_REQUEUE		(ATBM_BIT(1))
...
#define WSM_RX_STATUS_AGGREGATE		(ATBM_BIT(3))

/* Frame was first in the aggregation */
#define WSM_RX_STATUS_AGGREGATE_FIRST	(ATBM_BIT(4))

/* Frame was last in the aggregation */
#define WSM_RX_STATUS_AGGREGATE_LAST	(ATBM_BIT(5))

/* Indicates a defragmented frame */
#define WSM_RX_STATUS_DEFRAGMENTED	(ATBM_BIT(6))

/* Indicates a Beacon frame */
#define WSM_RX_STATUS_BEACON		(ATBM_BIT(7))

/* Indicates STA bit beacon TIM field */
#define WSM_RX_STATUS_TIM		(ATBM_BIT(8))

/* Indicates Beacon frame's virtual bitmap contains multicast bit */
#define WSM_RX_STATUS_MULTICAST		(ATBM_BIT(9))

/* Indicates frame contains a matching SSID */
#define WSM_RX_STATUS_MATCHING_SSID	(ATBM_BIT(10))

/* Indicates frame contains a matching BSSI */
#define WSM_RX_STATUS_MATCHING_BSSI	(ATBM_BIT(11))

/* Indicates SMARTCONFIG*/
#define WSM_RX_STATUS_SMARTCONFIG		(ATBM_BIT(12))

/* Indicates frame received during a measurement process */
#define WSM_RX_STATUS_MEASUREMENT	(ATBM_BIT(13))

/* Indicates frame received as an HT packet */
#define WSM_RX_STATUS_HT		(ATBM_BIT(14))

/* Indicates frame received with STBC */
#define WSM_RX_STATUS_STBC		(ATBM_BIT(15))

/* Indicates Address 1 field matches dot11StationId */
#define WSM_RX_STATUS_ADDRESS1		(ATBM_BIT(16))

/* Indicates Group address present in the Address 1 field */
#define WSM_RX_STATUS_GROUP		(ATBM_BIT(17))

/* Indicates Broadcast address present in the Address 1 field */
#define WSM_RX_STATUS_BROADCAST		(ATBM_BIT(18))

/* Indicates group key used with encrypted frames */
#define WSM_RX_STATUS_GROUP_KEY		(ATBM_BIT(19))
/*indicates rx 40M*/
#define WSM_RX_STATUS_RX_40M		(ATBM_BIT(22))
/* Macro to fetch encryption key index. */
#define WSM_RX_STATUS_KEY_IDX(status)	(((status >> 20)) & 0x0F)
#define WSM_RX_STATUS_SHORT_GI      (ATBM_BIT(24))

#define WSM_RX_STATUS_FILTER_FRAME	(BIT(29))

/* Frame Control field starts at Frame offset + 2 */
#define WSM_TX_2BYTES_SHIFT		(ATBM_BIT(7))
...
/* Join flags */
/* Unsynchronized */
#define WSM_JOIN_FLAGS_UNSYNCRONIZED	ATBM_BIT(0)
/* The BSS owner is a P2P GO */
#define WSM_JOIN_FLAGS_P2P_GO		ATBM_BIT(1)
/* Force to join BSS with the BSSID and the
 * SSID specified without waiting for beacons. The
 * ProbeForJoin parameter is ignored. */
#define WSM_JOIN_FLAGS_FORCE		ATBM_BIT(2)
/* Give probe request/response higher
 * priority over the BT traffic */
#define WSM_JOIN_FLAGS_PRIO		ATBM_BIT(3)
...
#define WSM_KEY_TYPE_NONE			(9)
#define WSM_KEY_TYPE_UNKNOWN		(15) 
...
#define WSM_ASSOCIATION_MODE_USE_PREAMBLE_TYPE		(ATBM_BIT(0))
#define WSM_ASSOCIATION_MODE_USE_HT_MODE		(ATBM_BIT(1))
#define WSM_ASSOCIATION_MODE_USE_BASIC_RATE_SET		(ATBM_BIT(2))
#define WSM_ASSOCIATION_MODE_USE_MPDU_START_SPACING	(ATBM_BIT(3))
#define WSM_ASSOCIATION_MODE_SNOOP_ASSOC_FRAMES		(ATBM_BIT(4))
#define WSM_ASSOCIATION_MODE_USE_HE_MODE			(ATBM_BIT(5))
#define WSM_ASSOCIATION_MODE_USE_SHORT_BA_WINDOW	(ATBM_BIT(6)) //addba windows = 32 , not set this flag windows=  64


/* RcpiRssiThreshold MIB flags */
#define WSM_RCPI_RSSI_THRESHOLD_ENABLE	(ATBM_BIT(0))
#define WSM_RCPI_RSSI_USE_RSSI		(ATBM_BIT(1))
#define WSM_RCPI_RSSI_DONT_USE_UPPER	(ATBM_BIT(2))
#define WSM_RCPI_RSSI_DONT_USE_LOWER	(ATBM_BIT(3))

/* Update-ie constants */
#define WSM_UPDATE_IE_BEACON		(ATBM_BIT(0))
#define WSM_UPDATE_IE_PROBE_RESP	(ATBM_BIT(1))
#define WSM_UPDATE_IE_PROBE_REQ		(ATBM_BIT(2))
...
/* Beacon CSA count end */
#define WSM_EVENT_IND_BEACON_CSA (11)

/*Wakeup host sdio tx thread*/
#define WSM_EVENT_WAKEUP_TX			(12)
...
struct wsm_hdr_tx {
	union{
		struct {
			...
			atbm_uint8 reserved;
			atbm_uint8 checksum; 		
		}atbm_align common;//sdio used this ,when wsm usb also used this, in hwusb change to  usb_hdr
		 struct{
			atbm_uint32 flag;//hw flag
			atbm_uint16 usb_len;
			atbm_uint16 usb_id;
		}atbm_align usb_hdr;//usb used this
	}atbm_align u;
	struct hw_enc_hdr enc_hdr;
	atbm_uint16 len;
	atbm_uint16 id;
}atbm_align;//atbm_packed;
...
#define WSM_GET_RX_ID(seq) (seq&0xF3F)

#define MAX_BEACON_SKIP_TIME_MS 1000
#define WSM_TX_FLAG(channel) (channel &0x1f)
#define WSM_TX_FLAG_CHECK(id) ((id &0xffff)<<16)
#ifdef FPGA_SETUP
#define WSM_CMD_LAST_CHANCE_TIMEOUT (ATBM_HZ * 9 / 2)
#else
#define WSM_CMD_LAST_CHANCE_TIMEOUT (ATBM_HZ * 20 / 2)
#endif
#define WSM_CMD_EXTENDED_TIMEOUT (ATBM_HZ * 20 / 2)
...
struct wsm_caps {
	...
	atbm_uint32 NumOfHwAggrSupports;
};
...
struct wsm_tx_confirm {
	...
	/* [out] */ atbm_uint32 NumOfTxRate;
				atbm_uint8  *RateTable;
}atbm_packed;
...
struct wsm_join {
	...
	/*[in]*/	atbm_uint8 transbssid[6];
	/*[in]*/	atbm_uint16 bssid_index;
	/*[in]*/	atbm_uint8 max_bssid_index;
	/*[in]*/	atbm_uint8 wifi4_option;
	/*[in]*/	atbm_uint8 not_support_multi_bssid;
	/*[in]*/	atbm_uint8 is_trans_bssid;
...
struct atbm_he_pkt_ext {
	atbm_uint8 pkt_ext_qam_th[MAX_HE_SUPP_NSS][MAX_HE_CHANNEL_BW_INDX][2];
} atbm_packed; /* PKT_EXT_DOT11AX_API_S */

//he_support_flag
#define F_HE_SUPPORT_ENABLE		ATBM_BIT(0)
#define F_HE_COLOR_ENABLE		ATBM_BIT(1)
#define F_HE_UORA_ENABLE		ATBM_BIT(2)
#define F_HE_MUL_BSSID_ENABLE	ATBM_BIT(3)
#define F_HE_MUL_PACKET_EXT		ATBM_BIT(4)
#define F_HE_SU_4XLTF_08US		ATBM_BIT(5)
#define F_HE_ER_4XLTF_08US		ATBM_BIT(6)
#define F_HE_1XLTF_08US		ATBM_BIT(7)

//htc_flags
#define F_HTC_SUPPORT_HE_ENABLE		ATBM_BIT(0)
#define F_HTC_SUPPORT_BSR_ENABLE	ATBM_BIT(1)
#define F_HTC_SUPPORT_OMI_ENABLE	ATBM_BIT(2)
#define F_HTC_SUPPORT_BQR_ENABLE	ATBM_BIT(3)
...
#if CONFIG_HE
	atbm_uint32 he_support_flag;
	atbm_uint32 htc_flags;	
	atbm_uint16 frame_time_rts_th;
	atbm_uint8 color;
	atbm_uint8 uora_ocw_range;/*ecwmin bit0~bit2: ecwmax bit3~bit5*/

	/* The below fields are set via Multiple BSSID IE */
	atbm_uint8 transmitter_bssid[6];	
...
struct wsm_mu_edca_queue_params
{
	...
	/* [in] */ atbm_uint8 aifns;
    /* CWmin/CWmax */
	atbm_uint8 ecw_min_max;

	atbm_uint8 mu_edca_timer;
};
...
#define WSM_EDCA_SET(edca, queue, aifs, cw_min, cw_max, txop, life_time, \
		uapsd, mu_edca, ecw_min_max_v, aifsn, mu_edca_timer_v)	\
	do {							\
		struct wsm_edca_queue_params *p = &(edca)->params[queue]; \
		struct wsm_mu_edca_queue_params *p_mu = &(edca)->mu_params[queue]; \
		p->cwMin = (cw_min); \
		p->cwMax = (cw_max); \
		p->aifns = (aifs); \
		...
		p->uapsdEnable = (uapsd); \
		p_mu->aifns = (mu_edca?aifsn:0); \
		p_mu->ecw_min_max = (mu_edca?ecw_min_max_v:0); \
		p_mu->mu_edca_timer = (mu_edca?mu_edca_timer_v:0); \
	} while (0);
...
#define WSM_SUPPORT_RATE_FLAGS__ENABLE_HT      ATBM_BIT(0)
#define WSM_SUPPORT_RATE_FLAGS__ENABLE_VHT     ATBM_BIT(1)
#define WSM_SUPPORT_RATE_FLAGS__ENABLE_HE      ATBM_BIT(2)
#define WSM_SUPPORT_RATE_FLAGS__ENABLE_40M     ATBM_BIT(3)
#define WSM_SUPPORT_RATE_FLAGS__ENABLE_5G      ATBM_BIT(4)
/* ******************************************************************** */
struct wsm_supp_rate{
    atbm_uint16 flags; 
    atbm_uint8 if_id;
    atbm_uint8 peer_id;
    atbm_uint32 supp_rates;       
    atbm_uint32 ht_flags;
    atbm_uint32 vht_flags;
    atbm_uint32 he_flags;
    atbm_uint32 bg_flags;
}atbm_packed;
...
#define HW_CHIP_VERSION_Coeus	 		(0x31)
#define HW_CHIP_VERSION_OCEANUS_LITE    (0x34)
#define HW_CHIP_VERSION_DEMETER_FM      (0x5E)
...
struct efuse_headr{
	...
	atbm_uint8 PowerSupplySel;
	atbm_uint8 mac[6];
	atbm_uint8 delta_gain1_5g; 
	atbm_uint8 delta_gain2_5g;
	atbm_uint8 delta_gain3_5g;
	atbm_uint8 delta_gain4_5g; 
	atbm_uint8 delta_gain5_5g;
	atbm_uint8 delta_gain6_5g;
	atbm_uint8 delta_gain7_5g; 
	atbm_uint8 delta_gain8_5g;
	atbm_uint8 delta_gain9_5g;
	atbm_uint8 delta_gain10_5g;
	char pdetK1;
	char pdetK2;
	char pdetK3;
};
...
int wsm_get_cca_threshold(struct atbmwifi_common *hw_priv,void *cca_threshold,int len);
...
#define WSM_BEACON_FILTER_IE_HAS_CHANGED	ATBM_BIT(0)
#define WSM_BEACON_FILTER_IE_NO_LONGER_PRESENT	ATBM_BIT(1)
#define WSM_BEACON_FILTER_IE_HAS_APPEARED	ATBM_BIT(2)
#define WSM_BEACON_FILTER_FRAME_TYPE			ATBM_BIT(3)
#define WSM_BEACON_FILTER_ACTION_ENABLE			ATBM_BIT(4)
#define WSM_BEACON_FILTER_OUI					ATBM_BIT(5)
...
#define WSM_BEACON_FILTER_ENABLE	ATBM_BIT(0) /* Enable/disable beacon filtering */
#define WSM_BEACON_FILTER_AUTO_ERP	ATBM_BIT(1) /* If 1 FW will handle ERP IE changes internally */
...
struct wsm_protected_mgmt_policy {
	...
	ATBM_BOOL encryptionNoForAuthFrame;
};
...
struct wsm_p2p_device_info {
	...
	struct wsm_p2p_device_type secondaryDevices[ATBM_ZEROSIZE];
} ;
...
struct wsm_mac_addr_filter {
	...
	atbm_uint8 Reserved[2];
	struct wsm_mac_addr_info macaddrfilter[ATBM_ZEROSIZE];
} ;
...
#define WSM_GET_CCA_FLAGS__START_CCA			(ATBM_BIT(0))
#define WSM_GET_CCA_FLAGS__STOP_CCA				(ATBM_BIT(1))
#define WSM_GET_CCA_FLAGS__SET_INIT				(ATBM_BIT(2))
...
#define WSM_SEND_CHTYPE_CHG_REQUEST__FLAGS_SEN_40M	(ATBM_BIT(1))
#define WSM_SEND_CHTYPE_CHG_REQUEST__FLAGS_SEN_20M	(ATBM_BIT(0))
...
#define HI_MSG_ID_BLE_BIT			ATBM_BIT(8)
...
static inline atbm_uint8 atbm_checksum_u8(atbm_uint8 *p, int len)
{
	atbm_uint16 sum = 0;
	while(len--){
		sum += *p++;
...
int wsm_get_efuse_status(struct atbmwifi_common *hw_priv);
...
struct wsm_csa
{
	atbm_uint8 flags;
	atbm_uint8 csa_mode;
	atbm_uint8 csa_channel;
	atbm_uint8 csa_count;
};
#define WSM_CSA_REQ_ID 0x002a
#define WSM_CSA_RESP_ID 0x042a
int wsm_csa_req(struct atbmwifi_common *hw_priv, const struct wsm_csa *arg, int if_id);
...
int wsm_csa_concurrent_req(struct atbmwifi_common *hw_priv, const struct wsm_csa_concurrent *arg,
	int if_id);
