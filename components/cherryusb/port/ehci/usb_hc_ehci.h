...
#define EHCI_PORTSC_HC_TST_PKDONE  (1 << 20)                    /* Bit 20: Data Transfer is Done for Test Packet in Host Port Test Control */
                                                                /* Bits 21-31: Reserved */
...
struct ehci_hcor {
    ...
    uint32_t reserved[9];
#endif
    uint32_t configflag;       /* 0x1c: Configured Flag Register */
    uint32_t portsc[15];       /* 0x20: Port Status/Control */
};
