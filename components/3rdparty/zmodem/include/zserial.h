...
/*
 * Port configuration for the hal_uart-backed zm_recv/zm_send (src/port.c):
 * select the UART instance and the zm_recv() idle timeout (ms, CLOSED on
 * expiry). Defaults: UART1, 30000 ms.
 */
