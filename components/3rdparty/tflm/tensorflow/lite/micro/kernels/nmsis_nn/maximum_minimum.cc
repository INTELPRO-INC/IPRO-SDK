...
nmsis_nn_dims FillVariableShape(const RuntimeShape& shape) {
...
TfLiteStatus EvalMaximum(TfLiteContext* context, TfLiteNode* node) {
  ...
  nmsis_nn_dims input_1_dims = FillVariableShape(input_1_shape);
  nmsis_nn_dims input_2_dims = FillVariableShape(input_2_shape);
  nmsis_nn_dims output_dims = FillVariableShape(output_shape);
