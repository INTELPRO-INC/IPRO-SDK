...
struct OpData {
  ...
  nmsis_nn_lstm_params params_cmsis_nn;  // Used for  CMSIS-NN implementation
};
...
TfLiteStatus NMSIS_NN_PortOpData(TfLiteContext* context, OpDataLSTM* params_ref,
                                 ...
                                 nmsis_nn_lstm_params* params_cmsis_nn) {
  // Unwrap pointers
...
TfLiteStatus NMSIS_NN_EvalInteger8x8_16Lstm(
  ...
  nmsis_nn_lstm_context cmsis_buffers = {};
  ...
  if (riscv_lstm_unidirectional_s8(input, output, &op_data.params_cmsis_nn,
                                 &cmsis_buffers) != RISCV_NMSIS_NN_SUCCESS) {
    return kTfLiteError;
  }
...
TfLiteStatus NMSIS_NN_EvalInteger16x8_16Lstm(
  ...
  if (riscv_lstm_unidirectional_s16(input, output, &op_data.params_cmsis_nn,
                                  &cmsis_buffers) != RISCV_NMSIS_NN_SUCCESS) {
    return kTfLiteError;
  }
