 ...
 */
 ...
 /**
   ...
   *
   */
  void riscv_blackman_harris_92db_f64(
        float64_t * pDst,
        uint32_t blockSize);
 ...
 /**
   ...
   *
   */
  void riscv_blackman_harris_92db_f32(
        float32_t * pDst,
        uint32_t blockSize);
 /**
