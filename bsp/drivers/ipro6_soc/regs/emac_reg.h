...
#define EMAC_RXEN_MSK                                           (((1ULL<<EMAC_RXEN_LEN)-1)<<EMAC_RXEN_POS)
#define EMAC_RXEN_UMSK                                          (~(((1ULL<<EMAC_RXEN_LEN)-1)<<EMAC_RXEN_POS))
#define EMAC_TXEN                                               EMAC_TXEN
#define EMAC_TXEN_POS                                           (1U)
#define EMAC_TXEN_LEN                                           (1U)
#define EMAC_TXEN_MSK                                           (((1ULL<<EMAC_TXEN_LEN)-1)<<EMAC_TXEN_POS)
#define EMAC_TXEN_UMSK                                          (~(((1ULL<<EMAC_TXEN_LEN)-1)<<EMAC_TXEN_POS))
#define EMAC_NOPRE                                              EMAC_NOPRE
#define EMAC_NOPRE_POS                                          (2U)
#define EMAC_NOPRE_LEN                                          (1U)
#define EMAC_NOPRE_MSK                                          (((1ULL<<EMAC_NOPRE_LEN)-1)<<EMAC_NOPRE_POS)
#define EMAC_NOPRE_UMSK                                         (~(((1ULL<<EMAC_NOPRE_LEN)-1)<<EMAC_NOPRE_POS))
#define EMAC_BRO                                                EMAC_BRO
#define EMAC_BRO_POS                                            (3U)
#define EMAC_BRO_LEN                                            (1U)
#define EMAC_BRO_MSK                                            (((1ULL<<EMAC_BRO_LEN)-1)<<EMAC_BRO_POS)
#define EMAC_BRO_UMSK                                           (~(((1ULL<<EMAC_BRO_LEN)-1)<<EMAC_BRO_POS))
#define EMAC_PRO                                                EMAC_PRO
#define EMAC_PRO_POS                                            (5U)
#define EMAC_PRO_LEN                                            (1U)
#define EMAC_PRO_MSK                                            (((1ULL<<EMAC_PRO_LEN)-1)<<EMAC_PRO_POS)
#define EMAC_PRO_UMSK                                           (~(((1ULL<<EMAC_PRO_LEN)-1)<<EMAC_PRO_POS))
#define EMAC_IFG                                                EMAC_IFG
#define EMAC_IFG_POS                                            (6U)
#define EMAC_IFG_LEN                                            (1U)
#define EMAC_IFG_MSK                                            (((1ULL<<EMAC_IFG_LEN)-1)<<EMAC_IFG_POS)
#define EMAC_IFG_UMSK                                           (~(((1ULL<<EMAC_IFG_LEN)-1)<<EMAC_IFG_POS))
#define EMAC_FULLD                                              EMAC_FULLD
#define EMAC_FULLD_POS                                          (10U)
#define EMAC_FULLD_LEN                                          (1U)
#define EMAC_FULLD_MSK                                          (((1ULL<<EMAC_FULLD_LEN)-1)<<EMAC_FULLD_POS)
#define EMAC_FULLD_UMSK                                         (~(((1ULL<<EMAC_FULLD_LEN)-1)<<EMAC_FULLD_POS))
#define EMAC_CRCEN                                              EMAC_CRCEN
#define EMAC_CRCEN_POS                                          (13U)
#define EMAC_CRCEN_LEN                                          (1U)
#define EMAC_CRCEN_MSK                                          (((1ULL<<EMAC_CRCEN_LEN)-1)<<EMAC_CRCEN_POS)
#define EMAC_CRCEN_UMSK                                         (~(((1ULL<<EMAC_CRCEN_LEN)-1)<<EMAC_CRCEN_POS))
#define EMAC_HUGEN                                              EMAC_HUGEN
#define EMAC_HUGEN_POS                                          (14U)
#define EMAC_HUGEN_LEN                                          (1U)
#define EMAC_HUGEN_MSK                                          (((1ULL<<EMAC_HUGEN_LEN)-1)<<EMAC_HUGEN_POS)
#define EMAC_HUGEN_UMSK                                         (~(((1ULL<<EMAC_HUGEN_LEN)-1)<<EMAC_HUGEN_POS))
#define EMAC_PAD                                                EMAC_PAD
#define EMAC_PAD_POS                                            (15U)
#define EMAC_PAD_LEN                                            (1U)
#define EMAC_PAD_MSK                                            (((1ULL<<EMAC_PAD_LEN)-1)<<EMAC_PAD_POS)
#define EMAC_PAD_UMSK                                           (~(((1ULL<<EMAC_PAD_LEN)-1)<<EMAC_PAD_POS))
#define EMAC_RECSMALL                                           EMAC_RECSMALL
#define EMAC_RECSMALL_POS                                       (16U)
#define EMAC_RECSMALL_LEN                                       (1U)
#define EMAC_RECSMALL_MSK                                       (((1ULL<<EMAC_RECSMALL_LEN)-1)<<EMAC_RECSMALL_POS)
#define EMAC_RECSMALL_UMSK                                      (~(((1ULL<<EMAC_RECSMALL_LEN)-1)<<EMAC_RECSMALL_POS))
#define EMAC_RMII_EN                                            EMAC_RMII_EN
#define EMAC_RMII_EN_POS                                        (17U)
#define EMAC_RMII_EN_LEN                                        (1U)
#define EMAC_RMII_EN_MSK                                        (((1ULL<<EMAC_RMII_EN_LEN)-1)<<EMAC_RMII_EN_POS)
#define EMAC_RMII_EN_UMSK                                       (~(((1ULL<<EMAC_RMII_EN_LEN)-1)<<EMAC_RMII_EN_POS))
...
#define EMAC_TXB_MSK                                            (((1ULL<<EMAC_TXB_LEN)-1)<<EMAC_TXB_POS)
#define EMAC_TXB_UMSK                                           (~(((1ULL<<EMAC_TXB_LEN)-1)<<EMAC_TXB_POS))
#define EMAC_TXE                                                EMAC_TXE
#define EMAC_TXE_POS                                            (1U)
#define EMAC_TXE_LEN                                            (1U)
#define EMAC_TXE_MSK                                            (((1ULL<<EMAC_TXE_LEN)-1)<<EMAC_TXE_POS)
#define EMAC_TXE_UMSK                                           (~(((1ULL<<EMAC_TXE_LEN)-1)<<EMAC_TXE_POS))
#define EMAC_RXB                                                EMAC_RXB
#define EMAC_RXB_POS                                            (2U)
#define EMAC_RXB_LEN                                            (1U)
#define EMAC_RXB_MSK                                            (((1ULL<<EMAC_RXB_LEN)-1)<<EMAC_RXB_POS)
#define EMAC_RXB_UMSK                                           (~(((1ULL<<EMAC_RXB_LEN)-1)<<EMAC_RXB_POS))
#define EMAC_RXE                                                EMAC_RXE
#define EMAC_RXE_POS                                            (3U)
#define EMAC_RXE_LEN                                            (1U)
#define EMAC_RXE_MSK                                            (((1ULL<<EMAC_RXE_LEN)-1)<<EMAC_RXE_POS)
#define EMAC_RXE_UMSK                                           (~(((1ULL<<EMAC_RXE_LEN)-1)<<EMAC_RXE_POS))
#define EMAC_BUSY                                               EMAC_BUSY
#define EMAC_BUSY_POS                                           (4U)
#define EMAC_BUSY_LEN                                           (1U)
#define EMAC_BUSY_MSK                                           (((1ULL<<EMAC_BUSY_LEN)-1)<<EMAC_BUSY_POS)
#define EMAC_BUSY_UMSK                                          (~(((1ULL<<EMAC_BUSY_LEN)-1)<<EMAC_BUSY_POS))
#define EMAC_TXC                                                EMAC_TXC
#define EMAC_TXC_POS                                            (5U)
#define EMAC_TXC_LEN                                            (1U)
#define EMAC_TXC_MSK                                            (((1ULL<<EMAC_TXC_LEN)-1)<<EMAC_TXC_POS)
#define EMAC_TXC_UMSK                                           (~(((1ULL<<EMAC_TXC_LEN)-1)<<EMAC_TXC_POS))
#define EMAC_RXC                                                EMAC_RXC
#define EMAC_RXC_POS                                            (6U)
#define EMAC_RXC_LEN                                            (1U)
#define EMAC_RXC_MSK                                            (((1ULL<<EMAC_RXC_LEN)-1)<<EMAC_RXC_POS)
#define EMAC_RXC_UMSK                                           (~(((1ULL<<EMAC_RXC_LEN)-1)<<EMAC_RXC_POS))
...
#define EMAC_TXB_M_MSK                                          (((1ULL<<EMAC_TXB_M_LEN)-1)<<EMAC_TXB_M_POS)
#define EMAC_TXB_M_UMSK                                         (~(((1ULL<<EMAC_TXB_M_LEN)-1)<<EMAC_TXB_M_POS))
#define EMAC_TXE_M                                              EMAC_TXE_M
#define EMAC_TXE_M_POS                                          (1U)
#define EMAC_TXE_M_LEN                                          (1U)
#define EMAC_TXE_M_MSK                                          (((1ULL<<EMAC_TXE_M_LEN)-1)<<EMAC_TXE_M_POS)
#define EMAC_TXE_M_UMSK                                         (~(((1ULL<<EMAC_TXE_M_LEN)-1)<<EMAC_TXE_M_POS))
#define EMAC_RXB_M                                              EMAC_RXB_M
#define EMAC_RXB_M_POS                                          (2U)
#define EMAC_RXB_M_LEN                                          (1U)
#define EMAC_RXB_M_MSK                                          (((1ULL<<EMAC_RXB_M_LEN)-1)<<EMAC_RXB_M_POS)
#define EMAC_RXB_M_UMSK                                         (~(((1ULL<<EMAC_RXB_M_LEN)-1)<<EMAC_RXB_M_POS))
#define EMAC_RXE_M                                              EMAC_RXE_M
#define EMAC_RXE_M_POS                                          (3U)
#define EMAC_RXE_M_LEN                                          (1U)
#define EMAC_RXE_M_MSK                                          (((1ULL<<EMAC_RXE_M_LEN)-1)<<EMAC_RXE_M_POS)
#define EMAC_RXE_M_UMSK                                         (~(((1ULL<<EMAC_RXE_M_LEN)-1)<<EMAC_RXE_M_POS))
#define EMAC_BUSY_M                                             EMAC_BUSY_M
#define EMAC_BUSY_M_POS                                         (4U)
#define EMAC_BUSY_M_LEN                                         (1U)
#define EMAC_BUSY_M_MSK                                         (((1ULL<<EMAC_BUSY_M_LEN)-1)<<EMAC_BUSY_M_POS)
#define EMAC_BUSY_M_UMSK                                        (~(((1ULL<<EMAC_BUSY_M_LEN)-1)<<EMAC_BUSY_M_POS))
#define EMAC_TXC_M                                              EMAC_TXC_M
#define EMAC_TXC_M_POS                                          (5U)
#define EMAC_TXC_M_LEN                                          (1U)
#define EMAC_TXC_M_MSK                                          (((1ULL<<EMAC_TXC_M_LEN)-1)<<EMAC_TXC_M_POS)
#define EMAC_TXC_M_UMSK                                         (~(((1ULL<<EMAC_TXC_M_LEN)-1)<<EMAC_TXC_M_POS))
#define EMAC_RXC_M                                              EMAC_RXC_M
#define EMAC_RXC_M_POS                                          (6U)
#define EMAC_RXC_M_LEN                                          (1U)
#define EMAC_RXC_M_MSK                                          (((1ULL<<EMAC_RXC_M_LEN)-1)<<EMAC_RXC_M_POS)
#define EMAC_RXC_M_UMSK                                         (~(((1ULL<<EMAC_RXC_M_LEN)-1)<<EMAC_RXC_M_POS))
...
#define EMAC_IPGT_MSK                                           (((1ULL<<EMAC_IPGT_LEN)-1)<<EMAC_IPGT_POS)
#define EMAC_IPGT_UMSK                                          (~(((1ULL<<EMAC_IPGT_LEN)-1)<<EMAC_IPGT_POS))
...
#define EMAC_MAXFL_MSK                                          (((1ULL<<EMAC_MAXFL_LEN)-1)<<EMAC_MAXFL_POS)
#define EMAC_MAXFL_UMSK                                         (~(((1ULL<<EMAC_MAXFL_LEN)-1)<<EMAC_MAXFL_POS))
#define EMAC_MINFL                                              EMAC_MINFL
#define EMAC_MINFL_POS                                          (16U)
#define EMAC_MINFL_LEN                                          (16U)
#define EMAC_MINFL_MSK                                          (((1ULL<<EMAC_MINFL_LEN)-1)<<EMAC_MINFL_POS)
#define EMAC_MINFL_UMSK                                         (~(((1ULL<<EMAC_MINFL_LEN)-1)<<EMAC_MINFL_POS))
...
#define EMAC_COLLVALID_MSK                                      (((1ULL<<EMAC_COLLVALID_LEN)-1)<<EMAC_COLLVALID_POS)
#define EMAC_COLLVALID_UMSK                                     (~(((1ULL<<EMAC_COLLVALID_LEN)-1)<<EMAC_COLLVALID_POS))
#define EMAC_MAXRET                                             EMAC_MAXRET
#define EMAC_MAXRET_POS                                         (16U)
#define EMAC_MAXRET_LEN                                         (4U)
#define EMAC_MAXRET_MSK                                         (((1ULL<<EMAC_MAXRET_LEN)-1)<<EMAC_MAXRET_POS)
#define EMAC_MAXRET_UMSK                                        (~(((1ULL<<EMAC_MAXRET_LEN)-1)<<EMAC_MAXRET_POS))
...
#define EMAC_TXBDNUM_MSK                                        (((1ULL<<EMAC_TXBDNUM_LEN)-1)<<EMAC_TXBDNUM_POS)
#define EMAC_TXBDNUM_UMSK                                       (~(((1ULL<<EMAC_TXBDNUM_LEN)-1)<<EMAC_TXBDNUM_POS))
#define EMAC_TXBDPTR                                            EMAC_TXBDPTR
#define EMAC_TXBDPTR_POS                                        (16U)
#define EMAC_TXBDPTR_LEN                                        (7U)
#define EMAC_TXBDPTR_MSK                                        (((1ULL<<EMAC_TXBDPTR_LEN)-1)<<EMAC_TXBDPTR_POS)
#define EMAC_TXBDPTR_UMSK                                       (~(((1ULL<<EMAC_TXBDPTR_LEN)-1)<<EMAC_TXBDPTR_POS))
#define EMAC_RXBDPTR                                            EMAC_RXBDPTR
#define EMAC_RXBDPTR_POS                                        (24U)
#define EMAC_RXBDPTR_LEN                                        (7U)
#define EMAC_RXBDPTR_MSK                                        (((1ULL<<EMAC_RXBDPTR_LEN)-1)<<EMAC_RXBDPTR_POS)
#define EMAC_RXBDPTR_UMSK                                       (~(((1ULL<<EMAC_RXBDPTR_LEN)-1)<<EMAC_RXBDPTR_POS))
...
#define EMAC_CLKDIV_MSK                                         (((1ULL<<EMAC_CLKDIV_LEN)-1)<<EMAC_CLKDIV_POS)
#define EMAC_CLKDIV_UMSK                                        (~(((1ULL<<EMAC_CLKDIV_LEN)-1)<<EMAC_CLKDIV_POS))
#define EMAC_MIINOPRE                                           EMAC_MIINOPRE
#define EMAC_MIINOPRE_POS                                       (8U)
#define EMAC_MIINOPRE_LEN                                       (1U)
#define EMAC_MIINOPRE_MSK                                       (((1ULL<<EMAC_MIINOPRE_LEN)-1)<<EMAC_MIINOPRE_POS)
#define EMAC_MIINOPRE_UMSK                                      (~(((1ULL<<EMAC_MIINOPRE_LEN)-1)<<EMAC_MIINOPRE_POS))
...
#define EMAC_SCANSTAT_MSK                                       (((1ULL<<EMAC_SCANSTAT_LEN)-1)<<EMAC_SCANSTAT_POS)
#define EMAC_SCANSTAT_UMSK                                      (~(((1ULL<<EMAC_SCANSTAT_LEN)-1)<<EMAC_SCANSTAT_POS))
#define EMAC_RSTAT                                              EMAC_RSTAT
#define EMAC_RSTAT_POS                                          (1U)
#define EMAC_RSTAT_LEN                                          (1U)
#define EMAC_RSTAT_MSK                                          (((1ULL<<EMAC_RSTAT_LEN)-1)<<EMAC_RSTAT_POS)
#define EMAC_RSTAT_UMSK                                         (~(((1ULL<<EMAC_RSTAT_LEN)-1)<<EMAC_RSTAT_POS))
#define EMAC_WCTRLDATA                                          EMAC_WCTRLDATA
#define EMAC_WCTRLDATA_POS                                      (2U)
#define EMAC_WCTRLDATA_LEN                                      (1U)
#define EMAC_WCTRLDATA_MSK                                      (((1ULL<<EMAC_WCTRLDATA_LEN)-1)<<EMAC_WCTRLDATA_POS)
#define EMAC_WCTRLDATA_UMSK                                     (~(((1ULL<<EMAC_WCTRLDATA_LEN)-1)<<EMAC_WCTRLDATA_POS))
...
#define EMAC_FIAD_MSK                                           (((1ULL<<EMAC_FIAD_LEN)-1)<<EMAC_FIAD_POS)
#define EMAC_FIAD_UMSK                                          (~(((1ULL<<EMAC_FIAD_LEN)-1)<<EMAC_FIAD_POS))
#define EMAC_RGAD                                               EMAC_RGAD
#define EMAC_RGAD_POS                                           (8U)
#define EMAC_RGAD_LEN                                           (5U)
#define EMAC_RGAD_MSK                                           (((1ULL<<EMAC_RGAD_LEN)-1)<<EMAC_RGAD_POS)
#define EMAC_RGAD_UMSK                                          (~(((1ULL<<EMAC_RGAD_LEN)-1)<<EMAC_RGAD_POS))
...
#define EMAC_CTRLDATA_MSK                                       (((1ULL<<EMAC_CTRLDATA_LEN)-1)<<EMAC_CTRLDATA_POS)
#define EMAC_CTRLDATA_UMSK                                      (~(((1ULL<<EMAC_CTRLDATA_LEN)-1)<<EMAC_CTRLDATA_POS))
...
#define EMAC_PRSD_MSK                                           (((1ULL<<EMAC_PRSD_LEN)-1)<<EMAC_PRSD_POS)
#define EMAC_PRSD_UMSK                                          (~(((1ULL<<EMAC_PRSD_LEN)-1)<<EMAC_PRSD_POS))
...
#define EMAC_MIIM_LINKFAIL_MSK                                  (((1ULL<<EMAC_MIIM_LINKFAIL_LEN)-1)<<EMAC_MIIM_LINKFAIL_POS)
#define EMAC_MIIM_LINKFAIL_UMSK                                 (~(((1ULL<<EMAC_MIIM_LINKFAIL_LEN)-1)<<EMAC_MIIM_LINKFAIL_POS))
#define EMAC_MIIM_BUSY                                          EMAC_MIIM_BUSY
#define EMAC_MIIM_BUSY_POS                                      (1U)
#define EMAC_MIIM_BUSY_LEN                                      (1U)
#define EMAC_MIIM_BUSY_MSK                                      (((1ULL<<EMAC_MIIM_BUSY_LEN)-1)<<EMAC_MIIM_BUSY_POS)
#define EMAC_MIIM_BUSY_UMSK                                     (~(((1ULL<<EMAC_MIIM_BUSY_LEN)-1)<<EMAC_MIIM_BUSY_POS))
...
#define EMAC_MAC_B5_MSK                                         (((1ULL<<EMAC_MAC_B5_LEN)-1)<<EMAC_MAC_B5_POS)
#define EMAC_MAC_B5_UMSK                                        (~(((1ULL<<EMAC_MAC_B5_LEN)-1)<<EMAC_MAC_B5_POS))
#define EMAC_MAC_B4                                             EMAC_MAC_B4
#define EMAC_MAC_B4_POS                                         (8U)
#define EMAC_MAC_B4_LEN                                         (8U)
#define EMAC_MAC_B4_MSK                                         (((1ULL<<EMAC_MAC_B4_LEN)-1)<<EMAC_MAC_B4_POS)
#define EMAC_MAC_B4_UMSK                                        (~(((1ULL<<EMAC_MAC_B4_LEN)-1)<<EMAC_MAC_B4_POS))
#define EMAC_MAC_B3                                             EMAC_MAC_B3
#define EMAC_MAC_B3_POS                                         (16U)
#define EMAC_MAC_B3_LEN                                         (8U)
#define EMAC_MAC_B3_MSK                                         (((1ULL<<EMAC_MAC_B3_LEN)-1)<<EMAC_MAC_B3_POS)
#define EMAC_MAC_B3_UMSK                                        (~(((1ULL<<EMAC_MAC_B3_LEN)-1)<<EMAC_MAC_B3_POS))
#define EMAC_MAC_B2                                             EMAC_MAC_B2
#define EMAC_MAC_B2_POS                                         (24U)
#define EMAC_MAC_B2_LEN                                         (8U)
#define EMAC_MAC_B2_MSK                                         (((1ULL<<EMAC_MAC_B2_LEN)-1)<<EMAC_MAC_B2_POS)
#define EMAC_MAC_B2_UMSK                                        (~(((1ULL<<EMAC_MAC_B2_LEN)-1)<<EMAC_MAC_B2_POS))
...
#define EMAC_MAC_B1_MSK                                         (((1ULL<<EMAC_MAC_B1_LEN)-1)<<EMAC_MAC_B1_POS)
#define EMAC_MAC_B1_UMSK                                        (~(((1ULL<<EMAC_MAC_B1_LEN)-1)<<EMAC_MAC_B1_POS))
#define EMAC_MAC_B0                                             EMAC_MAC_B0
#define EMAC_MAC_B0_POS                                         (8U)
#define EMAC_MAC_B0_LEN                                         (8U)
#define EMAC_MAC_B0_MSK                                         (((1ULL<<EMAC_MAC_B0_LEN)-1)<<EMAC_MAC_B0_POS)
#define EMAC_MAC_B0_UMSK                                        (~(((1ULL<<EMAC_MAC_B0_LEN)-1)<<EMAC_MAC_B0_POS))
...
#define EMAC_HASH0_MSK                                          (((1ULL<<EMAC_HASH0_LEN)-1)<<EMAC_HASH0_POS)
#define EMAC_HASH0_UMSK                                         (~(((1ULL<<EMAC_HASH0_LEN)-1)<<EMAC_HASH0_POS))
...
#define EMAC_HASH1_MSK                                          (((1ULL<<EMAC_HASH1_LEN)-1)<<EMAC_HASH1_POS)
#define EMAC_HASH1_UMSK                                         (~(((1ULL<<EMAC_HASH1_LEN)-1)<<EMAC_HASH1_POS))
...
#define EMAC_TXPAUSETV_MSK                                      (((1ULL<<EMAC_TXPAUSETV_LEN)-1)<<EMAC_TXPAUSETV_POS)
#define EMAC_TXPAUSETV_UMSK                                     (~(((1ULL<<EMAC_TXPAUSETV_LEN)-1)<<EMAC_TXPAUSETV_POS))
#define EMAC_TXPAUSERQ                                          EMAC_TXPAUSERQ
#define EMAC_TXPAUSERQ_POS                                      (16U)
#define EMAC_TXPAUSERQ_LEN                                      (1U)
#define EMAC_TXPAUSERQ_MSK                                      (((1ULL<<EMAC_TXPAUSERQ_LEN)-1)<<EMAC_TXPAUSERQ_POS)
#define EMAC_TXPAUSERQ_UMSK                                     (~(((1ULL<<EMAC_TXPAUSERQ_LEN)-1)<<EMAC_TXPAUSERQ_POS))
...
struct  emac_reg {
    ...
    union {
        struct {
            ...
            uint32_t rsvd_7_9                       :  3; /* [ 9: 7],       rsvd,        0x0 */
            uint32_t FULLD                          :  1; /* [   10],        r/w,        0x0 */
            uint32_t rsvd_11_12                     :  2; /* [12:11],       rsvd,        0x0 */
            ...
            uint32_t rsvd_18_23                     :  6; /* [23:18],       rsvd,        0x0 */
