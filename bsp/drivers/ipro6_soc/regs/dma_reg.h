...
#define DMA_INTSTATUS_MSK                                       (((1ULL<<DMA_INTSTATUS_LEN)-1)<<DMA_INTSTATUS_POS)
#define DMA_INTSTATUS_UMSK                                      (~(((1ULL<<DMA_INTSTATUS_LEN)-1)<<DMA_INTSTATUS_POS))
...
#define DMA_INTTCSTATUS_MSK                                     (((1ULL<<DMA_INTTCSTATUS_LEN)-1)<<DMA_INTTCSTATUS_POS)
#define DMA_INTTCSTATUS_UMSK                                    (~(((1ULL<<DMA_INTTCSTATUS_LEN)-1)<<DMA_INTTCSTATUS_POS))
...
#define DMA_INTTCCLEAR_MSK                                      (((1ULL<<DMA_INTTCCLEAR_LEN)-1)<<DMA_INTTCCLEAR_POS)
#define DMA_INTTCCLEAR_UMSK                                     (~(((1ULL<<DMA_INTTCCLEAR_LEN)-1)<<DMA_INTTCCLEAR_POS))
...
#define DMA_INTERRORSTATUS_MSK                                  (((1ULL<<DMA_INTERRORSTATUS_LEN)-1)<<DMA_INTERRORSTATUS_POS)
#define DMA_INTERRORSTATUS_UMSK                                 (~(((1ULL<<DMA_INTERRORSTATUS_LEN)-1)<<DMA_INTERRORSTATUS_POS))
...
#define DMA_INTERRCLR_MSK                                       (((1ULL<<DMA_INTERRCLR_LEN)-1)<<DMA_INTERRCLR_POS)
#define DMA_INTERRCLR_UMSK                                      (~(((1ULL<<DMA_INTERRCLR_LEN)-1)<<DMA_INTERRCLR_POS))
...
#define DMA_RAWINTTCSTATUS_MSK                                  (((1ULL<<DMA_RAWINTTCSTATUS_LEN)-1)<<DMA_RAWINTTCSTATUS_POS)
#define DMA_RAWINTTCSTATUS_UMSK                                 (~(((1ULL<<DMA_RAWINTTCSTATUS_LEN)-1)<<DMA_RAWINTTCSTATUS_POS))
...
#define DMA_RAWINTERRORSTATUS_MSK                               (((1ULL<<DMA_RAWINTERRORSTATUS_LEN)-1)<<DMA_RAWINTERRORSTATUS_POS)
#define DMA_RAWINTERRORSTATUS_UMSK                              (~(((1ULL<<DMA_RAWINTERRORSTATUS_LEN)-1)<<DMA_RAWINTERRORSTATUS_POS))
...
#define DMA_ENABLEDCHANNELS_MSK                                 (((1ULL<<DMA_ENABLEDCHANNELS_LEN)-1)<<DMA_ENABLEDCHANNELS_POS)
#define DMA_ENABLEDCHANNELS_UMSK                                (~(((1ULL<<DMA_ENABLEDCHANNELS_LEN)-1)<<DMA_ENABLEDCHANNELS_POS))
...
#define DMA_SOFTBREQ_MSK                                        (((1ULL<<DMA_SOFTBREQ_LEN)-1)<<DMA_SOFTBREQ_POS)
#define DMA_SOFTBREQ_UMSK                                       (~(((1ULL<<DMA_SOFTBREQ_LEN)-1)<<DMA_SOFTBREQ_POS))
...
#define DMA_SOFTSREQ_MSK                                        (((1ULL<<DMA_SOFTSREQ_LEN)-1)<<DMA_SOFTSREQ_POS)
#define DMA_SOFTSREQ_UMSK                                       (~(((1ULL<<DMA_SOFTSREQ_LEN)-1)<<DMA_SOFTSREQ_POS))
...
#define DMA_SOFTLBREQ_MSK                                       (((1ULL<<DMA_SOFTLBREQ_LEN)-1)<<DMA_SOFTLBREQ_POS)
#define DMA_SOFTLBREQ_UMSK                                      (~(((1ULL<<DMA_SOFTLBREQ_LEN)-1)<<DMA_SOFTLBREQ_POS))
...
#define DMA_SOFTLSREQ_MSK                                       (((1ULL<<DMA_SOFTLSREQ_LEN)-1)<<DMA_SOFTLSREQ_POS)
#define DMA_SOFTLSREQ_UMSK                                      (~(((1ULL<<DMA_SOFTLSREQ_LEN)-1)<<DMA_SOFTLSREQ_POS))
...
#define DMA_E_POS                                               (0U)
#define DMA_E_LEN                                               (1U)
#define DMA_E_MSK                                               (((1ULL<<DMA_E_LEN)-1)<<DMA_E_POS)
#define DMA_E_UMSK                                              (~(((1ULL<<DMA_E_LEN)-1)<<DMA_E_POS))
#define DMA_M                                                   DMA_M
#define DMA_M_POS                                               (1U)
#define DMA_M_LEN                                               (1U)
#define DMA_M_MSK                                               (((1ULL<<DMA_M_LEN)-1)<<DMA_M_POS)
#define DMA_M_UMSK                                              (~(((1ULL<<DMA_M_LEN)-1)<<DMA_M_POS))
...
#define DMA_SYNC_MSK                                            (((1ULL<<DMA_SYNC_LEN)-1)<<DMA_SYNC_POS)
#define DMA_SYNC_UMSK                                           (~(((1ULL<<DMA_SYNC_LEN)-1)<<DMA_SYNC_POS))
...
#define DMA_SRCADDR_MSK                                         (((1ULL<<DMA_SRCADDR_LEN)-1)<<DMA_SRCADDR_POS)
#define DMA_SRCADDR_UMSK                                        (~(((1ULL<<DMA_SRCADDR_LEN)-1)<<DMA_SRCADDR_POS))
...
#define DMA_DSTADDR_MSK                                         (((1ULL<<DMA_DSTADDR_LEN)-1)<<DMA_DSTADDR_POS)
#define DMA_DSTADDR_UMSK                                        (~(((1ULL<<DMA_DSTADDR_LEN)-1)<<DMA_DSTADDR_POS))
...
#define DMA_LLI_MSK                                             (((1ULL<<DMA_LLI_LEN)-1)<<DMA_LLI_POS)
#define DMA_LLI_UMSK                                            (~(((1ULL<<DMA_LLI_LEN)-1)<<DMA_LLI_POS))
...
#define DMA_TRANSFERSIZE_MSK                                    (((1ULL<<DMA_TRANSFERSIZE_LEN)-1)<<DMA_TRANSFERSIZE_POS)
#define DMA_TRANSFERSIZE_UMSK                                   (~(((1ULL<<DMA_TRANSFERSIZE_LEN)-1)<<DMA_TRANSFERSIZE_POS))
#define DMA_SBSIZE                                              DMA_SBSIZE
#define DMA_SBSIZE_POS                                          (12U)
#define DMA_SBSIZE_LEN                                          (2U)
#define DMA_SBSIZE_MSK                                          (((1ULL<<DMA_SBSIZE_LEN)-1)<<DMA_SBSIZE_POS)
#define DMA_SBSIZE_UMSK                                         (~(((1ULL<<DMA_SBSIZE_LEN)-1)<<DMA_SBSIZE_POS))
#define DMA_DST_MIN_MODE                                        DMA_DST_MIN_MODE
#define DMA_DST_MIN_MODE_POS                                    (14U)
#define DMA_DST_MIN_MODE_LEN                                    (1U)
#define DMA_DST_MIN_MODE_MSK                                    (((1ULL<<DMA_DST_MIN_MODE_LEN)-1)<<DMA_DST_MIN_MODE_POS)
#define DMA_DST_MIN_MODE_UMSK                                   (~(((1ULL<<DMA_DST_MIN_MODE_LEN)-1)<<DMA_DST_MIN_MODE_POS))
#define DMA_DBSIZE                                              DMA_DBSIZE
#define DMA_DBSIZE_POS                                          (15U)
#define DMA_DBSIZE_LEN                                          (2U)
#define DMA_DBSIZE_MSK                                          (((1ULL<<DMA_DBSIZE_LEN)-1)<<DMA_DBSIZE_POS)
#define DMA_DBSIZE_UMSK                                         (~(((1ULL<<DMA_DBSIZE_LEN)-1)<<DMA_DBSIZE_POS))
#define DMA_DST_ADD_MODE                                        DMA_DST_ADD_MODE
#define DMA_DST_ADD_MODE_POS                                    (17U)
#define DMA_DST_ADD_MODE_LEN                                    (1U)
#define DMA_DST_ADD_MODE_MSK                                    (((1ULL<<DMA_DST_ADD_MODE_LEN)-1)<<DMA_DST_ADD_MODE_POS)
#define DMA_DST_ADD_MODE_UMSK                                   (~(((1ULL<<DMA_DST_ADD_MODE_LEN)-1)<<DMA_DST_ADD_MODE_POS))
#define DMA_SWIDTH                                              DMA_SWIDTH
#define DMA_SWIDTH_POS                                          (18U)
#define DMA_SWIDTH_LEN                                          (2U)
#define DMA_SWIDTH_MSK                                          (((1ULL<<DMA_SWIDTH_LEN)-1)<<DMA_SWIDTH_POS)
#define DMA_SWIDTH_UMSK                                         (~(((1ULL<<DMA_SWIDTH_LEN)-1)<<DMA_SWIDTH_POS))
#define DMA_DWIDTH                                              DMA_DWIDTH
#define DMA_DWIDTH_POS                                          (21U)
#define DMA_DWIDTH_LEN                                          (2U)
#define DMA_DWIDTH_MSK                                          (((1ULL<<DMA_DWIDTH_LEN)-1)<<DMA_DWIDTH_POS)
#define DMA_DWIDTH_UMSK                                         (~(((1ULL<<DMA_DWIDTH_LEN)-1)<<DMA_DWIDTH_POS))
#define DMA_FIX_CNT                                             DMA_FIX_CNT
#define DMA_FIX_CNT_POS                                         (23U)
#define DMA_FIX_CNT_LEN                                         (3U)
#define DMA_FIX_CNT_MSK                                         (((1ULL<<DMA_FIX_CNT_LEN)-1)<<DMA_FIX_CNT_POS)
#define DMA_FIX_CNT_UMSK                                        (~(((1ULL<<DMA_FIX_CNT_LEN)-1)<<DMA_FIX_CNT_POS))
#define DMA_SI                                                  DMA_SI
#define DMA_SI_POS                                              (26U)
#define DMA_SI_LEN                                              (1U)
#define DMA_SI_MSK                                              (((1ULL<<DMA_SI_LEN)-1)<<DMA_SI_POS)
#define DMA_SI_UMSK                                             (~(((1ULL<<DMA_SI_LEN)-1)<<DMA_SI_POS))
#define DMA_DI                                                  DMA_DI
#define DMA_DI_POS                                              (27U)
#define DMA_DI_LEN                                              (1U)
#define DMA_DI_MSK                                              (((1ULL<<DMA_DI_LEN)-1)<<DMA_DI_POS)
#define DMA_DI_UMSK                                             (~(((1ULL<<DMA_DI_LEN)-1)<<DMA_DI_POS))
#define DMA_PROT                                                DMA_PROT
#define DMA_PROT_POS                                            (28U)
#define DMA_PROT_LEN                                            (3U)
#define DMA_PROT_MSK                                            (((1ULL<<DMA_PROT_LEN)-1)<<DMA_PROT_POS)
#define DMA_PROT_UMSK                                           (~(((1ULL<<DMA_PROT_LEN)-1)<<DMA_PROT_POS))
#define DMA_I                                                   DMA_I
#define DMA_I_POS                                               (31U)
#define DMA_I_LEN                                               (1U)
#define DMA_I_MSK                                               (((1ULL<<DMA_I_LEN)-1)<<DMA_I_POS)
#define DMA_I_UMSK                                              (~(((1ULL<<DMA_I_LEN)-1)<<DMA_I_POS))
...
#define DMA_SRCPERIPHERAL_MSK                                   (((1ULL<<DMA_SRCPERIPHERAL_LEN)-1)<<DMA_SRCPERIPHERAL_POS)
#define DMA_SRCPERIPHERAL_UMSK                                  (~(((1ULL<<DMA_SRCPERIPHERAL_LEN)-1)<<DMA_SRCPERIPHERAL_POS))
#define DMA_DSTPERIPHERAL                                       DMA_DSTPERIPHERAL
#define DMA_DSTPERIPHERAL_POS                                   (6U)
#define DMA_DSTPERIPHERAL_LEN                                   (5U)
#define DMA_DSTPERIPHERAL_MSK                                   (((1ULL<<DMA_DSTPERIPHERAL_LEN)-1)<<DMA_DSTPERIPHERAL_POS)
#define DMA_DSTPERIPHERAL_UMSK                                  (~(((1ULL<<DMA_DSTPERIPHERAL_LEN)-1)<<DMA_DSTPERIPHERAL_POS))
#define DMA_FLOWCNTRL                                           DMA_FLOWCNTRL
#define DMA_FLOWCNTRL_POS                                       (11U)
#define DMA_FLOWCNTRL_LEN                                       (3U)
#define DMA_FLOWCNTRL_MSK                                       (((1ULL<<DMA_FLOWCNTRL_LEN)-1)<<DMA_FLOWCNTRL_POS)
#define DMA_FLOWCNTRL_UMSK                                      (~(((1ULL<<DMA_FLOWCNTRL_LEN)-1)<<DMA_FLOWCNTRL_POS))
#define DMA_IE                                                  DMA_IE
#define DMA_IE_POS                                              (14U)
#define DMA_IE_LEN                                              (1U)
#define DMA_IE_MSK                                              (((1ULL<<DMA_IE_LEN)-1)<<DMA_IE_POS)
#define DMA_IE_UMSK                                             (~(((1ULL<<DMA_IE_LEN)-1)<<DMA_IE_POS))
#define DMA_ITC                                                 DMA_ITC
#define DMA_ITC_POS                                             (15U)
#define DMA_ITC_LEN                                             (1U)
#define DMA_ITC_MSK                                             (((1ULL<<DMA_ITC_LEN)-1)<<DMA_ITC_POS)
#define DMA_ITC_UMSK                                            (~(((1ULL<<DMA_ITC_LEN)-1)<<DMA_ITC_POS))
#define DMA_L                                                   DMA_L
#define DMA_L_POS                                               (16U)
#define DMA_L_LEN                                               (1U)
#define DMA_L_MSK                                               (((1ULL<<DMA_L_LEN)-1)<<DMA_L_POS)
#define DMA_L_UMSK                                              (~(((1ULL<<DMA_L_LEN)-1)<<DMA_L_POS))
#define DMA_A                                                   DMA_A
#define DMA_A_POS                                               (17U)
#define DMA_A_LEN                                               (1U)
#define DMA_A_MSK                                               (((1ULL<<DMA_A_LEN)-1)<<DMA_A_POS)
#define DMA_A_UMSK                                              (~(((1ULL<<DMA_A_LEN)-1)<<DMA_A_POS))
#define DMA_H                                                   DMA_H
#define DMA_H_POS                                               (18U)
#define DMA_H_LEN                                               (1U)
#define DMA_H_MSK                                               (((1ULL<<DMA_H_LEN)-1)<<DMA_H_POS)
#define DMA_H_UMSK                                              (~(((1ULL<<DMA_H_LEN)-1)<<DMA_H_POS))
#define DMA_LLICOUNTER                                          DMA_LLICOUNTER
#define DMA_LLICOUNTER_POS                                      (20U)
#define DMA_LLICOUNTER_LEN                                      (10U)
#define DMA_LLICOUNTER_MSK                                      (((1ULL<<DMA_LLICOUNTER_LEN)-1)<<DMA_LLICOUNTER_POS)
#define DMA_LLICOUNTER_UMSK                                     (~(((1ULL<<DMA_LLICOUNTER_LEN)-1)<<DMA_LLICOUNTER_POS))
...
#define DMA_DSTREMNSGLE_MSK                                     (((1ULL<<DMA_DSTREMNSGLE_LEN)-1)<<DMA_DSTREMNSGLE_POS)
#define DMA_DSTREMNSGLE_UMSK                                    (~(((1ULL<<DMA_DSTREMNSGLE_LEN)-1)<<DMA_DSTREMNSGLE_POS))
#define DMA_SRCREMNSGLE                                         DMA_SRCREMNSGLE
#define DMA_SRCREMNSGLE_POS                                     (4U)
#define DMA_SRCREMNSGLE_LEN                                     (1U)
#define DMA_SRCREMNSGLE_MSK                                     (((1ULL<<DMA_SRCREMNSGLE_LEN)-1)<<DMA_SRCREMNSGLE_POS)
#define DMA_SRCREMNSGLE_UMSK                                    (~(((1ULL<<DMA_SRCREMNSGLE_LEN)-1)<<DMA_SRCREMNSGLE_POS))
