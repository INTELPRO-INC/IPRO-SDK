...
#define PDS_GPIO_INT_SET_1_GPIO0_GPIO7      (0)
#define PDS_GPIO_INT_SET_2_GPIO8_GPIO15     (1)
#define PDS_GPIO_INT_SET_3_GPIO20_GPIO27    (2)
#define PDS_GPIO_INT_SET_4_GPIO28_GPIO34    (3)

#define PDS_GPIO_GROUP_SET_GPIO0_GPIO15     (0)
#define PDS_GPIO_GROUP_SET_GPIO20_GPIO36    (1)

#define PDS_GPIO_INT_SYNC_FALLING_EDGE              (0)
#define PDS_GPIO_INT_SYNC_RISING_EDGE               (1)
//#define PDS_GPIO_INT_SYNC_LOW_LEVEL                 (2)
#define PDS_GPIO_INT_SYNC_HIGH_LEVEL                (3)
//#define PDS_GPIO_INT_SYNC_RISING_FALLING_EDGE       (4)
#define PDS_GPIO_INT_ASYNC_FALLING_EDGE             (8)
#define PDS_GPIO_INT_ASYNC_RISING_EDGE              (9)
//#define PDS_GPIO_INT_ASYNC_LOW_LEVEL                (10)
#define PDS_GPIO_INT_ASYNC_HIGH_LEVEL               (11)
...
/* PDS wakeup trigger sources. Value = bit index within the PDS_INT
 * cr_pds_wakeup_src_en field (base bit PDS_CR_PDS_WAKEUP_SRC_EN_POS = 10).
 * Ordering matches the silicon: [10] pds timer, [11] hbn_irq_out (RTC/AON),
 * [12] glb gpio_irq, [13] pds_gpio_int, [17] usbh_wkp, [18] usbh_conn. */
typedef enum {
    PDS_WAKEUP_SRC_PDS_TIMER   = 0, /*!< wakeup by pds_sleep_cnt == 0 */
    PDS_WAKEUP_SRC_HBN_IRQ_OUT = 1, /*!< wakeup by hbn_irq_out[1:0] (RTC/AON) */
    PDS_WAKEUP_SRC_GLB_GPIO_IRQ = 2, /*!< wakeup by glb gpio_irq */
    PDS_WAKEUP_SRC_PDS_GPIO_INT = 3, /*!< wakeup by pds_gpio_int */
    PDS_WAKEUP_SRC_IRRX_INT     = 4, /*!< wakeup by irrx_int */
    PDS_WAKEUP_SRC_WIFI_WKP     = 5, /*!< wakeup by wifi wakeup event */
    PDS_WAKEUP_SRC_DM_SLP_IRQ   = 6, /*!< wakeup by dm_slp_irq */
    PDS_WAKEUP_SRC_USBH_WKP_DET = 7, /*!< wakeup by usbh_wkp_det_n */
    PDS_WAKEUP_SRC_USBH_CONN_DET = 8, /*!< wakeup by usbh_conn_det_n */
    PDS_WAKEUP_SRC_WIFI_TBTT    = 9, /*!< wakeup by wifi_tbtt event */
} PDS_WAKEUP_SRC_Type;
...
#define PDS_INT_WAKEUP              (0)
#define PDS_INT_RF_DONE             (1)
#define PDS_INT_WIFI_TBTT_SLEEP     (2)
#define PDS_INT_WIFI_TBTT_WAKEUP    (3)
#define PDS_INT_MAX                 (4)
...
int PDS_RAM_Config(PDS_CTRL_RAM1_Type *ram1Cfg, PDS_CTRL_RAM2_Type *ram2Cfg,
...
/*----------*/
int PDS_Wakeup_Src_En(PDS_WAKEUP_SRC_Type src, int enable);
