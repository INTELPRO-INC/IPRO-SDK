...
#define SDH_EnableIntStatus(mask)                                             \
    do {                                                                      \
        writel(\
                  readl(SDH_BASE + SDH_SD_NORMAL_INT_STATUS_EN_OFFSET) | (mask), SDH_BASE + SDH_SD_NORMAL_INT_STATUS_EN_OFFSET); \
    } while (0)
...
#define SDH_EnableIntSource(mask)                                                 \
    do {                                                                          \
        writel(\
                  readl(SDH_BASE + SDH_SD_NORMAL_INT_STATUS_INT_EN_OFFSET) | (mask), SDH_BASE + SDH_SD_NORMAL_INT_STATUS_INT_EN_OFFSET); \
    } while (0)
...
#define SDH_GetIntStatus()       readl(SDH_BASE + SDH_SD_NORMAL_INT_STATUS_OFFSET);
#define SDH_GetIntEnableStatus() readl(SDH_BASE + SDH_SD_NORMAL_INT_STATUS_INT_EN_OFFSET);
#define SDH_ClearIntStatus(mask) writel((mask), SDH_BASE + SDH_SD_NORMAL_INT_STATUS_OFFSET);
