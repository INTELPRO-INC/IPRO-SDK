...
#ifndef __DRV_ISO11898_H__
#define __DRV_ISO11898_H__
...
#define IS_ISO11898_STATUS_VALUE_TYPE(type)              (((type) == ISO11898_STATUS_RECEIVE_BUFFER_EMPTY || \
                                                          ((type) == ISO11898_STATUS_RECEIVE_BUFFER_NONEMPTY || \
                                                          ((type) == ISO11898_STATUS_DATA_OVERRUN_NULL || \
                                                          ((type) == ISO11898_STATUS_DATA_OVERRUN_EXIST || \
                                                          ((type) == ISO11898_STATUS_TRANSMIT_BUFFER_LOCKED || \
                                                          ((type) == ISO11898_STATUS_TRANSMIT_BUFFER_ACCESSIBLE || \
                                                          ((type) == ISO11898_STATUS_TRANSMISSION_COMPLETE_NOT || \
                                                          ((type) == ISO11898_STATUS_TRANSMISSION_COMPLETE_YES || \
                                                          ((type) == ISO11898_STATUS_RECEIVE_IDLE || \
                                                          ((type) == ISO11898_STATUS_RECEIVE_ONGOING || \
                                                          ((type) == ISO11898_STATUS_TRANSMIT_IDLE || \
                                                          ((type) == ISO11898_STATUS_TRANSMIT_ONGOING || \
                                                          ((type) == ISO11898_STATUS_ERROR_NULL || \
                                                          ((type) == ISO11898_STATUS_ERROR_EXIST || \
                                                          ((type) == ISO11898_STATUS_BUS_ON || \
                                                          ((type) == ISO11898_STATUS_BUS_OFF))
