...
/**
 * \defgroup NMSIS_Core_DSP_Intrinsic_IPRO_Default      Default SIMD DSP Additional Instructions
 * \ingroup  NMSIS_Core_DSP_Intrinsic
 * \brief    (RV32 & RV64)Customized DSP Instructions
 * \details  This is customized DSP instructions for both RV32 and RV64
 */

/* ===== Inline Function Start for EXPD80 ===== */
/**
 * \ingroup  NMSIS_Core_DSP_Intrinsic_IPRO_Default
...
/* XXXXX Extended DSP Instructions for RV32 XXXXX */

/**
 * \defgroup NMSIS_Core_DSP_Intrinsic_IPRO_N1      N1 SIMD DSP Additional Instructions
 * \ingroup  NMSIS_Core_DSP_Intrinsic
 * \brief    (RV32 only)Customized N1 DSP Instructions
 * \details  This is customized DSP N1 instructions only for RV32
 */
/**
 * \defgroup NMSIS_Core_DSP_Intrinsic_IPRO_N2      N2 SIMD DSP Additional Instructions
 * \ingroup  NMSIS_Core_DSP_Intrinsic
 * \brief    (RV32 only)Customized N2 DSP Instructions
 * \details  This is customized DSP N2 instructions only for RV32
 */
/**
 * \defgroup NMSIS_Core_DSP_Intrinsic_IPRO_N3      N3 SIMD DSP Additional Instructions
 * \ingroup  NMSIS_Core_DSP_Intrinsic
 * \brief    (RV32 only)Customized N3 DSP Instructions
 * \details  This is customized DSP N3 instructions only for RV32
 */

/* ===== Inline Function Start for DKHM8 ===== */
/**
 * \ingroup  NMSIS_Core_DSP_Intrinsic_IPRO_N1
...
/**
 * \ingroup  NMSIS_Core_DSP_Intrinsic_IPRO_N2
...
/**
 * \ingroup  NMSIS_Core_DSP_Intrinsic_IPRO_N3
...
// For now, the P-extention version of IAR IDE is 0.5.0, but ours supports 0.5.4
// so supplies a workround to add custom instructions of those not natively
// supported by the IAR Assembler. Note that __RV_BPICK remains to be implemented in future.
// And we only implement Xxldsp custom instruction set, bpick not implemented, expdxx
