 ...
 * @{
 */
/* The following macro __IPRO_N_REV/__IPRO_NX_REV/
 * __IPRO_CPU_REV/__IPRO_CPU_SERIES definition in this file
...
/**
 * \brief core revision number
 * \details
 * Reversion number format: [15:8] revision number, [7:0] patch number
 * \attention
 * Deprecated, this define is exclusive with \ref __IPRO_NX_REV
 */
#define __IPRO_N_REV                   (0x0309)
/**
 * \brief core revision number
 * \details
 * Reversion number format: [15:8] revision number, [7:0] patch number
 * \attention
 * Deprecated, this define is exclusive with \ref __IPRO_N_REV
 */
#define __IPRO_NX_REV                  (0x0207)
/**
 * \brief CPU core revision number
 * \details
 *  CPU Revision Number vX.Y.Z, eg. v3.10.1
 * \attention
 * This define is exclusive with \ref __IPRO_CPU_SERIES
 */
#define __IPRO_CPU_REV                 (0x030A01)
/**
 * \brief CPU core series
 * \details
 * RISC-V CPU Series Number, eg, 0x200, 0x300, 0x600, 0x900
 * for 200, 300, 600, 900 series.
 * \attention
 * This define is used together with \ref __IPRO_CPU_REV
 */
#define __IPRO_CPU_SERIES              (0x0200)
