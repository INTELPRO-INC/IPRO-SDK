...
#define DRV_SF1_SWAP_NONE           0
#define DRV_SF1_SWAP_CS_IO2         1
#define DRV_SF1_SWAP_IO0_IO3        2
#define DRV_SF1_SWAP_BOTH           3

typedef enum {
    SF_CTRL_SEL_EXTERNAL_FLASH_SF2,                 /*!< SF Ctrl pad select sf2, flash use GPIO 22-27, external flash */
    SF_CTRL_SEL_EXTERNAL_FLASH_SF3,                 /*!< SF Ctrl pad select sf3, flash use GPIO 28-33, external flash */
...
typedef enum {
    ...
    SF_CTRL_PAD_SEL_SF3, /*!< SF Ctrl pad 3 */
} SF_Ctrl_Pad_Select;
...
typedef struct
{
    ...
    uint8_t psramRxClkInvertSrc; /*!< Select psram rx clock invert source */
    uint8_t psramRxClkInvertSel; /*!< Select inveted psram rx clock */
    uint8_t psramDelaySrc;       /*!< Select psram read delay source */
