...
{                                                                                                                  \
        writel(reg_set_bits(readl(TIMER_BASE + TIMER_WFAR_OFFSET), TIMER_WFAR, 0xBABA), TIMER_BASE + TIMER_WFAR_OFFSET); \
        writel(reg_set_bits(readl(TIMER_BASE + TIMER_WSAR_OFFSET), TIMER_WSAR, 0xEB10), TIMER_BASE + TIMER_WSAR_OFFSET); \
}
