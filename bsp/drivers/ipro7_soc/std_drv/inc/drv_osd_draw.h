...
#ifndef __DRV_OSD_DRAW_H__
#define __DRV_OSD_DRAW_H__
...
#define OSD_A_DRAW_LAYER_L ((osd_draw_reg_t *)(OSD_DRAW_BASE))
...
#define OSD_MAX_LAYER      (8)
#define OSD_ALL_LAYER      (-1)
#define OSD_VALID_LAYER(l) ((l)&0x07)
    uint32_t layer;
