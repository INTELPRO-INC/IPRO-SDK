...
#define SPIFLASH_BLK32K_SIZE (32 * 1024)
#define SPIFLASH_BLK64K_SIZE (64 * 1024)
#define SPIFLASH_CMD_INVALID 0xff
...
int SFlash_IDbus_Read_Enable(SPI_Flash_Cfg_Type *flashCfg, uint8_t ioMode, uint8_t contRead,
                                     uint8_t bank);
int SFlash_Cache_Read_Enable(SPI_Flash_Cfg_Type *flashCfg, SF_Ctrl_IO_Type ioMode, uint8_t contRead,
                                     uint8_t wayDisable);
int SFlash_Restore_From_Powerdown(SPI_Flash_Cfg_Type *pFlashCfg, uint8_t flashContRead);
int SFlash_Read(SPI_Flash_Cfg_Type *flashCfg, SF_Ctrl_IO_Type ioMode, uint8_t contRead, uint32_t addr, uint8_t *data,
                        uint32_t len);
