...
void I2S_Init(I2S_ID_Type i2sId, I2S_CFG_Type *i2sCfg)
{
    ...
    switch (i2sCfg->fsChannel) {
        case I2S_FS_CHANNELS_2:
            tmpVal = reg_clr_bit(tmpVal, I2S_CR_FS_3CH_MODE);
            tmpVal = reg_clr_bit(tmpVal, I2S_CR_FS_4CH_MODE);
            break;

        case I2S_FS_CHANNELS_3:
            tmpVal = reg_set_bit(tmpVal, I2S_CR_FS_3CH_MODE);
            tmpVal = reg_clr_bit(tmpVal, I2S_CR_FS_4CH_MODE);
            break;

        case I2S_FS_CHANNELS_4:
            tmpVal = reg_clr_bit(tmpVal, I2S_CR_FS_3CH_MODE);
            tmpVal = reg_set_bit(tmpVal, I2S_CR_FS_4CH_MODE);
            break;
