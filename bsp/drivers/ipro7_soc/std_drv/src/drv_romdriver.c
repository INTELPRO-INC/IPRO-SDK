...
uint32_t const romDriverTable[]={
    ...
    [ROM_API_INDEX_Clock_Peripheral_Clock_Get_Flash]       = (uint32_t)Clock_Peripheral_Clock_Get_Flash,
    ...
    [ROM_API_INDEX_GLB_Switch_System_CLK]                  = (uint32_t)GLB_Switch_System_CLK,
    ...
    [ROM_API_INDEX_GLB_Set_USB_CLK]                        = (uint32_t)GLB_Set_USB_CLK,
    [ROM_API_INDEX_GLB_Set_QDEC_CLK]                       = (uint32_t)GLB_Set_QDEC_CLK,
    ...
    [ROM_API_INDEX_GLB_Set_Chip_Out_2_CLK_Sel]             = (uint32_t)GLB_Set_Chip_Out_2_CLK_Sel,
    [ROM_API_INDEX_GLB_Set_I2C_CLK]                        = (uint32_t)GLB_Set_I2C_CLK,
    [ROM_API_INDEX_GLB_Invert_ETH_RX_CLK]                  = (uint32_t)GLB_Invert_ETH_RX_CLK,
    [ROM_API_INDEX_GLB_Invert_RF_TEST_O_CLK]               = (uint32_t)GLB_Invert_RF_TEST_O_CLK,
    ...
    [ROM_API_INDEX_GLB_Set_IPROAISram]                       = (uint32_t)GLB_Set_IPROAISram,
    ...
    [ROM_API_INDEX_GLB_Select_RC32M_As_PLL_Ref]            = (uint32_t)GLB_Select_RC32M_As_PLL_Ref,
    [ROM_API_INDEX_GLB_Select_XTAL_As_PLL_Ref]             = (uint32_t)GLB_Select_XTAL_As_PLL_Ref,
    [ROM_API_INDEX_GLB_Power_On_PLL]                       = (uint32_t)GLB_Power_On_PLL,
    [ROM_API_INDEX_GLB_Enable_PLL_All_Clks]                = (uint32_t)GLB_Enable_PLL_All_Clks,
    [ROM_API_INDEX_GLB_Disable_PLL_All_Clks]               = (uint32_t)GLB_Disable_PLL_All_Clks,
    [ROM_API_INDEX_GLB_Enable_PLL_Clk]                     = (uint32_t)GLB_Enable_PLL_Clk,
    [ROM_API_INDEX_GLB_Disable_PLL_Clk]                    = (uint32_t)GLB_Disable_PLL_Clk,
    [ROM_API_INDEX_GLB_Power_Off_PLL]                      = (uint32_t)GLB_Power_Off_PLL,
    [ROM_API_INDEX_GLB_Set_Audio_PLL_Freq]                 = (uint32_t)GLB_Set_Audio_PLL_Freq,
    ...
    [ROM_API_INDEX_GLB_SetUnLockReq]                       = (uint32_t)GLB_SetUnLockReq,
    ...
    [ROM_API_INDEX_GLB_Set_Flash_Pad_HZ]                   = (uint32_t)GLB_Set_Flash_Pad_HZ,
    [ROM_API_INDEX_GLB_Set_Psram_Pad_HZ]                   = (uint32_t)GLB_Set_Psram_Pad_HZ,
    [ROM_API_INDEX_GLB_GPIO_Get_Fun]                       = (uint32_t)GLB_GPIO_Get_Fun,
    [ROM_API_INDEX_GLB_GPIO_Write]                         = (uint32_t)GLB_GPIO_Write,
    [ROM_API_INDEX_GLB_GPIO_Toggle]                        = (uint32_t)GLB_GPIO_Toggle,
    [ROM_API_INDEX_GLB_GPIO_Read]                          = (uint32_t)GLB_GPIO_Read,
    [ROM_API_INDEX_GLB_GPIO_IntMask]                       = (uint32_t)GLB_GPIO_IntMask,
    [ROM_API_INDEX_GLB_GPIO_IntClear]                      = (uint32_t)GLB_GPIO_IntClear,
    [ROM_API_INDEX_GLB_Get_GPIO_IntStatus]                 = (uint32_t)GLB_Get_GPIO_IntStatus,
    [ROM_API_INDEX_GLB_Set_GPIO_IntMod]                    = (uint32_t)GLB_Set_GPIO_IntMod,
    [ROM_API_INDEX_GLB_Get_GPIO_IntCtlMod]                 = (uint32_t)GLB_Get_GPIO_IntCtlMod,
    [ROM_API_INDEX_GLB_GPIO_Int2Mask]                      = (uint32_t)GLB_GPIO_Int2Mask,
    [ROM_API_INDEX_GLB_GPIO_Int2Clear]                     = (uint32_t)GLB_GPIO_Int2Clear,
    [ROM_API_INDEX_GLB_Get_GPIO_Int2Status]                = (uint32_t)GLB_Get_GPIO_Int2Status,
    [ROM_API_INDEX_GLB_Set_GPIO_Int2Mod]                   = (uint32_t)GLB_Set_GPIO_Int2Mod,
    [ROM_API_INDEX_GLB_Get_GPIO_Int2CtlMod]                = (uint32_t)GLB_Get_GPIO_Int2CtlMod,
    ...
    [ROM_API_INDEX_HBN_Set_ROOT_CLK]                       = (uint32_t)HBN_Set_ROOT_CLK,
    [ROM_API_INDEX_HBN_Get_ROOT_CLK]                       = (uint32_t)HBN_Get_ROOT_CLK,
    ...
    [ROM_API_INDEX_SF_Ctrl_SetDelay]                       = (uint32_t)SF_Ctrl_SetDelay,
    ...
    [ROM_API_INDEX_UART_DmaEnable]                         = (uint32_t)UART_DmaEnable,
    [ROM_API_INDEX_UART_DmaDisable]                        = (uint32_t)UART_DmaDisable,
    ...
    [ROM_API_INDEX_IR_TxSWMPulseWidthConfig]               = (uint32_t)IR_TxSWMPulseWidthConfig,
    [ROM_API_INDEX_IR_RxInit]                              = (uint32_t)IR_RxInit,
    ...
    [ROM_API_INDEX_IR_RxFIFOClear]                         = (uint32_t)IR_RxFIFOClear,
    ...
    [ROM_API_INDEX_IR_GetRxFIFOStatus]                     = (uint32_t)IR_GetRxFIFOStatus,
    [ROM_API_INDEX_IR_ReceiveData]                         = (uint32_t)IR_ReceiveData,
    [ROM_API_INDEX_IR_SWMReceiveData]                      = (uint32_t)IR_SWMReceiveData,
    [ROM_API_INDEX_IR_ReceiveNEC]                          = (uint32_t)IR_ReceiveNEC,
    [ROM_API_INDEX_IR_GetRxDataBitCount]                   = (uint32_t)IR_GetRxDataBitCount,
    [ROM_API_INDEX_IR_GetRxFIFOCount]                      = (uint32_t)IR_GetRxFIFOCount,
    [ROM_API_INDEX_IR_LearnToInit]                         = (uint32_t)IR_LearnToInit,
    [ROM_API_INDEX_IR_LearnToReceive]                      = (uint32_t)IR_LearnToReceive,
    [ROM_API_INDEX_IR_LearnToSend]                         = (uint32_t)IR_LearnToSend,
    ...
    [ROM_API_INDEX_KYS_GetKeycode]                         = (uint32_t)KYS_GetKeycode,
    ...
    [ROM_API_INDEX_TIMER_SetPreloadSrc]                    = (uint32_t)TIMER_SetPreloadSrc,
    ...
    [ROM_API_INDEX_TIMER_SetDiv]                           = (uint32_t)TIMER_SetDiv,
    ...
    [ROM_API_INDEX_WDT_ClearInt]                           = (uint32_t)WDT_ClearInt,
    ...
    [ROM_API_INDEX_utils_crc16]                            = (uint32_t)utils_crc16,
    [ROM_API_INDEX_utils_crc32_accumulate]                 = (uint32_t)utils_crc32_accumulate,
    [ROM_API_INDEX_utils_crc32]                            = (uint32_t)utils_crc32,
    [ROM_API_INDEX_utils_crc32_stream_init]                = (uint32_t)utils_crc32_stream_init,
    [ROM_API_INDEX_utils_crc32_stream_feed]                = (uint32_t)utils_crc32_stream_feed,
    [ROM_API_INDEX_utils_crc32_stream_feed_block]          = (uint32_t)utils_crc32_stream_feed_block,
    [ROM_API_INDEX_utils_crc32_stream_results]             = (uint32_t)utils_crc32_stream_results,
    [ROM_API_INDEX_utils_crc16_ccitt]                      = (uint32_t)utils_crc16_ccitt,
