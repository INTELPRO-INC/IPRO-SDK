...
#define EF_CTRL_EF_IF_XTAL_TYPE                                 EF_CTRL_EF_IF_XTAL_TYPE
#define EF_CTRL_EF_IF_XTAL_TYPE_POS                             (0U)
#define EF_CTRL_EF_IF_XTAL_TYPE_LEN                             (3U)
#define EF_CTRL_EF_IF_XTAL_TYPE_MSK                             (((1U<<EF_CTRL_EF_IF_XTAL_TYPE_LEN)-1)<<EF_CTRL_EF_IF_XTAL_TYPE_POS)
#define EF_CTRL_EF_IF_XTAL_TYPE_UMSK                            (~(((1U<<EF_CTRL_EF_IF_XTAL_TYPE_LEN)-1)<<EF_CTRL_EF_IF_XTAL_TYPE_POS))
...
struct  ef_ctrl_reg {
    ...
    union {
        struct {
            uint32_t ef_if_xtal_type                :  3; /* [ 2: 0],        r/w,        0x0 */
