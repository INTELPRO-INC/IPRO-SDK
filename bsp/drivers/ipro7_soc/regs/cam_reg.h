...
#define CAM_CR_SW_SHD                                           CAM_CR_SW_SHD
#define CAM_CR_SW_SHD_POS                                       (16U)
#define CAM_CR_SW_SHD_LEN                                       (1U)
#define CAM_CR_SW_SHD_MSK                                       (((1U<<CAM_CR_SW_SHD_LEN)-1)<<CAM_CR_SW_SHD_POS)
#define CAM_CR_SW_SHD_UMSK                                      (~(((1U<<CAM_CR_SW_SHD_LEN)-1)<<CAM_CR_SW_SHD_POS))
...
/* 0x24 : dvp2axi_dmy_cfg0 */
#define CAM_DVP2AXI_DMY_CFG0_OFFSET                             (0x24)
#define CAM_REG_LEFT_BLK_DMY                                    CAM_REG_LEFT_BLK_DMY
#define CAM_REG_LEFT_BLK_DMY_POS                                (0U)
#define CAM_REG_LEFT_BLK_DMY_LEN                                (1U)
#define CAM_REG_LEFT_BLK_DMY_MSK                                (((1U<<CAM_REG_LEFT_BLK_DMY_LEN)-1)<<CAM_REG_LEFT_BLK_DMY_POS)
#define CAM_REG_LEFT_BLK_DMY_UMSK                               (~(((1U<<CAM_REG_LEFT_BLK_DMY_LEN)-1)<<CAM_REG_LEFT_BLK_DMY_POS))
#define CAM_REG_RIGHT_BLK_DMY                                   CAM_REG_RIGHT_BLK_DMY
#define CAM_REG_RIGHT_BLK_DMY_POS                               (1U)
#define CAM_REG_RIGHT_BLK_DMY_LEN                               (1U)
#define CAM_REG_RIGHT_BLK_DMY_MSK                               (((1U<<CAM_REG_RIGHT_BLK_DMY_LEN)-1)<<CAM_REG_RIGHT_BLK_DMY_POS)
#define CAM_REG_RIGHT_BLK_DMY_UMSK                              (~(((1U<<CAM_REG_RIGHT_BLK_DMY_LEN)-1)<<CAM_REG_RIGHT_BLK_DMY_POS))
#define CAM_REG_UP_BLK_DMY                                      CAM_REG_UP_BLK_DMY
#define CAM_REG_UP_BLK_DMY_POS                                  (2U)
#define CAM_REG_UP_BLK_DMY_LEN                                  (1U)
#define CAM_REG_UP_BLK_DMY_MSK                                  (((1U<<CAM_REG_UP_BLK_DMY_LEN)-1)<<CAM_REG_UP_BLK_DMY_POS)
#define CAM_REG_UP_BLK_DMY_UMSK                                 (~(((1U<<CAM_REG_UP_BLK_DMY_LEN)-1)<<CAM_REG_UP_BLK_DMY_POS))
#define CAM_REG_DOWN_BLK_DMY                                    CAM_REG_DOWN_BLK_DMY
#define CAM_REG_DOWN_BLK_DMY_POS                                (3U)
#define CAM_REG_DOWN_BLK_DMY_LEN                                (1U)
#define CAM_REG_DOWN_BLK_DMY_MSK                                (((1U<<CAM_REG_DOWN_BLK_DMY_LEN)-1)<<CAM_REG_DOWN_BLK_DMY_POS)
#define CAM_REG_DOWN_BLK_DMY_UMSK                               (~(((1U<<CAM_REG_DOWN_BLK_DMY_LEN)-1)<<CAM_REG_DOWN_BLK_DMY_POS))
#define CAM_REG_VERTICAL_DMY8                                   CAM_REG_VERTICAL_DMY8
#define CAM_REG_VERTICAL_DMY8_POS                               (4U)
#define CAM_REG_VERTICAL_DMY8_LEN                               (1U)
#define CAM_REG_VERTICAL_DMY8_MSK                               (((1U<<CAM_REG_VERTICAL_DMY8_LEN)-1)<<CAM_REG_VERTICAL_DMY8_POS)
#define CAM_REG_VERTICAL_DMY8_UMSK                              (~(((1U<<CAM_REG_VERTICAL_DMY8_LEN)-1)<<CAM_REG_VERTICAL_DMY8_POS))

/* 0x28 : dvp2axi_dmy_cfg1 */
#define CAM_DVP2AXI_DMY_CFG1_OFFSET                             (0x28)
#define CAM_REG_VER_DMY_BURST_CNT                               CAM_REG_VER_DMY_BURST_CNT
#define CAM_REG_VER_DMY_BURST_CNT_POS                           (0U)
#define CAM_REG_VER_DMY_BURST_CNT_LEN                           (16U)
#define CAM_REG_VER_DMY_BURST_CNT_MSK                           (((1U<<CAM_REG_VER_DMY_BURST_CNT_LEN)-1)<<CAM_REG_VER_DMY_BURST_CNT_POS)
#define CAM_REG_VER_DMY_BURST_CNT_UMSK                          (~(((1U<<CAM_REG_VER_DMY_BURST_CNT_LEN)-1)<<CAM_REG_VER_DMY_BURST_CNT_POS))
#define CAM_REG_UP_DMY_FEND_DELAY                               CAM_REG_UP_DMY_FEND_DELAY
#define CAM_REG_UP_DMY_FEND_DELAY_POS                           (16U)
#define CAM_REG_UP_DMY_FEND_DELAY_LEN                           (16U)
#define CAM_REG_UP_DMY_FEND_DELAY_MSK                           (((1U<<CAM_REG_UP_DMY_FEND_DELAY_LEN)-1)<<CAM_REG_UP_DMY_FEND_DELAY_POS)
#define CAM_REG_UP_DMY_FEND_DELAY_UMSK                          (~(((1U<<CAM_REG_UP_DMY_FEND_DELAY_LEN)-1)<<CAM_REG_UP_DMY_FEND_DELAY_POS))
...
struct  cam_reg {
    ...
    union {
        struct {
            uint32_t reg_left_blk_dmy               :  1; /* [    0],        r/w,        0x0 */
            uint32_t reg_right_blk_dmy              :  1; /* [    1],        r/w,        0x0 */
            uint32_t reg_up_blk_dmy                 :  1; /* [    2],        r/w,        0x0 */
            uint32_t reg_down_blk_dmy               :  1; /* [    3],        r/w,        0x0 */
            uint32_t reg_vertical_dmy8              :  1; /* [    4],        r/w,        0x0 */
            uint32_t reserved_5_31                  : 27; /* [31: 5],       rsvd,        0x0 */
        }BF;
        uint32_t WORD;
    } dvp2axi_dmy_cfg0;
    ...
    union {
        struct {
            uint32_t reg_ver_dmy_burst_cnt          : 16; /* [15: 0],        r/w,        0x0 */
            uint32_t reg_up_dmy_fend_delay          : 16; /* [31:16],        r/w,        0x0 */
        }BF;
        uint32_t WORD;
    } dvp2axi_dmy_cfg1;
