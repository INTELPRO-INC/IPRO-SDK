...
#define AON_EFUSE_AUTOLOAD_FAST_EN                              AON_EFUSE_AUTOLOAD_FAST_EN
#define AON_EFUSE_AUTOLOAD_FAST_EN_POS                          (31U)
#define AON_EFUSE_AUTOLOAD_FAST_EN_LEN                          (1U)
#define AON_EFUSE_AUTOLOAD_FAST_EN_MSK                          (((1U<<AON_EFUSE_AUTOLOAD_FAST_EN_LEN)-1)<<AON_EFUSE_AUTOLOAD_FAST_EN_POS)
#define AON_EFUSE_AUTOLOAD_FAST_EN_UMSK                         (~(((1U<<AON_EFUSE_AUTOLOAD_FAST_EN_LEN)-1)<<AON_EFUSE_AUTOLOAD_FAST_EN_POS))
...
/* 0x82C : rc32m_ctrl0_aon */
#define AON_RC32M_CTRL0_AON_OFFSET                              (0x82C)
#define AON_RC32M_CODE_FR_EXT                                   AON_RC32M_CODE_FR_EXT
#define AON_RC32M_CODE_FR_EXT_POS                               (0U)
...
struct  aon_reg {
    ...
    union {
        struct {
            ...
            uint32_t reserved_1_30                  : 30; /* [30: 1],       rsvd,        0x0 */
            uint32_t efuse_autoload_fast_en         :  1; /* [   31],        r/w,        0x0 */
        }BF;
        uint32_t WORD;
    } aon_misc;
    ...
    union {
        struct {
            uint32_t reserved_0                     :  1; /* [    0],       rsvd,        0x0 */
            uint32_t ldo14_ocp_th_aon               :  3; /* [ 3: 1],        r/w,        0x6 */
            ...
            uint32_t reserved_14_15                 :  2; /* [15:14],       rsvd,        0x0 */
            uint32_t ldo14_vout_sel_aon             :  3; /* [18:16],        r/w,        0x7 */
    ...
    union {
        struct {
            uint32_t rc32m_code_fr_ext              :  8; /* [ 7: 0],        r/w,       0x60 */
