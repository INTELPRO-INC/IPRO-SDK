...
#define PWM_MC1_INT_STS                                         PWM_MC1_INT_STS
#define PWM_MC1_INT_STS_POS                                     (1U)
#define PWM_MC1_INT_STS_LEN                                     (1U)
#define PWM_MC1_INT_STS_MSK                                     (((1U<<PWM_MC1_INT_STS_LEN)-1)<<PWM_MC1_INT_STS_POS)
#define PWM_MC1_INT_STS_UMSK                                    (~(((1U<<PWM_MC1_INT_STS_LEN)-1)<<PWM_MC1_INT_STS_POS))
#define PWM_MC0_INT_CLR                                         PWM_MC0_INT_CLR
#define PWM_MC0_INT_CLR_POS                                     (8U)
...
#define PWM_MC1_INT_CLR                                         PWM_MC1_INT_CLR
#define PWM_MC1_INT_CLR_POS                                     (9U)
#define PWM_MC1_INT_CLR_LEN                                     (1U)
#define PWM_MC1_INT_CLR_MSK                                     (((1U<<PWM_MC1_INT_CLR_LEN)-1)<<PWM_MC1_INT_CLR_POS)
#define PWM_MC1_INT_CLR_UMSK                                    (~(((1U<<PWM_MC1_INT_CLR_LEN)-1)<<PWM_MC1_INT_CLR_POS))
...
struct  pwm_reg {
    ...
    union {
        struct {
            uint32_t pwm_mc0_int_sts                :  1; /* [    0],          r,        0x0 */
            uint32_t pwm_mc1_int_sts                :  1; /* [    1],          r,        0x0 */
            uint32_t reserved_2_7                   :  6; /* [ 7: 2],       rsvd,        0x0 */
            uint32_t pwm_mc0_int_clr                :  1; /* [    8],        w1c,        0x0 */
            uint32_t pwm_mc1_int_clr                :  1; /* [    9],        w1c,        0x0 */
