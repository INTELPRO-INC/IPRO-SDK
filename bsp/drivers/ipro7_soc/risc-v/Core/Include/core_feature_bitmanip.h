 ...
 *
 * This intrinsic function support in compiler is introduced in riscv gcc 10.2.
 *
 * For GCC 13/Clang 17, this intrinsic header no longer existed, please take care.
 *
 *   @{
 */
