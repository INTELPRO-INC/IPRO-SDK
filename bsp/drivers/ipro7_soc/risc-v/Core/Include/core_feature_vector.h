 ...
 *
 * For RISC-V GCC 10.2, it is an very old and not ratified version(no longer supported).
 *
 * For RISC-V GCC 13/Clang 17, the intrinsic API supported is v0.12 version, see
