 ...
 * @{
 *
 * Cluster Interrupt Distribution Unit (CIDU) for scenarios that a SMP system is designed for real
 * time application or both Linux and real time application, and processor core can optionally support CIDU.
