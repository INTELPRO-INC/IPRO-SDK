...
#ifndef __DRV_PSRAM_CTRL_H__
#define __DRV_PSRAM_CTRL_H__
...
typedef struct
{
    int rst;                            /*!< Winbond pSRAM CR1 - Software Reset */
    PSRAM_Clock_Type clockType;                 /*!< Winbond pSRAM CR1 - Master Clock Type */
    int inputPowerDownMode;             /*!< Winbond pSRAM CR1 - Input Power Down */
    int linear_dis;                     /*!< Winbond pSRAM linear burst disable */
    int hybridSleepMode;                /*!< Winbond pSRAM CR1 - Hybrid Sleep Mode configuration */
    PSRAM_Partial_Array_Refresh PASR;           /*!< Winbond pSRAM CR1 - Partial Array Refresh + Distributed Refresh Interval */
    int disDeepPowerDownMode;           /*!< Winbond pSRAM CR0 - Deep Power-Down Disable configuration */
    int fixedLatency;                   /*!< Winbond pSRAM CR1 - Fix Latency configuration */
...
typedef struct
{
    int rst;                          /*!< AP Memory pSRAM configure global reset enable */
    int fixedLatency;                 /*!< AP Memory pSRAM configure MR0 - read latency type */
    ...
    int halfSleepModeEnable;          /*!< AP Memory pSRAM configure MR6 - Half Sleep enable */
    int deepPowerDownModeEnable;      /*!< AP Memory pSRAM configure MR6 - Deep Power Down enable */
    int crossBoundaryEnable;          /*!< AP Memory pSRAM configure MR8 - cross boundary enable 1'b0 - Read within 1K boundary 1'b1 -
...
int PSram_Ctrl_Winbond_Write_Reg(PSRAM_ID_Type PSRAM_ID, PSRAM_Ctrl_Winbond_Cfg_Reg_Type reg_addr,
...
int PSram_Ctrl_ApMem_Write_Reg(PSRAM_ID_Type PSRAM_ID, PSRAM_Ctrl_ApMem_Cfg_Reg_Type reg_addr,
