...
/**
 * @file ipro7_demo_qfn32_board_config.h
 * @brief Board configuration for the IPRO7 SEVB QFN32 demo board.
 *
 * QFN32 demo board (NOT the EVB). No PSRAM, no AI/NPU (smaller package).
 * Externally usable pins are the TB2 connector:
 *   TB2_1=GPIO0  TB2_2=GPIO1  TB2_3=GPIO2  TB2_4=GPIO11
 *   TB2_5=GPIO40 TB2_6=GPIO39 TB2_7=GPIO33 TB2_8=GPIO30
 *   TB2_9=GPIO29 TB2_10=GPIO28 TB2_11=GPIO31 TB2_12=GPIO32
 * UART console is GPIO20/21. The factory-reset button is on TB2_12 = GPIO32
 * (same connector position as the QFN56 board, which uses GPIO41).
 *
 * Selected by CONFIG_DEMO_QFN32 (see board_config.h). This board does NOT
 * select USE_PSRAM/AI — leave them off in the app .config.
 */

#ifndef __IPRO7_DEMO_QFN32_BOARD_CONFIG_H__
#define __IPRO7_DEMO_QFN32_BOARD_CONFIG_H__
...
/* Factory-reset button — TB2_12 = GPIO32, the same connector position as the
 * QFN56 board's reset button (QFN56 TB0_12 = GPIO41). QFN32 does not bond out
 * GPIO41, so this board uses GPIO32 (the UART1_RX_2 net) instead. Not a JTAG
 * pin, so it does not clash with SWD/JTAG debug. */
#define BOARD_FACTORY_RESET_GPIO    32u

/*==============================================================================
 * Pin Configuration Table
 *
 * Minimal: UART0 console (GPIO20/21) + JTAG (GPIO0/1/2/9).
 *============================================================================*/
...
#endif /* __IPRO7_DEMO_QFN32_BOARD_CONFIG_H__ */
