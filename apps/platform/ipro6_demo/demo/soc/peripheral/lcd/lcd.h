...
/* Select screen Type */
#define LCD_DBI_ILI9488 /*LCD_SPI_ST7796*/ /*LCD_SPI_ILI9341*/ /*LCD_SPI_ILI9488*/  /*LCD_DPI_ILI9488*/ /*LCD_DBI_ILI9488 */
...
#pragma message "mipi_dbi/ili9488_dbi.h  Used!!!"
...
typedef struct {
    ...
    uint16_t line_x2;
    uint16_t line_y2; 
    uint16_t thickness;     /*unit: pixel*/
    lcd_color_t color;      /*LCD_COLOR_RGB(XX, XX, XX)*/
}LCD_DRAW_IN_BUF_CFG;
...
int lcd_draw_area_nonblocking(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, lcd_color_t color);
