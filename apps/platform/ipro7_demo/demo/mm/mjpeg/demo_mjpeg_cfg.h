...
#define _ENCODE_TEST_SAMPLE_VERIFICATION_
    ...
    /******************************************************/
    //#define MJENC_TEST_CASE_001_1920x1080_YUV420SP_UV

    //#define MJENC_TEST_CASE_ID_1  /*checksum error, 1 byte diff*/
    //#define MJENC_TEST_CASE_ID_2  /*checksum error, 1 byte diff*/
    //#define MJENC_TEST_CASE_ID_3
    //#define MJENC_TEST_CASE_ID_4  /*checksum error, 1 byte diff*/
    //#define MJENC_TEST_CASE_ID_5
    //#define MJENC_TEST_CASE_ID_6  /*checksum error, 1 byte diff*/
    //#define MJENC_TEST_CASE_ID_7
    //#define MJENC_TEST_CASE_ID_8  /*checksum error, 1 byte diff*/
    //#define MJENC_TEST_CASE_ID_9  /*checksum error, 1 byte diff*/
    //#define MJENC_TEST_CASE_ID_10 /*checksum error, 1 byte diff*/
    //#define MJENC_TEST_CASE_ID_11
    //#define MJENC_TEST_CASE_ID_12
    //#define MJENC_TEST_CASE_ID_13
    //#define MJENC_TEST_CASE_ID_14
    //#define MJENC_TEST_CASE_ID_15
    //#define MJENC_TEST_CASE_ID_16
    //#define MJENC_TEST_CASE_ID_17 /*checksum error, 1 byte diff*/
    //#define MJENC_TEST_CASE_ID_18 /*checksum error, 1 byte diff*/
    //#define MJENC_TEST_CASE_ID_19 /*checksum error, 1 byte diff*/
    //#define MJENC_TEST_CASE_ID_20 /*checksum error, 1 byte diff*/
    //#define MJENC_TEST_CASE_ID_21
    //#define MJENC_TEST_CASE_ID_22
    //#define MJENC_TEST_CASE_ID_23 /*checksum error, 1 byte diff*/
    //#define MJENC_TEST_CASE_ID_24 /*checksum error, 1 byte diff*/
    //#define MJENC_TEST_CASE_ID_25 /*checksum error, 1 byte diff*/
    //#define MJENC_TEST_CASE_ID_26 /*checksum error, 1 byte diff*/
    //#define MJENC_TEST_CASE_ID_27 /*checksum error, 1 byte diff*/
    //#define MJENC_TEST_CASE_ID_28 /*checksum error, 1 byte diff*/
    //#define MJENC_TEST_CASE_ID_29 /*checksum error, 1 byte diff*/
    //#define MJENC_TEST_CASE_ID_30
    //#define MJENC_TEST_CASE_ID_31 /*checksum error, 1 byte diff*/
    //#define MJENC_TEST_CASE_ID_32
    //#define MJENC_TEST_CASE_ID_33 /*checksum error, 1 byte diff*/
    //#define MJENC_TEST_CASE_ID_34 /*checksum error, 1 byte diff*/
    //#define MJENC_TEST_CASE_ID_35 /*checksum error, 1 byte diff*/
    //#define MJENC_TEST_CASE_ID_36 /*checksum error, 1 byte diff*/
    //#define MJENC_TEST_CASE_ID_37 /*checksum error, 1 byte diff*/
    //#define MJENC_TEST_CASE_ID_38 /*checksum error, 1 byte diff*/
    //#define MJENC_TEST_CASE_ID_39 /*checksum error, 1 byte diff*/
    //#define MJENC_TEST_CASE_ID_40 /*checksum error, 1 byte diff*/

    /*case41-44 for tsrc2mjpeg tsrc read 1280x720 and flyby to mjpeg test*/
    ...
    #if defined(MJENC_TEST_CASE_001_1920x1080_YUV420SP_UV)
...
#if defined(MJENC_TEST_CASE_ID_22) || defined(MJENC_TEST_CASE_ID_24) 
    #define MJENC_TEST_YUV_BUF_SIZE                     ( 0x3F4800 )   /*for 1920x1080 422sp & need to load source before start HW to avoid changed due to heep allocation.*/
#elif defined(MJENC_TEST_CASE_ID_41) || defined(MJENC_TEST_CASE_ID_42) || defined(MJENC_TEST_CASE_ID_43) || defined(MJENC_TEST_CASE_ID_44)
    #define MJENC_TEST_YUV_BUF_SIZE                     ( 0x100000 )   /*got tsrc input ring, max line is 1920x32 for yuv420 Y.*/
#else
    #define MJENC_TEST_YUV_BUF_SIZE                     ( 0x300000 )   /*for 1920x1080 422sp & need to load source before start HW to avoid changed due to heep allocation.*/
#endif

#if defined(USE_OCRAM_FOR_INPUT_RING) && (defined(MJENC_TEST_CASE_ID_41) || defined(MJENC_TEST_CASE_ID_42) || defined(MJENC_TEST_CASE_ID_43) || defined(MJENC_TEST_CASE_ID_44))
#define MJENC_TEST_YUV_BUF_ADDR                     ( 0x11010000) /*OCRAM: (0x11010000)*//*PSRAM: ( 0x1EC00000 - MJENC_TEST_YUV_BUF_SIZE)*/
#else
#define MJENC_TEST_YUV_BUF_ADDR                     ( 0x1EC00000 - MJENC_TEST_YUV_BUF_SIZE) /*OCRAM: (0x11010000)*//*PSRAM: ( 0x1EC00000 - MJENC_TEST_YUV_BUF_SIZE)*/
#endif

#define MJENC_TEST_SWAP_MODE_JPG_OUT_BUF_SIZE       ( 1024*1024 )
#define MJENC_TEST_SWAP_MODE_STREAM_OUT_BUF_SIZE    ( 512*1024 )
#define MJENC_TEST_NORM_MODE_JPG_OUT_BUF_SIZE       ( 1920*1080*9/10 )
