...
#define ISP_MODE_FLOW_FAST        0//sensor ae/awb manual, isp ae/awb contrl, no isp
#define ISP_MODE_FLOW_SENSOR_ISP  1//sensor ae/awb auto, with isp
#define ISP_MODE_FLOW_CALIBRATION 2//sensor ae auto, awb/cc/sat/gamma off, without isp
#define ISP_MODE_FLOW_NONE       99

#define ISP_MODE_FLOW ISP_MODE_FLOW_FAST

static int sample_isp_dvp(void)
{
...
#if (ISP_MODE_FLOW == ISP_MODE_FLOW_FAST)
    imgproc_start_fast(cam_desc);
#endif
#if (ISP_MODE_FLOW == ISP_MODE_FLOW_CALIBRATION)
    imgproc_start_calib(cam_desc);
#endif
#endif
