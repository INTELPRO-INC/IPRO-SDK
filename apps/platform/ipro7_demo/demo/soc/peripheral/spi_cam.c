...
static void spi_dma_cb(void *dev, uint32_t flag)
{
    ...
    switch (gSPICamState) {
        ...
        {
            L1C_DCACHE_INVALID_RANGE((uint32_t)spiCamBuf.frameHdrBuf, 9);
